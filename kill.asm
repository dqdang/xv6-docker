...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  eb:	c7 44 24 04 f7 0d 00 	movl   $0xdf7,0x4(%esp)
  f2:	00 
  f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fa:	e8 1e 09 00 00       	call   a1d <printf>
      exit();
 ...
 127:	c7 44 24 04 12 0e 00 	movl   $0xe12,0x4(%esp)
 12e:	00 
 12f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 136:	e8 e2 08 00 00       	call   a1d <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 3d5:	75 08                	jne    3df <strtok+0x15>
  s = lasts;
 3d7:	a1 24 12 00 00       	mov    0x1224,%eax
 ...
 42c:	a3 24 12 00 00       	mov    %eax,0x1224
    if (*lasts != 0)
 431:	a1 24 12 00 00       	mov    0x1224,%eax
 436:	8a 00                	mov    (%eax),%al
 438:	84 c0                	test   %al,%al
 43a:	74 11                	je     44d <strtok+0x83>
  *lasts++ = 0;
 43c:	a1 24 12 00 00       	mov    0x1224,%eax
 441:	8d 50 01             	lea    0x1(%eax),%edx
 444:	89 15 24 12 00 00    	mov    %edx,0x1224
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 5c6:	eb 22                	jmp    5ea <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 5c8:	8a 86 c0 11 00 00    	mov    0x11c0(%esi),%al
 ...
 5fb:	eb 25                	jmp    622 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 5fd:	8a 86 c0 11 00 00    	mov    0x11c0(%esi),%al
...
putc(int fd, char c)
{
 ...
 961:	e8 d2 fe ff ff       	call   838 <write>
}
 966:	c9                   	leave  
 967:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 9b9:	8a 80 0c 12 00 00    	mov    0x120c(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 b12:	75 09                	jne    b1d <printf+0x100>
          s = "(null)";
 b14:	c7 45 f4 2e 0e 00 00 	movl   $0xe2e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 bdb:	a1 30 12 00 00       	mov    0x1230,%eax
...
free(void *ap)
{
 ...
 ca6:	a3 30 12 00 00       	mov    %eax,0x1230
}
 cab:	c9                   	leave  
 cac:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 ccc:	e8 cf fb ff ff       	call   8a0 <sbrk>
 ...
 cf9:	e8 ce fe ff ff       	call   bcc <free>
  return freep;
 cfe:	a1 30 12 00 00       	mov    0x1230,%eax
}
 d03:	c9                   	leave  
 d04:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d15:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d18:	a1 30 12 00 00       	mov    0x1230,%eax
 d1d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d20:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d24:	75 23                	jne    d49 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d26:	c7 45 f0 28 12 00 00 	movl   $0x1228,-0x10(%ebp)
 d2d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d30:	a3 30 12 00 00       	mov    %eax,0x1230
 d35:	a1 30 12 00 00       	mov    0x1230,%eax
 d3a:	a3 28 12 00 00       	mov    %eax,0x1228
    base.s.size = 0;
 d3f:	c7 05 2c 12 00 00 00 	movl   $0x0,0x122c
 d46:	00 00 00 
  }
 ...
 d9c:	a3 30 12 00 00       	mov    %eax,0x1230
      return (void*)(p + 1);
 ...
 da7:	eb 38                	jmp    de1 <malloc+0xdc>
    ...
    if(p == freep)
 da9:	a1 30 12 00 00       	mov    0x1230,%eax
