...
main(int argc, char **argv)
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 03 0e 00 	movl   $0xe03,0x4(%esp)
  16:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  eb:	c7 44 24 04 17 0e 00 	movl   $0xe17,0x4(%esp)
  f2:	00 
  f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fa:	e8 3e 09 00 00       	call   a3d <printf>
      exit();
 ...
 127:	c7 44 24 04 32 0e 00 	movl   $0xe32,0x4(%esp)
 12e:	00 
 12f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 136:	e8 02 09 00 00       	call   a3d <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 3d5:	75 08                	jne    3df <strtok+0x15>
  s = lasts;
 3d7:	a1 44 12 00 00       	mov    0x1244,%eax
 ...
 42c:	a3 44 12 00 00       	mov    %eax,0x1244
    if (*lasts != 0)
 431:	a1 44 12 00 00       	mov    0x1244,%eax
 436:	8a 00                	mov    (%eax),%al
 438:	84 c0                	test   %al,%al
 43a:	74 11                	je     44d <strtok+0x83>
  *lasts++ = 0;
 43c:	a1 44 12 00 00       	mov    0x1244,%eax
 441:	8d 50 01             	lea    0x1(%eax),%edx
 444:	89 15 44 12 00 00    	mov    %edx,0x1244
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 5c6:	eb 22                	jmp    5ea <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 5c8:	8a 86 e0 11 00 00    	mov    0x11e0(%esi),%al
 ...
 5fb:	eb 25                	jmp    622 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 5fd:	8a 86 e0 11 00 00    	mov    0x11e0(%esi),%al
...
putc(int fd, char c)
{
 ...
 981:	e8 b2 fe ff ff       	call   838 <write>
}
 986:	c9                   	leave  
 987:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 9d9:	8a 80 2c 12 00 00    	mov    0x122c(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 b32:	75 09                	jne    b3d <printf+0x100>
          s = "(null)";
 b34:	c7 45 f4 4e 0e 00 00 	movl   $0xe4e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 bfb:	a1 50 12 00 00       	mov    0x1250,%eax
...
free(void *ap)
{
 ...
 cc6:	a3 50 12 00 00       	mov    %eax,0x1250
}
 ccb:	c9                   	leave  
 ccc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 cec:	e8 af fb ff ff       	call   8a0 <sbrk>
 ...
 d19:	e8 ce fe ff ff       	call   bec <free>
  return freep;
 d1e:	a1 50 12 00 00       	mov    0x1250,%eax
}
 d23:	c9                   	leave  
 d24:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d35:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d38:	a1 50 12 00 00       	mov    0x1250,%eax
 d3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d40:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d44:	75 23                	jne    d69 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d46:	c7 45 f0 48 12 00 00 	movl   $0x1248,-0x10(%ebp)
 d4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d50:	a3 50 12 00 00       	mov    %eax,0x1250
 d55:	a1 50 12 00 00       	mov    0x1250,%eax
 d5a:	a3 48 12 00 00       	mov    %eax,0x1248
    base.s.size = 0;
 d5f:	c7 05 4c 12 00 00 00 	movl   $0x0,0x124c
 d66:	00 00 00 
  }
 ...
 dbc:	a3 50 12 00 00       	mov    %eax,0x1250
      return (void*)(p + 1);
 ...
 dc7:	eb 38                	jmp    e01 <malloc+0xdc>
    ...
    if(p == freep)
 dc9:	a1 50 12 00 00       	mov    0x1250,%eax
