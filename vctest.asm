...
00000000 <main>:
   ...
   f:	c7 44 24 04 f0 0d 00 	movl   $0xdf0,0x4(%esp)
  16:	00 
  17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1e:	e8 06 0a 00 00       	call   a29 <printf>
  ...
  4c:	c7 44 24 04 16 0e 00 	movl   $0xe16,0x4(%esp)
  53:	00 
  54:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  5b:	e8 c9 09 00 00       	call   a29 <printf>
  ...
  e3:	c7 44 24 04 1f 0e 00 	movl   $0xe1f,0x4(%esp)
  ea:	00 
  eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f2:	e8 32 09 00 00       	call   a29 <printf>
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 17f:	c7 44 24 04 32 0e 00 	movl   $0xe32,0x4(%esp)
 186:	00 
 187:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 18e:	e8 96 08 00 00       	call   a29 <printf>
        exit();
 ...
 1bb:	c7 44 24 04 4d 0e 00 	movl   $0xe4d,0x4(%esp)
 1c2:	00 
 1c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1ca:	e8 5a 08 00 00       	call   a29 <printf>
        exit();
...
strtok(char *s, const char *delim)
{
 ...
 469:	75 08                	jne    473 <strtok+0x15>
  s = lasts;
 46b:	a1 64 12 00 00       	mov    0x1264,%eax
 ...
 4c0:	a3 64 12 00 00       	mov    %eax,0x1264
    if (*lasts != 0)
 4c5:	a1 64 12 00 00       	mov    0x1264,%eax
 4ca:	8a 00                	mov    (%eax),%al
 4cc:	84 c0                	test   %al,%al
 4ce:	74 11                	je     4e1 <strtok+0x83>
  *lasts++ = 0;
 4d0:	a1 64 12 00 00       	mov    0x1264,%eax
 4d5:	8d 50 01             	lea    0x1(%eax),%edx
 4d8:	89 15 64 12 00 00    	mov    %edx,0x1264
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 65a:	eb 22                	jmp    67e <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 65c:	8a 86 00 12 00 00    	mov    0x1200(%esi),%al
 ...
 68f:	eb 25                	jmp    6b6 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 691:	8a 86 00 12 00 00    	mov    0x1200(%esi),%al
...
0000094c <putc>:
 ...
 96d:	e8 5a ff ff ff       	call   8cc <write>
 972:	c9                   	leave  
 973:	c3                   	ret    
...
00000974 <printint>:
 ...
 9c5:	8a 80 4c 12 00 00    	mov    0x124c(%eax),%al
...
00000a29 <printf>:
 ...
 b20:	c7 45 f4 69 0e 00 00 	movl   $0xe69,-0xc(%ebp)
...
00000bd8 <free>:
 ...
 be7:	a1 70 12 00 00       	mov    0x1270,%eax
 ...
 cb2:	a3 70 12 00 00       	mov    %eax,0x1270
 cb7:	c9                   	leave  
 cb8:	c3                   	ret    
...
00000cb9 <morecore>:
 ...
 cd8:	e8 57 fc ff ff       	call   934 <sbrk>
 ...
 d0a:	a1 70 12 00 00       	mov    0x1270,%eax
 d0f:	c9                   	leave  
 d10:	c3                   	ret    
...
00000d11 <malloc>:
 ...
 d24:	a1 70 12 00 00       	mov    0x1270,%eax
 d29:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d2c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d30:	75 23                	jne    d55 <malloc+0x44>
 d32:	c7 45 f0 68 12 00 00 	movl   $0x1268,-0x10(%ebp)
 d39:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d3c:	a3 70 12 00 00       	mov    %eax,0x1270
 d41:	a1 70 12 00 00       	mov    0x1270,%eax
 d46:	a3 68 12 00 00       	mov    %eax,0x1268
 d4b:	c7 05 6c 12 00 00 00 	movl   $0x0,0x126c
 d52:	00 00 00 
