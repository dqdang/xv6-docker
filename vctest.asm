...
main(int argc, char *argv[])
{
  ...
  if (argc < 3) {
   ...
   f:	c7 44 24 04 78 0e 00 	movl   $0xe78,0x4(%esp)
  16:	00 
  17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1e:	e8 8e 0a 00 00       	call   ab1 <printf>
    exit();
  ...
  4c:	c7 44 24 04 9e 0e 00 	movl   $0xe9e,0x4(%esp)
  53:	00 
  54:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  5b:	e8 51 0a 00 00       	call   ab1 <printf>
  ...
  e3:	c7 44 24 04 a7 0e 00 	movl   $0xea7,0x4(%esp)
  ea:	00 
  eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f2:	e8 ba 09 00 00       	call   ab1 <printf>
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 17f:	c7 44 24 04 ba 0e 00 	movl   $0xeba,0x4(%esp)
 186:	00 
 187:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 18e:	e8 1e 09 00 00       	call   ab1 <printf>
      exit();
 ...
 1bb:	c7 44 24 04 d5 0e 00 	movl   $0xed5,0x4(%esp)
 1c2:	00 
 1c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1ca:	e8 e2 08 00 00       	call   ab1 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 469:	75 08                	jne    473 <strtok+0x15>
  s = lasts;
 46b:	a1 e4 12 00 00       	mov    0x12e4,%eax
 ...
 4c0:	a3 e4 12 00 00       	mov    %eax,0x12e4
    if (*lasts != 0)
 4c5:	a1 e4 12 00 00       	mov    0x12e4,%eax
 4ca:	8a 00                	mov    (%eax),%al
 4cc:	84 c0                	test   %al,%al
 4ce:	74 11                	je     4e1 <strtok+0x83>
  *lasts++ = 0;
 4d0:	a1 e4 12 00 00       	mov    0x12e4,%eax
 4d5:	8d 50 01             	lea    0x1(%eax),%edx
 4d8:	89 15 e4 12 00 00    	mov    %edx,0x12e4
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 65a:	eb 22                	jmp    67e <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 65c:	8a 86 80 12 00 00    	mov    0x1280(%esi),%al
 ...
 68f:	eb 25                	jmp    6b6 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 691:	8a 86 80 12 00 00    	mov    0x1280(%esi),%al
...
putc(int fd, char c)
{
 ...
 9dd:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
 9e0:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 9e7:	00 
 9e8:	8d 45 f4             	lea    -0xc(%ebp),%eax
 9eb:	89 44 24 04          	mov    %eax,0x4(%esp)
 9ef:	8b 45 08             	mov    0x8(%ebp),%eax
 9f2:	89 04 24             	mov    %eax,(%esp)
 9f5:	e8 d2 fe ff ff       	call   8cc <write>
}
 9fa:	c9                   	leave  
 9fb:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 a01:	83 ec 30             	sub    $0x30,%esp
  ...
  neg = 0;
 a04:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 a0b:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 a0f:	74 17                	je     a28 <printint+0x2c>
 a11:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 a15:	79 11                	jns    a28 <printint+0x2c>
    neg = 1;
 a17:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 a1e:	8b 45 0c             	mov    0xc(%ebp),%eax
 a21:	f7 d8                	neg    %eax
 a23:	89 45 ec             	mov    %eax,-0x14(%ebp)
 a26:	eb 06                	jmp    a2e <printint+0x32>
  } else {
    x = xx;
 ...
 a2e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 a35:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 a38:	8d 41 01             	lea    0x1(%ecx),%eax
 a3b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 a3e:	8b 5d 10             	mov    0x10(%ebp),%ebx
 a41:	8b 45 ec             	mov    -0x14(%ebp),%eax
 a44:	ba 00 00 00 00       	mov    $0x0,%edx
 a49:	f7 f3                	div    %ebx
 a4b:	89 d0                	mov    %edx,%eax
 a4d:	8a 80 cc 12 00 00    	mov    0x12cc(%eax),%al
 a53:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 a57:	8b 75 10             	mov    0x10(%ebp),%esi
 a5a:	8b 45 ec             	mov    -0x14(%ebp),%eax
 a5d:	ba 00 00 00 00       	mov    $0x0,%edx
 a62:	f7 f6                	div    %esi
 a64:	89 45 ec             	mov    %eax,-0x14(%ebp)
 a67:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a6b:	75 c8                	jne    a35 <printint+0x39>
  if(neg)
 a6d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a71:	74 10                	je     a83 <printint+0x87>
    buf[i++] = '-';
 a73:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a76:	8d 50 01             	lea    0x1(%eax),%edx
 a79:	89 55 f4             	mov    %edx,-0xc(%ebp)
 a7c:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 a81:	eb 1e                	jmp    aa1 <printint+0xa5>
 a83:	eb 1c                	jmp    aa1 <printint+0xa5>
    putc(fd, buf[i]);
 a85:	8d 55 dc             	lea    -0x24(%ebp),%edx
 ...
 a9c:	e8 33 ff ff ff       	call   9d4 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 aa1:	ff 4d f4             	decl   -0xc(%ebp)
 aa4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 aa8:	79 db                	jns    a85 <printint+0x89>
    putc(fd, buf[i]);
}
 aaa:	83 c4 30             	add    $0x30,%esp
 aad:	5b                   	pop    %ebx
 aae:	5e                   	pop    %esi
 aaf:	5d                   	pop    %ebp
 ab0:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 ab4:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
 ab7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 abe:	8d 45 0c             	lea    0xc(%ebp),%eax
 ac1:	83 c0 04             	add    $0x4,%eax
 ac4:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 ac7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 ace:	e9 77 01 00 00       	jmp    c4a <printf+0x199>
    c = fmt[i] & 0xff;
 ad3:	8b 55 0c             	mov    0xc(%ebp),%edx
 ad6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ad9:	01 d0                	add    %edx,%eax
 adb:	8a 00                	mov    (%eax),%al
 add:	0f be c0             	movsbl %al,%eax
 ae0:	25 ff 00 00 00       	and    $0xff,%eax
 ae5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 ae8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 aec:	75 2c                	jne    b1a <printf+0x69>
      if(c == '%'){
 aee:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 af2:	75 0c                	jne    b00 <printf+0x4f>
        state = '%';
 af4:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 afb:	e9 47 01 00 00       	jmp    c47 <printf+0x196>
      } else {
        putc(fd, c);
 b00:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 b03:	0f be c0             	movsbl %al,%eax
 b06:	89 44 24 04          	mov    %eax,0x4(%esp)
 b0a:	8b 45 08             	mov    0x8(%ebp),%eax
 b0d:	89 04 24             	mov    %eax,(%esp)
 b10:	e8 bf fe ff ff       	call   9d4 <putc>
 b15:	e9 2d 01 00 00       	jmp    c47 <printf+0x196>
      }
    } else if(state == '%'){
 b1a:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 b1e:	0f 85 23 01 00 00    	jne    c47 <printf+0x196>
      if(c == 'd'){
 b24:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 b28:	75 2d                	jne    b57 <printf+0xa6>
        printint(fd, *ap, 10, 1);
 b2a:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b2d:	8b 00                	mov    (%eax),%eax
 b2f:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 b36:	00 
 b37:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 b3e:	00 
 b3f:	89 44 24 04          	mov    %eax,0x4(%esp)
 b43:	8b 45 08             	mov    0x8(%ebp),%eax
 b46:	89 04 24             	mov    %eax,(%esp)
 b49:	e8 ae fe ff ff       	call   9fc <printint>
        ap++;
 b4e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b52:	e9 e9 00 00 00       	jmp    c40 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 b57:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 b5b:	74 06                	je     b63 <printf+0xb2>
 b5d:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 b61:	75 2d                	jne    b90 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 b63:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b66:	8b 00                	mov    (%eax),%eax
 b68:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 b6f:	00 
 b70:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 b77:	00 
 b78:	89 44 24 04          	mov    %eax,0x4(%esp)
 b7c:	8b 45 08             	mov    0x8(%ebp),%eax
 b7f:	89 04 24             	mov    %eax,(%esp)
 b82:	e8 75 fe ff ff       	call   9fc <printint>
        ap++;
 b87:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b8b:	e9 b0 00 00 00       	jmp    c40 <printf+0x18f>
      } else if(c == 's'){
 b90:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 b94:	75 42                	jne    bd8 <printf+0x127>
        s = (char*)*ap;
 ...
 ba6:	75 09                	jne    bb1 <printf+0x100>
          s = "(null)";
 ba8:	c7 45 f4 f1 0e 00 00 	movl   $0xef1,-0xc(%ebp)
        while(*s != 0){
 baf:	eb 1c                	jmp    bcd <printf+0x11c>
 bb1:	eb 1a                	jmp    bcd <printf+0x11c>
          putc(fd, *s);
 bb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
 bb6:	8a 00                	mov    (%eax),%al
 bb8:	0f be c0             	movsbl %al,%eax
 bbb:	89 44 24 04          	mov    %eax,0x4(%esp)
 bbf:	8b 45 08             	mov    0x8(%ebp),%eax
 bc2:	89 04 24             	mov    %eax,(%esp)
 bc5:	e8 0a fe ff ff       	call   9d4 <putc>
          s++;
 bca:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 bd0:	8a 00                	mov    (%eax),%al
 bd2:	84 c0                	test   %al,%al
 bd4:	75 dd                	jne    bb3 <printf+0x102>
 bd6:	eb 68                	jmp    c40 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 bd8:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 bdc:	75 1d                	jne    bfb <printf+0x14a>
        putc(fd, *ap);
 bde:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ...
 bf0:	e8 df fd ff ff       	call   9d4 <putc>
        ap++;
 bf5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 bf9:	eb 45                	jmp    c40 <printf+0x18f>
      } else if(c == '%'){
 bfb:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 bff:	75 17                	jne    c18 <printf+0x167>
        putc(fd, c);
 c01:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 c04:	0f be c0             	movsbl %al,%eax
 c07:	89 44 24 04          	mov    %eax,0x4(%esp)
 c0b:	8b 45 08             	mov    0x8(%ebp),%eax
 c0e:	89 04 24             	mov    %eax,(%esp)
 c11:	e8 be fd ff ff       	call   9d4 <putc>
 c16:	eb 28                	jmp    c40 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 c18:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 c1f:	00 
 c20:	8b 45 08             	mov    0x8(%ebp),%eax
 c23:	89 04 24             	mov    %eax,(%esp)
 c26:	e8 a9 fd ff ff       	call   9d4 <putc>
        putc(fd, c);
 ...
 c3b:	e8 94 fd ff ff       	call   9d4 <putc>
      }
      state = 0;
 c40:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 c47:	ff 45 f0             	incl   -0x10(%ebp)
 c4a:	8b 55 0c             	mov    0xc(%ebp),%edx
 c4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c50:	01 d0                	add    %edx,%eax
 c52:	8a 00                	mov    (%eax),%al
 c54:	84 c0                	test   %al,%al
 c56:	0f 85 77 fe ff ff    	jne    ad3 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 c69:	83 e8 08             	sub    $0x8,%eax
 c6c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 c6f:	a1 f0 12 00 00       	mov    0x12f0,%eax
 c74:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c77:	eb 24                	jmp    c9d <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 c79:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c7c:	8b 00                	mov    (%eax),%eax
 c7e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c81:	77 12                	ja     c95 <free+0x35>
 c83:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c86:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c89:	77 24                	ja     caf <free+0x4f>
 c8b:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c8e:	8b 00                	mov    (%eax),%eax
 c90:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c93:	77 1a                	ja     caf <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 c9a:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c9d:	8b 45 f8             	mov    -0x8(%ebp),%eax
 ca0:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 ca3:	76 d4                	jbe    c79 <free+0x19>
 ca5:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ca8:	8b 00                	mov    (%eax),%eax
 caa:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 cad:	76 ca                	jbe    c79 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
 caf:	8b 45 f8             	mov    -0x8(%ebp),%eax
 cb2:	8b 40 04             	mov    0x4(%eax),%eax
 cb5:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 cbc:	8b 45 f8             	mov    -0x8(%ebp),%eax
 cbf:	01 c2                	add    %eax,%edx
 cc1:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cc4:	8b 00                	mov    (%eax),%eax
 cc6:	39 c2                	cmp    %eax,%edx
 cc8:	75 24                	jne    cee <free+0x8e>
...
morecore(uint nu)
{
 ...
 d44:	83 ec 28             	sub    $0x28,%esp
  ...
  if(nu < 4096)
 d47:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 d4e:	77 07                	ja     d57 <morecore+0x16>
    nu = 4096;
 d50:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 d57:	8b 45 08             	mov    0x8(%ebp),%eax
 d5a:	c1 e0 03             	shl    $0x3,%eax
 d5d:	89 04 24             	mov    %eax,(%esp)
 d60:	e8 cf fb ff ff       	call   934 <sbrk>
 d65:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 d68:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 d6c:	75 07                	jne    d75 <morecore+0x34>
    return 0;
 d6e:	b8 00 00 00 00       	mov    $0x0,%eax
 d73:	eb 22                	jmp    d97 <morecore+0x56>
  hp = (Header*)p;
 ...
 d87:	83 c0 08             	add    $0x8,%eax
 d8a:	89 04 24             	mov    %eax,(%esp)
 d8d:	e8 ce fe ff ff       	call   c60 <free>
  return freep;
 d92:	a1 f0 12 00 00       	mov    0x12f0,%eax
}
 d97:	c9                   	leave  
 d98:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d9c:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 d9f:	8b 45 08             	mov    0x8(%ebp),%eax
 da2:	83 c0 07             	add    $0x7,%eax
 da5:	c1 e8 03             	shr    $0x3,%eax
 da8:	40                   	inc    %eax
 da9:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 dac:	a1 f0 12 00 00       	mov    0x12f0,%eax
 db1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 db4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 db8:	75 23                	jne    ddd <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 dba:	c7 45 f0 e8 12 00 00 	movl   $0x12e8,-0x10(%ebp)
 dc1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 dc4:	a3 f0 12 00 00       	mov    %eax,0x12f0
 dc9:	a1 f0 12 00 00       	mov    0x12f0,%eax
 dce:	a3 e8 12 00 00       	mov    %eax,0x12e8
    base.s.size = 0;
 dd3:	c7 05 ec 12 00 00 00 	movl   $0x0,0x12ec
 dda:	00 00 00 
  }
 ...
 e70:	e9 70 ff ff ff       	jmp    de5 <malloc+0x4c>
}
 e75:	c9                   	leave  
 e76:	c3                   	ret    
