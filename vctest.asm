...
main(int argc, char *argv[])
{
  ...
  if (argc < 3) {
   ...
   f:	c7 44 24 04 98 0e 00 	movl   $0xe98,0x4(%esp)
  16:	00 
  17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1e:	e8 ae 0a 00 00       	call   ad1 <printf>
    exit();
  ...
  4c:	c7 44 24 04 be 0e 00 	movl   $0xebe,0x4(%esp)
  53:	00 
  54:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  5b:	e8 71 0a 00 00       	call   ad1 <printf>
  ...
  e3:	c7 44 24 04 c7 0e 00 	movl   $0xec7,0x4(%esp)
  ea:	00 
  eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f2:	e8 da 09 00 00       	call   ad1 <printf>
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 17f:	c7 44 24 04 da 0e 00 	movl   $0xeda,0x4(%esp)
 186:	00 
 187:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 18e:	e8 3e 09 00 00       	call   ad1 <printf>
      exit();
 ...
 1bb:	c7 44 24 04 f5 0e 00 	movl   $0xef5,0x4(%esp)
 1c2:	00 
 1c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1ca:	e8 02 09 00 00       	call   ad1 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 469:	75 08                	jne    473 <strtok+0x15>
  s = lasts;
 46b:	a1 04 13 00 00       	mov    0x1304,%eax
 ...
 4c0:	a3 04 13 00 00       	mov    %eax,0x1304
    if (*lasts != 0)
 4c5:	a1 04 13 00 00       	mov    0x1304,%eax
 4ca:	8a 00                	mov    (%eax),%al
 4cc:	84 c0                	test   %al,%al
 4ce:	74 11                	je     4e1 <strtok+0x83>
  *lasts++ = 0;
 4d0:	a1 04 13 00 00       	mov    0x1304,%eax
 4d5:	8d 50 01             	lea    0x1(%eax),%edx
 4d8:	89 15 04 13 00 00    	mov    %edx,0x1304
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 65a:	eb 22                	jmp    67e <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 65c:	8a 86 a0 12 00 00    	mov    0x12a0(%esi),%al
 ...
 68f:	eb 25                	jmp    6b6 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 691:	8a 86 a0 12 00 00    	mov    0x12a0(%esi),%al
...
putc(int fd, char c)
{
 ...
 9fd:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
 a00:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 a07:	00 
 a08:	8d 45 f4             	lea    -0xc(%ebp),%eax
 a0b:	89 44 24 04          	mov    %eax,0x4(%esp)
 a0f:	8b 45 08             	mov    0x8(%ebp),%eax
 a12:	89 04 24             	mov    %eax,(%esp)
 a15:	e8 b2 fe ff ff       	call   8cc <write>
}
 a1a:	c9                   	leave  
 a1b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 a24:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 a2b:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 a2f:	74 17                	je     a48 <printint+0x2c>
 a31:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 a35:	79 11                	jns    a48 <printint+0x2c>
    neg = 1;
 a37:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 a3e:	8b 45 0c             	mov    0xc(%ebp),%eax
 a41:	f7 d8                	neg    %eax
 a43:	89 45 ec             	mov    %eax,-0x14(%ebp)
 a46:	eb 06                	jmp    a4e <printint+0x32>
  } else {
    x = xx;
 ...
 a4e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 a55:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 a58:	8d 41 01             	lea    0x1(%ecx),%eax
 a5b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 a5e:	8b 5d 10             	mov    0x10(%ebp),%ebx
 a61:	8b 45 ec             	mov    -0x14(%ebp),%eax
 a64:	ba 00 00 00 00       	mov    $0x0,%edx
 a69:	f7 f3                	div    %ebx
 a6b:	89 d0                	mov    %edx,%eax
 a6d:	8a 80 ec 12 00 00    	mov    0x12ec(%eax),%al
 a73:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 a77:	8b 75 10             	mov    0x10(%ebp),%esi
 a7a:	8b 45 ec             	mov    -0x14(%ebp),%eax
 a7d:	ba 00 00 00 00       	mov    $0x0,%edx
 a82:	f7 f6                	div    %esi
 a84:	89 45 ec             	mov    %eax,-0x14(%ebp)
 a87:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a8b:	75 c8                	jne    a55 <printint+0x39>
  if(neg)
 a8d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a91:	74 10                	je     aa3 <printint+0x87>
    buf[i++] = '-';
 a93:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a96:	8d 50 01             	lea    0x1(%eax),%edx
 a99:	89 55 f4             	mov    %edx,-0xc(%ebp)
 a9c:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 aa1:	eb 1e                	jmp    ac1 <printint+0xa5>
 aa3:	eb 1c                	jmp    ac1 <printint+0xa5>
    putc(fd, buf[i]);
 aa5:	8d 55 dc             	lea    -0x24(%ebp),%edx
 ...
 abc:	e8 33 ff ff ff       	call   9f4 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 ac1:	ff 4d f4             	decl   -0xc(%ebp)
 ac4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 ac8:	79 db                	jns    aa5 <printint+0x89>
    putc(fd, buf[i]);
}
 aca:	83 c4 30             	add    $0x30,%esp
 acd:	5b                   	pop    %ebx
 ace:	5e                   	pop    %esi
 acf:	5d                   	pop    %ebp
 ad0:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 ad4:	83 ec 38             	sub    $0x38,%esp
  ...
  state = 0;
 ad7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 ade:	8d 45 0c             	lea    0xc(%ebp),%eax
 ae1:	83 c0 04             	add    $0x4,%eax
 ae4:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 ae7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 aee:	e9 77 01 00 00       	jmp    c6a <printf+0x199>
    c = fmt[i] & 0xff;
 af3:	8b 55 0c             	mov    0xc(%ebp),%edx
 af6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 af9:	01 d0                	add    %edx,%eax
 afb:	8a 00                	mov    (%eax),%al
 afd:	0f be c0             	movsbl %al,%eax
 b00:	25 ff 00 00 00       	and    $0xff,%eax
 b05:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 b08:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 b0c:	75 2c                	jne    b3a <printf+0x69>
      if(c == '%'){
 b0e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 b12:	75 0c                	jne    b20 <printf+0x4f>
        state = '%';
 b14:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 b1b:	e9 47 01 00 00       	jmp    c67 <printf+0x196>
      } else {
        putc(fd, c);
 b20:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 b23:	0f be c0             	movsbl %al,%eax
 b26:	89 44 24 04          	mov    %eax,0x4(%esp)
 b2a:	8b 45 08             	mov    0x8(%ebp),%eax
 b2d:	89 04 24             	mov    %eax,(%esp)
 b30:	e8 bf fe ff ff       	call   9f4 <putc>
 b35:	e9 2d 01 00 00       	jmp    c67 <printf+0x196>
      }
    } else if(state == '%'){
 b3a:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 b3e:	0f 85 23 01 00 00    	jne    c67 <printf+0x196>
      if(c == 'd'){
 b44:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 b48:	75 2d                	jne    b77 <printf+0xa6>
        printint(fd, *ap, 10, 1);
 b4a:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b4d:	8b 00                	mov    (%eax),%eax
 b4f:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 b56:	00 
 b57:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 b5e:	00 
 b5f:	89 44 24 04          	mov    %eax,0x4(%esp)
 b63:	8b 45 08             	mov    0x8(%ebp),%eax
 b66:	89 04 24             	mov    %eax,(%esp)
 b69:	e8 ae fe ff ff       	call   a1c <printint>
        ap++;
 b6e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b72:	e9 e9 00 00 00       	jmp    c60 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 b77:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 b7b:	74 06                	je     b83 <printf+0xb2>
 b7d:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 b81:	75 2d                	jne    bb0 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 b83:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b86:	8b 00                	mov    (%eax),%eax
 b88:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 b8f:	00 
 b90:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 b97:	00 
 b98:	89 44 24 04          	mov    %eax,0x4(%esp)
 b9c:	8b 45 08             	mov    0x8(%ebp),%eax
 b9f:	89 04 24             	mov    %eax,(%esp)
 ba2:	e8 75 fe ff ff       	call   a1c <printint>
        ap++;
 ba7:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 bab:	e9 b0 00 00 00       	jmp    c60 <printf+0x18f>
      } else if(c == 's'){
 bb0:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 bb4:	75 42                	jne    bf8 <printf+0x127>
        s = (char*)*ap;
 ...
 bc6:	75 09                	jne    bd1 <printf+0x100>
          s = "(null)";
 bc8:	c7 45 f4 11 0f 00 00 	movl   $0xf11,-0xc(%ebp)
        while(*s != 0){
 bcf:	eb 1c                	jmp    bed <printf+0x11c>
 bd1:	eb 1a                	jmp    bed <printf+0x11c>
          putc(fd, *s);
 bd3:	8b 45 f4             	mov    -0xc(%ebp),%eax
 bd6:	8a 00                	mov    (%eax),%al
 bd8:	0f be c0             	movsbl %al,%eax
 bdb:	89 44 24 04          	mov    %eax,0x4(%esp)
 bdf:	8b 45 08             	mov    0x8(%ebp),%eax
 be2:	89 04 24             	mov    %eax,(%esp)
 be5:	e8 0a fe ff ff       	call   9f4 <putc>
          s++;
 bea:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 bf4:	75 dd                	jne    bd3 <printf+0x102>
 bf6:	eb 68                	jmp    c60 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 bf8:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 bfc:	75 1d                	jne    c1b <printf+0x14a>
        putc(fd, *ap);
 ...
 c10:	e8 df fd ff ff       	call   9f4 <putc>
        ap++;
 c15:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 c19:	eb 45                	jmp    c60 <printf+0x18f>
      } else if(c == '%'){
 c1b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 c1f:	75 17                	jne    c38 <printf+0x167>
        putc(fd, c);
 c21:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 c24:	0f be c0             	movsbl %al,%eax
 c27:	89 44 24 04          	mov    %eax,0x4(%esp)
 c2b:	8b 45 08             	mov    0x8(%ebp),%eax
 c2e:	89 04 24             	mov    %eax,(%esp)
 c31:	e8 be fd ff ff       	call   9f4 <putc>
 c36:	eb 28                	jmp    c60 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 c38:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 c3f:	00 
 c40:	8b 45 08             	mov    0x8(%ebp),%eax
 c43:	89 04 24             	mov    %eax,(%esp)
 c46:	e8 a9 fd ff ff       	call   9f4 <putc>
        putc(fd, c);
 c4b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 c4e:	0f be c0             	movsbl %al,%eax
 c51:	89 44 24 04          	mov    %eax,0x4(%esp)
 c55:	8b 45 08             	mov    0x8(%ebp),%eax
 c58:	89 04 24             	mov    %eax,(%esp)
 c5b:	e8 94 fd ff ff       	call   9f4 <putc>
      }
      state = 0;
 c60:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 c67:	ff 45 f0             	incl   -0x10(%ebp)
 c6a:	8b 55 0c             	mov    0xc(%ebp),%edx
 c6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c70:	01 d0                	add    %edx,%eax
 c72:	8a 00                	mov    (%eax),%al
 c74:	84 c0                	test   %al,%al
 c76:	0f 85 77 fe ff ff    	jne    af3 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 c89:	83 e8 08             	sub    $0x8,%eax
 c8c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 c8f:	a1 10 13 00 00       	mov    0x1310,%eax
 c94:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c97:	eb 24                	jmp    cbd <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 c99:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c9c:	8b 00                	mov    (%eax),%eax
 c9e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 ca1:	77 12                	ja     cb5 <free+0x35>
 ca3:	8b 45 f8             	mov    -0x8(%ebp),%eax
 ca6:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 ca9:	77 24                	ja     ccf <free+0x4f>
 cab:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cae:	8b 00                	mov    (%eax),%eax
 cb0:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 cb3:	77 1a                	ja     ccf <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 cba:	89 45 fc             	mov    %eax,-0x4(%ebp)
 cbd:	8b 45 f8             	mov    -0x8(%ebp),%eax
 cc0:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 cc3:	76 d4                	jbe    c99 <free+0x19>
 cc5:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cc8:	8b 00                	mov    (%eax),%eax
 cca:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 ccd:	76 ca                	jbe    c99 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
 ...
 cdc:	8b 45 f8             	mov    -0x8(%ebp),%eax
 cdf:	01 c2                	add    %eax,%edx
 ce1:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ce4:	8b 00                	mov    (%eax),%eax
 ce6:	39 c2                	cmp    %eax,%edx
 ce8:	75 24                	jne    d0e <free+0x8e>
...
morecore(uint nu)
{
 ...
 d64:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
 d67:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 d6e:	77 07                	ja     d77 <morecore+0x16>
    nu = 4096;
 d70:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 d77:	8b 45 08             	mov    0x8(%ebp),%eax
 d7a:	c1 e0 03             	shl    $0x3,%eax
 d7d:	89 04 24             	mov    %eax,(%esp)
 d80:	e8 af fb ff ff       	call   934 <sbrk>
 d85:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 d88:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 d8c:	75 07                	jne    d95 <morecore+0x34>
    return 0;
 d8e:	b8 00 00 00 00       	mov    $0x0,%eax
 d93:	eb 22                	jmp    db7 <morecore+0x56>
  hp = (Header*)p;
 d95:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d98:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
 d9b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d9e:	8b 55 08             	mov    0x8(%ebp),%edx
 da1:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
 da4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 da7:	83 c0 08             	add    $0x8,%eax
 daa:	89 04 24             	mov    %eax,(%esp)
 dad:	e8 ce fe ff ff       	call   c80 <free>
  return freep;
 db2:	a1 10 13 00 00       	mov    0x1310,%eax
}
 db7:	c9                   	leave  
 db8:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 dbc:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 dbf:	8b 45 08             	mov    0x8(%ebp),%eax
 dc2:	83 c0 07             	add    $0x7,%eax
 dc5:	c1 e8 03             	shr    $0x3,%eax
 dc8:	40                   	inc    %eax
 dc9:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 dcc:	a1 10 13 00 00       	mov    0x1310,%eax
 dd1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 dd4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 dd8:	75 23                	jne    dfd <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 dda:	c7 45 f0 08 13 00 00 	movl   $0x1308,-0x10(%ebp)
 de1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 de4:	a3 10 13 00 00       	mov    %eax,0x1310
 de9:	a1 10 13 00 00       	mov    0x1310,%eax
 dee:	a3 08 13 00 00       	mov    %eax,0x1308
    base.s.size = 0;
 df3:	c7 05 0c 13 00 00 00 	movl   $0x0,0x130c
 dfa:	00 00 00 
  }
 ...
 e0b:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 e0e:	72 4d                	jb     e5d <malloc+0xa4>
      if(p->s.size == nunits)
 e10:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e13:	8b 40 04             	mov    0x4(%eax),%eax
 e16:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 e19:	75 0c                	jne    e27 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
 e1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e1e:	8b 10                	mov    (%eax),%edx
 e20:	8b 45 f0             	mov    -0x10(%ebp),%eax
 e23:	89 10                	mov    %edx,(%eax)
 e25:	eb 26                	jmp    e4d <malloc+0x94>
      else {
        p->s.size -= nunits;
 e27:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e2a:	8b 40 04             	mov    0x4(%eax),%eax
 e2d:	2b 45 ec             	sub    -0x14(%ebp),%eax
 e30:	89 c2                	mov    %eax,%edx
 e32:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e35:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 e38:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e3b:	8b 40 04             	mov    0x4(%eax),%eax
 e3e:	c1 e0 03             	shl    $0x3,%eax
 e41:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 e44:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e47:	8b 55 ec             	mov    -0x14(%ebp),%edx
 e4a:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 e4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 e50:	a3 10 13 00 00       	mov    %eax,0x1310
      return (void*)(p + 1);
 e55:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e58:	83 c0 08             	add    $0x8,%eax
 e5b:	eb 38                	jmp    e95 <malloc+0xdc>
    }
    if(p == freep)
 e5d:	a1 10 13 00 00       	mov    0x1310,%eax
 e62:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 e65:	75 1b                	jne    e82 <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
 e67:	8b 45 ec             	mov    -0x14(%ebp),%eax
 e6a:	89 04 24             	mov    %eax,(%esp)
 e6d:	e8 ef fe ff ff       	call   d61 <morecore>
 e72:	89 45 f4             	mov    %eax,-0xc(%ebp)
 e75:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 e79:	75 07                	jne    e82 <malloc+0xc9>
        return 0;
 e7b:	b8 00 00 00 00       	mov    $0x0,%eax
 e80:	eb 13                	jmp    e95 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 e90:	e9 70 ff ff ff       	jmp    e05 <malloc+0x4c>
}
 e95:	c9                   	leave  
 e96:	c3                   	ret    
