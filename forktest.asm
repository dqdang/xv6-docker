...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 1c 0a 00 	movl   $0xa1c,0x4(%esp)
  36:	00 
  ...
  62:	e8 5d 08 00 00       	call   8c4 <exit>
{
  ...
  83:	00 
  84:	c7 44 24 04 28 0a 00 	movl   $0xa28,0x4(%esp)
  8b:	00 
  ...
  a8:	c7 44 24 04 47 0a 00 	movl   $0xa47,0x4(%esp)
  af:	00 
  ...
  d4:	c7 44 24 04 5b 0a 00 	movl   $0xa5b,0x4(%esp)
  db:	00 
  ...
  ed:	c7 44 24 04 6e 0a 00 	movl   $0xa6e,0x4(%esp)
  f4:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 197:	c7 44 24 04 7c 0a 00 	movl   $0xa7c,0x4(%esp)
 19e:	00 
 ...
 1d3:	c7 44 24 04 97 0a 00 	movl   $0xa97,0x4(%esp)
 1da:	00 
...
strtok(char *s, const char *delim)
{
 ...
 481:	75 08                	jne    48b <strtok+0x15>
  s = lasts;
 483:	a1 10 0e 00 00       	mov    0xe10,%eax
 ...
 4d8:	a3 10 0e 00 00       	mov    %eax,0xe10
    if (*lasts != 0)
 4dd:	a1 10 0e 00 00       	mov    0xe10,%eax
 4e2:	8a 00                	mov    (%eax),%al
 4e4:	84 c0                	test   %al,%al
 4e6:	74 11                	je     4f9 <strtok+0x83>
  *lasts++ = 0;
 4e8:	a1 10 0e 00 00       	mov    0xe10,%eax
 4ed:	8d 50 01             	lea    0x1(%eax),%edx
 4f0:	89 15 10 0e 00 00    	mov    %edx,0xe10
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 672:	eb 22                	jmp    696 <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 674:	8a 86 c0 0d 00 00    	mov    0xdc0(%esi),%al
 ...
 6a7:	eb 25                	jmp    6ce <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 6a9:	8a 86 c0 0d 00 00    	mov    0xdc0(%esi),%al
...
000009c4 <setvc>:
SYSCALL(setvc)
 9c4:	b8 22 00 00 00       	mov    $0x22,%eax
 9c9:	cd 40                	int    $0x40
 9cb:	c3                   	ret    

000009cc <setactivefs>:
SYSCALL(setactivefs)
 9cc:	b8 24 00 00 00       	mov    $0x24,%eax
 9d1:	cd 40                	int    $0x40
 9d3:	c3                   	ret    

000009d4 <getactivefs>:
SYSCALL(getactivefs)
 9d4:	b8 25 00 00 00       	mov    $0x25,%eax
 9d9:	cd 40                	int    $0x40
 9db:	c3                   	ret    

000009dc <getvcfs>:
SYSCALL(getvcfs)
 9dc:	b8 23 00 00 00       	mov    $0x23,%eax
 9e1:	cd 40                	int    $0x40
 9e3:	c3                   	ret    

000009e4 <getcwd>:
SYSCALL(getcwd)
 9e4:	b8 26 00 00 00       	mov    $0x26,%eax
 9e9:	cd 40                	int    $0x40
 9eb:	c3                   	ret    

000009ec <tostring>:
SYSCALL(tostring)
 9ec:	b8 27 00 00 00       	mov    $0x27,%eax
 9f1:	cd 40                	int    $0x40
 9f3:	c3                   	ret    

000009f4 <getactivefsindex>:
SYSCALL(getactivefsindex)
 9f4:	b8 28 00 00 00       	mov    $0x28,%eax
 9f9:	cd 40                	int    $0x40
 9fb:	c3                   	ret    

000009fc <setatroot>:
SYSCALL(setatroot)
 9fc:	b8 2a 00 00 00       	mov    $0x2a,%eax
 a01:	cd 40                	int    $0x40
 a03:	c3                   	ret    

00000a04 <getatroot>:
SYSCALL(getatroot)
 a04:	b8 29 00 00 00       	mov    $0x29,%eax
 a09:	cd 40                	int    $0x40
 a0b:	c3                   	ret    
...
00000a14 <setpath>:
SYSCALL(setpath)
 a14:	b8 2c 00 00 00       	mov    $0x2c,%eax
 a19:	cd 40                	int    $0x40
 a1b:	c3                   	ret    
