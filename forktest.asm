...
00000029 <forktest>:
  ...
  2f:	c7 44 24 04 64 09 00 	movl   $0x964,0x4(%esp)
  36:	00 
  ...
  83:	00 
  84:	c7 44 24 04 70 09 00 	movl   $0x970,0x4(%esp)
  8b:	00 
  ...
  a8:	c7 44 24 04 8f 09 00 	movl   $0x98f,0x4(%esp)
  af:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 197:	c7 44 24 04 c4 09 00 	movl   $0x9c4,0x4(%esp)
 19e:	00 
 ...
 1d3:	c7 44 24 04 df 09 00 	movl   $0x9df,0x4(%esp)
 1da:	00 
...
strtok(char *s, const char *delim)
{
 ...
 481:	75 08                	jne    48b <strtok+0x15>
  s = lasts;
 483:	a1 50 0d 00 00       	mov    0xd50,%eax
 ...
 4d8:	a3 50 0d 00 00       	mov    %eax,0xd50
    if (*lasts != 0)
 4dd:	a1 50 0d 00 00       	mov    0xd50,%eax
 4e2:	8a 00                	mov    (%eax),%al
 4e4:	84 c0                	test   %al,%al
 4e6:	74 11                	je     4f9 <strtok+0x83>
  *lasts++ = 0;
 4e8:	a1 50 0d 00 00       	mov    0xd50,%eax
 4ed:	8d 50 01             	lea    0x1(%eax),%edx
 4f0:	89 15 50 0d 00 00    	mov    %edx,0xd50
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 672:	eb 22                	jmp    696 <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 674:	8a 86 00 0d 00 00    	mov    0xd00(%esi),%al
 ...
 6a7:	eb 25                	jmp    6ce <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 6a9:	8a 86 00 0d 00 00    	mov    0xd00(%esi),%al
