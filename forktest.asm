  ...
  62:	e8 01 03 00 00       	call   368 <exit>
{
  ...
  83:	00 
  84:	c7 44 24 04 14 04 00 	movl   $0x414,0x4(%esp)
  8b:	00 
  ...
  a8:	c7 44 24 04 33 04 00 	movl   $0x433,0x4(%esp)
  af:	00 
  ...
  d4:	c7 44 24 04 47 04 00 	movl   $0x447,0x4(%esp)
  db:	00 
  ...
  ed:	c7 44 24 04 5a 04 00 	movl   $0x45a,0x4(%esp)
  f4:	00 
