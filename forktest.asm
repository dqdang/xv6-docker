...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 0c 0a 00 	movl   $0xa0c,0x4(%esp)
  36:	00 
  ...
  62:	e8 5d 08 00 00       	call   8c4 <exit>
{
  ...
  83:	00 
  84:	c7 44 24 04 18 0a 00 	movl   $0xa18,0x4(%esp)
  8b:	00 
  ...
  a8:	c7 44 24 04 37 0a 00 	movl   $0xa37,0x4(%esp)
  af:	00 
  ...
  d4:	c7 44 24 04 4b 0a 00 	movl   $0xa4b,0x4(%esp)
  db:	00 
  ...
  ed:	c7 44 24 04 5e 0a 00 	movl   $0xa5e,0x4(%esp)
  f4:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 197:	c7 44 24 04 6c 0a 00 	movl   $0xa6c,0x4(%esp)
 19e:	00 
 ...
 1d3:	c7 44 24 04 87 0a 00 	movl   $0xa87,0x4(%esp)
 1da:	00 
...
strtok(char *s, const char *delim)
{
 ...
 481:	75 08                	jne    48b <strtok+0x15>
  s = lasts;
 483:	a1 f0 0d 00 00       	mov    0xdf0,%eax
 ...
 4d8:	a3 f0 0d 00 00       	mov    %eax,0xdf0
    if (*lasts != 0)
 4dd:	a1 f0 0d 00 00       	mov    0xdf0,%eax
 4e2:	8a 00                	mov    (%eax),%al
 4e4:	84 c0                	test   %al,%al
 4e6:	74 11                	je     4f9 <strtok+0x83>
  *lasts++ = 0;
 4e8:	a1 f0 0d 00 00       	mov    0xdf0,%eax
 4ed:	8d 50 01             	lea    0x1(%eax),%edx
 4f0:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 672:	eb 22                	jmp    696 <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 674:	8a 86 a0 0d 00 00    	mov    0xda0(%esi),%al
 ...
 6a7:	eb 25                	jmp    6ce <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 6a9:	8a 86 a0 0d 00 00    	mov    0xda0(%esi),%al
