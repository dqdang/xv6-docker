...
main(int argc, char *argv[])
{
  ...
  3f:	e8 5c 08 00 00       	call   8a0 <link>
  ...
  60:	c7 44 24 04 96 0d 00 	movl   $0xd96,0x4(%esp)
  67:	00 
  68:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6f:	e8 49 09 00 00       	call   9bd <printf>
  exit();
  74:	e8 c7 07 00 00       	call   840 <exit>
  79:	90                   	nop
  7a:	90                   	nop
  7b:	90                   	nop
...
int copy(char *inputfile, char *outputfile, int used_disk, int max_disk){
 ...
 162:	c7 44 24 04 e1 0d 00 	movl   $0xde1,0x4(%esp)
 169:	00 
 16a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 171:	e8 47 08 00 00       	call   9bd <printf>
        if(max > max_disk){
 176:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 179:	3b 45 14             	cmp    0x14(%ebp),%eax
 17c:	7e 07                	jle    185 <copy+0xb6>
          return -1;
 17e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 183:	eb 5c                	jmp    1e1 <copy+0x112>
        }
        bytes = bytes + count;
...
memset(void *dst, int c, uint n)
{
 ...
 2a8:	e8 cf fd ff ff       	call   7c <stosb>
  return dst;
...
printf(int fd, char *fmt, ...)
{
 ...
 ab2:	75 09                	jne    abd <printf+0x100>
          s = "(null)";
 ab4:	c7 45 f4 f2 0d 00 00 	movl   $0xdf2,-0xc(%ebp)
        while(*s != 0){
