...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 f7 0d 00 	movl   $0xdf7,0x4(%esp)
  16:	00 
  17:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1e:	e8 0e 0a 00 00       	call   a31 <printf>
    exit();
  ...
  60:	c7 44 24 04 0a 0e 00 	movl   $0xe0a,0x4(%esp)
  67:	00 
  68:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6f:	e8 bd 09 00 00       	call   a31 <printf>
  exit();
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  ff:	c7 44 24 04 1e 0e 00 	movl   $0xe1e,0x4(%esp)
 106:	00 
 107:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 10e:	e8 1e 09 00 00       	call   a31 <printf>
      exit();
 ...
 13b:	c7 44 24 04 39 0e 00 	movl   $0xe39,0x4(%esp)
 142:	00 
 143:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 14a:	e8 e2 08 00 00       	call   a31 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 3e9:	75 08                	jne    3f3 <strtok+0x15>
  s = lasts;
 3eb:	a1 44 12 00 00       	mov    0x1244,%eax
 ...
 440:	a3 44 12 00 00       	mov    %eax,0x1244
    if (*lasts != 0)
 445:	a1 44 12 00 00       	mov    0x1244,%eax
 44a:	8a 00                	mov    (%eax),%al
 44c:	84 c0                	test   %al,%al
 44e:	74 11                	je     461 <strtok+0x83>
  *lasts++ = 0;
 450:	a1 44 12 00 00       	mov    0x1244,%eax
 455:	8d 50 01             	lea    0x1(%eax),%edx
 458:	89 15 44 12 00 00    	mov    %edx,0x1244
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 5da:	eb 22                	jmp    5fe <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 5dc:	8a 86 e0 11 00 00    	mov    0x11e0(%esi),%al
 ...
 60f:	eb 25                	jmp    636 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 611:	8a 86 e0 11 00 00    	mov    0x11e0(%esi),%al
...
putc(int fd, char c)
{
 ...
 95d:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
 960:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 967:	00 
 968:	8d 45 f4             	lea    -0xc(%ebp),%eax
 96b:	89 44 24 04          	mov    %eax,0x4(%esp)
 96f:	8b 45 08             	mov    0x8(%ebp),%eax
 972:	89 04 24             	mov    %eax,(%esp)
 975:	e8 d2 fe ff ff       	call   84c <write>
}
 97a:	c9                   	leave  
 97b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 981:	83 ec 30             	sub    $0x30,%esp
  ...
  neg = 0;
 984:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 98b:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 98f:	74 17                	je     9a8 <printint+0x2c>
 991:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 995:	79 11                	jns    9a8 <printint+0x2c>
    neg = 1;
 997:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 99e:	8b 45 0c             	mov    0xc(%ebp),%eax
 9a1:	f7 d8                	neg    %eax
 9a3:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9a6:	eb 06                	jmp    9ae <printint+0x32>
  } else {
    x = xx;
 ...
 9ae:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 9b5:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 9b8:	8d 41 01             	lea    0x1(%ecx),%eax
 9bb:	89 45 f4             	mov    %eax,-0xc(%ebp)
 9be:	8b 5d 10             	mov    0x10(%ebp),%ebx
 9c1:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9c4:	ba 00 00 00 00       	mov    $0x0,%edx
 9c9:	f7 f3                	div    %ebx
 9cb:	89 d0                	mov    %edx,%eax
 9cd:	8a 80 2c 12 00 00    	mov    0x122c(%eax),%al
 9d3:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 9d7:	8b 75 10             	mov    0x10(%ebp),%esi
 ...
 9eb:	75 c8                	jne    9b5 <printint+0x39>
  if(neg)
 9ed:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 9f1:	74 10                	je     a03 <printint+0x87>
    buf[i++] = '-';
 ...
 a1c:	e8 33 ff ff ff       	call   954 <putc>
  ...
  while(--i >= 0)
 a21:	ff 4d f4             	decl   -0xc(%ebp)
 a24:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a28:	79 db                	jns    a05 <printint+0x89>
    putc(fd, buf[i]);
}
 a2a:	83 c4 30             	add    $0x30,%esp
 a2d:	5b                   	pop    %ebx
 a2e:	5e                   	pop    %esi
 a2f:	5d                   	pop    %ebp
 a30:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 a34:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
 a37:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 a3e:	8d 45 0c             	lea    0xc(%ebp),%eax
 a41:	83 c0 04             	add    $0x4,%eax
 a44:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 a47:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 a4e:	e9 77 01 00 00       	jmp    bca <printf+0x199>
    c = fmt[i] & 0xff;
 a53:	8b 55 0c             	mov    0xc(%ebp),%edx
 a56:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a59:	01 d0                	add    %edx,%eax
 a5b:	8a 00                	mov    (%eax),%al
 a5d:	0f be c0             	movsbl %al,%eax
 a60:	25 ff 00 00 00       	and    $0xff,%eax
 a65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 a68:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a6c:	75 2c                	jne    a9a <printf+0x69>
      if(c == '%'){
 a6e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a72:	75 0c                	jne    a80 <printf+0x4f>
        state = '%';
 a74:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 a7b:	e9 47 01 00 00       	jmp    bc7 <printf+0x196>
      } else {
        putc(fd, c);
 ...
 a90:	e8 bf fe ff ff       	call   954 <putc>
 a95:	e9 2d 01 00 00       	jmp    bc7 <printf+0x196>
      }
    } else if(state == '%'){
 a9a:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 a9e:	0f 85 23 01 00 00    	jne    bc7 <printf+0x196>
      if(c == 'd'){
 aa4:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 aa8:	75 2d                	jne    ad7 <printf+0xa6>
        printint(fd, *ap, 10, 1);
 aaa:	8b 45 e8             	mov    -0x18(%ebp),%eax
 aad:	8b 00                	mov    (%eax),%eax
 aaf:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 ab6:	00 
 ab7:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 abe:	00 
 abf:	89 44 24 04          	mov    %eax,0x4(%esp)
 ac3:	8b 45 08             	mov    0x8(%ebp),%eax
 ac6:	89 04 24             	mov    %eax,(%esp)
 ac9:	e8 ae fe ff ff       	call   97c <printint>
        ap++;
 ace:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 ad2:	e9 e9 00 00 00       	jmp    bc0 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 ad7:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 adb:	74 06                	je     ae3 <printf+0xb2>
 add:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 ae1:	75 2d                	jne    b10 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 ae3:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ae6:	8b 00                	mov    (%eax),%eax
 ae8:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 aef:	00 
 af0:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 af7:	00 
 af8:	89 44 24 04          	mov    %eax,0x4(%esp)
 afc:	8b 45 08             	mov    0x8(%ebp),%eax
 aff:	89 04 24             	mov    %eax,(%esp)
 b02:	e8 75 fe ff ff       	call   97c <printint>
        ap++;
 b07:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b0b:	e9 b0 00 00 00       	jmp    bc0 <printf+0x18f>
      } else if(c == 's'){
 b10:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 b14:	75 42                	jne    b58 <printf+0x127>
        s = (char*)*ap;
 b16:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b19:	8b 00                	mov    (%eax),%eax
 b1b:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
 b1e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
 b22:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b26:	75 09                	jne    b31 <printf+0x100>
          s = "(null)";
 b28:	c7 45 f4 55 0e 00 00 	movl   $0xe55,-0xc(%ebp)
        while(*s != 0){
 b2f:	eb 1c                	jmp    b4d <printf+0x11c>
 b31:	eb 1a                	jmp    b4d <printf+0x11c>
          putc(fd, *s);
 b33:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b36:	8a 00                	mov    (%eax),%al
 b38:	0f be c0             	movsbl %al,%eax
 b3b:	89 44 24 04          	mov    %eax,0x4(%esp)
 b3f:	8b 45 08             	mov    0x8(%ebp),%eax
 b42:	89 04 24             	mov    %eax,(%esp)
 b45:	e8 0a fe ff ff       	call   954 <putc>
          s++;
 b4a:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 b50:	8a 00                	mov    (%eax),%al
 b52:	84 c0                	test   %al,%al
 b54:	75 dd                	jne    b33 <printf+0x102>
 b56:	eb 68                	jmp    bc0 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 b58:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 b5c:	75 1d                	jne    b7b <printf+0x14a>
        putc(fd, *ap);
 ...
 b70:	e8 df fd ff ff       	call   954 <putc>
        ap++;
 b75:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b79:	eb 45                	jmp    bc0 <printf+0x18f>
      } else if(c == '%'){
 b7b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 b7f:	75 17                	jne    b98 <printf+0x167>
        putc(fd, c);
 ...
 b91:	e8 be fd ff ff       	call   954 <putc>
 b96:	eb 28                	jmp    bc0 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 b98:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 b9f:	00 
 ba0:	8b 45 08             	mov    0x8(%ebp),%eax
 ba3:	89 04 24             	mov    %eax,(%esp)
 ba6:	e8 a9 fd ff ff       	call   954 <putc>
        putc(fd, c);
 bab:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 bae:	0f be c0             	movsbl %al,%eax
 bb1:	89 44 24 04          	mov    %eax,0x4(%esp)
 bb5:	8b 45 08             	mov    0x8(%ebp),%eax
 bb8:	89 04 24             	mov    %eax,(%esp)
 bbb:	e8 94 fd ff ff       	call   954 <putc>
      }
      state = 0;
 bc0:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 bc7:	ff 45 f0             	incl   -0x10(%ebp)
 bca:	8b 55 0c             	mov    0xc(%ebp),%edx
 bcd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 bd0:	01 d0                	add    %edx,%eax
 bd2:	8a 00                	mov    (%eax),%al
 bd4:	84 c0                	test   %al,%al
 bd6:	0f 85 77 fe ff ff    	jne    a53 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 be9:	83 e8 08             	sub    $0x8,%eax
 bec:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 bef:	a1 50 12 00 00       	mov    0x1250,%eax
 bf4:	89 45 fc             	mov    %eax,-0x4(%ebp)
 bf7:	eb 24                	jmp    c1d <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 bf9:	8b 45 fc             	mov    -0x4(%ebp),%eax
 bfc:	8b 00                	mov    (%eax),%eax
 bfe:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c01:	77 12                	ja     c15 <free+0x35>
 c03:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c06:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c09:	77 24                	ja     c2f <free+0x4f>
 c0b:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c0e:	8b 00                	mov    (%eax),%eax
 c10:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c13:	77 1a                	ja     c2f <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 c7e:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 c85:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c88:	01 d0                	add    %edx,%eax
 c8a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c8d:	75 20                	jne    caf <free+0xcf>
    p->s.size += bp->s.size;
 c8f:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c92:	8b 50 04             	mov    0x4(%eax),%edx
 c95:	8b 45 f8             	mov    -0x8(%ebp),%eax
 ...
 cab:	89 10                	mov    %edx,(%eax)
 cad:	eb 08                	jmp    cb7 <free+0xd7>
  } else
    p->s.ptr = bp;
 caf:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cb2:	8b 55 f8             	mov    -0x8(%ebp),%edx
 cb5:	89 10                	mov    %edx,(%eax)
  freep = p;
 cb7:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cba:	a3 50 12 00 00       	mov    %eax,0x1250
}
 cbf:	c9                   	leave  
 cc0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 cc4:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
 cc7:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 cce:	77 07                	ja     cd7 <morecore+0x16>
    nu = 4096;
 cd0:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 cd7:	8b 45 08             	mov    0x8(%ebp),%eax
 cda:	c1 e0 03             	shl    $0x3,%eax
 cdd:	89 04 24             	mov    %eax,(%esp)
 ce0:	e8 cf fb ff ff       	call   8b4 <sbrk>
 ce5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 ce8:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 cec:	75 07                	jne    cf5 <morecore+0x34>
    return 0;
 cee:	b8 00 00 00 00       	mov    $0x0,%eax
 cf3:	eb 22                	jmp    d17 <morecore+0x56>
  hp = (Header*)p;
 cf5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 cf8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
 cfb:	8b 45 f0             	mov    -0x10(%ebp),%eax
 cfe:	8b 55 08             	mov    0x8(%ebp),%edx
 d01:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
 d04:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d07:	83 c0 08             	add    $0x8,%eax
 d0a:	89 04 24             	mov    %eax,(%esp)
 d0d:	e8 ce fe ff ff       	call   be0 <free>
  return freep;
 d12:	a1 50 12 00 00       	mov    0x1250,%eax
}
 d17:	c9                   	leave  
 d18:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d22:	83 c0 07             	add    $0x7,%eax
 d25:	c1 e8 03             	shr    $0x3,%eax
 d28:	40                   	inc    %eax
 d29:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d2c:	a1 50 12 00 00       	mov    0x1250,%eax
 d31:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d34:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d38:	75 23                	jne    d5d <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d3a:	c7 45 f0 48 12 00 00 	movl   $0x1248,-0x10(%ebp)
 d41:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d44:	a3 50 12 00 00       	mov    %eax,0x1250
 d49:	a1 50 12 00 00       	mov    0x1250,%eax
 d4e:	a3 48 12 00 00       	mov    %eax,0x1248
    base.s.size = 0;
 d53:	c7 05 4c 12 00 00 00 	movl   $0x0,0x124c
 d5a:	00 00 00 
  }
 ...
 d6b:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 d6e:	72 4d                	jb     dbd <malloc+0xa4>
      if(p->s.size == nunits)
 d70:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d73:	8b 40 04             	mov    0x4(%eax),%eax
 d76:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 d79:	75 0c                	jne    d87 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
 d7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d7e:	8b 10                	mov    (%eax),%edx
 d80:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d83:	89 10                	mov    %edx,(%eax)
 d85:	eb 26                	jmp    dad <malloc+0x94>
      else {
        p->s.size -= nunits;
 d87:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d8a:	8b 40 04             	mov    0x4(%eax),%eax
 d8d:	2b 45 ec             	sub    -0x14(%ebp),%eax
 d90:	89 c2                	mov    %eax,%edx
 d92:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d95:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 d98:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d9b:	8b 40 04             	mov    0x4(%eax),%eax
 d9e:	c1 e0 03             	shl    $0x3,%eax
 da1:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 da4:	8b 45 f4             	mov    -0xc(%ebp),%eax
 da7:	8b 55 ec             	mov    -0x14(%ebp),%edx
 daa:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 dad:	8b 45 f0             	mov    -0x10(%ebp),%eax
 db0:	a3 50 12 00 00       	mov    %eax,0x1250
      return (void*)(p + 1);
 db5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 db8:	83 c0 08             	add    $0x8,%eax
 dbb:	eb 38                	jmp    df5 <malloc+0xdc>
    }
    if(p == freep)
 dbd:	a1 50 12 00 00       	mov    0x1250,%eax
 dc2:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 dc5:	75 1b                	jne    de2 <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
 dc7:	8b 45 ec             	mov    -0x14(%ebp),%eax
 dca:	89 04 24             	mov    %eax,(%esp)
 dcd:	e8 ef fe ff ff       	call   cc1 <morecore>
 dd2:	89 45 f4             	mov    %eax,-0xc(%ebp)
 dd5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 dd9:	75 07                	jne    de2 <malloc+0xc9>
        return 0;
 ddb:	b8 00 00 00 00       	mov    $0x0,%eax
 de0:	eb 13                	jmp    df5 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 df0:	e9 70 ff ff ff       	jmp    d65 <malloc+0x4c>
}
 df5:	c9                   	leave  
 df6:	c3                   	ret    
