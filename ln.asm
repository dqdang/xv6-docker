...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 17 0e 00 	movl   $0xe17,0x4(%esp)
  16:	00 
  17:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1e:	e8 2e 0a 00 00       	call   a51 <printf>
    exit();
  ...
  60:	c7 44 24 04 2a 0e 00 	movl   $0xe2a,0x4(%esp)
  67:	00 
  68:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6f:	e8 dd 09 00 00       	call   a51 <printf>
  exit();
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  ff:	c7 44 24 04 3e 0e 00 	movl   $0xe3e,0x4(%esp)
 106:	00 
 107:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 10e:	e8 3e 09 00 00       	call   a51 <printf>
      exit();
 ...
 13b:	c7 44 24 04 59 0e 00 	movl   $0xe59,0x4(%esp)
 142:	00 
 143:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 14a:	e8 02 09 00 00       	call   a51 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 3e9:	75 08                	jne    3f3 <strtok+0x15>
  s = lasts;
 3eb:	a1 64 12 00 00       	mov    0x1264,%eax
 ...
 440:	a3 64 12 00 00       	mov    %eax,0x1264
    if (*lasts != 0)
 445:	a1 64 12 00 00       	mov    0x1264,%eax
 44a:	8a 00                	mov    (%eax),%al
 44c:	84 c0                	test   %al,%al
 44e:	74 11                	je     461 <strtok+0x83>
  *lasts++ = 0;
 450:	a1 64 12 00 00       	mov    0x1264,%eax
 455:	8d 50 01             	lea    0x1(%eax),%edx
 458:	89 15 64 12 00 00    	mov    %edx,0x1264
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 5da:	eb 22                	jmp    5fe <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 5dc:	8a 86 00 12 00 00    	mov    0x1200(%esi),%al
 ...
 60f:	eb 25                	jmp    636 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 611:	8a 86 00 12 00 00    	mov    0x1200(%esi),%al
...
putc(int fd, char c)
{
 ...
 995:	e8 b2 fe ff ff       	call   84c <write>
}
 99a:	c9                   	leave  
 99b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 9ed:	8a 80 4c 12 00 00    	mov    0x124c(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 b46:	75 09                	jne    b51 <printf+0x100>
          s = "(null)";
 b48:	c7 45 f4 75 0e 00 00 	movl   $0xe75,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 c0f:	a1 70 12 00 00       	mov    0x1270,%eax
...
free(void *ap)
{
 ...
 cda:	a3 70 12 00 00       	mov    %eax,0x1270
}
 cdf:	c9                   	leave  
 ce0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 d00:	e8 af fb ff ff       	call   8b4 <sbrk>
 ...
 d2d:	e8 ce fe ff ff       	call   c00 <free>
  return freep;
 d32:	a1 70 12 00 00       	mov    0x1270,%eax
}
 d37:	c9                   	leave  
 d38:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d49:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d4c:	a1 70 12 00 00       	mov    0x1270,%eax
 d51:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d54:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d58:	75 23                	jne    d7d <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d5a:	c7 45 f0 68 12 00 00 	movl   $0x1268,-0x10(%ebp)
 d61:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d64:	a3 70 12 00 00       	mov    %eax,0x1270
 d69:	a1 70 12 00 00       	mov    0x1270,%eax
 d6e:	a3 68 12 00 00       	mov    %eax,0x1268
    base.s.size = 0;
 d73:	c7 05 6c 12 00 00 00 	movl   $0x0,0x126c
 d7a:	00 00 00 
  }
 ...
 dd0:	a3 70 12 00 00       	mov    %eax,0x1270
      return (void*)(p + 1);
 ...
 ddb:	eb 38                	jmp    e15 <malloc+0xdc>
    ...
    if(p == freep)
 ddd:	a1 70 12 00 00       	mov    0x1270,%eax
