...
00000000 <main>:
   ...
   f:	c7 44 24 04 9c 0d 00 	movl   $0xd9c,0x4(%esp)
  16:	00 
  17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1e:	e8 b2 09 00 00       	call   9d5 <printf>
  ...
  50:	b8 c3 0d 00 00       	mov    $0xdc3,%eax
  55:	eb 05                	jmp    5c <main+0x5c>
  57:	b8 c5 0d 00 00       	mov    $0xdc5,%eax
  ...
  76:	c7 44 24 04 c7 0d 00 	movl   $0xdc7,0x4(%esp)
  7d:	00 
  7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  85:	e8 4b 09 00 00       	call   9d5 <printf>
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 12b:	c7 44 24 04 cc 0d 00 	movl   $0xdcc,0x4(%esp)
 132:	00 
 133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 13a:	e8 96 08 00 00       	call   9d5 <printf>
        exit();
 ...
 167:	c7 44 24 04 e7 0d 00 	movl   $0xde7,0x4(%esp)
 16e:	00 
 16f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 176:	e8 5a 08 00 00       	call   9d5 <printf>
        exit();
...
strtok(char *s, const char *delim)
{
 ...
 415:	75 08                	jne    41f <strtok+0x15>
  s = lasts;
 417:	a1 04 12 00 00       	mov    0x1204,%eax
 ...
 46c:	a3 04 12 00 00       	mov    %eax,0x1204
    if (*lasts != 0)
 471:	a1 04 12 00 00       	mov    0x1204,%eax
 476:	8a 00                	mov    (%eax),%al
 478:	84 c0                	test   %al,%al
 47a:	74 11                	je     48d <strtok+0x83>
  *lasts++ = 0;
 47c:	a1 04 12 00 00       	mov    0x1204,%eax
 481:	8d 50 01             	lea    0x1(%eax),%edx
 484:	89 15 04 12 00 00    	mov    %edx,0x1204
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 606:	eb 22                	jmp    62a <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 608:	8a 86 a0 11 00 00    	mov    0x11a0(%esi),%al
 ...
 63b:	eb 25                	jmp    662 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 63d:	8a 86 a0 11 00 00    	mov    0x11a0(%esi),%al
...
00000920 <printint>:
 ...
 923:	56                   	push   %esi
 924:	53                   	push   %ebx
 925:	83 ec 30             	sub    $0x30,%esp
 928:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 92f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 933:	74 17                	je     94c <printint+0x2c>
 935:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 939:	79 11                	jns    94c <printint+0x2c>
 93b:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
 942:	8b 45 0c             	mov    0xc(%ebp),%eax
 945:	f7 d8                	neg    %eax
 947:	89 45 ec             	mov    %eax,-0x14(%ebp)
 94a:	eb 06                	jmp    952 <printint+0x32>
 94c:	8b 45 0c             	mov    0xc(%ebp),%eax
 94f:	89 45 ec             	mov    %eax,-0x14(%ebp)
 952:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 959:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 95c:	8d 41 01             	lea    0x1(%ecx),%eax
 95f:	89 45 f4             	mov    %eax,-0xc(%ebp)
 962:	8b 5d 10             	mov    0x10(%ebp),%ebx
 965:	8b 45 ec             	mov    -0x14(%ebp),%eax
 968:	ba 00 00 00 00       	mov    $0x0,%edx
 96d:	f7 f3                	div    %ebx
 96f:	89 d0                	mov    %edx,%eax
 971:	8a 80 ec 11 00 00    	mov    0x11ec(%eax),%al
 977:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
 97b:	8b 75 10             	mov    0x10(%ebp),%esi
 97e:	8b 45 ec             	mov    -0x14(%ebp),%eax
 981:	ba 00 00 00 00       	mov    $0x0,%edx
 986:	f7 f6                	div    %esi
 988:	89 45 ec             	mov    %eax,-0x14(%ebp)
 98b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 98f:	75 c8                	jne    959 <printint+0x39>
 991:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 995:	74 10                	je     9a7 <printint+0x87>
 997:	8b 45 f4             	mov    -0xc(%ebp),%eax
 99a:	8d 50 01             	lea    0x1(%eax),%edx
 99d:	89 55 f4             	mov    %edx,-0xc(%ebp)
 9a0:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
 9a5:	eb 1e                	jmp    9c5 <printint+0xa5>
 9a7:	eb 1c                	jmp    9c5 <printint+0xa5>
 9a9:	8d 55 dc             	lea    -0x24(%ebp),%edx
 9ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
 9af:	01 d0                	add    %edx,%eax
 9b1:	8a 00                	mov    (%eax),%al
 9b3:	0f be c0             	movsbl %al,%eax
 9b6:	89 44 24 04          	mov    %eax,0x4(%esp)
 9ba:	8b 45 08             	mov    0x8(%ebp),%eax
 9bd:	89 04 24             	mov    %eax,(%esp)
 9c0:	e8 33 ff ff ff       	call   8f8 <putc>
 9c5:	ff 4d f4             	decl   -0xc(%ebp)
 9c8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 9cc:	79 db                	jns    9a9 <printint+0x89>
 9ce:	83 c4 30             	add    $0x30,%esp
 9d1:	5b                   	pop    %ebx
 9d2:	5e                   	pop    %esi
 9d3:	5d                   	pop    %ebp
 9d4:	c3                   	ret    
...
000009d5 <printf>:
 ...
 9d8:	83 ec 38             	sub    $0x38,%esp
 9db:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
 9e2:	8d 45 0c             	lea    0xc(%ebp),%eax
 9e5:	83 c0 04             	add    $0x4,%eax
 9e8:	89 45 e8             	mov    %eax,-0x18(%ebp)
 9eb:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 9f2:	e9 77 01 00 00       	jmp    b6e <printf+0x199>
 9f7:	8b 55 0c             	mov    0xc(%ebp),%edx
 9fa:	8b 45 f0             	mov    -0x10(%ebp),%eax
 9fd:	01 d0                	add    %edx,%eax
 9ff:	8a 00                	mov    (%eax),%al
 a01:	0f be c0             	movsbl %al,%eax
 a04:	25 ff 00 00 00       	and    $0xff,%eax
 a09:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 a0c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a10:	75 2c                	jne    a3e <printf+0x69>
 a12:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a16:	75 0c                	jne    a24 <printf+0x4f>
 a18:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 a1f:	e9 47 01 00 00       	jmp    b6b <printf+0x196>
 ...
 a34:	e8 bf fe ff ff       	call   8f8 <putc>
 a39:	e9 2d 01 00 00       	jmp    b6b <printf+0x196>
 a3e:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 a42:	0f 85 23 01 00 00    	jne    b6b <printf+0x196>
 a48:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 a4c:	75 2d                	jne    a7b <printf+0xa6>
 a4e:	8b 45 e8             	mov    -0x18(%ebp),%eax
 a51:	8b 00                	mov    (%eax),%eax
 a53:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 a5a:	00 
 a5b:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 a62:	00 
 a63:	89 44 24 04          	mov    %eax,0x4(%esp)
 a67:	8b 45 08             	mov    0x8(%ebp),%eax
 a6a:	89 04 24             	mov    %eax,(%esp)
 a6d:	e8 ae fe ff ff       	call   920 <printint>
 a72:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 a76:	e9 e9 00 00 00       	jmp    b64 <printf+0x18f>
 a7b:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 a7f:	74 06                	je     a87 <printf+0xb2>
 a81:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 a85:	75 2d                	jne    ab4 <printf+0xdf>
 a87:	8b 45 e8             	mov    -0x18(%ebp),%eax
 a8a:	8b 00                	mov    (%eax),%eax
 a8c:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 a93:	00 
 a94:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 a9b:	00 
 a9c:	89 44 24 04          	mov    %eax,0x4(%esp)
 aa0:	8b 45 08             	mov    0x8(%ebp),%eax
 aa3:	89 04 24             	mov    %eax,(%esp)
 aa6:	e8 75 fe ff ff       	call   920 <printint>
 aab:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 aaf:	e9 b0 00 00 00       	jmp    b64 <printf+0x18f>
 ab4:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 ab8:	75 42                	jne    afc <printf+0x127>
 ...
 b35:	e8 be fd ff ff       	call   8f8 <putc>
 b3a:	eb 28                	jmp    b64 <printf+0x18f>
 b3c:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 b43:	00 
 b44:	8b 45 08             	mov    0x8(%ebp),%eax
 b47:	89 04 24             	mov    %eax,(%esp)
 b4a:	e8 a9 fd ff ff       	call   8f8 <putc>
 ...
 b5f:	e8 94 fd ff ff       	call   8f8 <putc>
 b64:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
 b6b:	ff 45 f0             	incl   -0x10(%ebp)
 b6e:	8b 55 0c             	mov    0xc(%ebp),%edx
 b71:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b74:	01 d0                	add    %edx,%eax
 b76:	8a 00                	mov    (%eax),%al
 b78:	84 c0                	test   %al,%al
 b7a:	0f 85 77 fe ff ff    	jne    9f7 <printf+0x22>
 b80:	c9                   	leave  
 b81:	c3                   	ret    
 b82:	90                   	nop
 b83:	90                   	nop
...
00000b84 <free>:
 ...
 b87:	83 ec 10             	sub    $0x10,%esp
 b8a:	8b 45 08             	mov    0x8(%ebp),%eax
 b8d:	83 e8 08             	sub    $0x8,%eax
 b90:	89 45 f8             	mov    %eax,-0x8(%ebp)
 b93:	a1 10 12 00 00       	mov    0x1210,%eax
 b98:	89 45 fc             	mov    %eax,-0x4(%ebp)
 b9b:	eb 24                	jmp    bc1 <free+0x3d>
 b9d:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ba0:	8b 00                	mov    (%eax),%eax
 ba2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 ba5:	77 12                	ja     bb9 <free+0x35>
 ba7:	8b 45 f8             	mov    -0x8(%ebp),%eax
 baa:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 bad:	77 24                	ja     bd3 <free+0x4f>
 baf:	8b 45 fc             	mov    -0x4(%ebp),%eax
 bb2:	8b 00                	mov    (%eax),%eax
 bb4:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 bb7:	77 1a                	ja     bd3 <free+0x4f>
 bb9:	8b 45 fc             	mov    -0x4(%ebp),%eax
 bbc:	8b 00                	mov    (%eax),%eax
 bbe:	89 45 fc             	mov    %eax,-0x4(%ebp)
 bc1:	8b 45 f8             	mov    -0x8(%ebp),%eax
 bc4:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 bc7:	76 d4                	jbe    b9d <free+0x19>
 bc9:	8b 45 fc             	mov    -0x4(%ebp),%eax
 bcc:	8b 00                	mov    (%eax),%eax
 bce:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 bd1:	76 ca                	jbe    b9d <free+0x19>
 bd3:	8b 45 f8             	mov    -0x8(%ebp),%eax
 bd6:	8b 40 04             	mov    0x4(%eax),%eax
 bd9:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 be0:	8b 45 f8             	mov    -0x8(%ebp),%eax
 be3:	01 c2                	add    %eax,%edx
 be5:	8b 45 fc             	mov    -0x4(%ebp),%eax
 be8:	8b 00                	mov    (%eax),%eax
 bea:	39 c2                	cmp    %eax,%edx
 bec:	75 24                	jne    c12 <free+0x8e>
 ...
 c51:	eb 08                	jmp    c5b <free+0xd7>
 c53:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c56:	8b 55 f8             	mov    -0x8(%ebp),%edx
 c59:	89 10                	mov    %edx,(%eax)
 c5b:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c5e:	a3 10 12 00 00       	mov    %eax,0x1210
 c63:	c9                   	leave  
 c64:	c3                   	ret    
...
00000c65 <morecore>:
 ...
 c6b:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 c72:	77 07                	ja     c7b <morecore+0x16>
 c74:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
 c7b:	8b 45 08             	mov    0x8(%ebp),%eax
 c7e:	c1 e0 03             	shl    $0x3,%eax
 c81:	89 04 24             	mov    %eax,(%esp)
 c84:	e8 57 fc ff ff       	call   8e0 <sbrk>
 c89:	89 45 f4             	mov    %eax,-0xc(%ebp)
 c8c:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 c90:	75 07                	jne    c99 <morecore+0x34>
 c92:	b8 00 00 00 00       	mov    $0x0,%eax
 c97:	eb 22                	jmp    cbb <morecore+0x56>
 ...
 cb1:	e8 ce fe ff ff       	call   b84 <free>
 cb6:	a1 10 12 00 00       	mov    0x1210,%eax
 cbb:	c9                   	leave  
 cbc:	c3                   	ret    
...
00000cbd <malloc>:
 ...
 cc0:	83 ec 28             	sub    $0x28,%esp
 cc3:	8b 45 08             	mov    0x8(%ebp),%eax
 cc6:	83 c0 07             	add    $0x7,%eax
 cc9:	c1 e8 03             	shr    $0x3,%eax
 ccc:	40                   	inc    %eax
 ccd:	89 45 ec             	mov    %eax,-0x14(%ebp)
 cd0:	a1 10 12 00 00       	mov    0x1210,%eax
 cd5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 cd8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 cdc:	75 23                	jne    d01 <malloc+0x44>
 cde:	c7 45 f0 08 12 00 00 	movl   $0x1208,-0x10(%ebp)
 ce5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ce8:	a3 10 12 00 00       	mov    %eax,0x1210
 ced:	a1 10 12 00 00       	mov    0x1210,%eax
 cf2:	a3 08 12 00 00       	mov    %eax,0x1208
 cf7:	c7 05 0c 12 00 00 00 	movl   $0x0,0x120c
 cfe:	00 00 00 
 ...
 d0f:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 d12:	72 4d                	jb     d61 <malloc+0xa4>
 d14:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d17:	8b 40 04             	mov    0x4(%eax),%eax
 d1a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 d1d:	75 0c                	jne    d2b <malloc+0x6e>
 d1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d22:	8b 10                	mov    (%eax),%edx
 d24:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d27:	89 10                	mov    %edx,(%eax)
 d29:	eb 26                	jmp    d51 <malloc+0x94>
 d2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d2e:	8b 40 04             	mov    0x4(%eax),%eax
 d31:	2b 45 ec             	sub    -0x14(%ebp),%eax
 ...
 d45:	01 45 f4             	add    %eax,-0xc(%ebp)
 d48:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d4b:	8b 55 ec             	mov    -0x14(%ebp),%edx
 d4e:	89 50 04             	mov    %edx,0x4(%eax)
 d51:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d54:	a3 10 12 00 00       	mov    %eax,0x1210
 d59:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d5c:	83 c0 08             	add    $0x8,%eax
 d5f:	eb 38                	jmp    d99 <malloc+0xdc>
 d61:	a1 10 12 00 00       	mov    0x1210,%eax
 d66:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 d69:	75 1b                	jne    d86 <malloc+0xc9>
 d6b:	8b 45 ec             	mov    -0x14(%ebp),%eax
 d6e:	89 04 24             	mov    %eax,(%esp)
 d71:	e8 ef fe ff ff       	call   c65 <morecore>
 d76:	89 45 f4             	mov    %eax,-0xc(%ebp)
 d79:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 d7d:	75 07                	jne    d86 <malloc+0xc9>
 d7f:	b8 00 00 00 00       	mov    $0x0,%eax
 d84:	eb 13                	jmp    d99 <malloc+0xdc>
 ...
 d94:	e9 70 ff ff ff       	jmp    d09 <malloc+0x4c>
 d99:	c9                   	leave  
 d9a:	c3                   	ret    
