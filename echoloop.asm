...
main(int argc, char *argv[])
{
  ...
  if (argc < 3) {
   ...
   f:	c7 44 24 04 fc 0d 00 	movl   $0xdfc,0x4(%esp)
  16:	00 
  17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1e:	e8 12 0a 00 00       	call   a35 <printf>
  	exit();
  ...
  50:	b8 23 0e 00 00       	mov    $0xe23,%eax
  55:	eb 05                	jmp    5c <main+0x5c>
  57:	b8 25 0e 00 00       	mov    $0xe25,%eax
  ...
  76:	c7 44 24 04 27 0e 00 	movl   $0xe27,0x4(%esp)
  7d:	00 
  7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  85:	e8 ab 09 00 00       	call   a35 <printf>
  }
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 12b:	c7 44 24 04 2c 0e 00 	movl   $0xe2c,0x4(%esp)
 132:	00 
 133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 13a:	e8 f6 08 00 00       	call   a35 <printf>
      exit();
 ...
 167:	c7 44 24 04 47 0e 00 	movl   $0xe47,0x4(%esp)
 16e:	00 
 16f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 176:	e8 ba 08 00 00       	call   a35 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 415:	75 08                	jne    41f <strtok+0x15>
  s = lasts;
 417:	a1 64 12 00 00       	mov    0x1264,%eax
 ...
 46c:	a3 64 12 00 00       	mov    %eax,0x1264
    if (*lasts != 0)
 471:	a1 64 12 00 00       	mov    0x1264,%eax
 476:	8a 00                	mov    (%eax),%al
 478:	84 c0                	test   %al,%al
 47a:	74 11                	je     48d <strtok+0x83>
  *lasts++ = 0;
 47c:	a1 64 12 00 00       	mov    0x1264,%eax
 481:	8d 50 01             	lea    0x1(%eax),%edx
 484:	89 15 64 12 00 00    	mov    %edx,0x1264
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 606:	eb 22                	jmp    62a <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 608:	8a 86 00 12 00 00    	mov    0x1200(%esi),%al
 ...
 63b:	eb 25                	jmp    662 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 63d:	8a 86 00 12 00 00    	mov    0x1200(%esi),%al
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 985:	83 ec 30             	sub    $0x30,%esp
  ...
  neg = 0;
 988:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 98f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 993:	74 17                	je     9ac <printint+0x2c>
 995:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 999:	79 11                	jns    9ac <printint+0x2c>
    neg = 1;
 99b:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 9a2:	8b 45 0c             	mov    0xc(%ebp),%eax
 9a5:	f7 d8                	neg    %eax
 9a7:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9aa:	eb 06                	jmp    9b2 <printint+0x32>
  } else {
    x = xx;
 ...
 9b2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 9b9:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 9bc:	8d 41 01             	lea    0x1(%ecx),%eax
 9bf:	89 45 f4             	mov    %eax,-0xc(%ebp)
 9c2:	8b 5d 10             	mov    0x10(%ebp),%ebx
 9c5:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9c8:	ba 00 00 00 00       	mov    $0x0,%edx
 9cd:	f7 f3                	div    %ebx
 9cf:	89 d0                	mov    %edx,%eax
 9d1:	8a 80 4c 12 00 00    	mov    0x124c(%eax),%al
 9d7:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 9db:	8b 75 10             	mov    0x10(%ebp),%esi
 9de:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9e1:	ba 00 00 00 00       	mov    $0x0,%edx
 9e6:	f7 f6                	div    %esi
 9e8:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9eb:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 9ef:	75 c8                	jne    9b9 <printint+0x39>
  if(neg)
 9f1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 9f5:	74 10                	je     a07 <printint+0x87>
    buf[i++] = '-';
 9f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
 9fa:	8d 50 01             	lea    0x1(%eax),%edx
 9fd:	89 55 f4             	mov    %edx,-0xc(%ebp)
 a00:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 a05:	eb 1e                	jmp    a25 <printint+0xa5>
 a07:	eb 1c                	jmp    a25 <printint+0xa5>
    putc(fd, buf[i]);
 a09:	8d 55 dc             	lea    -0x24(%ebp),%edx
 ...
 a20:	e8 33 ff ff ff       	call   958 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 a25:	ff 4d f4             	decl   -0xc(%ebp)
 a28:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a2c:	79 db                	jns    a09 <printint+0x89>
    putc(fd, buf[i]);
}
 a2e:	83 c4 30             	add    $0x30,%esp
 a31:	5b                   	pop    %ebx
 a32:	5e                   	pop    %esi
 a33:	5d                   	pop    %ebp
 a34:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 a3b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 a42:	8d 45 0c             	lea    0xc(%ebp),%eax
 a45:	83 c0 04             	add    $0x4,%eax
 a48:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 a4b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 a52:	e9 77 01 00 00       	jmp    bce <printf+0x199>
    c = fmt[i] & 0xff;
 a57:	8b 55 0c             	mov    0xc(%ebp),%edx
 a5a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a5d:	01 d0                	add    %edx,%eax
 a5f:	8a 00                	mov    (%eax),%al
 a61:	0f be c0             	movsbl %al,%eax
 a64:	25 ff 00 00 00       	and    $0xff,%eax
 a69:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 a6c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a70:	75 2c                	jne    a9e <printf+0x69>
      if(c == '%'){
 a72:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a76:	75 0c                	jne    a84 <printf+0x4f>
        state = '%';
 a78:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 a7f:	e9 47 01 00 00       	jmp    bcb <printf+0x196>
      } else {
        putc(fd, c);
 a84:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a87:	0f be c0             	movsbl %al,%eax
 a8a:	89 44 24 04          	mov    %eax,0x4(%esp)
 a8e:	8b 45 08             	mov    0x8(%ebp),%eax
 a91:	89 04 24             	mov    %eax,(%esp)
 a94:	e8 bf fe ff ff       	call   958 <putc>
 a99:	e9 2d 01 00 00       	jmp    bcb <printf+0x196>
      }
    } else if(state == '%'){
 a9e:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 aa2:	0f 85 23 01 00 00    	jne    bcb <printf+0x196>
      if(c == 'd'){
 aa8:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 aac:	75 2d                	jne    adb <printf+0xa6>
        printint(fd, *ap, 10, 1);
 aae:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ab1:	8b 00                	mov    (%eax),%eax
 ab3:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 aba:	00 
 abb:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 ac2:	00 
 ac3:	89 44 24 04          	mov    %eax,0x4(%esp)
 ac7:	8b 45 08             	mov    0x8(%ebp),%eax
 aca:	89 04 24             	mov    %eax,(%esp)
 acd:	e8 ae fe ff ff       	call   980 <printint>
        ap++;
 ad2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 ad6:	e9 e9 00 00 00       	jmp    bc4 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 adb:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 adf:	74 06                	je     ae7 <printf+0xb2>
 ae1:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 ae5:	75 2d                	jne    b14 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 ae7:	8b 45 e8             	mov    -0x18(%ebp),%eax
 aea:	8b 00                	mov    (%eax),%eax
 aec:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 af3:	00 
 af4:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 afb:	00 
 afc:	89 44 24 04          	mov    %eax,0x4(%esp)
 b00:	8b 45 08             	mov    0x8(%ebp),%eax
 b03:	89 04 24             	mov    %eax,(%esp)
 b06:	e8 75 fe ff ff       	call   980 <printint>
        ap++;
 b0b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b0f:	e9 b0 00 00 00       	jmp    bc4 <printf+0x18f>
      } else if(c == 's'){
 b14:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 b18:	75 42                	jne    b5c <printf+0x127>
        s = (char*)*ap;
 b1a:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b1d:	8b 00                	mov    (%eax),%eax
 b1f:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
 b22:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
 b26:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b2a:	75 09                	jne    b35 <printf+0x100>
          s = "(null)";
 b2c:	c7 45 f4 63 0e 00 00 	movl   $0xe63,-0xc(%ebp)
        while(*s != 0){
 b33:	eb 1c                	jmp    b51 <printf+0x11c>
 b35:	eb 1a                	jmp    b51 <printf+0x11c>
          putc(fd, *s);
 b37:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b3a:	8a 00                	mov    (%eax),%al
 b3c:	0f be c0             	movsbl %al,%eax
 b3f:	89 44 24 04          	mov    %eax,0x4(%esp)
 b43:	8b 45 08             	mov    0x8(%ebp),%eax
 b46:	89 04 24             	mov    %eax,(%esp)
 b49:	e8 0a fe ff ff       	call   958 <putc>
          s++;
 b4e:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 b54:	8a 00                	mov    (%eax),%al
 b56:	84 c0                	test   %al,%al
 b58:	75 dd                	jne    b37 <printf+0x102>
 b5a:	eb 68                	jmp    bc4 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 b5c:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 b60:	75 1d                	jne    b7f <printf+0x14a>
        putc(fd, *ap);
 ...
 b74:	e8 df fd ff ff       	call   958 <putc>
        ap++;
 b79:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b7d:	eb 45                	jmp    bc4 <printf+0x18f>
      } else if(c == '%'){
 b7f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 b83:	75 17                	jne    b9c <printf+0x167>
        putc(fd, c);
 b85:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 b88:	0f be c0             	movsbl %al,%eax
 b8b:	89 44 24 04          	mov    %eax,0x4(%esp)
 b8f:	8b 45 08             	mov    0x8(%ebp),%eax
 b92:	89 04 24             	mov    %eax,(%esp)
 b95:	e8 be fd ff ff       	call   958 <putc>
 b9a:	eb 28                	jmp    bc4 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 b9c:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 ba3:	00 
 ba4:	8b 45 08             	mov    0x8(%ebp),%eax
 ba7:	89 04 24             	mov    %eax,(%esp)
 baa:	e8 a9 fd ff ff       	call   958 <putc>
        putc(fd, c);
 ...
 bbf:	e8 94 fd ff ff       	call   958 <putc>
      }
      state = 0;
 bc4:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
...
free(void *ap)
{
 ...
 be7:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
 bea:	8b 45 08             	mov    0x8(%ebp),%eax
 bed:	83 e8 08             	sub    $0x8,%eax
 bf0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 bf3:	a1 70 12 00 00       	mov    0x1270,%eax
 bf8:	89 45 fc             	mov    %eax,-0x4(%ebp)
 bfb:	eb 24                	jmp    c21 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 bfd:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c00:	8b 00                	mov    (%eax),%eax
 c02:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c05:	77 12                	ja     c19 <free+0x35>
 c07:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c0a:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c0d:	77 24                	ja     c33 <free+0x4f>
 c0f:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c12:	8b 00                	mov    (%eax),%eax
 c14:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c17:	77 1a                	ja     c33 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 c70:	eb 0a                	jmp    c7c <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
 c72:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ...
 c82:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 c89:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c8c:	01 d0                	add    %edx,%eax
 c8e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c91:	75 20                	jne    cb3 <free+0xcf>
    p->s.size += bp->s.size;
 c93:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c96:	8b 50 04             	mov    0x4(%eax),%edx
 c99:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c9c:	8b 40 04             	mov    0x4(%eax),%eax
 c9f:	01 c2                	add    %eax,%edx
 ca1:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ca4:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 ca7:	8b 45 f8             	mov    -0x8(%ebp),%eax
 caa:	8b 10                	mov    (%eax),%edx
 cac:	8b 45 fc             	mov    -0x4(%ebp),%eax
 caf:	89 10                	mov    %edx,(%eax)
 cb1:	eb 08                	jmp    cbb <free+0xd7>
  } else
    p->s.ptr = bp;
 cb3:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cb6:	8b 55 f8             	mov    -0x8(%ebp),%edx
 cb9:	89 10                	mov    %edx,(%eax)
  freep = p;
 cbb:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cbe:	a3 70 12 00 00       	mov    %eax,0x1270
}
 cc3:	c9                   	leave  
 cc4:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 cc8:	83 ec 28             	sub    $0x28,%esp
  ...
  if(nu < 4096)
 ccb:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 cd2:	77 07                	ja     cdb <morecore+0x16>
    nu = 4096;
 cd4:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 cdb:	8b 45 08             	mov    0x8(%ebp),%eax
 cde:	c1 e0 03             	shl    $0x3,%eax
 ce1:	89 04 24             	mov    %eax,(%esp)
 ce4:	e8 f7 fb ff ff       	call   8e0 <sbrk>
 ce9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 cec:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 cf0:	75 07                	jne    cf9 <morecore+0x34>
    return 0;
 cf2:	b8 00 00 00 00       	mov    $0x0,%eax
 cf7:	eb 22                	jmp    d1b <morecore+0x56>
  hp = (Header*)p;
 ...
 d11:	e8 ce fe ff ff       	call   be4 <free>
  return freep;
 d16:	a1 70 12 00 00       	mov    0x1270,%eax
}
 d1b:	c9                   	leave  
 d1c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d26:	83 c0 07             	add    $0x7,%eax
 d29:	c1 e8 03             	shr    $0x3,%eax
 d2c:	40                   	inc    %eax
 d2d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d30:	a1 70 12 00 00       	mov    0x1270,%eax
 d35:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d38:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d3c:	75 23                	jne    d61 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d3e:	c7 45 f0 68 12 00 00 	movl   $0x1268,-0x10(%ebp)
 d45:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d48:	a3 70 12 00 00       	mov    %eax,0x1270
 d4d:	a1 70 12 00 00       	mov    0x1270,%eax
 d52:	a3 68 12 00 00       	mov    %eax,0x1268
    base.s.size = 0;
 d57:	c7 05 6c 12 00 00 00 	movl   $0x0,0x126c
 d5e:	00 00 00 
  }
 ...
 df4:	e9 70 ff ff ff       	jmp    d69 <malloc+0x4c>
}
 df9:	c9                   	leave  
 dfa:	c3                   	ret    
