...
main(int argc, char *argv[])
{
  ...
  if (argc < 3) {
   ...
   f:	c7 44 24 04 24 0e 00 	movl   $0xe24,0x4(%esp)
  16:	00 
  17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1e:	e8 3a 0a 00 00       	call   a5d <printf>
  	exit();
  ...
  50:	b8 4b 0e 00 00       	mov    $0xe4b,%eax
  55:	eb 05                	jmp    5c <main+0x5c>
  57:	b8 4d 0e 00 00       	mov    $0xe4d,%eax
  ...
  76:	c7 44 24 04 4f 0e 00 	movl   $0xe4f,0x4(%esp)
  7d:	00 
  7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  85:	e8 d3 09 00 00       	call   a5d <printf>
  }
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 12b:	c7 44 24 04 54 0e 00 	movl   $0xe54,0x4(%esp)
 132:	00 
 133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 13a:	e8 1e 09 00 00       	call   a5d <printf>
      exit();
 ...
 167:	c7 44 24 04 6f 0e 00 	movl   $0xe6f,0x4(%esp)
 16e:	00 
 16f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 176:	e8 e2 08 00 00       	call   a5d <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 415:	75 08                	jne    41f <strtok+0x15>
  s = lasts;
 417:	a1 84 12 00 00       	mov    0x1284,%eax
 ...
 46c:	a3 84 12 00 00       	mov    %eax,0x1284
    if (*lasts != 0)
 471:	a1 84 12 00 00       	mov    0x1284,%eax
 476:	8a 00                	mov    (%eax),%al
 478:	84 c0                	test   %al,%al
 47a:	74 11                	je     48d <strtok+0x83>
  *lasts++ = 0;
 47c:	a1 84 12 00 00       	mov    0x1284,%eax
 481:	8d 50 01             	lea    0x1(%eax),%edx
 484:	89 15 84 12 00 00    	mov    %edx,0x1284
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 606:	eb 22                	jmp    62a <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 608:	8a 86 20 12 00 00    	mov    0x1220(%esi),%al
 ...
 63b:	eb 25                	jmp    662 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 63d:	8a 86 20 12 00 00    	mov    0x1220(%esi),%al
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 9b0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 9b7:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 9bb:	74 17                	je     9d4 <printint+0x2c>
 9bd:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 9c1:	79 11                	jns    9d4 <printint+0x2c>
    neg = 1;
 9c3:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 9ca:	8b 45 0c             	mov    0xc(%ebp),%eax
 9cd:	f7 d8                	neg    %eax
 9cf:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9d2:	eb 06                	jmp    9da <printint+0x32>
  } else {
    x = xx;
 ...
 9da:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 9e1:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 9e4:	8d 41 01             	lea    0x1(%ecx),%eax
 9e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
 9ea:	8b 5d 10             	mov    0x10(%ebp),%ebx
 9ed:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9f0:	ba 00 00 00 00       	mov    $0x0,%edx
 9f5:	f7 f3                	div    %ebx
 9f7:	89 d0                	mov    %edx,%eax
 9f9:	8a 80 6c 12 00 00    	mov    0x126c(%eax),%al
 9ff:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 a03:	8b 75 10             	mov    0x10(%ebp),%esi
 ...
 a17:	75 c8                	jne    9e1 <printint+0x39>
  if(neg)
 a19:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a1d:	74 10                	je     a2f <printint+0x87>
    buf[i++] = '-';
 a1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a22:	8d 50 01             	lea    0x1(%eax),%edx
 a25:	89 55 f4             	mov    %edx,-0xc(%ebp)
 a28:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 a2d:	eb 1e                	jmp    a4d <printint+0xa5>
 a2f:	eb 1c                	jmp    a4d <printint+0xa5>
    putc(fd, buf[i]);
 a31:	8d 55 dc             	lea    -0x24(%ebp),%edx
 a34:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a37:	01 d0                	add    %edx,%eax
 a39:	8a 00                	mov    (%eax),%al
 a3b:	0f be c0             	movsbl %al,%eax
 a3e:	89 44 24 04          	mov    %eax,0x4(%esp)
 a42:	8b 45 08             	mov    0x8(%ebp),%eax
 a45:	89 04 24             	mov    %eax,(%esp)
 a48:	e8 33 ff ff ff       	call   980 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 a4d:	ff 4d f4             	decl   -0xc(%ebp)
 a50:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a54:	79 db                	jns    a31 <printint+0x89>
    putc(fd, buf[i]);
}
 a56:	83 c4 30             	add    $0x30,%esp
 a59:	5b                   	pop    %ebx
 a5a:	5e                   	pop    %esi
 a5b:	5d                   	pop    %ebp
 a5c:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 a63:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 a6a:	8d 45 0c             	lea    0xc(%ebp),%eax
 a6d:	83 c0 04             	add    $0x4,%eax
 a70:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 a73:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 a7a:	e9 77 01 00 00       	jmp    bf6 <printf+0x199>
    c = fmt[i] & 0xff;
 a7f:	8b 55 0c             	mov    0xc(%ebp),%edx
 a82:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a85:	01 d0                	add    %edx,%eax
 a87:	8a 00                	mov    (%eax),%al
 a89:	0f be c0             	movsbl %al,%eax
 a8c:	25 ff 00 00 00       	and    $0xff,%eax
 a91:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 a94:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a98:	75 2c                	jne    ac6 <printf+0x69>
      if(c == '%'){
 a9a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a9e:	75 0c                	jne    aac <printf+0x4f>
        state = '%';
 aa0:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 aa7:	e9 47 01 00 00       	jmp    bf3 <printf+0x196>
      } else {
        putc(fd, c);
 aac:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 aaf:	0f be c0             	movsbl %al,%eax
 ab2:	89 44 24 04          	mov    %eax,0x4(%esp)
 ab6:	8b 45 08             	mov    0x8(%ebp),%eax
 ab9:	89 04 24             	mov    %eax,(%esp)
 abc:	e8 bf fe ff ff       	call   980 <putc>
 ac1:	e9 2d 01 00 00       	jmp    bf3 <printf+0x196>
      }
    } else if(state == '%'){
 ac6:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 aca:	0f 85 23 01 00 00    	jne    bf3 <printf+0x196>
      if(c == 'd'){
 ad0:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 ad4:	75 2d                	jne    b03 <printf+0xa6>
        printint(fd, *ap, 10, 1);
 ad6:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ad9:	8b 00                	mov    (%eax),%eax
 adb:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 ae2:	00 
 ae3:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 aea:	00 
 aeb:	89 44 24 04          	mov    %eax,0x4(%esp)
 aef:	8b 45 08             	mov    0x8(%ebp),%eax
 af2:	89 04 24             	mov    %eax,(%esp)
 af5:	e8 ae fe ff ff       	call   9a8 <printint>
        ap++;
 afa:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 afe:	e9 e9 00 00 00       	jmp    bec <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 b03:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 b07:	74 06                	je     b0f <printf+0xb2>
 b09:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 b0d:	75 2d                	jne    b3c <printf+0xdf>
        printint(fd, *ap, 16, 0);
 b0f:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b12:	8b 00                	mov    (%eax),%eax
 b14:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 b1b:	00 
 b1c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 b23:	00 
 b24:	89 44 24 04          	mov    %eax,0x4(%esp)
 b28:	8b 45 08             	mov    0x8(%ebp),%eax
 b2b:	89 04 24             	mov    %eax,(%esp)
 b2e:	e8 75 fe ff ff       	call   9a8 <printint>
        ap++;
 b33:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b37:	e9 b0 00 00 00       	jmp    bec <printf+0x18f>
      } else if(c == 's'){
 b3c:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 b40:	75 42                	jne    b84 <printf+0x127>
        s = (char*)*ap;
 b42:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b45:	8b 00                	mov    (%eax),%eax
 b47:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
 b4a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
 b4e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b52:	75 09                	jne    b5d <printf+0x100>
          s = "(null)";
 b54:	c7 45 f4 8b 0e 00 00 	movl   $0xe8b,-0xc(%ebp)
        while(*s != 0){
 b5b:	eb 1c                	jmp    b79 <printf+0x11c>
 b5d:	eb 1a                	jmp    b79 <printf+0x11c>
          putc(fd, *s);
 b5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b62:	8a 00                	mov    (%eax),%al
 b64:	0f be c0             	movsbl %al,%eax
 b67:	89 44 24 04          	mov    %eax,0x4(%esp)
 b6b:	8b 45 08             	mov    0x8(%ebp),%eax
 b6e:	89 04 24             	mov    %eax,(%esp)
 b71:	e8 0a fe ff ff       	call   980 <putc>
          s++;
 b76:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 b7c:	8a 00                	mov    (%eax),%al
 b7e:	84 c0                	test   %al,%al
 b80:	75 dd                	jne    b5f <printf+0x102>
 b82:	eb 68                	jmp    bec <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 b84:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 b88:	75 1d                	jne    ba7 <printf+0x14a>
        putc(fd, *ap);
 ...
 b9c:	e8 df fd ff ff       	call   980 <putc>
        ap++;
 ba1:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 ba5:	eb 45                	jmp    bec <printf+0x18f>
      } else if(c == '%'){
 ba7:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 bab:	75 17                	jne    bc4 <printf+0x167>
        putc(fd, c);
 bad:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 bb0:	0f be c0             	movsbl %al,%eax
 bb3:	89 44 24 04          	mov    %eax,0x4(%esp)
 bb7:	8b 45 08             	mov    0x8(%ebp),%eax
 bba:	89 04 24             	mov    %eax,(%esp)
 bbd:	e8 be fd ff ff       	call   980 <putc>
 bc2:	eb 28                	jmp    bec <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 bc4:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 bcb:	00 
 bcc:	8b 45 08             	mov    0x8(%ebp),%eax
 bcf:	89 04 24             	mov    %eax,(%esp)
 bd2:	e8 a9 fd ff ff       	call   980 <putc>
        putc(fd, c);
 ...
 be7:	e8 94 fd ff ff       	call   980 <putc>
      }
      state = 0;
 bec:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 bf3:	ff 45 f0             	incl   -0x10(%ebp)
 bf6:	8b 55 0c             	mov    0xc(%ebp),%edx
 bf9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 bfc:	01 d0                	add    %edx,%eax
 bfe:	8a 00                	mov    (%eax),%al
 c00:	84 c0                	test   %al,%al
 c02:	0f 85 77 fe ff ff    	jne    a7f <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 c0f:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
 c12:	8b 45 08             	mov    0x8(%ebp),%eax
 c15:	83 e8 08             	sub    $0x8,%eax
 c18:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 c1b:	a1 90 12 00 00       	mov    0x1290,%eax
 c20:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c23:	eb 24                	jmp    c49 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 c25:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c28:	8b 00                	mov    (%eax),%eax
 c2a:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c2d:	77 12                	ja     c41 <free+0x35>
 c2f:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c32:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c35:	77 24                	ja     c5b <free+0x4f>
 c37:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c3a:	8b 00                	mov    (%eax),%eax
 c3c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c3f:	77 1a                	ja     c5b <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 caa:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 cb1:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cb4:	01 d0                	add    %edx,%eax
 cb6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 cb9:	75 20                	jne    cdb <free+0xcf>
    p->s.size += bp->s.size;
 cbb:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cbe:	8b 50 04             	mov    0x4(%eax),%edx
 ...
 cd2:	8b 10                	mov    (%eax),%edx
 cd4:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cd7:	89 10                	mov    %edx,(%eax)
 cd9:	eb 08                	jmp    ce3 <free+0xd7>
  } else
    p->s.ptr = bp;
 cdb:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cde:	8b 55 f8             	mov    -0x8(%ebp),%edx
 ce1:	89 10                	mov    %edx,(%eax)
  freep = p;
 ce3:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ce6:	a3 90 12 00 00       	mov    %eax,0x1290
}
 ceb:	c9                   	leave  
 cec:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 cf0:	83 ec 28             	sub    $0x28,%esp
  ...
  if(nu < 4096)
 cf3:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 cfa:	77 07                	ja     d03 <morecore+0x16>
    nu = 4096;
 cfc:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 d03:	8b 45 08             	mov    0x8(%ebp),%eax
 d06:	c1 e0 03             	shl    $0x3,%eax
 d09:	89 04 24             	mov    %eax,(%esp)
 d0c:	e8 cf fb ff ff       	call   8e0 <sbrk>
 d11:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 d14:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 d18:	75 07                	jne    d21 <morecore+0x34>
    return 0;
 d1a:	b8 00 00 00 00       	mov    $0x0,%eax
 d1f:	eb 22                	jmp    d43 <morecore+0x56>
  hp = (Header*)p;
 d21:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d24:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
 d27:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d2a:	8b 55 08             	mov    0x8(%ebp),%edx
 d2d:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
 d30:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d33:	83 c0 08             	add    $0x8,%eax
 d36:	89 04 24             	mov    %eax,(%esp)
 d39:	e8 ce fe ff ff       	call   c0c <free>
  return freep;
 d3e:	a1 90 12 00 00       	mov    0x1290,%eax
}
 d43:	c9                   	leave  
 d44:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d4e:	83 c0 07             	add    $0x7,%eax
 d51:	c1 e8 03             	shr    $0x3,%eax
 d54:	40                   	inc    %eax
 d55:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d58:	a1 90 12 00 00       	mov    0x1290,%eax
 d5d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d60:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d64:	75 23                	jne    d89 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d66:	c7 45 f0 88 12 00 00 	movl   $0x1288,-0x10(%ebp)
 d6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d70:	a3 90 12 00 00       	mov    %eax,0x1290
 d75:	a1 90 12 00 00       	mov    0x1290,%eax
 d7a:	a3 88 12 00 00       	mov    %eax,0x1288
    base.s.size = 0;
 d7f:	c7 05 8c 12 00 00 00 	movl   $0x0,0x128c
 d86:	00 00 00 
  }
 ...
 d97:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 d9a:	72 4d                	jb     de9 <malloc+0xa4>
      if(p->s.size == nunits)
 d9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d9f:	8b 40 04             	mov    0x4(%eax),%eax
 da2:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 da5:	75 0c                	jne    db3 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
 da7:	8b 45 f4             	mov    -0xc(%ebp),%eax
 daa:	8b 10                	mov    (%eax),%edx
 dac:	8b 45 f0             	mov    -0x10(%ebp),%eax
 daf:	89 10                	mov    %edx,(%eax)
 db1:	eb 26                	jmp    dd9 <malloc+0x94>
      else {
        p->s.size -= nunits;
 db3:	8b 45 f4             	mov    -0xc(%ebp),%eax
 db6:	8b 40 04             	mov    0x4(%eax),%eax
 db9:	2b 45 ec             	sub    -0x14(%ebp),%eax
 ...
 dcd:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 dd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dd3:	8b 55 ec             	mov    -0x14(%ebp),%edx
 dd6:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 dd9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ddc:	a3 90 12 00 00       	mov    %eax,0x1290
      return (void*)(p + 1);
 de1:	8b 45 f4             	mov    -0xc(%ebp),%eax
 de4:	83 c0 08             	add    $0x8,%eax
 de7:	eb 38                	jmp    e21 <malloc+0xdc>
    }
    if(p == freep)
 de9:	a1 90 12 00 00       	mov    0x1290,%eax
 dee:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 df1:	75 1b                	jne    e0e <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
 df3:	8b 45 ec             	mov    -0x14(%ebp),%eax
 df6:	89 04 24             	mov    %eax,(%esp)
 df9:	e8 ef fe ff ff       	call   ced <morecore>
 dfe:	89 45 f4             	mov    %eax,-0xc(%ebp)
 e01:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 e05:	75 07                	jne    e0e <malloc+0xc9>
        return 0;
 e07:	b8 00 00 00 00       	mov    $0x0,%eax
 e0c:	eb 13                	jmp    e21 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 e1c:	e9 70 ff ff ff       	jmp    d91 <malloc+0x4c>
}
 e21:	c9                   	leave  
 e22:	c3                   	ret    
