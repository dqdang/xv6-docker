...
main(int argc, char *argv[])
{
  ...
  if (argc < 3) {
   ...
   f:	c7 44 24 04 44 0e 00 	movl   $0xe44,0x4(%esp)
  16:	00 
  17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1e:	e8 5a 0a 00 00       	call   a7d <printf>
  	exit();
  ...
  50:	b8 6b 0e 00 00       	mov    $0xe6b,%eax
  55:	eb 05                	jmp    5c <main+0x5c>
  57:	b8 6d 0e 00 00       	mov    $0xe6d,%eax
  ...
  76:	c7 44 24 04 6f 0e 00 	movl   $0xe6f,0x4(%esp)
  7d:	00 
  7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  85:	e8 f3 09 00 00       	call   a7d <printf>
  }
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 12b:	c7 44 24 04 74 0e 00 	movl   $0xe74,0x4(%esp)
 132:	00 
 133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 13a:	e8 3e 09 00 00       	call   a7d <printf>
      exit();
 ...
 167:	c7 44 24 04 8f 0e 00 	movl   $0xe8f,0x4(%esp)
 16e:	00 
 16f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 176:	e8 02 09 00 00       	call   a7d <printf>
      exit();
...
putc(int fd, char c)
{
 ...
 9c1:	e8 b2 fe ff ff       	call   878 <write>
}
 9c6:	c9                   	leave  
 9c7:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 a19:	8a 80 8c 12 00 00    	mov    0x128c(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 b72:	75 09                	jne    b7d <printf+0x100>
          s = "(null)";
 b74:	c7 45 f4 ab 0e 00 00 	movl   $0xeab,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 c3b:	a1 b0 12 00 00       	mov    0x12b0,%eax
...
free(void *ap)
{
 ...
 d06:	a3 b0 12 00 00       	mov    %eax,0x12b0
}
 d0b:	c9                   	leave  
 d0c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 d2c:	e8 af fb ff ff       	call   8e0 <sbrk>
 ...
 d59:	e8 ce fe ff ff       	call   c2c <free>
  return freep;
 d5e:	a1 b0 12 00 00       	mov    0x12b0,%eax
}
 d63:	c9                   	leave  
 d64:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d75:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d78:	a1 b0 12 00 00       	mov    0x12b0,%eax
 d7d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d80:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d84:	75 23                	jne    da9 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d86:	c7 45 f0 a8 12 00 00 	movl   $0x12a8,-0x10(%ebp)
 d8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d90:	a3 b0 12 00 00       	mov    %eax,0x12b0
 d95:	a1 b0 12 00 00       	mov    0x12b0,%eax
 d9a:	a3 a8 12 00 00       	mov    %eax,0x12a8
    base.s.size = 0;
 d9f:	c7 05 ac 12 00 00 00 	movl   $0x0,0x12ac
 da6:	00 00 00 
  }
 ...
 dfc:	a3 b0 12 00 00       	mov    %eax,0x12b0
      return (void*)(p + 1);
 ...
 e07:	eb 38                	jmp    e41 <malloc+0xdc>
    ...
    if(p == freep)
 e09:	a1 b0 12 00 00       	mov    0x12b0,%eax
