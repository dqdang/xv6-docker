...
80100087:	c7 44 24 04 e7 81 10 	movl   $0x801081e7,0x4(%esp)
8010008e:	80 
...
801001a7:	c7 04 24 ee 81 10 80 	movl   $0x801081ee,(%esp)
...
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 ff 81 10 80 	movl   $0x801081ff,(%esp)
...
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 06 82 10 80 	movl   $0x80108206,(%esp)
...
801003e6:	75 0c                	jne    801003f4 <cprintf+0x33>
    panic("null fmt");
801003e8:	c7 04 24 0d 82 10 80 	movl   $0x8010820d,(%esp)
...
801004cd:	75 09                	jne    801004d8 <cprintf+0x117>
        s = "(null)";
801004cf:	c7 45 ec 16 82 10 80 	movl   $0x80108216,-0x14(%ebp)
      for(; *s; s++)
...
80100572:	c7 04 24 1d 82 10 80 	movl   $0x8010821d,(%esp)
...
80100584:	e8 38 fe ff ff       	call   801003c1 <cprintf>
  cprintf("\n");
80100589:	c7 04 24 31 82 10 80 	movl   $0x80108231,(%esp)
...
801005bb:	c7 04 24 33 82 10 80 	movl   $0x80108233,(%esp)
...
80100695:	c7 04 24 37 82 10 80 	movl   $0x80108237,(%esp)
...
80100a1f:	c7 04 24 4a 82 10 80 	movl   $0x8010824a,(%esp)
...
80100a47:	89 45 f4             	mov    %eax,-0xc(%ebp)
  acquire(&cons.lock);
80100a4a:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
...
80100a67:	74 21                	je     80100a8a <consoleread+0x57>
        release(&cons.lock);
80100a69:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
...
80100a8a:	c7 44 24 04 a0 b5 10 	movl   $0x8010b5a0,0x4(%esp)
80100a91:	80 
80100a92:	c7 04 24 20 10 11 80 	movl   $0x80111020,(%esp)
80100a99:	e8 ba 3f 00 00       	call   80104a58 <sleep>
  ...
  while(n > 0){
    while((input.r == input.w) || (active != ip->minor-1)){
80100a9e:	8b 15 20 10 11 80    	mov    0x80111020,%edx
80100aa4:	a1 24 10 11 80       	mov    0x80111024,%eax
...
80100ab7:	a1 84 b5 10 80       	mov    0x8010b584,%eax
...
80100ac0:	a1 20 10 11 80       	mov    0x80111020,%eax
80100ac5:	8d 50 01             	lea    0x1(%eax),%edx
80100ac8:	89 15 20 10 11 80    	mov    %edx,0x80111020
80100ace:	83 e0 7f             	and    $0x7f,%eax
80100ad1:	8a 80 a0 0f 11 80    	mov    -0x7feef060(%eax),%al
...
80100ae9:	73 0d                	jae    80100af8 <consoleread+0xc5>
        ...
        input.r--;
80100aeb:	a1 20 10 11 80       	mov    0x80111020,%eax
80100af0:	48                   	dec    %eax
80100af1:	a3 20 10 11 80       	mov    %eax,0x80111020
      }
      break;
...
80100b17:	0f 8f 3e ff ff ff    	jg     80100a5b <consoleread+0x28>
  ...
  release(&cons.lock);
80100b1d:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
...
80100b50:	a1 84 b5 10 80       	mov    0x8010b584,%eax
...
80100b5f:	e8 cc 0f 00 00       	call   80101b30 <iunlock>
    acquire(&cons.lock);
80100b64:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
...
80100b9a:	7c dd                	jl     80100b79 <consolewrite+0x39>
      consputc(buf[i] & 0xff);
    release(&cons.lock);
80100b9c:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
...
80100bbe:	c7 44 24 04 63 82 10 	movl   $0x80108263,0x4(%esp)
80100bc5:	80 
80100bc6:	c7 04 24 a0 b5 10 80 	movl   $0x8010b5a0,(%esp)
80100bcd:	e8 34 42 00 00       	call   80104e06 <initlock>

  devsw[CONSOLE].write = consolewrite;
80100bd2:	c7 05 ac 1c 11 80 40 	movl   $0x80100b40,0x80111cac
80100bd9:	0b 10 80 
  devsw[CONSOLE].read = consoleread;
80100bdc:	c7 05 a8 1c 11 80 33 	movl   $0x80100a33,0x80111ca8
80100be3:	0a 10 80 
  cons.locking = 1;
80100be6:	c7 05 d4 b5 10 80 01 	movl   $0x1,0x8010b5d4
80100bed:	00 00 00 
...
80100c32:	e8 6a 29 00 00       	call   801035a1 <end_op>
    cprintf("exec: fail\n");
80100c37:	c7 04 24 6b 82 10 80 	movl   $0x8010826b,(%esp)
...
80100c9b:	e9 77 03 00 00       	jmp    80101017 <exec+0x40f>
  ...
  if((pgdir = setupkvm()) == 0)
80100ca0:	e8 9d 6c 00 00       	call   80107942 <setupkvm>
...
80100d5e:	e8 ab 6f 00 00       	call   80107d0e <allocuvm>
...
80100db0:	e8 76 6e 00 00       	call   80107c2b <loaduvm>
...
80100e1c:	e8 ed 6e 00 00       	call   80107d0e <allocuvm>
...
80100e41:	e8 38 71 00 00       	call   80107f7e <clearpteu>
  sp = sz;
...
80100ecc:	e8 65 72 00 00       	call   80108136 <copyout>
...
80100f70:	e8 c1 71 00 00       	call   80108136 <copyout>
...
80101000:	e8 17 6a 00 00       	call   80107a1c <switchuvm>
  freevm(oldpgdir);
80101005:	8b 45 cc             	mov    -0x34(%ebp),%eax
80101008:	89 04 24             	mov    %eax,(%esp)
8010100b:	e8 d8 6e 00 00       	call   80107ee8 <freevm>
  return 0;
...
80101023:	e8 c0 6e 00 00       	call   80107ee8 <freevm>
  if(ip){
...
8010104e:	c7 44 24 04 77 82 10 	movl   $0x80108277,0x4(%esp)
80101055:	80 
80101056:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
80101067:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ftable.lock);
8010106a:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
80101071:	e8 b1 3d 00 00       	call   80104e27 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80101076:	c7 45 f4 34 13 11 80 	movl   $0x80111334,-0xc(%ebp)
...
8010108c:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
      release(&ftable.lock);
80101093:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
801010a8:	81 7d f4 94 1c 11 80 	cmpl   $0x80111c94,-0xc(%ebp)
801010af:	72 ce                	jb     8010107f <filealloc+0x1b>
  ...
  release(&ftable.lock);
801010b1:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
801010c7:	83 ec 18             	sub    $0x18,%esp
  acquire(&ftable.lock);
801010ca:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
801010de:	7f 0c                	jg     801010ec <filedup+0x28>
    panic("filedup");
801010e0:	c7 04 24 7e 82 10 80 	movl   $0x8010827e,(%esp)
...
801010f8:	89 50 04             	mov    %edx,0x4(%eax)
  release(&ftable.lock);
801010fb:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
80101112:	83 ec 3c             	sub    $0x3c,%esp
  ...
  acquire(&ftable.lock);
80101115:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
80101129:	7f 0c                	jg     80101137 <fileclose+0x2b>
    panic("fileclose");
8010112b:	c7 04 24 86 82 10 80 	movl   $0x80108286,(%esp)
...
8010114e:	7e 0e                	jle    8010115e <fileclose+0x52>
    release(&ftable.lock);
80101150:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
80101180:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  release(&ftable.lock);
80101186:	c7 04 24 00 13 11 80 	movl   $0x80111300,(%esp)
...
801012d0:	eb 0c                	jmp    801012de <fileread+0xb9>
  ...
  panic("fileread");
801012d2:	c7 04 24 90 82 10 80 	movl   $0x80108290,(%esp)
...
801013dd:	c7 04 24 99 82 10 80 	movl   $0x80108299,(%esp)
...
8010140d:	eb 0c                	jmp    8010141b <filewrite+0x13b>
  ...
  panic("filewrite");
8010140f:	c7 04 24 a9 82 10 80 	movl   $0x801082a9,(%esp)
...
801014e5:	a1 18 1d 11 80       	mov    0x80111d18,%eax
...
801015b8:	a1 00 1d 11 80       	mov    0x80111d00,%eax
...
801015da:	a1 00 1d 11 80       	mov    0x80111d00,%eax
...
801015e7:	c7 04 24 b4 82 10 80 	movl   $0x801082b4,(%esp)
...
801015f8:	83 ec 28             	sub    $0x28,%esp
  ...
  readsb(dev, &sb);
801015fb:	c7 44 24 04 00 1d 11 	movl   $0x80111d00,0x4(%esp)
80101602:	80 
...
80101616:	a1 18 1d 11 80       	mov    0x80111d18,%eax
...
80101677:	c7 04 24 ca 82 10 80 	movl   $0x801082ca,(%esp)
...
801016cf:	c7 44 24 04 dd 82 10 	movl   $0x801082dd,0x4(%esp)
801016d6:	80 
801016d7:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
801016fc:	05 20 1d 11 80       	add    $0x80111d20,%eax
80101701:	83 c0 10             	add    $0x10,%eax
80101704:	c7 44 24 04 e4 82 10 	movl   $0x801082e4,0x4(%esp)
8010170b:	80 
...
8010171b:	7e cf                	jle    801016ec <iinit+0x2d>
  ...
  readsb(dev, &sb);
8010171d:	c7 44 24 04 00 1d 11 	movl   $0x80111d00,0x4(%esp)
80101724:	80 
80101725:	8b 45 08             	mov    0x8(%ebp),%eax
80101728:	89 04 24             	mov    %eax,(%esp)
8010172b:	e8 f4 fc ff ff       	call   80101424 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101730:	a1 18 1d 11 80       	mov    0x80111d18,%eax
80101735:	8b 3d 14 1d 11 80    	mov    0x80111d14,%edi
8010173b:	8b 35 10 1d 11 80    	mov    0x80111d10,%esi
80101741:	8b 1d 0c 1d 11 80    	mov    0x80111d0c,%ebx
80101747:	8b 0d 08 1d 11 80    	mov    0x80111d08,%ecx
8010174d:	8b 15 04 1d 11 80    	mov    0x80111d04,%edx
80101753:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80101756:	8b 15 00 1d 11 80    	mov    0x80111d00,%edx
...
8010177d:	c7 04 24 ec 82 10 80 	movl   $0x801082ec,(%esp)
...
801017b2:	a1 14 1d 11 80       	mov    0x80111d14,%eax
...
80101848:	a1 08 1d 11 80       	mov    0x80111d08,%eax
...
80101855:	c7 04 24 3f 83 10 80 	movl   $0x8010833f,(%esp)
...
80101874:	a1 14 1d 11 80       	mov    0x80111d14,%eax
...
80101922:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&icache.lock);
80101925:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80101938:	c7 45 f4 54 1d 11 80 	movl   $0x80111d54,-0xc(%ebp)
...
8010196c:	89 50 08             	mov    %edx,0x8(%eax)
      release(&icache.lock);
8010196f:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
8010199d:	81 7d f4 74 39 11 80 	cmpl   $0x80113974,-0xc(%ebp)
...
801019ac:	c7 04 24 51 83 10 80 	movl   $0x80108351,(%esp)
...
801019dc:	c7 40 4c 00 00 00 00 	movl   $0x0,0x4c(%eax)
  release(&icache.lock);
801019e3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
801019f7:	83 ec 18             	sub    $0x18,%esp
  acquire(&icache.lock);
801019fa:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80101a12:	89 50 08             	mov    %edx,0x8(%eax)
  release(&icache.lock);
80101a15:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80101a3a:	7f 0c                	jg     80101a48 <ilock+0x22>
    panic("ilock");
80101a3c:	c7 04 24 61 83 10 80 	movl   $0x80108361,(%esp)
...
80101a6f:	a1 14 1d 11 80       	mov    0x80111d14,%eax
...
80101b20:	75 0c                	jne    80101b2e <ilock+0x108>
      panic("ilock: no type");
80101b22:	c7 04 24 67 83 10 80 	movl   $0x80108367,(%esp)
...
80101b56:	7f 0c                	jg     80101b64 <iunlock+0x34>
    panic("iunlock");
80101b58:	c7 04 24 76 83 10 80 	movl   $0x80108376,(%esp)
...
80101b9c:	75 50                	jne    80101bee <iput+0x7a>
    acquire(&icache.lock);
80101b9e:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80101bb0:	89 45 f4             	mov    %eax,-0xc(%ebp)
    release(&icache.lock);
80101bb3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80101bf7:	e8 61 31 00 00       	call   80104d5d <releasesleep>
  ...
  acquire(&icache.lock);
80101bfc:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80101c14:	89 50 08             	mov    %edx,0x8(%eax)
  release(&icache.lock);
80101c17:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80101d44:	c7 04 24 7e 83 10 80 	movl   $0x8010837e,(%esp)
...
80101eef:	98                   	cwtl   
80101ef0:	8b 04 c5 a0 1c 11 80 	mov    -0x7feee360(,%eax,8),%eax
...
80101f0c:	98                   	cwtl   
80101f0d:	8b 04 c5 a0 1c 11 80 	mov    -0x7feee360(,%eax,8),%eax
...
80102053:	98                   	cwtl   
80102054:	8b 04 c5 a4 1c 11 80 	mov    -0x7feee35c(,%eax,8),%eax
...
80102070:	98                   	cwtl   
80102071:	8b 04 c5 a4 1c 11 80 	mov    -0x7feee35c(,%eax,8),%eax
...
801021e4:	c7 04 24 91 83 10 80 	movl   $0x80108391,(%esp)
...
80102222:	c7 04 24 a3 83 10 80 	movl   $0x801083a3,(%esp)
...
80102303:	74 0c                	je     80102311 <dirlink+0x79>
      panic("dirlink read");
80102305:	c7 04 24 b2 83 10 80 	movl   $0x801083b2,(%esp)
...
80102379:	74 0c                	je     80102387 <dirlink+0xef>
    panic("dirlink");
8010237b:	c7 04 24 bf 83 10 80 	movl   $0x801083bf,(%esp)
...
8010265b:	c7 44 24 04 c7 83 10 	movl   $0x801083c7,0x4(%esp)
80102662:	80 
80102663:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
8010266a:	e8 97 27 00 00       	call   80104e06 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
8010266f:	a1 40 40 11 80       	mov    0x80114040,%eax
80102674:	48                   	dec    %eax
...
801026bc:	74 0c                	je     801026ca <ideinit+0x75>
      havedisk1 = 1;
801026be:	c7 05 18 b6 10 80 01 	movl   $0x1,0x8010b618
801026c5:	00 00 00 
      break;
...
801026f6:	75 0c                	jne    80102704 <idestart+0x18>
    panic("idestart");
801026f8:	c7 04 24 cb 83 10 80 	movl   $0x801083cb,(%esp)
...
80102763:	c7 04 24 cb 83 10 80 	movl   $0x801083cb,(%esp)
...
801028ad:	a3 14 b6 10 80       	mov    %eax,0x8010b614
...
80102951:	c7 04 24 e6 83 10 80 	movl   $0x801083e6,(%esp)
...
8010296a:	c7 04 24 fc 83 10 80 	movl   $0x801083fc,(%esp)
...
80102980:	a1 18 b6 10 80       	mov    0x8010b618,%eax
80102985:	85 c0                	test   %eax,%eax
80102987:	75 0c                	jne    80102995 <iderw+0x5c>
    panic("iderw: ide disk 1 not present");
80102989:	c7 04 24 11 84 10 80 	movl   $0x80108411,(%esp)
80102990:	e8 bf db ff ff       	call   80100554 <panic>

  acquire(&idelock);  //DOC:acquire-lock
80102995:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
...
801029ab:	c7 45 f4 14 b6 10 80 	movl   $0x8010b614,-0xc(%ebp)
...
801029ce:	89 10                	mov    %edx,(%eax)
  ...
  if(idequeue == b)
801029d0:	a1 14 b6 10 80       	mov    0x8010b614,%eax
...
801029e7:	eb 13                	jmp    801029fc <iderw+0xc3>
    sleep(b, &idelock);
801029e9:	c7 44 24 04 e0 b5 10 	movl   $0x8010b5e0,0x4(%esp)
801029f0:	80 
...
80102a07:	75 e0                	jne    801029e9 <iderw+0xb0>
  ...
  release(&idelock);
80102a09:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
...
80102a19:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
80102a1b:	a1 74 39 11 80       	mov    0x80113974,%eax
80102a20:	8b 55 08             	mov    0x8(%ebp),%edx
80102a23:	89 10                	mov    %edx,(%eax)
  return ioapic->data;
80102a25:	a1 74 39 11 80       	mov    0x80113974,%eax
...
80102a30:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
80102a32:	a1 74 39 11 80       	mov    0x80113974,%eax
80102a37:	8b 55 08             	mov    0x8(%ebp),%edx
80102a3a:	89 10                	mov    %edx,(%eax)
  ioapic->data = data;
80102a3c:	a1 74 39 11 80       	mov    0x80113974,%eax
...
80102a4f:	c7 05 74 39 11 80 00 	movl   $0xfec00000,0x80113974
80102a56:	00 c0 fe 
...
80102b32:	c7 44 24 04 62 84 10 	movl   $0x80108462,0x4(%esp)
80102b39:	80 
80102b3a:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80102b41:	e8 c0 22 00 00       	call   80104e06 <initlock>
  kmem.use_lock = 0;
80102b46:	c7 05 b4 39 11 80 00 	movl   $0x0,0x801139b4
80102b4d:	00 00 00 
...
80102b77:	e8 0c 00 00 00       	call   80102b88 <freerange>
  kmem.use_lock = 1;
80102b7c:	c7 05 b4 39 11 80 01 	movl   $0x1,0x801139b4
80102b83:	00 00 00 
}
80102b86:	c9                   	leave  
80102b87:	c3                   	ret    
...
80102bd3:	81 7d 08 e8 67 11 80 	cmpl   $0x801167e8,0x8(%ebp)
...
80102be9:	76 0c                	jbe    80102bf7 <kfree+0x36>
    panic("kfree");
80102beb:	c7 04 24 67 84 10 80 	movl   $0x80108467,(%esp)
...
80102c5a:	83 ec 28             	sub    $0x28,%esp
  ...
  if(kmem.use_lock)
80102c5d:	a1 b4 39 11 80       	mov    0x801139b4,%eax
80102c62:	85 c0                	test   %eax,%eax
80102c64:	74 0c                	je     80102c72 <kalloc+0x1b>
    acquire(&kmem.lock);
80102c66:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80102c6d:	e8 b5 21 00 00       	call   80104e27 <acquire>
  r = kmem.freelist;
80102c72:	a1 b8 39 11 80       	mov    0x801139b8,%eax
...
80102c85:	a3 b8 39 11 80       	mov    %eax,0x801139b8
  if(kmem.use_lock)
80102c8a:	a1 b4 39 11 80       	mov    0x801139b4,%eax
80102c8f:	85 c0                	test   %eax,%eax
80102c91:	74 0c                	je     80102c9f <kalloc+0x48>
    release(&kmem.lock);
80102c93:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
...
80102d04:	75 17                	jne    80102d1d <kbdgetc+0x5e>
    shift |= E0ESC;
80102d06:	a1 1c b6 10 80       	mov    0x8010b61c,%eax
80102d0b:	83 c8 40             	or     $0x40,%eax
80102d0e:	a3 1c b6 10 80       	mov    %eax,0x8010b61c
    return 0;
...
80102d29:	a1 1c b6 10 80       	mov    0x8010b61c,%eax
...
80102d79:	81 4d fc 80 00 00 00 	orl    $0x80,-0x4(%ebp)
    shift &= ~E0ESC;
80102d80:	a1 1c b6 10 80       	mov    0x8010b61c,%eax
80102d85:	83 e0 bf             	and    $0xffffffbf,%eax
80102d88:	a3 1c b6 10 80       	mov    %eax,0x8010b61c
  }
...
80102d9a:	a1 1c b6 10 80       	mov    0x8010b61c,%eax
80102d9f:	09 d0                	or     %edx,%eax
80102da1:	a3 1c b6 10 80       	mov    %eax,0x8010b61c
...
80102db3:	a1 1c b6 10 80       	mov    0x8010b61c,%eax
...
80102dd8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(shift & CAPSLOCK){
80102ddb:	a1 1c b6 10 80       	mov    0x8010b61c,%eax
...
80102e5c:	89 e5                	mov    %esp,%ebp
  lapic[index] = value;
80102e5e:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80102e70:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80102e7f:	83 ec 08             	sub    $0x8,%esp
  if(!lapic)
80102e82:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80102f08:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80102fa9:	90                   	nop
80102faa:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80102fd6:	89 e5                	mov    %esp,%ebp
  if (!lapic)
80102fd8:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80102fe6:	eb 0d                	jmp    80102ff5 <lapicid+0x20>
  return lapic[ID] >> 24;
80102fe8:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80102ffa:	83 ec 08             	sub    $0x8,%esp
  if(lapic)
80102ffd:	a1 bc 39 11 80       	mov    0x801139bc,%eax
...
80103326:	c7 44 24 04 6d 84 10 	movl   $0x8010846d,0x4(%esp)
8010332d:	80 
8010332e:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
...
8010334f:	a3 f4 39 11 80       	mov    %eax,0x801139f4
  log.size = sb.nlog;
80103354:	8b 45 e8             	mov    -0x18(%ebp),%eax
80103357:	a3 f8 39 11 80       	mov    %eax,0x801139f8
  log.dev = dev;
8010335c:	8b 45 08             	mov    0x8(%ebp),%eax
8010335f:	a3 04 3a 11 80       	mov    %eax,0x80113a04
  recover_from_log();
...
8010337d:	8b 15 f4 39 11 80    	mov    0x801139f4,%edx
80103383:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103386:	01 d0                	add    %edx,%eax
80103388:	40                   	inc    %eax
80103389:	89 c2                	mov    %eax,%edx
8010338b:	a1 04 3a 11 80       	mov    0x80113a04,%eax
...
801033a5:	8b 04 85 cc 39 11 80 	mov    -0x7feec634(,%eax,4),%eax
801033ac:	89 c2                	mov    %eax,%edx
801033ae:	a1 04 3a 11 80       	mov    0x80113a04,%eax
...
80103406:	a1 08 3a 11 80       	mov    0x80113a08,%eax
...
8010341c:	a1 f4 39 11 80       	mov    0x801139f4,%eax
80103421:	89 c2                	mov    %eax,%edx
80103423:	a1 04 3a 11 80       	mov    0x80113a04,%eax
...
80103445:	a3 08 3a 11 80       	mov    %eax,0x80113a08
...
80103463:	89 04 95 cc 39 11 80 	mov    %eax,-0x7feec634(,%edx,4)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
8010346d:	a1 08 3a 11 80       	mov    0x80113a08,%eax
...
80103487:	83 ec 28             	sub    $0x28,%esp
  struct buf *buf = bread(log.dev, log.start);
8010348a:	a1 f4 39 11 80       	mov    0x801139f4,%eax
8010348f:	89 c2                	mov    %eax,%edx
80103491:	a1 04 3a 11 80       	mov    0x80113a04,%eax
...
801034ab:	89 45 ec             	mov    %eax,-0x14(%ebp)
  int i;
  hb->n = log.lh.n;
801034ae:	8b 15 08 3a 11 80    	mov    0x80113a08,%edx
...
801034c8:	8b 0c 85 cc 39 11 80 	mov    -0x7feec634(,%eax,4),%ecx
...
801034dc:	a1 08 3a 11 80       	mov    0x80113a08,%eax
...
80103509:	e8 5d fe ff ff       	call   8010336b <install_trans>
  log.lh.n = 0;
8010350e:	c7 05 08 3a 11 80 00 	movl   $0x0,0x80113a08
80103515:	00 00 00 
...
80103522:	83 ec 18             	sub    $0x18,%esp
  acquire(&log.lock);
80103525:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
8010352c:	e8 f6 18 00 00       	call   80104e27 <acquire>
  while(1){
    if(log.committing){
80103531:	a1 00 3a 11 80       	mov    0x80113a00,%eax
80103536:	85 c0                	test   %eax,%eax
80103538:	74 16                	je     80103550 <begin_op+0x31>
      sleep(&log, &log.lock);
8010353a:	c7 44 24 04 c0 39 11 	movl   $0x801139c0,0x4(%esp)
80103541:	80 
80103542:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
80103549:	e8 0a 15 00 00       	call   80104a58 <sleep>
8010354e:	eb 4d                	jmp    8010359d <begin_op+0x7e>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80103550:	8b 15 08 3a 11 80    	mov    0x80113a08,%edx
80103556:	a1 fc 39 11 80       	mov    0x801139fc,%eax
...
8010356c:	7e 16                	jle    80103584 <begin_op+0x65>
      ...
      sleep(&log, &log.lock);
8010356e:	c7 44 24 04 c0 39 11 	movl   $0x801139c0,0x4(%esp)
80103575:	80 
80103576:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
8010357d:	e8 d6 14 00 00       	call   80104a58 <sleep>
80103582:	eb 19                	jmp    8010359d <begin_op+0x7e>
    } else {
      log.outstanding += 1;
80103584:	a1 fc 39 11 80       	mov    0x801139fc,%eax
80103589:	40                   	inc    %eax
8010358a:	a3 fc 39 11 80       	mov    %eax,0x801139fc
      release(&log.lock);
8010358f:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
...
801035a7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  ...
  acquire(&log.lock);
801035ae:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
801035b5:	e8 6d 18 00 00       	call   80104e27 <acquire>
  log.outstanding -= 1;
801035ba:	a1 fc 39 11 80       	mov    0x801139fc,%eax
801035bf:	48                   	dec    %eax
801035c0:	a3 fc 39 11 80       	mov    %eax,0x801139fc
  if(log.committing)
801035c5:	a1 00 3a 11 80       	mov    0x80113a00,%eax
801035ca:	85 c0                	test   %eax,%eax
801035cc:	74 0c                	je     801035da <end_op+0x39>
    panic("log.committing");
801035ce:	c7 04 24 71 84 10 80 	movl   $0x80108471,(%esp)
801035d5:	e8 7a cf ff ff       	call   80100554 <panic>
  if(log.outstanding == 0){
801035da:	a1 fc 39 11 80       	mov    0x801139fc,%eax
801035df:	85 c0                	test   %eax,%eax
801035e1:	75 13                	jne    801035f6 <end_op+0x55>
    do_commit = 1;
801035e3:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    log.committing = 1;
801035ea:	c7 05 00 3a 11 80 01 	movl   $0x1,0x80113a00
801035f1:	00 00 00 
801035f4:	eb 0c                	jmp    80103602 <end_op+0x61>
    ...
    wakeup(&log);
801035f6:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
...
80103614:	e8 db 00 00 00       	call   801036f4 <commit>
    acquire(&log.lock);
80103619:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
80103620:	e8 02 18 00 00       	call   80104e27 <acquire>
    log.committing = 0;
80103625:	c7 05 00 3a 11 80 00 	movl   $0x0,0x80113a00
8010362c:	00 00 00 
    wakeup(&log);
8010362f:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
...
8010365b:	8b 15 f4 39 11 80    	mov    0x801139f4,%edx
80103661:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103664:	01 d0                	add    %edx,%eax
80103666:	40                   	inc    %eax
80103667:	89 c2                	mov    %eax,%edx
80103669:	a1 04 3a 11 80       	mov    0x80113a04,%eax
...
80103683:	8b 04 85 cc 39 11 80 	mov    -0x7feec634(,%eax,4),%eax
8010368a:	89 c2                	mov    %eax,%edx
8010368c:	a1 04 3a 11 80       	mov    0x80113a04,%eax
...
801036e4:	a1 08 3a 11 80       	mov    0x80113a08,%eax
...
801036f7:	83 ec 08             	sub    $0x8,%esp
  if (log.lh.n > 0) {
801036fa:	a1 08 3a 11 80       	mov    0x80113a08,%eax
...
8010370d:	e8 59 fc ff ff       	call   8010336b <install_trans>
    log.lh.n = 0;
80103712:	c7 05 08 3a 11 80 00 	movl   $0x0,0x80113a08
80103719:	00 00 00 
...
80103729:	a1 08 3a 11 80       	mov    0x80113a08,%eax
8010372e:	83 f8 1d             	cmp    $0x1d,%eax
80103731:	7f 10                	jg     80103743 <log_write+0x20>
80103733:	a1 08 3a 11 80       	mov    0x80113a08,%eax
80103738:	8b 15 f8 39 11 80    	mov    0x801139f8,%edx
8010373e:	4a                   	dec    %edx
8010373f:	39 d0                	cmp    %edx,%eax
80103741:	7c 0c                	jl     8010374f <log_write+0x2c>
    panic("too big a transaction");
80103743:	c7 04 24 80 84 10 80 	movl   $0x80108480,(%esp)
8010374a:	e8 05 ce ff ff       	call   80100554 <panic>
  if (log.outstanding < 1)
8010374f:	a1 fc 39 11 80       	mov    0x801139fc,%eax
80103754:	85 c0                	test   %eax,%eax
80103756:	7f 0c                	jg     80103764 <log_write+0x41>
    panic("log_write outside of trans");
80103758:	c7 04 24 96 84 10 80 	movl   $0x80108496,(%esp)
8010375f:	e8 f0 cd ff ff       	call   80100554 <panic>

  acquire(&log.lock);
80103764:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
...
8010377f:	8b 04 85 cc 39 11 80 	mov    -0x7feec634(,%eax,4),%eax
...
80103797:	a1 08 3a 11 80       	mov    0x80113a08,%eax
...
801037ad:	89 04 95 cc 39 11 80 	mov    %eax,-0x7feec634(,%edx,4)
  if (i == log.lh.n)
801037b4:	a1 08 3a 11 80       	mov    0x80113a08,%eax
801037b9:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801037bc:	75 0b                	jne    801037c9 <log_write+0xa6>
    log.lh.n++;
801037be:	a1 08 3a 11 80       	mov    0x80113a08,%eax
801037c3:	40                   	inc    %eax
801037c4:	a3 08 3a 11 80       	mov    %eax,0x80113a08
...
801037d6:	89 10                	mov    %edx,(%eax)
  release(&log.lock);
801037d8:	c7 04 24 c0 39 11 80 	movl   $0x801139c0,(%esp)
...
80103842:	e8 18 30 00 00       	call   8010685f <uartinit>
  pinit();         // process table
80103847:	e8 e6 08 00 00       	call   80104132 <pinit>
  tvinit();        // trap vectors
8010384c:	e8 f7 2b 00 00       	call   80106448 <tvinit>
  binit();         // buffer cache
...
80103886:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103889:	e8 74 41 00 00       	call   80107a02 <switchkvm>
  seginit();
8010388e:	e8 40 3c 00 00       	call   801074d3 <seginit>
  lapicinit();
...
801038b8:	c7 04 24 b1 84 10 80 	movl   $0x801084b1,(%esp)
801038bf:	e8 fd ca ff ff       	call   801003c1 <cprintf>
  idtinit();       // load idt register
801038c4:	e8 dc 2c 00 00       	call   801065a5 <idtinit>
...
80103911:	c7 45 f4 c0 3a 11 80 	movl   $0x80113ac0,-0xc(%ebp)
...
8010398f:	a1 40 40 11 80       	mov    0x80114040,%eax
...
801039a4:	05 c0 3a 11 80       	add    $0x80113ac0,%eax
...
80103a4c:	00 
80103a4d:	c7 44 24 04 c8 84 10 	movl   $0x801084c8,0x4(%esp)
80103a54:	80 
...
80103b83:	00 
80103b84:	c7 44 24 04 cd 84 10 	movl   $0x801084cd,0x4(%esp)
80103b8b:	80 
...
80103c07:	c7 04 24 d2 84 10 80 	movl   $0x801084d2,(%esp)
...
80103c20:	a3 bc 39 11 80       	mov    %eax,0x801139bc
...
80103c4e:	8b 04 85 0c 85 10 80 	mov    -0x7fef7af4(,%eax,4),%eax
...
80103c5a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      if(ncpu < NCPU) {
80103c5d:	a1 40 40 11 80       	mov    0x80114040,%eax
80103c62:	83 f8 07             	cmp    $0x7,%eax
80103c65:	7f 2c                	jg     80103c93 <mpinit+0xa6>
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
80103c67:	8b 15 40 40 11 80    	mov    0x80114040,%edx
...
80103c81:	05 c0 3a 11 80       	add    $0x80113ac0,%eax
80103c86:	88 08                	mov    %cl,(%eax)
        ncpu++;
80103c88:	a1 40 40 11 80       	mov    0x80114040,%eax
80103c8d:	40                   	inc    %eax
80103c8e:	a3 40 40 11 80       	mov    %eax,0x80114040
      }
...
80103ca5:	a2 a0 3a 11 80       	mov    %al,0x80113aa0
...
80103cd0:	c7 04 24 ec 84 10 80 	movl   $0x801084ec,(%esp)
...
80103e04:	c7 44 24 04 20 85 10 	movl   $0x80108520,0x4(%esp)
80103e0b:	80 
...
80104138:	c7 44 24 04 28 85 10 	movl   $0x80108528,0x4(%esp)
8010413f:	80 
80104140:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
8010415b:	b8 c0 3a 11 80       	mov    $0x80113ac0,%eax
...
801041a7:	c7 04 24 30 85 10 80 	movl   $0x80108530,(%esp)
...
801041d5:	05 c0 3a 11 80       	add    $0x80113ac0,%eax
...
801041f5:	05 c0 3a 11 80       	add    $0x80113ac0,%eax
...
801041ff:	a1 40 40 11 80       	mov    0x80114040,%eax
...
80104209:	c7 04 24 56 85 10 80 	movl   $0x80108556,(%esp)
...
80104243:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104246:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
8010424d:	e8 d5 0b 00 00       	call   80104e27 <acquire>

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104252:	c7 45 f4 94 40 11 80 	movl   $0x80114094,-0xc(%ebp)
...
80104281:	89 42 10             	mov    %eax,0x10(%edx)
  ...
  release(&ptable.lock);
80104284:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
801042ab:	81 7d f4 94 5f 11 80 	cmpl   $0x80115f94,-0xc(%ebp)
801042b2:	72 a7                	jb     8010425b <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;

  release(&ptable.lock);
801042b4:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
801042f7:	ba 04 64 10 80       	mov    $0x80106404,%edx
...
80104350:	a3 20 b6 10 80       	mov    %eax,0x8010b620
  if((p->pgdir = setupkvm()) == 0)
80104355:	e8 e8 35 00 00       	call   80107942 <setupkvm>
...
8010436a:	c7 04 24 66 85 10 80 	movl   $0x80108566,(%esp)
...
80104385:	c7 44 24 04 c0 b4 10 	movl   $0x8010b4c0,0x4(%esp)
8010438c:	80 
8010438d:	89 04 24             	mov    %eax,(%esp)
80104390:	e8 0e 38 00 00       	call   80107ba3 <inituvm>
  p->sz = PGSIZE;
...
8010442e:	00 
8010442f:	c7 44 24 04 7f 85 10 	movl   $0x8010857f,0x4(%esp)
80104436:	80 
80104437:	89 04 24             	mov    %eax,(%esp)
8010443a:	e8 57 0e 00 00       	call   80105296 <safestrcpy>
  p->cwd = namei("/");
8010443f:	c7 04 24 88 85 10 80 	movl   $0x80108588,(%esp)
...
8010444e:	89 42 68             	mov    %eax,0x68(%edx)
  ...
  acquire(&ptable.lock);
80104451:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104460:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  release(&ptable.lock);
80104467:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
801044ad:	e8 5c 38 00 00       	call   80107d0e <allocuvm>
...
801044e4:	e8 3b 39 00 00       	call   80107e24 <deallocuvm>
...
80104507:	e8 10 35 00 00       	call   80107a1c <switchuvm>
  return 0;
...
8010454e:	e8 71 3a 00 00       	call   80107fc4 <copyuvm>
...
80104649:	89 45 d8             	mov    %eax,-0x28(%ebp)
  ...
  acquire(&ptable.lock);
8010464c:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
8010465b:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  release(&ptable.lock);
80104662:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104684:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  if(curproc == initproc)
80104687:	a1 20 b6 10 80       	mov    0x8010b620,%eax
8010468c:	39 45 ec             	cmp    %eax,-0x14(%ebp)
8010468f:	75 0c                	jne    8010469d <exit+0x24>
    panic("init exiting");
80104691:	c7 04 24 8a 85 10 80 	movl   $0x8010858a,(%esp)
...
80104701:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)
  ...
  acquire(&ptable.lock);
80104708:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
8010471d:	e8 cc 03 00 00       	call   80104aee <wakeup1>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104722:	c7 45 f4 94 40 11 80 	movl   $0x80114094,-0xc(%ebp)
...
80104734:	75 24                	jne    8010475a <exit+0xe1>
      p->parent = initproc;
80104736:	8b 15 20 b6 10 80    	mov    0x8010b620,%edx
...
8010475e:	81 7d f4 94 5f 11 80 	cmpl   $0x80115f94,-0xc(%ebp)
...
80104771:	e8 c3 01 00 00       	call   80104939 <sched>
  panic("zombie exit");
80104776:	c7 04 24 97 85 10 80 	movl   $0x80108597,(%esp)
...
8010478d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  acquire(&ptable.lock);
80104790:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
8010479c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047a3:	c7 45 f4 94 40 11 80 	movl   $0x80114094,-0xc(%ebp)
...
801047fb:	e8 e8 36 00 00       	call   80107ee8 <freevm>
        p->pid = 0;
...
80104828:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        release(&ptable.lock);
8010482f:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104844:	81 7d f4 94 5f 11 80 	cmpl   $0x80115f94,-0xc(%ebp)
...
8010485f:	74 13                	je     80104874 <wait+0xf2>
      release(&ptable.lock);
80104861:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104874:	c7 44 24 04 60 40 11 	movl   $0x80114060,0x4(%esp)
8010487b:	80 
...
801048a9:	e8 7e f8 ff ff       	call   8010412c <sti>
    ...
    acquire(&ptable.lock);
801048ae:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
801048b5:	e8 6d 05 00 00       	call   80104e27 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048ba:	c7 45 f4 94 40 11 80 	movl   $0x80114094,-0xc(%ebp)
...
801048e2:	e8 35 31 00 00       	call   80107a1c <switchuvm>
      p->state = RUNNING;
...
80104904:	e8 fb 09 00 00       	call   80105304 <swtch>
      switchkvm();
80104909:	e8 f4 30 00 00       	call   80107a02 <switchkvm>
...
8010491f:	81 7d f4 94 5f 11 80 	cmpl   $0x80115f94,-0xc(%ebp)
80104926:	72 9b                	jb     801048c3 <scheduler+0x35>
    ...
    release(&ptable.lock);
80104928:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104971:	74 0c                	je     8010497f <sched+0x46>
    panic("sched locks");
80104973:	c7 04 24 b5 85 10 80 	movl   $0x801085b5,(%esp)
...
80104988:	75 0c                	jne    80104996 <sched+0x5d>
    panic("sched running");
8010498a:	c7 04 24 c1 85 10 80 	movl   $0x801085c1,(%esp)
...
801049a4:	c7 04 24 cf 85 10 80 	movl   $0x801085cf,(%esp)
...
801049ee:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104a06:	e8 2e ff ff ff       	call   80104939 <sched>
  release(&ptable.lock);
80104a0b:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104a1c:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104a1f:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104a6a:	75 0c                	jne    80104a78 <sleep+0x20>
    panic("sleep");
80104a6c:	c7 04 24 e3 85 10 80 	movl   $0x801085e3,(%esp)
...
80104a7e:	c7 04 24 e9 85 10 80 	movl   $0x801085e9,(%esp)
...
80104a8a:	81 7d 0c 60 40 11 80 	cmpl   $0x80114060,0xc(%ebp)
80104a91:	74 17                	je     80104aaa <sleep+0x52>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104a93:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104acc:	81 7d 0c 60 40 11 80 	cmpl   $0x80114060,0xc(%ebp)
80104ad3:	74 17                	je     80104aec <sleep+0x94>
    release(&ptable.lock);
80104ad5:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104af1:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104af4:	c7 45 fc 94 40 11 80 	movl   $0x80114094,-0x4(%ebp)
...
80104b21:	81 7d fc 94 5f 11 80 	cmpl   $0x80115f94,-0x4(%ebp)
...
80104b2f:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104b32:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104b44:	e8 a5 ff ff ff       	call   80104aee <wakeup1>
  release(&ptable.lock);
80104b49:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104b5a:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104b5d:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
80104b64:	e8 be 02 00 00       	call   80104e27 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b69:	c7 45 f4 94 40 11 80 	movl   $0x80114094,-0xc(%ebp)
...
80104b95:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104b9c:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104bb3:	81 7d f4 94 5f 11 80 	cmpl   $0x80115f94,-0xc(%ebp)
80104bba:	72 b6                	jb     80104b72 <kill+0x1b>
  ...
  release(&ptable.lock);
80104bbc:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
...
80104bd2:	83 ec 58             	sub    $0x58,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bd5:	c7 45 f0 94 40 11 80 	movl   $0x80114094,-0x10(%ebp)
...
80104c1c:	eb 07                	jmp    80104c25 <procdump+0x56>
      ...
      state = "???";
80104c1e:	c7 45 ec fa 85 10 80 	movl   $0x801085fa,-0x14(%ebp)
...
80104c40:	c7 04 24 fe 85 10 80 	movl   $0x801085fe,(%esp)
...
80104c86:	c7 04 24 07 86 10 80 	movl   $0x80108607,(%esp)
...
80104ca4:	75 d5                	jne    80104c7b <procdump+0xac>
    ...
    cprintf("\n");
80104ca6:	c7 04 24 0b 86 10 80 	movl   $0x8010860b,(%esp)
...
80104cb6:	81 7d f0 94 5f 11 80 	cmpl   $0x80115f94,-0x10(%ebp)
...
80104cd4:	c7 44 24 04 37 86 10 	movl   $0x80108637,0x4(%esp)
80104cdb:	80 
...
80104e40:	74 0c                	je     80104e4e <acquire+0x27>
    panic("acquire");
80104e42:	c7 04 24 42 86 10 80 	movl   $0x80108642,(%esp)
...
80104ea4:	75 0c                	jne    80104eb2 <release+0x21>
    panic("release");
80104ea6:	c7 04 24 4a 86 10 80 	movl   $0x8010864a,(%esp)
...
80104fe4:	c7 04 24 52 86 10 80 	movl   $0x80108652,(%esp)
...
8010500a:	79 0c                	jns    80105018 <popcli+0x48>
    panic("popcli");
8010500c:	c7 04 24 69 86 10 80 	movl   $0x80108669,(%esp)
...
801054af:	83 f8 15             	cmp    $0x15,%eax
...
801054f4:	c7 04 24 70 86 10 80 	movl   $0x80108670,(%esp)
...
80105985:	c7 04 24 8c 86 10 80 	movl   $0x8010868c,(%esp)
...
80105a1e:	c7 44 24 04 9e 86 10 	movl   $0x8010869e,0x4(%esp)
80105a25:	80 
...
80105a39:	c7 44 24 04 a0 86 10 	movl   $0x801086a0,0x4(%esp)
80105a40:	80 
...
80105a92:	c7 04 24 a3 86 10 80 	movl   $0x801086a3,(%esp)
...
80105b08:	74 0c                	je     80105b16 <sys_unlink+0x159>
    panic("unlink: writei");
80105b0a:	c7 04 24 b5 86 10 80 	movl   $0x801086b5,(%esp)
...
80105c5e:	75 0c                	jne    80105c6c <create+0xdd>
    panic("create: ialloc");
80105c60:	c7 04 24 c4 86 10 80 	movl   $0x801086c4,(%esp)
...
80105cca:	c7 44 24 04 9e 86 10 	movl   $0x8010869e,0x4(%esp)
80105cd1:	80 
...
80105ceb:	c7 44 24 04 a0 86 10 	movl   $0x801086a0,0x4(%esp)
80105cf2:	80 
...
80105d00:	79 0c                	jns    80105d0e <create+0x17f>
      panic("create dots");
80105d02:	c7 04 24 d3 86 10 80 	movl   $0x801086d3,(%esp)
...
80105d2e:	c7 04 24 df 86 10 80 	movl   $0x801086df,(%esp)
...
8010627b:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010627e:	e8 90 e2 ff ff       	call   80104513 <fork>
}
80106283:	c9                   	leave  
80106284:	c3                   	ret    
...
80106288:	83 ec 08             	sub    $0x8,%esp
  exit();
8010628b:	e8 e9 e3 ff ff       	call   80104679 <exit>
...
8010629a:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010629d:	e8 e0 e4 ff ff       	call   80104782 <wait>
}
801062a2:	c9                   	leave  
801062a3:	c3                   	ret    
...
801062b8:	e8 00 f1 ff ff       	call   801053bd <argint>
801062bd:	85 c0                	test   %eax,%eax
801062bf:	79 07                	jns    801062c8 <sys_kill+0x24>
    return -1;
801062c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c6:	eb 0b                	jmp    801062d3 <sys_kill+0x2f>
  return kill(pid);
801062c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062cb:	89 04 24             	mov    %eax,(%esp)
801062ce:	e8 84 e8 ff ff       	call   80104b57 <kill>
}
801062d3:	c9                   	leave  
801062d4:	c3                   	ret    
...
801062d8:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801062db:	e8 37 df ff ff       	call   80104217 <myproc>
...
801062f9:	e8 bf f0 ff ff       	call   801053bd <argint>
801062fe:	85 c0                	test   %eax,%eax
80106300:	79 07                	jns    80106309 <sys_sbrk+0x24>
    return -1;
80106302:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106307:	eb 23                	jmp    8010632c <sys_sbrk+0x47>
  addr = myproc()->sz;
80106309:	e8 09 df ff ff       	call   80104217 <myproc>
...
80106319:	e8 57 e1 ff ff       	call   80104475 <growproc>
8010631e:	85 c0                	test   %eax,%eax
80106320:	79 07                	jns    80106329 <sys_sbrk+0x44>
    return -1;
80106322:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106327:	eb 03                	jmp    8010632c <sys_sbrk+0x47>
  return addr;
...
80106342:	e8 76 f0 ff ff       	call   801053bd <argint>
80106347:	85 c0                	test   %eax,%eax
80106349:	79 07                	jns    80106352 <sys_sleep+0x24>
    return -1;
8010634b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106350:	eb 6b                	jmp    801063bd <sys_sleep+0x8f>
  acquire(&tickslock);
80106352:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
80106359:	e8 c9 ea ff ff       	call   80104e27 <acquire>
  ticks0 = ticks;
8010635e:	a1 e0 67 11 80       	mov    0x801167e0,%eax
80106363:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106366:	eb 33                	jmp    8010639b <sys_sleep+0x6d>
    if(myproc()->killed){
80106368:	e8 aa de ff ff       	call   80104217 <myproc>
8010636d:	8b 40 24             	mov    0x24(%eax),%eax
80106370:	85 c0                	test   %eax,%eax
80106372:	74 13                	je     80106387 <sys_sleep+0x59>
      release(&tickslock);
80106374:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
8010637b:	e8 11 eb ff ff       	call   80104e91 <release>
      return -1;
80106380:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106385:	eb 36                	jmp    801063bd <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
80106387:	c7 44 24 04 a0 5f 11 	movl   $0x80115fa0,0x4(%esp)
8010638e:	80 
8010638f:	c7 04 24 e0 67 11 80 	movl   $0x801167e0,(%esp)
80106396:	e8 bd e6 ff ff       	call   80104a58 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010639b:	a1 e0 67 11 80       	mov    0x801167e0,%eax
801063a0:	2b 45 f4             	sub    -0xc(%ebp),%eax
801063a3:	89 c2                	mov    %eax,%edx
801063a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063a8:	39 c2                	cmp    %eax,%edx
801063aa:	72 bc                	jb     80106368 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801063ac:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
801063b3:	e8 d9 ea ff ff       	call   80104e91 <release>
  return 0;
...
801063c2:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801063c5:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
801063cc:	e8 56 ea ff ff       	call   80104e27 <acquire>
  xticks = ticks;
801063d1:	a1 e0 67 11 80       	mov    0x801167e0,%eax
801063d6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063d9:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
801063e0:	e8 ac ea ff ff       	call   80104e91 <release>
  return xticks;
...
801063ed:	06                   	push   %es
  pushl %fs
801063ee:	0f a0                	push   %fs
  pushl %gs
801063f0:	0f a8                	push   %gs
  pushal
801063f2:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801063f3:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801063f7:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801063f9:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801063fb:	54                   	push   %esp
  call trap
801063fc:	e8 c0 01 00 00       	call   801065c1 <trap>
  addl $4, %esp
...
80106419:	48                   	dec    %eax
8010641a:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010641e:	8b 45 08             	mov    0x8(%ebp),%eax
80106421:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
...
8010643a:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
8010643d:	0f 20 d0             	mov    %cr2,%eax
80106440:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
...
8010644b:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
8010644e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106455:	e9 b8 00 00 00       	jmp    80106512 <tvinit+0xca>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010645a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010645d:	8b 04 85 78 b0 10 80 	mov    -0x7fef4f88(,%eax,4),%eax
80106464:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106467:	66 89 04 d5 e0 5f 11 	mov    %ax,-0x7feea020(,%edx,8)
8010646e:	80 
8010646f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106472:	66 c7 04 c5 e2 5f 11 	movw   $0x8,-0x7feea01e(,%eax,8)
80106479:	80 08 00 
8010647c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010647f:	8a 14 c5 e4 5f 11 80 	mov    -0x7feea01c(,%eax,8),%dl
80106486:	83 e2 e0             	and    $0xffffffe0,%edx
80106489:	88 14 c5 e4 5f 11 80 	mov    %dl,-0x7feea01c(,%eax,8)
80106490:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106493:	8a 14 c5 e4 5f 11 80 	mov    -0x7feea01c(,%eax,8),%dl
8010649a:	83 e2 1f             	and    $0x1f,%edx
8010649d:	88 14 c5 e4 5f 11 80 	mov    %dl,-0x7feea01c(,%eax,8)
801064a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064a7:	8a 14 c5 e5 5f 11 80 	mov    -0x7feea01b(,%eax,8),%dl
801064ae:	83 e2 f0             	and    $0xfffffff0,%edx
801064b1:	83 ca 0e             	or     $0xe,%edx
801064b4:	88 14 c5 e5 5f 11 80 	mov    %dl,-0x7feea01b(,%eax,8)
801064bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064be:	8a 14 c5 e5 5f 11 80 	mov    -0x7feea01b(,%eax,8),%dl
801064c5:	83 e2 ef             	and    $0xffffffef,%edx
801064c8:	88 14 c5 e5 5f 11 80 	mov    %dl,-0x7feea01b(,%eax,8)
801064cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064d2:	8a 14 c5 e5 5f 11 80 	mov    -0x7feea01b(,%eax,8),%dl
801064d9:	83 e2 9f             	and    $0xffffff9f,%edx
801064dc:	88 14 c5 e5 5f 11 80 	mov    %dl,-0x7feea01b(,%eax,8)
801064e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e6:	8a 14 c5 e5 5f 11 80 	mov    -0x7feea01b(,%eax,8),%dl
801064ed:	83 ca 80             	or     $0xffffff80,%edx
801064f0:	88 14 c5 e5 5f 11 80 	mov    %dl,-0x7feea01b(,%eax,8)
801064f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064fa:	8b 04 85 78 b0 10 80 	mov    -0x7fef4f88(,%eax,4),%eax
80106501:	c1 e8 10             	shr    $0x10,%eax
80106504:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106507:	66 89 04 d5 e6 5f 11 	mov    %ax,-0x7feea01a(,%edx,8)
8010650e:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
8010650f:	ff 45 f4             	incl   -0xc(%ebp)
80106512:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106519:	0f 8e 3b ff ff ff    	jle    8010645a <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010651f:	a1 78 b1 10 80       	mov    0x8010b178,%eax
80106524:	66 a3 e0 61 11 80    	mov    %ax,0x801161e0
8010652a:	66 c7 05 e2 61 11 80 	movw   $0x8,0x801161e2
80106531:	08 00 
80106533:	a0 e4 61 11 80       	mov    0x801161e4,%al
80106538:	83 e0 e0             	and    $0xffffffe0,%eax
8010653b:	a2 e4 61 11 80       	mov    %al,0x801161e4
80106540:	a0 e4 61 11 80       	mov    0x801161e4,%al
80106545:	83 e0 1f             	and    $0x1f,%eax
80106548:	a2 e4 61 11 80       	mov    %al,0x801161e4
8010654d:	a0 e5 61 11 80       	mov    0x801161e5,%al
80106552:	83 c8 0f             	or     $0xf,%eax
80106555:	a2 e5 61 11 80       	mov    %al,0x801161e5
8010655a:	a0 e5 61 11 80       	mov    0x801161e5,%al
8010655f:	83 e0 ef             	and    $0xffffffef,%eax
80106562:	a2 e5 61 11 80       	mov    %al,0x801161e5
80106567:	a0 e5 61 11 80       	mov    0x801161e5,%al
8010656c:	83 c8 60             	or     $0x60,%eax
8010656f:	a2 e5 61 11 80       	mov    %al,0x801161e5
80106574:	a0 e5 61 11 80       	mov    0x801161e5,%al
80106579:	83 c8 80             	or     $0xffffff80,%eax
8010657c:	a2 e5 61 11 80       	mov    %al,0x801161e5
80106581:	a1 78 b1 10 80       	mov    0x8010b178,%eax
80106586:	c1 e8 10             	shr    $0x10,%eax
80106589:	66 a3 e6 61 11 80    	mov    %ax,0x801161e6

  initlock(&tickslock, "time");
8010658f:	c7 44 24 04 f0 86 10 	movl   $0x801086f0,0x4(%esp)
80106596:	80 
80106597:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
8010659e:	e8 63 e8 ff ff       	call   80104e06 <initlock>
}
801065a3:	c9                   	leave  
801065a4:	c3                   	ret    
...
801065a8:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801065ab:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801065b2:	00 
801065b3:	c7 04 24 e0 5f 11 80 	movl   $0x80115fe0,(%esp)
801065ba:	e8 51 fe ff ff       	call   80106410 <lidt>
}
801065bf:	c9                   	leave  
801065c0:	c3                   	ret    
...
801065c7:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801065ca:	8b 45 08             	mov    0x8(%ebp),%eax
801065cd:	8b 40 30             	mov    0x30(%eax),%eax
801065d0:	83 f8 40             	cmp    $0x40,%eax
801065d3:	75 3c                	jne    80106611 <trap+0x50>
    if(myproc()->killed)
801065d5:	e8 3d dc ff ff       	call   80104217 <myproc>
801065da:	8b 40 24             	mov    0x24(%eax),%eax
801065dd:	85 c0                	test   %eax,%eax
801065df:	74 05                	je     801065e6 <trap+0x25>
      exit();
801065e1:	e8 93 e0 ff ff       	call   80104679 <exit>
    myproc()->tf = tf;
801065e6:	e8 2c dc ff ff       	call   80104217 <myproc>
801065eb:	8b 55 08             	mov    0x8(%ebp),%edx
801065ee:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801065f1:	e8 95 ee ff ff       	call   8010548b <syscall>
    if(myproc()->killed)
801065f6:	e8 1c dc ff ff       	call   80104217 <myproc>
801065fb:	8b 40 24             	mov    0x24(%eax),%eax
801065fe:	85 c0                	test   %eax,%eax
80106600:	74 0a                	je     8010660c <trap+0x4b>
      exit();
80106602:	e8 72 e0 ff ff       	call   80104679 <exit>
    return;
80106607:	e9 13 02 00 00       	jmp    8010681f <trap+0x25e>
8010660c:	e9 0e 02 00 00       	jmp    8010681f <trap+0x25e>
  }

  switch(tf->trapno){
80106611:	8b 45 08             	mov    0x8(%ebp),%eax
80106614:	8b 40 30             	mov    0x30(%eax),%eax
80106617:	83 e8 20             	sub    $0x20,%eax
8010661a:	83 f8 1f             	cmp    $0x1f,%eax
8010661d:	0f 87 ae 00 00 00    	ja     801066d1 <trap+0x110>
80106623:	8b 04 85 98 87 10 80 	mov    -0x7fef7868(,%eax,4),%eax
8010662a:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
8010662c:	e8 1d db ff ff       	call   8010414e <cpuid>
80106631:	85 c0                	test   %eax,%eax
80106633:	75 2f                	jne    80106664 <trap+0xa3>
      acquire(&tickslock);
80106635:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
8010663c:	e8 e6 e7 ff ff       	call   80104e27 <acquire>
      ticks++;
80106641:	a1 e0 67 11 80       	mov    0x801167e0,%eax
80106646:	40                   	inc    %eax
80106647:	a3 e0 67 11 80       	mov    %eax,0x801167e0
      wakeup(&ticks);
8010664c:	c7 04 24 e0 67 11 80 	movl   $0x801167e0,(%esp)
80106653:	e8 d4 e4 ff ff       	call   80104b2c <wakeup>
      release(&tickslock);
80106658:	c7 04 24 a0 5f 11 80 	movl   $0x80115fa0,(%esp)
8010665f:	e8 2d e8 ff ff       	call   80104e91 <release>
    }
    lapiceoi();
80106664:	e8 8e c9 ff ff       	call   80102ff7 <lapiceoi>
    break;
80106669:	e9 35 01 00 00       	jmp    801067a3 <trap+0x1e2>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010666e:	e8 03 c2 ff ff       	call   80102876 <ideintr>
    lapiceoi();
80106673:	e8 7f c9 ff ff       	call   80102ff7 <lapiceoi>
    break;
80106678:	e9 26 01 00 00       	jmp    801067a3 <trap+0x1e2>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010667d:	e8 8c c7 ff ff       	call   80102e0e <kbdintr>
    lapiceoi();
80106682:	e8 70 c9 ff ff       	call   80102ff7 <lapiceoi>
    break;
80106687:	e9 17 01 00 00       	jmp    801067a3 <trap+0x1e2>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010668c:	e8 70 03 00 00       	call   80106a01 <uartintr>
    lapiceoi();
80106691:	e8 61 c9 ff ff       	call   80102ff7 <lapiceoi>
    break;
80106696:	e9 08 01 00 00       	jmp    801067a3 <trap+0x1e2>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010669b:	8b 45 08             	mov    0x8(%ebp),%eax
8010669e:	8b 70 38             	mov    0x38(%eax),%esi
            cpuid(), tf->cs, tf->eip);
801066a1:	8b 45 08             	mov    0x8(%ebp),%eax
801066a4:	8b 40 3c             	mov    0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
801066aa:	e8 9f da ff ff       	call   8010414e <cpuid>
801066af:	89 74 24 0c          	mov    %esi,0xc(%esp)
801066b3:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801066b7:	89 44 24 04          	mov    %eax,0x4(%esp)
801066bb:	c7 04 24 f8 86 10 80 	movl   $0x801086f8,(%esp)
801066c2:	e8 fa 9c ff ff       	call   801003c1 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801066c7:	e8 2b c9 ff ff       	call   80102ff7 <lapiceoi>
    break;
801066cc:	e9 d2 00 00 00       	jmp    801067a3 <trap+0x1e2>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
801066d1:	e8 41 db ff ff       	call   80104217 <myproc>
801066d6:	85 c0                	test   %eax,%eax
801066d8:	74 10                	je     801066ea <trap+0x129>
...
801066e8:	75 40                	jne    8010672a <trap+0x169>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801066ea:	e8 48 fd ff ff       	call   80106437 <rcr2>
801066ef:	89 c3                	mov    %eax,%ebx
801066f1:	8b 45 08             	mov    0x8(%ebp),%eax
801066f4:	8b 70 38             	mov    0x38(%eax),%esi
801066f7:	e8 52 da ff ff       	call   8010414e <cpuid>
801066fc:	8b 55 08             	mov    0x8(%ebp),%edx
801066ff:	8b 52 30             	mov    0x30(%edx),%edx
80106702:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106706:	89 74 24 0c          	mov    %esi,0xc(%esp)
8010670a:	89 44 24 08          	mov    %eax,0x8(%esp)
8010670e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106712:	c7 04 24 1c 87 10 80 	movl   $0x8010871c,(%esp)
80106719:	e8 a3 9c ff ff       	call   801003c1 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010671e:	c7 04 24 4e 87 10 80 	movl   $0x8010874e,(%esp)
80106725:	e8 2a 9e ff ff       	call   80100554 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010672a:	e8 08 fd ff ff       	call   80106437 <rcr2>
8010672f:	89 c6                	mov    %eax,%esi
80106731:	8b 45 08             	mov    0x8(%ebp),%eax
80106734:	8b 40 38             	mov    0x38(%eax),%eax
80106737:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010673a:	e8 0f da ff ff       	call   8010414e <cpuid>
8010673f:	89 c3                	mov    %eax,%ebx
80106741:	8b 45 08             	mov    0x8(%ebp),%eax
80106744:	8b 78 34             	mov    0x34(%eax),%edi
80106747:	89 7d e0             	mov    %edi,-0x20(%ebp)
8010674a:	8b 45 08             	mov    0x8(%ebp),%eax
8010674d:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106750:	e8 c2 da ff ff       	call   80104217 <myproc>
80106755:	8d 50 6c             	lea    0x6c(%eax),%edx
80106758:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010675b:	e8 b7 da ff ff       	call   80104217 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106760:	8b 40 10             	mov    0x10(%eax),%eax
80106763:	89 74 24 1c          	mov    %esi,0x1c(%esp)
80106767:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010676a:	89 4c 24 18          	mov    %ecx,0x18(%esp)
8010676e:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80106772:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106775:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80106779:	89 7c 24 0c          	mov    %edi,0xc(%esp)
8010677d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106780:	89 54 24 08          	mov    %edx,0x8(%esp)
80106784:	89 44 24 04          	mov    %eax,0x4(%esp)
80106788:	c7 04 24 54 87 10 80 	movl   $0x80108754,(%esp)
8010678f:	e8 2d 9c ff ff       	call   801003c1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
...
801067a0:	eb 01                	jmp    801067a3 <trap+0x1e2>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801067a3:	e8 6f da ff ff       	call   80104217 <myproc>
801067a8:	85 c0                	test   %eax,%eax
801067aa:	74 22                	je     801067ce <trap+0x20d>
801067ac:	e8 66 da ff ff       	call   80104217 <myproc>
801067b1:	8b 40 24             	mov    0x24(%eax),%eax
801067b4:	85 c0                	test   %eax,%eax
801067b6:	74 16                	je     801067ce <trap+0x20d>
801067b8:	8b 45 08             	mov    0x8(%ebp),%eax
801067bb:	8b 40 3c             	mov    0x3c(%eax),%eax
801067be:	0f b7 c0             	movzwl %ax,%eax
801067c1:	83 e0 03             	and    $0x3,%eax
801067c4:	83 f8 03             	cmp    $0x3,%eax
801067c7:	75 05                	jne    801067ce <trap+0x20d>
    exit();
801067c9:	e8 ab de ff ff       	call   80104679 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801067ce:	e8 44 da ff ff       	call   80104217 <myproc>
801067d3:	85 c0                	test   %eax,%eax
801067d5:	74 1d                	je     801067f4 <trap+0x233>
801067d7:	e8 3b da ff ff       	call   80104217 <myproc>
801067dc:	8b 40 0c             	mov    0xc(%eax),%eax
801067df:	83 f8 04             	cmp    $0x4,%eax
801067e2:	75 10                	jne    801067f4 <trap+0x233>
...
801067e7:	8b 40 30             	mov    0x30(%eax),%eax
  ...
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801067ea:	83 f8 20             	cmp    $0x20,%eax
801067ed:	75 05                	jne    801067f4 <trap+0x233>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
801067ef:	e8 f4 e1 ff ff       	call   801049e8 <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801067f4:	e8 1e da ff ff       	call   80104217 <myproc>
801067f9:	85 c0                	test   %eax,%eax
801067fb:	74 22                	je     8010681f <trap+0x25e>
801067fd:	e8 15 da ff ff       	call   80104217 <myproc>
80106802:	8b 40 24             	mov    0x24(%eax),%eax
80106805:	85 c0                	test   %eax,%eax
80106807:	74 16                	je     8010681f <trap+0x25e>
80106809:	8b 45 08             	mov    0x8(%ebp),%eax
8010680c:	8b 40 3c             	mov    0x3c(%eax),%eax
8010680f:	0f b7 c0             	movzwl %ax,%eax
80106812:	83 e0 03             	and    $0x3,%eax
80106815:	83 f8 03             	cmp    $0x3,%eax
80106818:	75 05                	jne    8010681f <trap+0x25e>
    exit();
8010681a:	e8 5a de ff ff       	call   80104679 <exit>
}
8010681f:	83 c4 3c             	add    $0x3c,%esp
80106822:	5b                   	pop    %ebx
80106823:	5e                   	pop    %esi
80106824:	5f                   	pop    %edi
80106825:	5d                   	pop    %ebp
...
8010682b:	83 ec 14             	sub    $0x14,%esp
8010682e:	8b 45 08             	mov    0x8(%ebp),%eax
80106831:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106835:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106838:	89 c2                	mov    %eax,%edx
8010683a:	ec                   	in     (%dx),%al
8010683b:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
8010683e:	8a 45 ff             	mov    -0x1(%ebp),%al
}
80106841:	c9                   	leave  
80106842:	c3                   	ret    
...
8010684c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010684f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
80106853:	88 55 f8             	mov    %dl,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106856:	8a 45 f8             	mov    -0x8(%ebp),%al
80106859:	8b 55 fc             	mov    -0x4(%ebp),%edx
...
80106874:	e8 ca ff ff ff       	call   80106843 <outb>

  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106879:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106880:	00 
80106881:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106888:	e8 b6 ff ff ff       	call   80106843 <outb>
  outb(COM1+0, 115200/9600);
8010688d:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106894:	00 
80106895:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010689c:	e8 a2 ff ff ff       	call   80106843 <outb>
  outb(COM1+1, 0);
801068a1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068a8:	00 
801068a9:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801068b0:	e8 8e ff ff ff       	call   80106843 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801068b5:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801068bc:	00 
801068bd:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801068c4:	e8 7a ff ff ff       	call   80106843 <outb>
  outb(COM1+4, 0);
801068c9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068d0:	00 
801068d1:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801068d8:	e8 66 ff ff ff       	call   80106843 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801068dd:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801068e4:	00 
801068e5:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801068ec:	e8 52 ff ff ff       	call   80106843 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801068f1:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801068f8:	e8 2b ff ff ff       	call   80106828 <inb>
801068fd:	3c ff                	cmp    $0xff,%al
801068ff:	75 02                	jne    80106903 <uartinit+0xa4>
    return;
80106901:	eb 5b                	jmp    8010695e <uartinit+0xff>
  uart = 1;
80106903:	c7 05 24 b6 10 80 01 	movl   $0x1,0x8010b624
8010690a:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
8010690d:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106914:	e8 0f ff ff ff       	call   80106828 <inb>
  inb(COM1+0);
80106919:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106920:	e8 03 ff ff ff       	call   80106828 <inb>
  ioapicenable(IRQ_COM1, 0);
80106925:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010692c:	00 
8010692d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106934:	e8 b2 c1 ff ff       	call   80102aeb <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106939:	c7 45 f4 18 88 10 80 	movl   $0x80108818,-0xc(%ebp)
80106940:	eb 13                	jmp    80106955 <uartinit+0xf6>
    uartputc(*p);
80106942:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106945:	8a 00                	mov    (%eax),%al
80106947:	0f be c0             	movsbl %al,%eax
8010694a:	89 04 24             	mov    %eax,(%esp)
8010694d:	e8 0e 00 00 00       	call   80106960 <uartputc>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106952:	ff 45 f4             	incl   -0xc(%ebp)
80106955:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106958:	8a 00                	mov    (%eax),%al
8010695a:	84 c0                	test   %al,%al
8010695c:	75 e4                	jne    80106942 <uartinit+0xe3>
    uartputc(*p);
}
8010695e:	c9                   	leave  
8010695f:	c3                   	ret    
...
80106963:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106966:	a1 24 b6 10 80       	mov    0x8010b624,%eax
8010696b:	85 c0                	test   %eax,%eax
8010696d:	75 02                	jne    80106971 <uartputc+0x11>
    return;
8010696f:	eb 4a                	jmp    801069bb <uartputc+0x5b>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106971:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106978:	eb 0f                	jmp    80106989 <uartputc+0x29>
    microdelay(10);
8010697a:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106981:	e8 96 c6 ff ff       	call   8010301c <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106986:	ff 45 f4             	incl   -0xc(%ebp)
80106989:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
8010698d:	7f 16                	jg     801069a5 <uartputc+0x45>
8010698f:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106996:	e8 8d fe ff ff       	call   80106828 <inb>
8010699b:	0f b6 c0             	movzbl %al,%eax
8010699e:	83 e0 20             	and    $0x20,%eax
801069a1:	85 c0                	test   %eax,%eax
801069a3:	74 d5                	je     8010697a <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
801069a5:	8b 45 08             	mov    0x8(%ebp),%eax
801069a8:	0f b6 c0             	movzbl %al,%eax
801069ab:	89 44 24 04          	mov    %eax,0x4(%esp)
801069af:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069b6:	e8 88 fe ff ff       	call   80106843 <outb>
}
801069bb:	c9                   	leave  
801069bc:	c3                   	ret    
...
801069c0:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801069c3:	a1 24 b6 10 80       	mov    0x8010b624,%eax
801069c8:	85 c0                	test   %eax,%eax
801069ca:	75 07                	jne    801069d3 <uartgetc+0x16>
    return -1;
801069cc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069d1:	eb 2c                	jmp    801069ff <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
801069d3:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069da:	e8 49 fe ff ff       	call   80106828 <inb>
801069df:	0f b6 c0             	movzbl %al,%eax
801069e2:	83 e0 01             	and    $0x1,%eax
801069e5:	85 c0                	test   %eax,%eax
801069e7:	75 07                	jne    801069f0 <uartgetc+0x33>
    return -1;
801069e9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069ee:	eb 0f                	jmp    801069ff <uartgetc+0x42>
  return inb(COM1+0);
801069f0:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069f7:	e8 2c fe ff ff       	call   80106828 <inb>
801069fc:	0f b6 c0             	movzbl %al,%eax
}
801069ff:	c9                   	leave  
80106a00:	c3                   	ret    
...
80106a07:	c7 04 24 bd 69 10 80 	movl   $0x801069bd,(%esp)
80106a0e:	e8 e2 9d ff ff       	call   801007f5 <consoleintr>
}
80106a13:	c9                   	leave  
80106a14:	c3                   	ret    
80106a15:	00 00                	add    %al,(%eax)
	...
...
80106a1a:	6a 00                	push   $0x0
  jmp alltraps
80106a1c:	e9 cb f9 ff ff       	jmp    801063ec <alltraps>
...
80106a21:	6a 00                	push   $0x0
  pushl $1
80106a23:	6a 01                	push   $0x1
  jmp alltraps
80106a25:	e9 c2 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a2a:	6a 00                	push   $0x0
  pushl $2
80106a2c:	6a 02                	push   $0x2
  jmp alltraps
80106a2e:	e9 b9 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a33:	6a 00                	push   $0x0
  pushl $3
80106a35:	6a 03                	push   $0x3
  jmp alltraps
80106a37:	e9 b0 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a3e:	6a 04                	push   $0x4
  jmp alltraps
80106a40:	e9 a7 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a45:	6a 00                	push   $0x0
  pushl $5
80106a47:	6a 05                	push   $0x5
  jmp alltraps
80106a49:	e9 9e f9 ff ff       	jmp    801063ec <alltraps>
...
80106a50:	6a 06                	push   $0x6
  jmp alltraps
80106a52:	e9 95 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a57:	6a 00                	push   $0x0
  pushl $7
80106a59:	6a 07                	push   $0x7
  jmp alltraps
80106a5b:	e9 8c f9 ff ff       	jmp    801063ec <alltraps>

80106a60 <vector8>:
.globl vector8
vector8:
  pushl $8
80106a60:	6a 08                	push   $0x8
  jmp alltraps
80106a62:	e9 85 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a67:	6a 00                	push   $0x0
  pushl $9
80106a69:	6a 09                	push   $0x9
  jmp alltraps
80106a6b:	e9 7c f9 ff ff       	jmp    801063ec <alltraps>

80106a70 <vector10>:
.globl vector10
vector10:
  pushl $10
80106a70:	6a 0a                	push   $0xa
  jmp alltraps
80106a72:	e9 75 f9 ff ff       	jmp    801063ec <alltraps>

80106a77 <vector11>:
.globl vector11
vector11:
  pushl $11
80106a77:	6a 0b                	push   $0xb
  jmp alltraps
80106a79:	e9 6e f9 ff ff       	jmp    801063ec <alltraps>

80106a7e <vector12>:
.globl vector12
vector12:
  pushl $12
80106a7e:	6a 0c                	push   $0xc
  jmp alltraps
80106a80:	e9 67 f9 ff ff       	jmp    801063ec <alltraps>

80106a85 <vector13>:
.globl vector13
vector13:
  pushl $13
80106a85:	6a 0d                	push   $0xd
  jmp alltraps
80106a87:	e9 60 f9 ff ff       	jmp    801063ec <alltraps>

80106a8c <vector14>:
.globl vector14
vector14:
  pushl $14
80106a8c:	6a 0e                	push   $0xe
  jmp alltraps
80106a8e:	e9 59 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a93:	6a 00                	push   $0x0
  pushl $15
80106a95:	6a 0f                	push   $0xf
  jmp alltraps
80106a97:	e9 50 f9 ff ff       	jmp    801063ec <alltraps>
...
80106a9c:	6a 00                	push   $0x0
  pushl $16
80106a9e:	6a 10                	push   $0x10
  jmp alltraps
80106aa0:	e9 47 f9 ff ff       	jmp    801063ec <alltraps>

80106aa5 <vector17>:
.globl vector17
vector17:
  pushl $17
80106aa5:	6a 11                	push   $0x11
  jmp alltraps
80106aa7:	e9 40 f9 ff ff       	jmp    801063ec <alltraps>
...
80106aac:	6a 00                	push   $0x0
  pushl $18
80106aae:	6a 12                	push   $0x12
  jmp alltraps
80106ab0:	e9 37 f9 ff ff       	jmp    801063ec <alltraps>
...
80106ab5:	6a 00                	push   $0x0
  pushl $19
80106ab7:	6a 13                	push   $0x13
  jmp alltraps
80106ab9:	e9 2e f9 ff ff       	jmp    801063ec <alltraps>
...
80106abe:	6a 00                	push   $0x0
  pushl $20
80106ac0:	6a 14                	push   $0x14
  jmp alltraps
80106ac2:	e9 25 f9 ff ff       	jmp    801063ec <alltraps>
...
80106ac7:	6a 00                	push   $0x0
  pushl $21
80106ac9:	6a 15                	push   $0x15
  jmp alltraps
80106acb:	e9 1c f9 ff ff       	jmp    801063ec <alltraps>
...
80106ad0:	6a 00                	push   $0x0
  pushl $22
80106ad2:	6a 16                	push   $0x16
  jmp alltraps
80106ad4:	e9 13 f9 ff ff       	jmp    801063ec <alltraps>
...
80106ad9:	6a 00                	push   $0x0
  pushl $23
80106adb:	6a 17                	push   $0x17
  jmp alltraps
80106add:	e9 0a f9 ff ff       	jmp    801063ec <alltraps>
...
80106ae2:	6a 00                	push   $0x0
  pushl $24
80106ae4:	6a 18                	push   $0x18
  jmp alltraps
80106ae6:	e9 01 f9 ff ff       	jmp    801063ec <alltraps>
...
80106aeb:	6a 00                	push   $0x0
  pushl $25
80106aed:	6a 19                	push   $0x19
  jmp alltraps
80106aef:	e9 f8 f8 ff ff       	jmp    801063ec <alltraps>
...
80106af4:	6a 00                	push   $0x0
  pushl $26
80106af6:	6a 1a                	push   $0x1a
  jmp alltraps
80106af8:	e9 ef f8 ff ff       	jmp    801063ec <alltraps>
...
80106afd:	6a 00                	push   $0x0
  pushl $27
80106aff:	6a 1b                	push   $0x1b
  jmp alltraps
80106b01:	e9 e6 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b06:	6a 00                	push   $0x0
  pushl $28
80106b08:	6a 1c                	push   $0x1c
  jmp alltraps
80106b0a:	e9 dd f8 ff ff       	jmp    801063ec <alltraps>
...
80106b0f:	6a 00                	push   $0x0
  pushl $29
80106b11:	6a 1d                	push   $0x1d
  jmp alltraps
80106b13:	e9 d4 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b18:	6a 00                	push   $0x0
  pushl $30
80106b1a:	6a 1e                	push   $0x1e
  jmp alltraps
80106b1c:	e9 cb f8 ff ff       	jmp    801063ec <alltraps>
...
80106b21:	6a 00                	push   $0x0
  pushl $31
80106b23:	6a 1f                	push   $0x1f
  jmp alltraps
80106b25:	e9 c2 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b2a:	6a 00                	push   $0x0
  pushl $32
80106b2c:	6a 20                	push   $0x20
  jmp alltraps
80106b2e:	e9 b9 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b33:	6a 00                	push   $0x0
  pushl $33
80106b35:	6a 21                	push   $0x21
  jmp alltraps
80106b37:	e9 b0 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b3c:	6a 00                	push   $0x0
  pushl $34
80106b3e:	6a 22                	push   $0x22
  jmp alltraps
80106b40:	e9 a7 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b45:	6a 00                	push   $0x0
  pushl $35
80106b47:	6a 23                	push   $0x23
  jmp alltraps
80106b49:	e9 9e f8 ff ff       	jmp    801063ec <alltraps>
...
80106b4e:	6a 00                	push   $0x0
  pushl $36
80106b50:	6a 24                	push   $0x24
  jmp alltraps
80106b52:	e9 95 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b57:	6a 00                	push   $0x0
  pushl $37
80106b59:	6a 25                	push   $0x25
  jmp alltraps
80106b5b:	e9 8c f8 ff ff       	jmp    801063ec <alltraps>
...
80106b60:	6a 00                	push   $0x0
  pushl $38
80106b62:	6a 26                	push   $0x26
  jmp alltraps
80106b64:	e9 83 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b69:	6a 00                	push   $0x0
  pushl $39
80106b6b:	6a 27                	push   $0x27
  jmp alltraps
80106b6d:	e9 7a f8 ff ff       	jmp    801063ec <alltraps>
...
80106b72:	6a 00                	push   $0x0
  pushl $40
80106b74:	6a 28                	push   $0x28
  jmp alltraps
80106b76:	e9 71 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b7b:	6a 00                	push   $0x0
  pushl $41
80106b7d:	6a 29                	push   $0x29
  jmp alltraps
80106b7f:	e9 68 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b84:	6a 00                	push   $0x0
  pushl $42
80106b86:	6a 2a                	push   $0x2a
  jmp alltraps
80106b88:	e9 5f f8 ff ff       	jmp    801063ec <alltraps>
...
80106b8d:	6a 00                	push   $0x0
  pushl $43
80106b8f:	6a 2b                	push   $0x2b
  jmp alltraps
80106b91:	e9 56 f8 ff ff       	jmp    801063ec <alltraps>
...
80106b96:	6a 00                	push   $0x0
  pushl $44
80106b98:	6a 2c                	push   $0x2c
  jmp alltraps
80106b9a:	e9 4d f8 ff ff       	jmp    801063ec <alltraps>
...
80106b9f:	6a 00                	push   $0x0
  pushl $45
80106ba1:	6a 2d                	push   $0x2d
  jmp alltraps
80106ba3:	e9 44 f8 ff ff       	jmp    801063ec <alltraps>
...
80106ba8:	6a 00                	push   $0x0
  pushl $46
80106baa:	6a 2e                	push   $0x2e
  jmp alltraps
80106bac:	e9 3b f8 ff ff       	jmp    801063ec <alltraps>
...
80106bb1:	6a 00                	push   $0x0
  pushl $47
80106bb3:	6a 2f                	push   $0x2f
  jmp alltraps
80106bb5:	e9 32 f8 ff ff       	jmp    801063ec <alltraps>
...
80106bba:	6a 00                	push   $0x0
  pushl $48
80106bbc:	6a 30                	push   $0x30
  jmp alltraps
80106bbe:	e9 29 f8 ff ff       	jmp    801063ec <alltraps>
...
80106bc3:	6a 00                	push   $0x0
  pushl $49
80106bc5:	6a 31                	push   $0x31
  jmp alltraps
80106bc7:	e9 20 f8 ff ff       	jmp    801063ec <alltraps>
...
80106bcc:	6a 00                	push   $0x0
  pushl $50
80106bce:	6a 32                	push   $0x32
  jmp alltraps
80106bd0:	e9 17 f8 ff ff       	jmp    801063ec <alltraps>
...
80106bd5:	6a 00                	push   $0x0
  pushl $51
80106bd7:	6a 33                	push   $0x33
  jmp alltraps
80106bd9:	e9 0e f8 ff ff       	jmp    801063ec <alltraps>
...
80106bde:	6a 00                	push   $0x0
  pushl $52
80106be0:	6a 34                	push   $0x34
  jmp alltraps
80106be2:	e9 05 f8 ff ff       	jmp    801063ec <alltraps>
...
80106be7:	6a 00                	push   $0x0
  pushl $53
80106be9:	6a 35                	push   $0x35
  jmp alltraps
80106beb:	e9 fc f7 ff ff       	jmp    801063ec <alltraps>
...
80106bf0:	6a 00                	push   $0x0
  pushl $54
80106bf2:	6a 36                	push   $0x36
  jmp alltraps
80106bf4:	e9 f3 f7 ff ff       	jmp    801063ec <alltraps>
...
80106bf9:	6a 00                	push   $0x0
  pushl $55
80106bfb:	6a 37                	push   $0x37
  jmp alltraps
80106bfd:	e9 ea f7 ff ff       	jmp    801063ec <alltraps>
...
80106c02:	6a 00                	push   $0x0
  pushl $56
80106c04:	6a 38                	push   $0x38
  jmp alltraps
80106c06:	e9 e1 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c0b:	6a 00                	push   $0x0
  pushl $57
80106c0d:	6a 39                	push   $0x39
  jmp alltraps
80106c0f:	e9 d8 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c14:	6a 00                	push   $0x0
  pushl $58
80106c16:	6a 3a                	push   $0x3a
  jmp alltraps
80106c18:	e9 cf f7 ff ff       	jmp    801063ec <alltraps>
...
80106c1d:	6a 00                	push   $0x0
  pushl $59
80106c1f:	6a 3b                	push   $0x3b
  jmp alltraps
80106c21:	e9 c6 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c26:	6a 00                	push   $0x0
  pushl $60
80106c28:	6a 3c                	push   $0x3c
  jmp alltraps
80106c2a:	e9 bd f7 ff ff       	jmp    801063ec <alltraps>
...
80106c2f:	6a 00                	push   $0x0
  pushl $61
80106c31:	6a 3d                	push   $0x3d
  jmp alltraps
80106c33:	e9 b4 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c38:	6a 00                	push   $0x0
  pushl $62
80106c3a:	6a 3e                	push   $0x3e
  jmp alltraps
80106c3c:	e9 ab f7 ff ff       	jmp    801063ec <alltraps>
...
80106c41:	6a 00                	push   $0x0
  pushl $63
80106c43:	6a 3f                	push   $0x3f
  jmp alltraps
80106c45:	e9 a2 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c4a:	6a 00                	push   $0x0
  pushl $64
80106c4c:	6a 40                	push   $0x40
  jmp alltraps
80106c4e:	e9 99 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c53:	6a 00                	push   $0x0
  pushl $65
80106c55:	6a 41                	push   $0x41
  jmp alltraps
80106c57:	e9 90 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c5c:	6a 00                	push   $0x0
  pushl $66
80106c5e:	6a 42                	push   $0x42
  jmp alltraps
80106c60:	e9 87 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c65:	6a 00                	push   $0x0
  pushl $67
80106c67:	6a 43                	push   $0x43
  jmp alltraps
80106c69:	e9 7e f7 ff ff       	jmp    801063ec <alltraps>
...
80106c6e:	6a 00                	push   $0x0
  pushl $68
80106c70:	6a 44                	push   $0x44
  jmp alltraps
80106c72:	e9 75 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c77:	6a 00                	push   $0x0
  pushl $69
80106c79:	6a 45                	push   $0x45
  jmp alltraps
80106c7b:	e9 6c f7 ff ff       	jmp    801063ec <alltraps>
...
80106c80:	6a 00                	push   $0x0
  pushl $70
80106c82:	6a 46                	push   $0x46
  jmp alltraps
80106c84:	e9 63 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c89:	6a 00                	push   $0x0
  pushl $71
80106c8b:	6a 47                	push   $0x47
  jmp alltraps
80106c8d:	e9 5a f7 ff ff       	jmp    801063ec <alltraps>
...
80106c92:	6a 00                	push   $0x0
  pushl $72
80106c94:	6a 48                	push   $0x48
  jmp alltraps
80106c96:	e9 51 f7 ff ff       	jmp    801063ec <alltraps>
...
80106c9b:	6a 00                	push   $0x0
  pushl $73
80106c9d:	6a 49                	push   $0x49
  jmp alltraps
80106c9f:	e9 48 f7 ff ff       	jmp    801063ec <alltraps>
...
80106ca4:	6a 00                	push   $0x0
  pushl $74
80106ca6:	6a 4a                	push   $0x4a
  jmp alltraps
80106ca8:	e9 3f f7 ff ff       	jmp    801063ec <alltraps>
...
80106cad:	6a 00                	push   $0x0
  pushl $75
80106caf:	6a 4b                	push   $0x4b
  jmp alltraps
80106cb1:	e9 36 f7 ff ff       	jmp    801063ec <alltraps>
...
80106cb6:	6a 00                	push   $0x0
  pushl $76
80106cb8:	6a 4c                	push   $0x4c
  jmp alltraps
80106cba:	e9 2d f7 ff ff       	jmp    801063ec <alltraps>
...
80106cbf:	6a 00                	push   $0x0
  pushl $77
80106cc1:	6a 4d                	push   $0x4d
  jmp alltraps
80106cc3:	e9 24 f7 ff ff       	jmp    801063ec <alltraps>
...
80106cc8:	6a 00                	push   $0x0
  pushl $78
80106cca:	6a 4e                	push   $0x4e
  jmp alltraps
80106ccc:	e9 1b f7 ff ff       	jmp    801063ec <alltraps>
...
80106cd1:	6a 00                	push   $0x0
  pushl $79
80106cd3:	6a 4f                	push   $0x4f
  jmp alltraps
80106cd5:	e9 12 f7 ff ff       	jmp    801063ec <alltraps>
...
80106cda:	6a 00                	push   $0x0
  pushl $80
80106cdc:	6a 50                	push   $0x50
  jmp alltraps
80106cde:	e9 09 f7 ff ff       	jmp    801063ec <alltraps>
...
80106ce3:	6a 00                	push   $0x0
  pushl $81
80106ce5:	6a 51                	push   $0x51
  jmp alltraps
80106ce7:	e9 00 f7 ff ff       	jmp    801063ec <alltraps>
...
80106cec:	6a 00                	push   $0x0
  pushl $82
80106cee:	6a 52                	push   $0x52
  jmp alltraps
80106cf0:	e9 f7 f6 ff ff       	jmp    801063ec <alltraps>
...
80106cf5:	6a 00                	push   $0x0
  pushl $83
80106cf7:	6a 53                	push   $0x53
  jmp alltraps
80106cf9:	e9 ee f6 ff ff       	jmp    801063ec <alltraps>
...
80106cfe:	6a 00                	push   $0x0
  pushl $84
80106d00:	6a 54                	push   $0x54
  jmp alltraps
80106d02:	e9 e5 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d07:	6a 00                	push   $0x0
  pushl $85
80106d09:	6a 55                	push   $0x55
  jmp alltraps
80106d0b:	e9 dc f6 ff ff       	jmp    801063ec <alltraps>
...
80106d10:	6a 00                	push   $0x0
  pushl $86
80106d12:	6a 56                	push   $0x56
  jmp alltraps
80106d14:	e9 d3 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d19:	6a 00                	push   $0x0
  pushl $87
80106d1b:	6a 57                	push   $0x57
  jmp alltraps
80106d1d:	e9 ca f6 ff ff       	jmp    801063ec <alltraps>
...
80106d22:	6a 00                	push   $0x0
  pushl $88
80106d24:	6a 58                	push   $0x58
  jmp alltraps
80106d26:	e9 c1 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d2b:	6a 00                	push   $0x0
  pushl $89
80106d2d:	6a 59                	push   $0x59
  jmp alltraps
80106d2f:	e9 b8 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d34:	6a 00                	push   $0x0
  pushl $90
80106d36:	6a 5a                	push   $0x5a
  jmp alltraps
80106d38:	e9 af f6 ff ff       	jmp    801063ec <alltraps>
...
80106d3d:	6a 00                	push   $0x0
  pushl $91
80106d3f:	6a 5b                	push   $0x5b
  jmp alltraps
80106d41:	e9 a6 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d46:	6a 00                	push   $0x0
  pushl $92
80106d48:	6a 5c                	push   $0x5c
  jmp alltraps
80106d4a:	e9 9d f6 ff ff       	jmp    801063ec <alltraps>
...
80106d4f:	6a 00                	push   $0x0
  pushl $93
80106d51:	6a 5d                	push   $0x5d
  jmp alltraps
80106d53:	e9 94 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d58:	6a 00                	push   $0x0
  pushl $94
80106d5a:	6a 5e                	push   $0x5e
  jmp alltraps
80106d5c:	e9 8b f6 ff ff       	jmp    801063ec <alltraps>
...
80106d61:	6a 00                	push   $0x0
  pushl $95
80106d63:	6a 5f                	push   $0x5f
  jmp alltraps
80106d65:	e9 82 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d6a:	6a 00                	push   $0x0
  pushl $96
80106d6c:	6a 60                	push   $0x60
  jmp alltraps
80106d6e:	e9 79 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d73:	6a 00                	push   $0x0
  pushl $97
80106d75:	6a 61                	push   $0x61
  jmp alltraps
80106d77:	e9 70 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d7c:	6a 00                	push   $0x0
  pushl $98
80106d7e:	6a 62                	push   $0x62
  jmp alltraps
80106d80:	e9 67 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d85:	6a 00                	push   $0x0
  pushl $99
80106d87:	6a 63                	push   $0x63
  jmp alltraps
80106d89:	e9 5e f6 ff ff       	jmp    801063ec <alltraps>
...
80106d8e:	6a 00                	push   $0x0
  pushl $100
80106d90:	6a 64                	push   $0x64
  jmp alltraps
80106d92:	e9 55 f6 ff ff       	jmp    801063ec <alltraps>
...
80106d97:	6a 00                	push   $0x0
  pushl $101
80106d99:	6a 65                	push   $0x65
  jmp alltraps
80106d9b:	e9 4c f6 ff ff       	jmp    801063ec <alltraps>
...
80106da0:	6a 00                	push   $0x0
  pushl $102
80106da2:	6a 66                	push   $0x66
  jmp alltraps
80106da4:	e9 43 f6 ff ff       	jmp    801063ec <alltraps>
...
80106da9:	6a 00                	push   $0x0
  pushl $103
80106dab:	6a 67                	push   $0x67
  jmp alltraps
80106dad:	e9 3a f6 ff ff       	jmp    801063ec <alltraps>
...
80106db2:	6a 00                	push   $0x0
  pushl $104
80106db4:	6a 68                	push   $0x68
  jmp alltraps
80106db6:	e9 31 f6 ff ff       	jmp    801063ec <alltraps>
...
80106dbb:	6a 00                	push   $0x0
  pushl $105
80106dbd:	6a 69                	push   $0x69
  jmp alltraps
80106dbf:	e9 28 f6 ff ff       	jmp    801063ec <alltraps>
...
80106dc4:	6a 00                	push   $0x0
  pushl $106
80106dc6:	6a 6a                	push   $0x6a
  jmp alltraps
80106dc8:	e9 1f f6 ff ff       	jmp    801063ec <alltraps>
...
80106dcd:	6a 00                	push   $0x0
  pushl $107
80106dcf:	6a 6b                	push   $0x6b
  jmp alltraps
80106dd1:	e9 16 f6 ff ff       	jmp    801063ec <alltraps>
...
80106dd6:	6a 00                	push   $0x0
  pushl $108
80106dd8:	6a 6c                	push   $0x6c
  jmp alltraps
80106dda:	e9 0d f6 ff ff       	jmp    801063ec <alltraps>
...
80106ddf:	6a 00                	push   $0x0
  pushl $109
80106de1:	6a 6d                	push   $0x6d
  jmp alltraps
80106de3:	e9 04 f6 ff ff       	jmp    801063ec <alltraps>
...
80106de8:	6a 00                	push   $0x0
  pushl $110
80106dea:	6a 6e                	push   $0x6e
  jmp alltraps
80106dec:	e9 fb f5 ff ff       	jmp    801063ec <alltraps>
...
80106df1:	6a 00                	push   $0x0
  pushl $111
80106df3:	6a 6f                	push   $0x6f
  jmp alltraps
80106df5:	e9 f2 f5 ff ff       	jmp    801063ec <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $112
80106dfc:	6a 70                	push   $0x70
  jmp alltraps
80106dfe:	e9 e9 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e03:	6a 00                	push   $0x0
  pushl $113
80106e05:	6a 71                	push   $0x71
  jmp alltraps
80106e07:	e9 e0 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e0c:	6a 00                	push   $0x0
  pushl $114
80106e0e:	6a 72                	push   $0x72
  jmp alltraps
80106e10:	e9 d7 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e15:	6a 00                	push   $0x0
  pushl $115
80106e17:	6a 73                	push   $0x73
  jmp alltraps
80106e19:	e9 ce f5 ff ff       	jmp    801063ec <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $116
80106e20:	6a 74                	push   $0x74
  jmp alltraps
80106e22:	e9 c5 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e27:	6a 00                	push   $0x0
  pushl $117
80106e29:	6a 75                	push   $0x75
  jmp alltraps
80106e2b:	e9 bc f5 ff ff       	jmp    801063ec <alltraps>
...
80106e30:	6a 00                	push   $0x0
  pushl $118
80106e32:	6a 76                	push   $0x76
  jmp alltraps
80106e34:	e9 b3 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e39:	6a 00                	push   $0x0
  pushl $119
80106e3b:	6a 77                	push   $0x77
  jmp alltraps
80106e3d:	e9 aa f5 ff ff       	jmp    801063ec <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $120
80106e44:	6a 78                	push   $0x78
  jmp alltraps
80106e46:	e9 a1 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e4b:	6a 00                	push   $0x0
  pushl $121
80106e4d:	6a 79                	push   $0x79
  jmp alltraps
80106e4f:	e9 98 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e54:	6a 00                	push   $0x0
  pushl $122
80106e56:	6a 7a                	push   $0x7a
  jmp alltraps
80106e58:	e9 8f f5 ff ff       	jmp    801063ec <alltraps>
...
80106e5d:	6a 00                	push   $0x0
  pushl $123
80106e5f:	6a 7b                	push   $0x7b
  jmp alltraps
80106e61:	e9 86 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $124
80106e68:	6a 7c                	push   $0x7c
  jmp alltraps
80106e6a:	e9 7d f5 ff ff       	jmp    801063ec <alltraps>
...
80106e6f:	6a 00                	push   $0x0
  pushl $125
80106e71:	6a 7d                	push   $0x7d
  jmp alltraps
80106e73:	e9 74 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e78:	6a 00                	push   $0x0
  pushl $126
80106e7a:	6a 7e                	push   $0x7e
  jmp alltraps
80106e7c:	e9 6b f5 ff ff       	jmp    801063ec <alltraps>
...
80106e81:	6a 00                	push   $0x0
  pushl $127
80106e83:	6a 7f                	push   $0x7f
  jmp alltraps
80106e85:	e9 62 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $128
80106e8c:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106e91:	e9 56 f5 ff ff       	jmp    801063ec <alltraps>
...
80106e96:	6a 00                	push   $0x0
  pushl $129
80106e98:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106e9d:	e9 4a f5 ff ff       	jmp    801063ec <alltraps>
...
80106ea2:	6a 00                	push   $0x0
  pushl $130
80106ea4:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106ea9:	e9 3e f5 ff ff       	jmp    801063ec <alltraps>
...
80106eae:	6a 00                	push   $0x0
  pushl $131
80106eb0:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106eb5:	e9 32 f5 ff ff       	jmp    801063ec <alltraps>
...
80106eba:	6a 00                	push   $0x0
  pushl $132
80106ebc:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106ec1:	e9 26 f5 ff ff       	jmp    801063ec <alltraps>
...
80106ec6:	6a 00                	push   $0x0
  pushl $133
80106ec8:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106ecd:	e9 1a f5 ff ff       	jmp    801063ec <alltraps>
...
80106ed2:	6a 00                	push   $0x0
  pushl $134
80106ed4:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106ed9:	e9 0e f5 ff ff       	jmp    801063ec <alltraps>
...
80106ede:	6a 00                	push   $0x0
  pushl $135
80106ee0:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106ee5:	e9 02 f5 ff ff       	jmp    801063ec <alltraps>
...
80106eea:	6a 00                	push   $0x0
  pushl $136
80106eec:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106ef1:	e9 f6 f4 ff ff       	jmp    801063ec <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $137
80106ef8:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106efd:	e9 ea f4 ff ff       	jmp    801063ec <alltraps>
...
80106f02:	6a 00                	push   $0x0
  pushl $138
80106f04:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106f09:	e9 de f4 ff ff       	jmp    801063ec <alltraps>
...
80106f0e:	6a 00                	push   $0x0
  pushl $139
80106f10:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106f15:	e9 d2 f4 ff ff       	jmp    801063ec <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $140
80106f1c:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106f21:	e9 c6 f4 ff ff       	jmp    801063ec <alltraps>
...
80106f26:	6a 00                	push   $0x0
  pushl $141
80106f28:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106f2d:	e9 ba f4 ff ff       	jmp    801063ec <alltraps>
...
80106f32:	6a 00                	push   $0x0
  pushl $142
80106f34:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106f39:	e9 ae f4 ff ff       	jmp    801063ec <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $143
80106f40:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106f45:	e9 a2 f4 ff ff       	jmp    801063ec <alltraps>
...
80106f4a:	6a 00                	push   $0x0
  pushl $144
80106f4c:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106f51:	e9 96 f4 ff ff       	jmp    801063ec <alltraps>
...
80106f56:	6a 00                	push   $0x0
  pushl $145
80106f58:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106f5d:	e9 8a f4 ff ff       	jmp    801063ec <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $146
80106f64:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106f69:	e9 7e f4 ff ff       	jmp    801063ec <alltraps>
...
80106f6e:	6a 00                	push   $0x0
  pushl $147
80106f70:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106f75:	e9 72 f4 ff ff       	jmp    801063ec <alltraps>
...
80106f7a:	6a 00                	push   $0x0
  pushl $148
80106f7c:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106f81:	e9 66 f4 ff ff       	jmp    801063ec <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $149
80106f88:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106f8d:	e9 5a f4 ff ff       	jmp    801063ec <alltraps>
...
80106f92:	6a 00                	push   $0x0
  pushl $150
80106f94:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106f99:	e9 4e f4 ff ff       	jmp    801063ec <alltraps>
...
80106f9e:	6a 00                	push   $0x0
  pushl $151
80106fa0:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106fa5:	e9 42 f4 ff ff       	jmp    801063ec <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $152
80106fac:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106fb1:	e9 36 f4 ff ff       	jmp    801063ec <alltraps>
...
80106fb6:	6a 00                	push   $0x0
  pushl $153
80106fb8:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106fbd:	e9 2a f4 ff ff       	jmp    801063ec <alltraps>
...
80106fc2:	6a 00                	push   $0x0
  pushl $154
80106fc4:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106fc9:	e9 1e f4 ff ff       	jmp    801063ec <alltraps>
...
80106fce:	6a 00                	push   $0x0
  pushl $155
80106fd0:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106fd5:	e9 12 f4 ff ff       	jmp    801063ec <alltraps>
...
80106fda:	6a 00                	push   $0x0
  pushl $156
80106fdc:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106fe1:	e9 06 f4 ff ff       	jmp    801063ec <alltraps>
...
80106fe6:	6a 00                	push   $0x0
  pushl $157
80106fe8:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106fed:	e9 fa f3 ff ff       	jmp    801063ec <alltraps>
...
80106ff2:	6a 00                	push   $0x0
  pushl $158
80106ff4:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106ff9:	e9 ee f3 ff ff       	jmp    801063ec <alltraps>
...
80106ffe:	6a 00                	push   $0x0
  pushl $159
80107000:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107005:	e9 e2 f3 ff ff       	jmp    801063ec <alltraps>
...
8010700a:	6a 00                	push   $0x0
  pushl $160
8010700c:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107011:	e9 d6 f3 ff ff       	jmp    801063ec <alltraps>
...
80107016:	6a 00                	push   $0x0
  pushl $161
80107018:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010701d:	e9 ca f3 ff ff       	jmp    801063ec <alltraps>
...
80107022:	6a 00                	push   $0x0
  pushl $162
80107024:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107029:	e9 be f3 ff ff       	jmp    801063ec <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $163
80107030:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107035:	e9 b2 f3 ff ff       	jmp    801063ec <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $164
8010703c:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107041:	e9 a6 f3 ff ff       	jmp    801063ec <alltraps>
...
80107046:	6a 00                	push   $0x0
  pushl $165
80107048:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010704d:	e9 9a f3 ff ff       	jmp    801063ec <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $166
80107054:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107059:	e9 8e f3 ff ff       	jmp    801063ec <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $167
80107060:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107065:	e9 82 f3 ff ff       	jmp    801063ec <alltraps>
...
8010706a:	6a 00                	push   $0x0
  pushl $168
8010706c:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107071:	e9 76 f3 ff ff       	jmp    801063ec <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $169
80107078:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010707d:	e9 6a f3 ff ff       	jmp    801063ec <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $170
80107084:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107089:	e9 5e f3 ff ff       	jmp    801063ec <alltraps>
...
8010708e:	6a 00                	push   $0x0
  pushl $171
80107090:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107095:	e9 52 f3 ff ff       	jmp    801063ec <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $172
8010709c:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801070a1:	e9 46 f3 ff ff       	jmp    801063ec <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $173
801070a8:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801070ad:	e9 3a f3 ff ff       	jmp    801063ec <alltraps>
...
801070b2:	6a 00                	push   $0x0
  pushl $174
801070b4:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801070b9:	e9 2e f3 ff ff       	jmp    801063ec <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $175
801070c0:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801070c5:	e9 22 f3 ff ff       	jmp    801063ec <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $176
801070cc:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801070d1:	e9 16 f3 ff ff       	jmp    801063ec <alltraps>
...
801070d6:	6a 00                	push   $0x0
  pushl $177
801070d8:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801070dd:	e9 0a f3 ff ff       	jmp    801063ec <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $178
801070e4:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801070e9:	e9 fe f2 ff ff       	jmp    801063ec <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $179
801070f0:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801070f5:	e9 f2 f2 ff ff       	jmp    801063ec <alltraps>
...
801070fa:	6a 00                	push   $0x0
  pushl $180
801070fc:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107101:	e9 e6 f2 ff ff       	jmp    801063ec <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $181
80107108:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010710d:	e9 da f2 ff ff       	jmp    801063ec <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $182
80107114:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107119:	e9 ce f2 ff ff       	jmp    801063ec <alltraps>
...
8010711e:	6a 00                	push   $0x0
  pushl $183
80107120:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107125:	e9 c2 f2 ff ff       	jmp    801063ec <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $184
8010712c:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107131:	e9 b6 f2 ff ff       	jmp    801063ec <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $185
80107138:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010713d:	e9 aa f2 ff ff       	jmp    801063ec <alltraps>
...
80107142:	6a 00                	push   $0x0
  pushl $186
80107144:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107149:	e9 9e f2 ff ff       	jmp    801063ec <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $187
80107150:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107155:	e9 92 f2 ff ff       	jmp    801063ec <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $188
8010715c:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107161:	e9 86 f2 ff ff       	jmp    801063ec <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $189
80107168:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010716d:	e9 7a f2 ff ff       	jmp    801063ec <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $190
80107174:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107179:	e9 6e f2 ff ff       	jmp    801063ec <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $191
80107180:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107185:	e9 62 f2 ff ff       	jmp    801063ec <alltraps>
...
8010718a:	6a 00                	push   $0x0
  pushl $192
8010718c:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107191:	e9 56 f2 ff ff       	jmp    801063ec <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $193
80107198:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010719d:	e9 4a f2 ff ff       	jmp    801063ec <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $194
801071a4:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801071a9:	e9 3e f2 ff ff       	jmp    801063ec <alltraps>
...
801071ae:	6a 00                	push   $0x0
  pushl $195
801071b0:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801071b5:	e9 32 f2 ff ff       	jmp    801063ec <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $196
801071bc:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801071c1:	e9 26 f2 ff ff       	jmp    801063ec <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $197
801071c8:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801071cd:	e9 1a f2 ff ff       	jmp    801063ec <alltraps>
...
801071d2:	6a 00                	push   $0x0
  pushl $198
801071d4:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801071d9:	e9 0e f2 ff ff       	jmp    801063ec <alltraps>
...
801071de:	6a 00                	push   $0x0
  pushl $199
801071e0:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801071e5:	e9 02 f2 ff ff       	jmp    801063ec <alltraps>
...
801071ea:	6a 00                	push   $0x0
  pushl $200
801071ec:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801071f1:	e9 f6 f1 ff ff       	jmp    801063ec <alltraps>
...
801071f6:	6a 00                	push   $0x0
  pushl $201
801071f8:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801071fd:	e9 ea f1 ff ff       	jmp    801063ec <alltraps>
...
80107202:	6a 00                	push   $0x0
  pushl $202
80107204:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107209:	e9 de f1 ff ff       	jmp    801063ec <alltraps>
...
8010720e:	6a 00                	push   $0x0
  pushl $203
80107210:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107215:	e9 d2 f1 ff ff       	jmp    801063ec <alltraps>
...
8010721a:	6a 00                	push   $0x0
  pushl $204
8010721c:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107221:	e9 c6 f1 ff ff       	jmp    801063ec <alltraps>
...
80107226:	6a 00                	push   $0x0
  pushl $205
80107228:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010722d:	e9 ba f1 ff ff       	jmp    801063ec <alltraps>
...
80107232:	6a 00                	push   $0x0
  pushl $206
80107234:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107239:	e9 ae f1 ff ff       	jmp    801063ec <alltraps>
...
8010723e:	6a 00                	push   $0x0
  pushl $207
80107240:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107245:	e9 a2 f1 ff ff       	jmp    801063ec <alltraps>
...
8010724a:	6a 00                	push   $0x0
  pushl $208
8010724c:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107251:	e9 96 f1 ff ff       	jmp    801063ec <alltraps>
...
80107256:	6a 00                	push   $0x0
  pushl $209
80107258:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010725d:	e9 8a f1 ff ff       	jmp    801063ec <alltraps>
...
80107262:	6a 00                	push   $0x0
  pushl $210
80107264:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107269:	e9 7e f1 ff ff       	jmp    801063ec <alltraps>
...
8010726e:	6a 00                	push   $0x0
  pushl $211
80107270:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107275:	e9 72 f1 ff ff       	jmp    801063ec <alltraps>
...
8010727a:	6a 00                	push   $0x0
  pushl $212
8010727c:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107281:	e9 66 f1 ff ff       	jmp    801063ec <alltraps>
...
80107286:	6a 00                	push   $0x0
  pushl $213
80107288:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010728d:	e9 5a f1 ff ff       	jmp    801063ec <alltraps>
...
80107292:	6a 00                	push   $0x0
  pushl $214
80107294:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107299:	e9 4e f1 ff ff       	jmp    801063ec <alltraps>
...
8010729e:	6a 00                	push   $0x0
  pushl $215
801072a0:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801072a5:	e9 42 f1 ff ff       	jmp    801063ec <alltraps>
...
801072aa:	6a 00                	push   $0x0
  pushl $216
801072ac:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801072b1:	e9 36 f1 ff ff       	jmp    801063ec <alltraps>
...
801072b6:	6a 00                	push   $0x0
  pushl $217
801072b8:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801072bd:	e9 2a f1 ff ff       	jmp    801063ec <alltraps>
...
801072c2:	6a 00                	push   $0x0
  pushl $218
801072c4:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801072c9:	e9 1e f1 ff ff       	jmp    801063ec <alltraps>
...
801072ce:	6a 00                	push   $0x0
  pushl $219
801072d0:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801072d5:	e9 12 f1 ff ff       	jmp    801063ec <alltraps>
...
801072da:	6a 00                	push   $0x0
  pushl $220
801072dc:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801072e1:	e9 06 f1 ff ff       	jmp    801063ec <alltraps>
...
801072e6:	6a 00                	push   $0x0
  pushl $221
801072e8:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801072ed:	e9 fa f0 ff ff       	jmp    801063ec <alltraps>
...
801072f2:	6a 00                	push   $0x0
  pushl $222
801072f4:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801072f9:	e9 ee f0 ff ff       	jmp    801063ec <alltraps>
...
801072fe:	6a 00                	push   $0x0
  pushl $223
80107300:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107305:	e9 e2 f0 ff ff       	jmp    801063ec <alltraps>
...
8010730a:	6a 00                	push   $0x0
  pushl $224
8010730c:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107311:	e9 d6 f0 ff ff       	jmp    801063ec <alltraps>
...
80107316:	6a 00                	push   $0x0
  pushl $225
80107318:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010731d:	e9 ca f0 ff ff       	jmp    801063ec <alltraps>
...
80107322:	6a 00                	push   $0x0
  pushl $226
80107324:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107329:	e9 be f0 ff ff       	jmp    801063ec <alltraps>
...
8010732e:	6a 00                	push   $0x0
  pushl $227
80107330:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107335:	e9 b2 f0 ff ff       	jmp    801063ec <alltraps>
...
8010733a:	6a 00                	push   $0x0
  pushl $228
8010733c:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107341:	e9 a6 f0 ff ff       	jmp    801063ec <alltraps>
...
80107346:	6a 00                	push   $0x0
  pushl $229
80107348:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010734d:	e9 9a f0 ff ff       	jmp    801063ec <alltraps>
...
80107352:	6a 00                	push   $0x0
  pushl $230
80107354:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107359:	e9 8e f0 ff ff       	jmp    801063ec <alltraps>
...
8010735e:	6a 00                	push   $0x0
  pushl $231
80107360:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107365:	e9 82 f0 ff ff       	jmp    801063ec <alltraps>
...
8010736a:	6a 00                	push   $0x0
  pushl $232
8010736c:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107371:	e9 76 f0 ff ff       	jmp    801063ec <alltraps>
...
80107376:	6a 00                	push   $0x0
  pushl $233
80107378:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010737d:	e9 6a f0 ff ff       	jmp    801063ec <alltraps>
...
80107382:	6a 00                	push   $0x0
  pushl $234
80107384:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107389:	e9 5e f0 ff ff       	jmp    801063ec <alltraps>
...
8010738e:	6a 00                	push   $0x0
  pushl $235
80107390:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107395:	e9 52 f0 ff ff       	jmp    801063ec <alltraps>
...
8010739a:	6a 00                	push   $0x0
  pushl $236
8010739c:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801073a1:	e9 46 f0 ff ff       	jmp    801063ec <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $237
801073a8:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801073ad:	e9 3a f0 ff ff       	jmp    801063ec <alltraps>
...
801073b2:	6a 00                	push   $0x0
  pushl $238
801073b4:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801073b9:	e9 2e f0 ff ff       	jmp    801063ec <alltraps>
...
801073be:	6a 00                	push   $0x0
  pushl $239
801073c0:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801073c5:	e9 22 f0 ff ff       	jmp    801063ec <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $240
801073cc:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801073d1:	e9 16 f0 ff ff       	jmp    801063ec <alltraps>
...
801073d6:	6a 00                	push   $0x0
  pushl $241
801073d8:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801073dd:	e9 0a f0 ff ff       	jmp    801063ec <alltraps>
...
801073e2:	6a 00                	push   $0x0
  pushl $242
801073e4:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801073e9:	e9 fe ef ff ff       	jmp    801063ec <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $243
801073f0:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801073f5:	e9 f2 ef ff ff       	jmp    801063ec <alltraps>
...
801073fa:	6a 00                	push   $0x0
  pushl $244
801073fc:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107401:	e9 e6 ef ff ff       	jmp    801063ec <alltraps>
...
80107406:	6a 00                	push   $0x0
  pushl $245
80107408:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010740d:	e9 da ef ff ff       	jmp    801063ec <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $246
80107414:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107419:	e9 ce ef ff ff       	jmp    801063ec <alltraps>
...
8010741e:	6a 00                	push   $0x0
  pushl $247
80107420:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107425:	e9 c2 ef ff ff       	jmp    801063ec <alltraps>
...
8010742a:	6a 00                	push   $0x0
  pushl $248
8010742c:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107431:	e9 b6 ef ff ff       	jmp    801063ec <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $249
80107438:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010743d:	e9 aa ef ff ff       	jmp    801063ec <alltraps>
...
80107442:	6a 00                	push   $0x0
  pushl $250
80107444:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107449:	e9 9e ef ff ff       	jmp    801063ec <alltraps>
...
8010744e:	6a 00                	push   $0x0
  pushl $251
80107450:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107455:	e9 92 ef ff ff       	jmp    801063ec <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $252
8010745c:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107461:	e9 86 ef ff ff       	jmp    801063ec <alltraps>
...
80107466:	6a 00                	push   $0x0
  pushl $253
80107468:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010746d:	e9 7a ef ff ff       	jmp    801063ec <alltraps>
...
80107472:	6a 00                	push   $0x0
  pushl $254
80107474:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107479:	e9 6e ef ff ff       	jmp    801063ec <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $255
80107480:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107485:	e9 62 ef ff ff       	jmp    801063ec <alltraps>
	...
...
8010748f:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107492:	8b 45 0c             	mov    0xc(%ebp),%eax
80107495:	48                   	dec    %eax
80107496:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010749a:	8b 45 08             	mov    0x8(%ebp),%eax
8010749d:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801074a1:	8b 45 08             	mov    0x8(%ebp),%eax
801074a4:	c1 e8 10             	shr    $0x10,%eax
801074a7:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801074ab:	8d 45 fa             	lea    -0x6(%ebp),%eax
801074ae:	0f 01 10             	lgdtl  (%eax)
}
801074b1:	c9                   	leave  
801074b2:	c3                   	ret    
...
801074bc:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801074c0:	8b 45 fc             	mov    -0x4(%ebp),%eax
801074c3:	0f 00 d8             	ltr    %ax
}
801074c6:	c9                   	leave  
801074c7:	c3                   	ret    
...
801074d6:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
801074d9:	e8 70 cc ff ff       	call   8010414e <cpuid>
801074de:	89 c2                	mov    %eax,%edx
801074e0:	89 d0                	mov    %edx,%eax
801074e2:	c1 e0 02             	shl    $0x2,%eax
801074e5:	01 d0                	add    %edx,%eax
801074e7:	01 c0                	add    %eax,%eax
801074e9:	01 d0                	add    %edx,%eax
801074eb:	c1 e0 04             	shl    $0x4,%eax
801074ee:	05 c0 3a 11 80       	add    $0x80113ac0,%eax
801074f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801074f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801074f9:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801074ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107502:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107508:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010750b:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
8010750f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107512:	8a 50 7d             	mov    0x7d(%eax),%dl
80107515:	83 e2 f0             	and    $0xfffffff0,%edx
80107518:	83 ca 0a             	or     $0xa,%edx
8010751b:	88 50 7d             	mov    %dl,0x7d(%eax)
8010751e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107521:	8a 50 7d             	mov    0x7d(%eax),%dl
80107524:	83 ca 10             	or     $0x10,%edx
...
80107581:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107585:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107588:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
8010758f:	ff ff 
80107591:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107594:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
8010759b:	00 00 
8010759d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075a0:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801075a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075aa:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
801075b0:	83 e2 f0             	and    $0xfffffff0,%edx
801075b3:	83 ca 02             	or     $0x2,%edx
801075b6:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801075bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075bf:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
801075c5:	83 ca 10             	or     $0x10,%edx
801075c8:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801075ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075d1:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
801075d7:	83 e2 9f             	and    $0xffffff9f,%edx
801075da:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801075e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075e3:	8a 90 85 00 00 00    	mov    0x85(%eax),%dl
801075e9:	83 ca 80             	or     $0xffffff80,%edx
801075ec:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801075f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075f5:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
801075fb:	83 ca 0f             	or     $0xf,%edx
801075fe:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107604:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107607:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
8010760d:	83 e2 ef             	and    $0xffffffef,%edx
80107610:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107616:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107619:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
8010761f:	83 e2 df             	and    $0xffffffdf,%edx
80107622:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107628:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010762b:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
80107631:	83 ca 40             	or     $0x40,%edx
80107634:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010763a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010763d:	8a 90 86 00 00 00    	mov    0x86(%eax),%dl
...
80107659:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
80107660:	ff ff 
80107662:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107665:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
8010766c:	00 00 
8010766e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107671:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
80107678:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010767b:	8a 90 8d 00 00 00    	mov    0x8d(%eax),%dl
...
80107813:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107816:	8b 45 0c             	mov    0xc(%ebp),%eax
80107819:	c1 e8 16             	shr    $0x16,%eax
8010781c:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107823:	8b 45 08             	mov    0x8(%ebp),%eax
80107826:	01 d0                	add    %edx,%eax
80107828:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
8010782b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010782e:	8b 00                	mov    (%eax),%eax
80107830:	83 e0 01             	and    $0x1,%eax
80107833:	85 c0                	test   %eax,%eax
80107835:	74 14                	je     8010784b <walkpgdir+0x3b>
...
80107846:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107849:	eb 48                	jmp    80107893 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010784b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010784f:	74 0e                	je     8010785f <walkpgdir+0x4f>
80107851:	e8 01 b4 ff ff       	call   80102c57 <kalloc>
80107856:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107859:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010785d:	75 07                	jne    80107866 <walkpgdir+0x56>
      return 0;
8010785f:	b8 00 00 00 00       	mov    $0x0,%eax
80107864:	eb 44                	jmp    801078aa <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107866:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010786d:	00 
8010786e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107875:	00 
80107876:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107879:	89 04 24             	mov    %eax,(%esp)
8010787c:	e8 09 d8 ff ff       	call   8010508a <memset>
...
80107889:	83 c8 07             	or     $0x7,%eax
8010788c:	89 c2                	mov    %eax,%edx
8010788e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107891:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107893:	8b 45 0c             	mov    0xc(%ebp),%eax
80107896:	c1 e8 0c             	shr    $0xc,%eax
80107899:	25 ff 03 00 00       	and    $0x3ff,%eax
8010789e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801078a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a8:	01 d0                	add    %edx,%eax
}
801078aa:	c9                   	leave  
801078ab:	c3                   	ret    
...
801078af:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
801078b2:	8b 45 0c             	mov    0xc(%ebp),%eax
801078b5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801078ba:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801078bd:	8b 55 0c             	mov    0xc(%ebp),%edx
801078c0:	8b 45 10             	mov    0x10(%ebp),%eax
801078c3:	01 d0                	add    %edx,%eax
801078c5:	48                   	dec    %eax
801078c6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801078cb:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801078ce:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
801078d5:	00 
801078d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801078dd:	8b 45 08             	mov    0x8(%ebp),%eax
801078e0:	89 04 24             	mov    %eax,(%esp)
801078e3:	e8 28 ff ff ff       	call   80107810 <walkpgdir>
801078e8:	89 45 ec             	mov    %eax,-0x14(%ebp)
801078eb:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801078ef:	75 07                	jne    801078f8 <mappages+0x4c>
      return -1;
801078f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801078f6:	eb 48                	jmp    80107940 <mappages+0x94>
    if(*pte & PTE_P)
801078f8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801078fb:	8b 00                	mov    (%eax),%eax
801078fd:	83 e0 01             	and    $0x1,%eax
80107900:	85 c0                	test   %eax,%eax
80107902:	74 0c                	je     80107910 <mappages+0x64>
      panic("remap");
80107904:	c7 04 24 20 88 10 80 	movl   $0x80108820,(%esp)
8010790b:	e8 44 8c ff ff       	call   80100554 <panic>
    *pte = pa | perm | PTE_P;
80107910:	8b 45 18             	mov    0x18(%ebp),%eax
80107913:	0b 45 14             	or     0x14(%ebp),%eax
80107916:	83 c8 01             	or     $0x1,%eax
80107919:	89 c2                	mov    %eax,%edx
8010791b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010791e:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107920:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107923:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107926:	75 08                	jne    80107930 <mappages+0x84>
      break;
80107928:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
  ...
  return 0;
80107929:	b8 00 00 00 00       	mov    $0x0,%eax
8010792e:	eb 10                	jmp    80107940 <mappages+0x94>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
80107930:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107937:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
8010793e:	eb 8e                	jmp    801078ce <mappages+0x22>
  return 0;
}
80107940:	c9                   	leave  
80107941:	c3                   	ret    
...
80107946:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107949:	e8 09 b3 ff ff       	call   80102c57 <kalloc>
8010794e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107951:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107955:	75 0a                	jne    80107961 <setupkvm+0x1f>
    return 0;
80107957:	b8 00 00 00 00       	mov    $0x0,%eax
8010795c:	e9 84 00 00 00       	jmp    801079e5 <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
80107961:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107968:	00 
80107969:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107970:	00 
80107971:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107974:	89 04 24             	mov    %eax,(%esp)
80107977:	e8 0e d7 ff ff       	call   8010508a <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010797c:	c7 45 f4 80 b4 10 80 	movl   $0x8010b480,-0xc(%ebp)
80107983:	eb 54                	jmp    801079d9 <setupkvm+0x97>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80107985:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107988:	8b 48 0c             	mov    0xc(%eax),%ecx
8010798b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010798e:	8b 50 04             	mov    0x4(%eax),%edx
80107991:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107994:	8b 58 08             	mov    0x8(%eax),%ebx
80107997:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010799a:	8b 40 04             	mov    0x4(%eax),%eax
8010799d:	29 c3                	sub    %eax,%ebx
8010799f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079a2:	8b 00                	mov    (%eax),%eax
801079a4:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801079a8:	89 54 24 0c          	mov    %edx,0xc(%esp)
801079ac:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801079b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801079b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079b7:	89 04 24             	mov    %eax,(%esp)
801079ba:	e8 ed fe ff ff       	call   801078ac <mappages>
801079bf:	85 c0                	test   %eax,%eax
801079c1:	79 12                	jns    801079d5 <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
801079c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079c6:	89 04 24             	mov    %eax,(%esp)
801079c9:	e8 1a 05 00 00       	call   80107ee8 <freevm>
      return 0;
801079ce:	b8 00 00 00 00       	mov    $0x0,%eax
801079d3:	eb 10                	jmp    801079e5 <setupkvm+0xa3>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801079d5:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801079d9:	81 7d f4 c0 b4 10 80 	cmpl   $0x8010b4c0,-0xc(%ebp)
801079e0:	72 a3                	jb     80107985 <setupkvm+0x43>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
      return 0;
  ...
  return pgdir;
801079e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
801079e5:	83 c4 34             	add    $0x34,%esp
801079e8:	5b                   	pop    %ebx
801079e9:	5d                   	pop    %ebp
801079ea:	c3                   	ret    
...
801079ee:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801079f1:	e8 4c ff ff ff       	call   80107942 <setupkvm>
801079f6:	a3 e4 67 11 80       	mov    %eax,0x801167e4
  switchkvm();
801079fb:	e8 02 00 00 00       	call   80107a02 <switchkvm>
}
80107a00:	c9                   	leave  
80107a01:	c3                   	ret    
...
80107a08:	a1 e4 67 11 80       	mov    0x801167e4,%eax
80107a0d:	05 00 00 00 80       	add    $0x80000000,%eax
80107a12:	89 04 24             	mov    %eax,(%esp)
80107a15:	e8 ae fa ff ff       	call   801074c8 <lcr3>
}
80107a1a:	c9                   	leave  
80107a1b:	c3                   	ret    
...
80107a1f:	57                   	push   %edi
80107a20:	56                   	push   %esi
80107a21:	53                   	push   %ebx
80107a22:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107a25:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107a29:	75 0c                	jne    80107a37 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107a2b:	c7 04 24 26 88 10 80 	movl   $0x80108826,(%esp)
80107a32:	e8 1d 8b ff ff       	call   80100554 <panic>
  if(p->kstack == 0)
80107a37:	8b 45 08             	mov    0x8(%ebp),%eax
80107a3a:	8b 40 08             	mov    0x8(%eax),%eax
80107a3d:	85 c0                	test   %eax,%eax
80107a3f:	75 0c                	jne    80107a4d <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107a41:	c7 04 24 3c 88 10 80 	movl   $0x8010883c,(%esp)
80107a48:	e8 07 8b ff ff       	call   80100554 <panic>
  if(p->pgdir == 0)
80107a4d:	8b 45 08             	mov    0x8(%ebp),%eax
80107a50:	8b 40 04             	mov    0x4(%eax),%eax
80107a53:	85 c0                	test   %eax,%eax
80107a55:	75 0c                	jne    80107a63 <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107a57:	c7 04 24 51 88 10 80 	movl   $0x80108851,(%esp)
80107a5e:	e8 f1 8a ff ff       	call   80100554 <panic>

  pushcli();
80107a63:	e8 1e d5 ff ff       	call   80104f86 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107a68:	e8 26 c7 ff ff       	call   80104193 <mycpu>
80107a6d:	89 c3                	mov    %eax,%ebx
80107a6f:	e8 1f c7 ff ff       	call   80104193 <mycpu>
80107a74:	83 c0 08             	add    $0x8,%eax
80107a77:	89 c6                	mov    %eax,%esi
80107a79:	e8 15 c7 ff ff       	call   80104193 <mycpu>
80107a7e:	83 c0 08             	add    $0x8,%eax
80107a81:	c1 e8 10             	shr    $0x10,%eax
80107a84:	89 c7                	mov    %eax,%edi
80107a86:	e8 08 c7 ff ff       	call   80104193 <mycpu>
80107a8b:	83 c0 08             	add    $0x8,%eax
80107a8e:	c1 e8 18             	shr    $0x18,%eax
80107a91:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107a98:	67 00 
80107a9a:	66 89 b3 9a 00 00 00 	mov    %si,0x9a(%ebx)
80107aa1:	89 f9                	mov    %edi,%ecx
80107aa3:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107aa9:	8a 93 9d 00 00 00    	mov    0x9d(%ebx),%dl
80107aaf:	83 e2 f0             	and    $0xfffffff0,%edx
80107ab2:	83 ca 09             	or     $0x9,%edx
80107ab5:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107abb:	8a 93 9d 00 00 00    	mov    0x9d(%ebx),%dl
80107ac1:	83 ca 10             	or     $0x10,%edx
80107ac4:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107aca:	8a 93 9d 00 00 00    	mov    0x9d(%ebx),%dl
80107ad0:	83 e2 9f             	and    $0xffffff9f,%edx
80107ad3:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107ad9:	8a 93 9d 00 00 00    	mov    0x9d(%ebx),%dl
80107adf:	83 ca 80             	or     $0xffffff80,%edx
80107ae2:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107ae8:	8a 93 9e 00 00 00    	mov    0x9e(%ebx),%dl
80107aee:	83 e2 f0             	and    $0xfffffff0,%edx
80107af1:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107af7:	8a 93 9e 00 00 00    	mov    0x9e(%ebx),%dl
80107afd:	83 e2 ef             	and    $0xffffffef,%edx
80107b00:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b06:	8a 93 9e 00 00 00    	mov    0x9e(%ebx),%dl
80107b0c:	83 e2 df             	and    $0xffffffdf,%edx
80107b0f:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b15:	8a 93 9e 00 00 00    	mov    0x9e(%ebx),%dl
80107b1b:	83 ca 40             	or     $0x40,%edx
80107b1e:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b24:	8a 93 9e 00 00 00    	mov    0x9e(%ebx),%dl
80107b2a:	83 e2 7f             	and    $0x7f,%edx
80107b2d:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b33:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107b39:	e8 55 c6 ff ff       	call   80104193 <mycpu>
80107b3e:	8a 90 9d 00 00 00    	mov    0x9d(%eax),%dl
80107b44:	83 e2 ef             	and    $0xffffffef,%edx
80107b47:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107b4d:	e8 41 c6 ff ff       	call   80104193 <mycpu>
80107b52:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107b58:	e8 36 c6 ff ff       	call   80104193 <mycpu>
80107b5d:	8b 55 08             	mov    0x8(%ebp),%edx
80107b60:	8b 52 08             	mov    0x8(%edx),%edx
80107b63:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107b69:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107b6c:	e8 22 c6 ff ff       	call   80104193 <mycpu>
80107b71:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107b77:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107b7e:	e8 30 f9 ff ff       	call   801074b3 <ltr>
  lcr3(V2P(p->pgdir));  // switch to process's address space
80107b83:	8b 45 08             	mov    0x8(%ebp),%eax
80107b86:	8b 40 04             	mov    0x4(%eax),%eax
80107b89:	05 00 00 00 80       	add    $0x80000000,%eax
80107b8e:	89 04 24             	mov    %eax,(%esp)
80107b91:	e8 32 f9 ff ff       	call   801074c8 <lcr3>
  popcli();
80107b96:	e8 35 d4 ff ff       	call   80104fd0 <popcli>
}
80107b9b:	83 c4 1c             	add    $0x1c,%esp
80107b9e:	5b                   	pop    %ebx
80107b9f:	5e                   	pop    %esi
80107ba0:	5f                   	pop    %edi
80107ba1:	5d                   	pop    %ebp
...
80107ba6:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107ba9:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107bb0:	76 0c                	jbe    80107bbe <inituvm+0x1b>
    panic("inituvm: more than a page");
80107bb2:	c7 04 24 65 88 10 80 	movl   $0x80108865,(%esp)
80107bb9:	e8 96 89 ff ff       	call   80100554 <panic>
  mem = kalloc();
80107bbe:	e8 94 b0 ff ff       	call   80102c57 <kalloc>
80107bc3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
...
80107bdc:	e8 a9 d4 ff ff       	call   8010508a <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107be1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107be4:	05 00 00 00 80       	add    $0x80000000,%eax
80107be9:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107bf0:	00 
80107bf1:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107bf5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107bfc:	00 
80107bfd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c04:	00 
80107c05:	8b 45 08             	mov    0x8(%ebp),%eax
80107c08:	89 04 24             	mov    %eax,(%esp)
80107c0b:	e8 9c fc ff ff       	call   801078ac <mappages>
  memmove(mem, init, sz);
80107c10:	8b 45 10             	mov    0x10(%ebp),%eax
80107c13:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107c24:	e8 2a d5 ff ff       	call   80105153 <memmove>
}
80107c29:	c9                   	leave  
80107c2a:	c3                   	ret    
...
80107c2e:	83 ec 28             	sub    $0x28,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107c31:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c34:	25 ff 0f 00 00       	and    $0xfff,%eax
80107c39:	85 c0                	test   %eax,%eax
80107c3b:	74 0c                	je     80107c49 <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107c3d:	c7 04 24 80 88 10 80 	movl   $0x80108880,(%esp)
80107c44:	e8 0b 89 ff ff       	call   80100554 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107c49:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107c50:	e9 a6 00 00 00       	jmp    80107cfb <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107c55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c58:	8b 55 0c             	mov    0xc(%ebp),%edx
80107c5b:	01 d0                	add    %edx,%eax
80107c5d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107c64:	00 
80107c65:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c69:	8b 45 08             	mov    0x8(%ebp),%eax
80107c6c:	89 04 24             	mov    %eax,(%esp)
80107c6f:	e8 9c fb ff ff       	call   80107810 <walkpgdir>
80107c74:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107c77:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107c7b:	75 0c                	jne    80107c89 <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107c7d:	c7 04 24 a3 88 10 80 	movl   $0x801088a3,(%esp)
80107c84:	e8 cb 88 ff ff       	call   80100554 <panic>
    pa = PTE_ADDR(*pte);
80107c89:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c8c:	8b 00                	mov    (%eax),%eax
80107c8e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107c93:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107c96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c99:	8b 55 18             	mov    0x18(%ebp),%edx
80107c9c:	29 c2                	sub    %eax,%edx
80107c9e:	89 d0                	mov    %edx,%eax
80107ca0:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107ca5:	77 0f                	ja     80107cb6 <loaduvm+0x8b>
      n = sz - i;
80107ca7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107caa:	8b 55 18             	mov    0x18(%ebp),%edx
80107cad:	29 c2                	sub    %eax,%edx
80107caf:	89 d0                	mov    %edx,%eax
80107cb1:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107cb4:	eb 07                	jmp    80107cbd <loaduvm+0x92>
    else
      n = PGSIZE;
80107cb6:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107cbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cc0:	8b 55 14             	mov    0x14(%ebp),%edx
80107cc3:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107cc6:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107cc9:	05 00 00 00 80       	add    $0x80000000,%eax
80107cce:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107cd1:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107cd5:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107cd9:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cdd:	8b 45 10             	mov    0x10(%ebp),%eax
80107ce0:	89 04 24             	mov    %eax,(%esp)
80107ce3:	e8 d5 a1 ff ff       	call   80101ebd <readi>
80107ce8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107ceb:	74 07                	je     80107cf4 <loaduvm+0xc9>
      return -1;
80107ced:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107cf2:	eb 18                	jmp    80107d0c <loaduvm+0xe1>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80107cf4:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107cfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cfe:	3b 45 18             	cmp    0x18(%ebp),%eax
80107d01:	0f 82 4e ff ff ff    	jb     80107c55 <loaduvm+0x2a>
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n)
      return -1;
...
80107d11:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107d19:	79 0a                	jns    80107d25 <allocuvm+0x17>
    return 0;
80107d1b:	b8 00 00 00 00       	mov    $0x0,%eax
80107d20:	e9 fd 00 00 00       	jmp    80107e22 <allocuvm+0x114>
  if(newsz < oldsz)
80107d25:	8b 45 10             	mov    0x10(%ebp),%eax
80107d28:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107d2b:	73 08                	jae    80107d35 <allocuvm+0x27>
    return oldsz;
80107d2d:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d30:	e9 ed 00 00 00       	jmp    80107e22 <allocuvm+0x114>
...
80107d45:	e9 c9 00 00 00       	jmp    80107e13 <allocuvm+0x105>
    mem = kalloc();
80107d4a:	e8 08 af ff ff       	call   80102c57 <kalloc>
80107d4f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107d52:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107d56:	75 2f                	jne    80107d87 <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
80107d58:	c7 04 24 c1 88 10 80 	movl   $0x801088c1,(%esp)
80107d5f:	e8 5d 86 ff ff       	call   801003c1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107d64:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d67:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107d78:	e8 a7 00 00 00       	call   80107e24 <deallocuvm>
      return 0;
80107d7d:	b8 00 00 00 00       	mov    $0x0,%eax
80107d82:	e9 9b 00 00 00       	jmp    80107e22 <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
80107d87:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107d8e:	00 
80107d8f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d96:	00 
80107d97:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d9a:	89 04 24             	mov    %eax,(%esp)
80107d9d:	e8 e8 d2 ff ff       	call   8010508a <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107da2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107da5:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80107dab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dae:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107db5:	00 
80107db6:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107dba:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107dc1:	00 
80107dc2:	89 44 24 04          	mov    %eax,0x4(%esp)
80107dc6:	8b 45 08             	mov    0x8(%ebp),%eax
80107dc9:	89 04 24             	mov    %eax,(%esp)
80107dcc:	e8 db fa ff ff       	call   801078ac <mappages>
80107dd1:	85 c0                	test   %eax,%eax
80107dd3:	79 37                	jns    80107e0c <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
80107dd5:	c7 04 24 d9 88 10 80 	movl   $0x801088d9,(%esp)
80107ddc:	e8 e0 85 ff ff       	call   801003c1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107de1:	8b 45 0c             	mov    0xc(%ebp),%eax
80107de4:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107df5:	e8 2a 00 00 00       	call   80107e24 <deallocuvm>
      kfree(mem);
80107dfa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107dfd:	89 04 24             	mov    %eax,(%esp)
80107e00:	e8 bc ad ff ff       	call   80102bc1 <kfree>
      return 0;
80107e05:	b8 00 00 00 00       	mov    $0x0,%eax
80107e0a:	eb 16                	jmp    80107e22 <allocuvm+0x114>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80107e0c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107e13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e16:	3b 45 10             	cmp    0x10(%ebp),%eax
80107e19:	0f 82 2b ff ff ff    	jb     80107d4a <allocuvm+0x3c>
      deallocuvm(pgdir, newsz, oldsz);
      kfree(mem);
      return 0;
    }
  ...
  return newsz;
80107e1f:	8b 45 10             	mov    0x10(%ebp),%eax
}
80107e22:	c9                   	leave  
80107e23:	c3                   	ret    
...
80107e27:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80107e2a:	8b 45 10             	mov    0x10(%ebp),%eax
80107e2d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107e30:	72 08                	jb     80107e3a <deallocuvm+0x16>
    return oldsz;
80107e32:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e35:	e9 ac 00 00 00       	jmp    80107ee6 <deallocuvm+0xc2>

  a = PGROUNDUP(newsz);
80107e3a:	8b 45 10             	mov    0x10(%ebp),%eax
80107e3d:	05 ff 0f 00 00       	add    $0xfff,%eax
80107e42:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107e47:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107e4a:	e9 88 00 00 00       	jmp    80107ed7 <deallocuvm+0xb3>
    pte = walkpgdir(pgdir, (char*)a, 0);
80107e4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e52:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107e59:	00 
80107e5a:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e5e:	8b 45 08             	mov    0x8(%ebp),%eax
80107e61:	89 04 24             	mov    %eax,(%esp)
80107e64:	e8 a7 f9 ff ff       	call   80107810 <walkpgdir>
80107e69:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80107e6c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107e70:	75 14                	jne    80107e86 <deallocuvm+0x62>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80107e72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e75:	c1 e8 16             	shr    $0x16,%eax
80107e78:	40                   	inc    %eax
80107e79:	c1 e0 16             	shl    $0x16,%eax
80107e7c:	2d 00 10 00 00       	sub    $0x1000,%eax
80107e81:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107e84:	eb 4a                	jmp    80107ed0 <deallocuvm+0xac>
    else if((*pte & PTE_P) != 0){
80107e86:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e89:	8b 00                	mov    (%eax),%eax
80107e8b:	83 e0 01             	and    $0x1,%eax
80107e8e:	85 c0                	test   %eax,%eax
80107e90:	74 3e                	je     80107ed0 <deallocuvm+0xac>
      pa = PTE_ADDR(*pte);
...
80107ea3:	75 0c                	jne    80107eb1 <deallocuvm+0x8d>
        panic("kfree");
80107ea5:	c7 04 24 f5 88 10 80 	movl   $0x801088f5,(%esp)
80107eac:	e8 a3 86 ff ff       	call   80100554 <panic>
      char *v = P2V(pa);
80107eb1:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107eb4:	05 00 00 00 80       	add    $0x80000000,%eax
80107eb9:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80107ebc:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107ebf:	89 04 24             	mov    %eax,(%esp)
80107ec2:	e8 fa ac ff ff       	call   80102bc1 <kfree>
      *pte = 0;
80107ec7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107eca:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80107ed0:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107ed7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eda:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107edd:	0f 82 6c ff ff ff    	jb     80107e4f <deallocuvm+0x2b>
      char *v = P2V(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
80107ee3:	8b 45 10             	mov    0x10(%ebp),%eax
}
80107ee6:	c9                   	leave  
80107ee7:	c3                   	ret    
...
80107eeb:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80107eee:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107ef2:	75 0c                	jne    80107f00 <freevm+0x18>
    panic("freevm: no pgdir");
80107ef4:	c7 04 24 fb 88 10 80 	movl   $0x801088fb,(%esp)
80107efb:	e8 54 86 ff ff       	call   80100554 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80107f00:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f07:	00 
80107f08:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80107f0f:	80 
80107f10:	8b 45 08             	mov    0x8(%ebp),%eax
80107f13:	89 04 24             	mov    %eax,(%esp)
80107f16:	e8 09 ff ff ff       	call   80107e24 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80107f1b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f22:	eb 44                	jmp    80107f68 <freevm+0x80>
    if(pgdir[i] & PTE_P){
80107f24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f27:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107f3a:	74 29                	je     80107f65 <freevm+0x7d>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80107f3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f3f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107f60:	e8 5c ac ff ff       	call   80102bc1 <kfree>
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107f65:	ff 45 f4             	incl   -0xc(%ebp)
80107f68:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80107f6f:	76 b3                	jbe    80107f24 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80107f77:	e8 45 ac ff ff       	call   80102bc1 <kfree>
}
80107f7c:	c9                   	leave  
80107f7d:	c3                   	ret    
...
80107f81:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
80107f99:	e8 72 f8 ff ff       	call   80107810 <walkpgdir>
80107f9e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80107fa1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107fa5:	75 0c                	jne    80107fb3 <clearpteu+0x35>
    panic("clearpteu");
80107fa7:	c7 04 24 0c 89 10 80 	movl   $0x8010890c,(%esp)
80107fae:	e8 a1 85 ff ff       	call   80100554 <panic>
  *pte &= ~PTE_U;
80107fb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb6:	8b 00                	mov    (%eax),%eax
80107fb8:	83 e0 fb             	and    $0xfffffffb,%eax
80107fbb:	89 c2                	mov    %eax,%edx
80107fbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc0:	89 10                	mov    %edx,(%eax)
}
80107fc2:	c9                   	leave  
80107fc3:	c3                   	ret    
...
80107fc7:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80107fca:	e8 73 f9 ff ff       	call   80107942 <setupkvm>
80107fcf:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107fd2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107fd6:	75 0a                	jne    80107fe2 <copyuvm+0x1e>
    return 0;
80107fd8:	b8 00 00 00 00       	mov    $0x0,%eax
80107fdd:	e9 f8 00 00 00       	jmp    801080da <copyuvm+0x116>
  for(i = 0; i < sz; i += PGSIZE){
80107fe2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107fe9:	e9 cb 00 00 00       	jmp    801080b9 <copyuvm+0xf5>
...
80108003:	e8 08 f8 ff ff       	call   80107810 <walkpgdir>
80108008:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010800b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010800f:	75 0c                	jne    8010801d <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108011:	c7 04 24 16 89 10 80 	movl   $0x80108916,(%esp)
80108018:	e8 37 85 ff ff       	call   80100554 <panic>
    if(!(*pte & PTE_P))
8010801d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108020:	8b 00                	mov    (%eax),%eax
80108022:	83 e0 01             	and    $0x1,%eax
80108025:	85 c0                	test   %eax,%eax
80108027:	75 0c                	jne    80108035 <copyuvm+0x71>
      panic("copyuvm: page not present");
80108029:	c7 04 24 30 89 10 80 	movl   $0x80108930,(%esp)
80108030:	e8 1f 85 ff ff       	call   80100554 <panic>
    pa = PTE_ADDR(*pte);
...
80108045:	8b 00                	mov    (%eax),%eax
80108047:	25 ff 0f 00 00       	and    $0xfff,%eax
8010804c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010804f:	e8 03 ac ff ff       	call   80102c57 <kalloc>
80108054:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108057:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010805b:	75 02                	jne    8010805f <copyuvm+0x9b>
      goto bad;
8010805d:	eb 6b                	jmp    801080ca <copyuvm+0x106>
...
80108073:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108076:	89 04 24             	mov    %eax,(%esp)
80108079:	e8 d5 d0 ff ff       	call   80105153 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
8010807e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80108081:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108084:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
8010808a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010808d:	89 54 24 10          	mov    %edx,0x10(%esp)
80108091:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80108095:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010809c:	00 
8010809d:	89 44 24 04          	mov    %eax,0x4(%esp)
801080a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080a4:	89 04 24             	mov    %eax,(%esp)
801080a7:	e8 00 f8 ff ff       	call   801078ac <mappages>
801080ac:	85 c0                	test   %eax,%eax
801080ae:	79 02                	jns    801080b2 <copyuvm+0xee>
      goto bad;
801080b0:	eb 18                	jmp    801080ca <copyuvm+0x106>
  uint pa, i, flags;
  char *mem;
...
801080bc:	3b 45 0c             	cmp    0xc(%ebp),%eax
801080bf:	0f 82 29 ff ff ff    	jb     80107fee <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
...
801080c8:	eb 10                	jmp    801080da <copyuvm+0x116>

bad:
  freevm(d);
801080ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080cd:	89 04 24             	mov    %eax,(%esp)
801080d0:	e8 13 fe ff ff       	call   80107ee8 <freevm>
  return 0;
...
801080df:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801080e2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801080e9:	00 
...
801080f7:	e8 14 f7 ff ff       	call   80107810 <walkpgdir>
...
80108139:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
8010813f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108142:	e9 87 00 00 00       	jmp    801081ce <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
80108147:	8b 45 0c             	mov    0xc(%ebp),%eax
8010814a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010814f:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
8010815f:	e8 78 ff ff ff       	call   801080dc <uva2ka>
80108164:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108167:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
8010816b:	75 07                	jne    80108174 <copyout+0x3e>
      return -1;
8010816d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108172:	eb 69                	jmp    801081dd <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108174:	8b 45 0c             	mov    0xc(%ebp),%eax
80108177:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010817a:	29 c2                	sub    %eax,%edx
8010817c:	89 d0                	mov    %edx,%eax
...
8010818c:	76 06                	jbe    80108194 <copyout+0x5e>
      n = len;
...
801081b2:	e8 9c cf ff ff       	call   80105153 <memmove>
    len -= n;
...
801081d2:	0f 85 6f ff ff ff    	jne    80108147 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
