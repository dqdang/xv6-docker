...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 3f 0e 00 	movl   $0xe3f,0x4(%esp)
  6d:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 113:	c7 44 24 04 58 0e 00 	movl   $0xe58,0x4(%esp)
 11a:	00 
 ...
 14f:	c7 44 24 04 73 0e 00 	movl   $0xe73,0x4(%esp)
 156:	00 
...
printf(int fd, char *fmt, ...)
{
 ...
 b5a:	75 09                	jne    b65 <printf+0x100>
          s = "(null)";
 b5c:	c7 45 f4 8f 0e 00 00 	movl   $0xe8f,-0xc(%ebp)
        while(*s != 0){
