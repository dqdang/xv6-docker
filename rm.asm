...
main(int argc, char *argv[])
{
  ...
  47:	e8 58 08 00 00       	call   8a4 <unlink>
  ...
  66:	c7 44 24 04 ab 0d 00 	movl   $0xdab,0x4(%esp)
  6d:	00 
...
int copy(char *inputfile, char *outputfile, int used_disk, int max_disk){
 ...
 10c:	c7 44 24 04 c4 0d 00 	movl   $0xdc4,0x4(%esp)
 113:	00 
 ...
 148:	c7 44 24 04 df 0d 00 	movl   $0xddf,0x4(%esp)
 14f:	00 
 ...
 176:	c7 44 24 04 fb 0d 00 	movl   $0xdfb,0x4(%esp)
 17d:	00 
...
printf(int fd, char *fmt, ...)
{
 ...
 ac6:	75 09                	jne    ad1 <printf+0x100>
          s = "(null)";
 ac8:	c7 45 f4 0c 0e 00 00 	movl   $0xe0c,-0xc(%ebp)
        while(*s != 0){
