...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 4f 0e 00 	movl   $0xe4f,0x4(%esp)
  6d:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 113:	c7 44 24 04 68 0e 00 	movl   $0xe68,0x4(%esp)
 11a:	00 
 ...
 14f:	c7 44 24 04 83 0e 00 	movl   $0xe83,0x4(%esp)
 156:	00 
...
printf(int fd, char *fmt, ...)
{
 ...
 b6a:	75 09                	jne    b75 <printf+0x100>
          s = "(null)";
 b6c:	c7 45 f4 9f 0e 00 00 	movl   $0xe9f,-0xc(%ebp)
        while(*s != 0){
