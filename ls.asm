...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
      ...
      5e:	c7 04 24 c0 15 00 00 	movl   $0x15c0,(%esp)
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      89:	05 c0 15 00 00       	add    $0x15c0,%eax
  ...
  return buf;
      a2:	b8 c0 15 00 00       	mov    $0x15c0,%eax
}
...
ls(char *path)
{
  ...
  if((fd = open(path, 0)) < 0){
    ...
    printf(2, "ls: cannot open %s\n", path);
      ...
      dc:	c7 44 24 04 ff 10 00 	movl   $0x10ff,0x4(%esp)
      e3:	00 
      e4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      eb:	e8 49 0c 00 00       	call   d39 <printf>
    return;
  ...
  if(fstat(fd, &st) < 0){
    ...
    printf(2, "ls: cannot stat %s\n", path);
     ...
     115:	c7 44 24 04 13 11 00 	movl   $0x1113,0x4(%esp)
     11c:	00 
     11d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     124:	e8 10 0c 00 00       	call   d39 <printf>
    close(fd);
  ...
  case T_FILE:
    printf(1, "%s %d %d %d\n", fmtname(path), st.type, st.ino, st.size);
     ...
     17e:	c7 44 24 04 27 11 00 	movl   $0x1127,0x4(%esp)
     185:	00 
     186:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     18d:	e8 a7 0b 00 00       	call   d39 <printf>
    break;
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1ac:	c7 44 24 04 34 11 00 	movl   $0x1134,0x4(%esp)
     1b3:	00 
     1b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1bb:	e8 79 0b 00 00       	call   d39 <printf>
      break;
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     263:	c7 44 24 04 13 11 00 	movl   $0x1113,0x4(%esp)
     26a:	00 
     26b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     272:	e8 c2 0a 00 00       	call   d39 <printf>
        continue;
     ...
     2ac:	c7 44 24 04 27 11 00 	movl   $0x1127,0x4(%esp)
     2b3:	00 
     2b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     2bb:	e8 79 0a 00 00       	call   d39 <printf>
      break;
    }
    strcpy(buf, path);
    p = buf+strlen(buf);
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     30c:	c7 04 24 47 11 00 00 	movl   $0x1147,(%esp)
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
     ...
     3ce:	79 20                	jns    3f0 <copy+0x49>
  {
     ...
     3d7:	c7 44 24 04 49 11 00 	movl   $0x1149,0x4(%esp)
     3de:	00 
     3df:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     3e6:	e8 4e 09 00 00       	call   d39 <printf>
      exit();
     ...
     40a:	79 20                	jns    42c <copy+0x85>
  {
     ...
     413:	c7 44 24 04 64 11 00 	movl   $0x1164,0x4(%esp)
     41a:	00 
     41b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     422:	e8 12 09 00 00       	call   d39 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
  ...
  s = lasts;
     6c3:	a1 d4 15 00 00       	mov    0x15d4,%eax
  ...
  if ((ch = *s++) == '\0')
    ...
    lasts = s + strcspn(s, delim);
     ...
     718:	a3 d4 15 00 00       	mov    %eax,0x15d4
    if (*lasts != 0)
     71d:	a1 d4 15 00 00       	mov    0x15d4,%eax
     722:	8a 00                	mov    (%eax),%al
     724:	84 c0                	test   %al,%al
     726:	74 11                	je     739 <strtok+0x83>
  *lasts++ = 0;
     728:	a1 d4 15 00 00       	mov    0x15d4,%eax
     72d:	8d 50 01             	lea    0x1(%eax),%edx
     730:	89 15 d4 15 00 00    	mov    %edx,0x15d4
  ...
  for ( ; ; p += 1) {
    ...
    break;
     8b2:	eb 22                	jmp    8d6 <strtoul+0x113>
      ...
      digit = cvtIn[digit];
     8b4:	8a 86 60 15 00 00    	mov    0x1560(%esi),%al
  ...
  for ( ; ; p += 1) {
    ...
    break;
     8e7:	eb 25                	jmp    90e <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
     8e9:	8a 86 60 15 00 00    	mov    0x1560(%esi),%al
...
00000c2c <tostring>:
SYSCALL(tostring)
     c2c:	b8 27 00 00 00       	mov    $0x27,%eax
     c31:	cd 40                	int    $0x40
     c33:	c3                   	ret    

00000c34 <getactivefsindex>:
SYSCALL(getactivefsindex)
     c34:	b8 28 00 00 00       	mov    $0x28,%eax
     c39:	cd 40                	int    $0x40
     c3b:	c3                   	ret    

00000c3c <setatroot>:
SYSCALL(setatroot)
     c3c:	b8 2a 00 00 00       	mov    $0x2a,%eax
     c41:	cd 40                	int    $0x40
     c43:	c3                   	ret    

00000c44 <getatroot>:
SYSCALL(getatroot)
     c44:	b8 29 00 00 00       	mov    $0x29,%eax
     c49:	cd 40                	int    $0x40
     c4b:	c3                   	ret    

00000c4c <getpath>:
SYSCALL(getpath)
     c4c:	b8 2b 00 00 00       	mov    $0x2b,%eax
     c51:	cd 40                	int    $0x40
     c53:	c3                   	ret    

00000c54 <setpath>:
SYSCALL(setpath)
     c54:	b8 2c 00 00 00       	mov    $0x2c,%eax
     c59:	cd 40                	int    $0x40
     c5b:	c3                   	ret    
...
putc(int fd, char c)
{
     ...
     c5f:	83 ec 18             	sub    $0x18,%esp
     c62:	8b 45 0c             	mov    0xc(%ebp),%eax
     c65:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     c68:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     c6f:	00 
     c70:	8d 45 f4             	lea    -0xc(%ebp),%eax
     c73:	89 44 24 04          	mov    %eax,0x4(%esp)
     c77:	8b 45 08             	mov    0x8(%ebp),%eax
     c7a:	89 04 24             	mov    %eax,(%esp)
     c7d:	e8 a2 fe ff ff       	call   b24 <write>
}
     c82:	c9                   	leave  
     c83:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     c8c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     c93:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     c97:	74 17                	je     cb0 <printint+0x2c>
     c99:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     c9d:	79 11                	jns    cb0 <printint+0x2c>
    neg = 1;
     c9f:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     ca6:	8b 45 0c             	mov    0xc(%ebp),%eax
     ca9:	f7 d8                	neg    %eax
     cab:	89 45 ec             	mov    %eax,-0x14(%ebp)
     cae:	eb 06                	jmp    cb6 <printint+0x32>
  } else {
    x = xx;
     cb0:	8b 45 0c             	mov    0xc(%ebp),%eax
     cb3:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
     cb6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
     cbd:	8b 4d f4             	mov    -0xc(%ebp),%ecx
     cc0:	8d 41 01             	lea    0x1(%ecx),%eax
     cc3:	89 45 f4             	mov    %eax,-0xc(%ebp)
     cc6:	8b 5d 10             	mov    0x10(%ebp),%ebx
     cc9:	8b 45 ec             	mov    -0x14(%ebp),%eax
     ccc:	ba 00 00 00 00       	mov    $0x0,%edx
     cd1:	f7 f3                	div    %ebx
     cd3:	89 d0                	mov    %edx,%eax
     cd5:	8a 80 ac 15 00 00    	mov    0x15ac(%eax),%al
     cdb:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
     cdf:	8b 75 10             	mov    0x10(%ebp),%esi
     ce2:	8b 45 ec             	mov    -0x14(%ebp),%eax
     ce5:	ba 00 00 00 00       	mov    $0x0,%edx
     cea:	f7 f6                	div    %esi
     cec:	89 45 ec             	mov    %eax,-0x14(%ebp)
     cef:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     cf3:	75 c8                	jne    cbd <printint+0x39>
  if(neg)
     cf5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     cf9:	74 10                	je     d0b <printint+0x87>
    buf[i++] = '-';
     cfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
     cfe:	8d 50 01             	lea    0x1(%eax),%edx
     d01:	89 55 f4             	mov    %edx,-0xc(%ebp)
     d04:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
     d09:	eb 1e                	jmp    d29 <printint+0xa5>
     d0b:	eb 1c                	jmp    d29 <printint+0xa5>
    putc(fd, buf[i]);
     d0d:	8d 55 dc             	lea    -0x24(%ebp),%edx
     d10:	8b 45 f4             	mov    -0xc(%ebp),%eax
     d13:	01 d0                	add    %edx,%eax
     d15:	8a 00                	mov    (%eax),%al
     d17:	0f be c0             	movsbl %al,%eax
     d1a:	89 44 24 04          	mov    %eax,0x4(%esp)
     d1e:	8b 45 08             	mov    0x8(%ebp),%eax
     d21:	89 04 24             	mov    %eax,(%esp)
     d24:	e8 33 ff ff ff       	call   c5c <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
     d29:	ff 4d f4             	decl   -0xc(%ebp)
     d2c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     d30:	79 db                	jns    d0d <printint+0x89>
    putc(fd, buf[i]);
}
     d32:	83 c4 30             	add    $0x30,%esp
     d35:	5b                   	pop    %ebx
     d36:	5e                   	pop    %esi
     d37:	5d                   	pop    %ebp
     d38:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
     ...
     d3c:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
     d3f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
     d46:	8d 45 0c             	lea    0xc(%ebp),%eax
     d49:	83 c0 04             	add    $0x4,%eax
     d4c:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
     d4f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
     d56:	e9 77 01 00 00       	jmp    ed2 <printf+0x199>
    c = fmt[i] & 0xff;
     d5b:	8b 55 0c             	mov    0xc(%ebp),%edx
     d5e:	8b 45 f0             	mov    -0x10(%ebp),%eax
     d61:	01 d0                	add    %edx,%eax
     d63:	8a 00                	mov    (%eax),%al
     d65:	0f be c0             	movsbl %al,%eax
     d68:	25 ff 00 00 00       	and    $0xff,%eax
     d6d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
     d70:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     d74:	75 2c                	jne    da2 <printf+0x69>
      if(c == '%'){
     d76:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     d7a:	75 0c                	jne    d88 <printf+0x4f>
        state = '%';
     d7c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
     d83:	e9 47 01 00 00       	jmp    ecf <printf+0x196>
      } else {
        putc(fd, c);
     d88:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     d8b:	0f be c0             	movsbl %al,%eax
     d8e:	89 44 24 04          	mov    %eax,0x4(%esp)
     d92:	8b 45 08             	mov    0x8(%ebp),%eax
     d95:	89 04 24             	mov    %eax,(%esp)
     d98:	e8 bf fe ff ff       	call   c5c <putc>
     d9d:	e9 2d 01 00 00       	jmp    ecf <printf+0x196>
      }
    } else if(state == '%'){
     da2:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
     da6:	0f 85 23 01 00 00    	jne    ecf <printf+0x196>
      if(c == 'd'){
     dac:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
     db0:	75 2d                	jne    ddf <printf+0xa6>
        printint(fd, *ap, 10, 1);
     db2:	8b 45 e8             	mov    -0x18(%ebp),%eax
     db5:	8b 00                	mov    (%eax),%eax
     db7:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
     dbe:	00 
     dbf:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     dc6:	00 
     dc7:	89 44 24 04          	mov    %eax,0x4(%esp)
     dcb:	8b 45 08             	mov    0x8(%ebp),%eax
     dce:	89 04 24             	mov    %eax,(%esp)
     dd1:	e8 ae fe ff ff       	call   c84 <printint>
        ap++;
     dd6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     dda:	e9 e9 00 00 00       	jmp    ec8 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
     ddf:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
     de3:	74 06                	je     deb <printf+0xb2>
     de5:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
     de9:	75 2d                	jne    e18 <printf+0xdf>
        printint(fd, *ap, 16, 0);
     deb:	8b 45 e8             	mov    -0x18(%ebp),%eax
     dee:	8b 00                	mov    (%eax),%eax
     df0:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
     df7:	00 
     df8:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
     dff:	00 
     e00:	89 44 24 04          	mov    %eax,0x4(%esp)
     e04:	8b 45 08             	mov    0x8(%ebp),%eax
     e07:	89 04 24             	mov    %eax,(%esp)
     e0a:	e8 75 fe ff ff       	call   c84 <printint>
        ap++;
     e0f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     e13:	e9 b0 00 00 00       	jmp    ec8 <printf+0x18f>
      } else if(c == 's'){
     e18:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
     e1c:	75 42                	jne    e60 <printf+0x127>
        s = (char*)*ap;
     e1e:	8b 45 e8             	mov    -0x18(%ebp),%eax
     e21:	8b 00                	mov    (%eax),%eax
     e23:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
     e26:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
     e2a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     e2e:	75 09                	jne    e39 <printf+0x100>
          s = "(null)";
     e30:	c7 45 f4 80 11 00 00 	movl   $0x1180,-0xc(%ebp)
        while(*s != 0){
     e37:	eb 1c                	jmp    e55 <printf+0x11c>
     e39:	eb 1a                	jmp    e55 <printf+0x11c>
          putc(fd, *s);
     e3b:	8b 45 f4             	mov    -0xc(%ebp),%eax
     e3e:	8a 00                	mov    (%eax),%al
     e40:	0f be c0             	movsbl %al,%eax
     e43:	89 44 24 04          	mov    %eax,0x4(%esp)
     e47:	8b 45 08             	mov    0x8(%ebp),%eax
     e4a:	89 04 24             	mov    %eax,(%esp)
     e4d:	e8 0a fe ff ff       	call   c5c <putc>
          s++;
     ...
     e5c:	75 dd                	jne    e3b <printf+0x102>
     e5e:	eb 68                	jmp    ec8 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
     e60:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
     e64:	75 1d                	jne    e83 <printf+0x14a>
        putc(fd, *ap);
     e66:	8b 45 e8             	mov    -0x18(%ebp),%eax
     e69:	8b 00                	mov    (%eax),%eax
     e6b:	0f be c0             	movsbl %al,%eax
     e6e:	89 44 24 04          	mov    %eax,0x4(%esp)
     e72:	8b 45 08             	mov    0x8(%ebp),%eax
     e75:	89 04 24             	mov    %eax,(%esp)
     e78:	e8 df fd ff ff       	call   c5c <putc>
        ap++;
     e7d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     e81:	eb 45                	jmp    ec8 <printf+0x18f>
      } else if(c == '%'){
     e83:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     e87:	75 17                	jne    ea0 <printf+0x167>
        putc(fd, c);
     e89:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     e8c:	0f be c0             	movsbl %al,%eax
     e8f:	89 44 24 04          	mov    %eax,0x4(%esp)
     e93:	8b 45 08             	mov    0x8(%ebp),%eax
     e96:	89 04 24             	mov    %eax,(%esp)
     e99:	e8 be fd ff ff       	call   c5c <putc>
     e9e:	eb 28                	jmp    ec8 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
     ea0:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
     ea7:	00 
     ea8:	8b 45 08             	mov    0x8(%ebp),%eax
     eab:	89 04 24             	mov    %eax,(%esp)
     eae:	e8 a9 fd ff ff       	call   c5c <putc>
        putc(fd, c);
     ...
     ec3:	e8 94 fd ff ff       	call   c5c <putc>
      }
      state = 0;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     ecf:	ff 45 f0             	incl   -0x10(%ebp)
     ed2:	8b 55 0c             	mov    0xc(%ebp),%edx
     ed5:	8b 45 f0             	mov    -0x10(%ebp),%eax
     ed8:	01 d0                	add    %edx,%eax
     eda:	8a 00                	mov    (%eax),%al
     edc:	84 c0                	test   %al,%al
     ede:	0f 85 77 fe ff ff    	jne    d5b <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
     ...
     eeb:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
     eee:	8b 45 08             	mov    0x8(%ebp),%eax
     ef1:	83 e8 08             	sub    $0x8,%eax
     ef4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ef7:	a1 e0 15 00 00       	mov    0x15e0,%eax
     efc:	89 45 fc             	mov    %eax,-0x4(%ebp)
     eff:	eb 24                	jmp    f25 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     f01:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f04:	8b 00                	mov    (%eax),%eax
     f06:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     f09:	77 12                	ja     f1d <free+0x35>
     f0b:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f0e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     f11:	77 24                	ja     f37 <free+0x4f>
     f13:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f16:	8b 00                	mov    (%eax),%eax
     f18:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f1b:	77 1a                	ja     f37 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     f22:	89 45 fc             	mov    %eax,-0x4(%ebp)
     f25:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f28:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     f2b:	76 d4                	jbe    f01 <free+0x19>
     f2d:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f30:	8b 00                	mov    (%eax),%eax
     f32:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f35:	76 ca                	jbe    f01 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
     f37:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f3a:	8b 40 04             	mov    0x4(%eax),%eax
     f3d:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f44:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f47:	01 c2                	add    %eax,%edx
     f49:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f4c:	8b 00                	mov    (%eax),%eax
     f4e:	39 c2                	cmp    %eax,%edx
     f50:	75 24                	jne    f76 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
     f52:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f55:	8b 50 04             	mov    0x4(%eax),%edx
     f58:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f5b:	8b 00                	mov    (%eax),%eax
     f5d:	8b 40 04             	mov    0x4(%eax),%eax
     f60:	01 c2                	add    %eax,%edx
     f62:	8b 45 f8             	mov    -0x8(%ebp),%eax
    ...
    bp->s.ptr = p->s.ptr->s.ptr;
     ...
     f74:	eb 0a                	jmp    f80 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
     f76:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f79:	8b 10                	mov    (%eax),%edx
     f7b:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f7e:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
     f80:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f83:	8b 40 04             	mov    0x4(%eax),%eax
     f86:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f8d:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f90:	01 d0                	add    %edx,%eax
     f92:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f95:	75 20                	jne    fb7 <free+0xcf>
    p->s.size += bp->s.size;
     f97:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f9a:	8b 50 04             	mov    0x4(%eax),%edx
     f9d:	8b 45 f8             	mov    -0x8(%ebp),%eax
     fa0:	8b 40 04             	mov    0x4(%eax),%eax
     fa3:	01 c2                	add    %eax,%edx
     fa5:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fa8:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
     fab:	8b 45 f8             	mov    -0x8(%ebp),%eax
     fae:	8b 10                	mov    (%eax),%edx
     fb0:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fb3:	89 10                	mov    %edx,(%eax)
     fb5:	eb 08                	jmp    fbf <free+0xd7>
  } else
    p->s.ptr = bp;
     fb7:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fba:	8b 55 f8             	mov    -0x8(%ebp),%edx
     fbd:	89 10                	mov    %edx,(%eax)
  freep = p;
     fbf:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fc2:	a3 e0 15 00 00       	mov    %eax,0x15e0
}
     fc7:	c9                   	leave  
     fc8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
     fcf:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
     fd6:	77 07                	ja     fdf <morecore+0x16>
    nu = 4096;
     fd8:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
     fdf:	8b 45 08             	mov    0x8(%ebp),%eax
     fe2:	c1 e0 03             	shl    $0x3,%eax
     fe5:	89 04 24             	mov    %eax,(%esp)
     fe8:	e8 9f fb ff ff       	call   b8c <sbrk>
     fed:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
     ff0:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
     ff4:	75 07                	jne    ffd <morecore+0x34>
    return 0;
     ff6:	b8 00 00 00 00       	mov    $0x0,%eax
     ffb:	eb 22                	jmp    101f <morecore+0x56>
  hp = (Header*)p;
     ffd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1000:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    1003:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1006:	8b 55 08             	mov    0x8(%ebp),%edx
    1009:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    100c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    100f:	83 c0 08             	add    $0x8,%eax
    1012:	89 04 24             	mov    %eax,(%esp)
    1015:	e8 ce fe ff ff       	call   ee8 <free>
  return freep;
    101a:	a1 e0 15 00 00       	mov    0x15e0,%eax
}
    101f:	c9                   	leave  
    1020:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    1024:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1027:	8b 45 08             	mov    0x8(%ebp),%eax
    102a:	83 c0 07             	add    $0x7,%eax
    102d:	c1 e8 03             	shr    $0x3,%eax
    1030:	40                   	inc    %eax
    1031:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1034:	a1 e0 15 00 00       	mov    0x15e0,%eax
    1039:	89 45 f0             	mov    %eax,-0x10(%ebp)
    103c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1040:	75 23                	jne    1065 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1042:	c7 45 f0 d8 15 00 00 	movl   $0x15d8,-0x10(%ebp)
    1049:	8b 45 f0             	mov    -0x10(%ebp),%eax
    104c:	a3 e0 15 00 00       	mov    %eax,0x15e0
    1051:	a1 e0 15 00 00       	mov    0x15e0,%eax
    1056:	a3 d8 15 00 00       	mov    %eax,0x15d8
    base.s.size = 0;
    105b:	c7 05 dc 15 00 00 00 	movl   $0x0,0x15dc
    1062:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1065:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1068:	8b 00                	mov    (%eax),%eax
    106a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    106d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1070:	8b 40 04             	mov    0x4(%eax),%eax
    1073:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1076:	72 4d                	jb     10c5 <malloc+0xa4>
      if(p->s.size == nunits)
    1078:	8b 45 f4             	mov    -0xc(%ebp),%eax
    107b:	8b 40 04             	mov    0x4(%eax),%eax
    107e:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1081:	75 0c                	jne    108f <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    1083:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1086:	8b 10                	mov    (%eax),%edx
    1088:	8b 45 f0             	mov    -0x10(%ebp),%eax
    108b:	89 10                	mov    %edx,(%eax)
    108d:	eb 26                	jmp    10b5 <malloc+0x94>
      else {
        p->s.size -= nunits;
    108f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1092:	8b 40 04             	mov    0x4(%eax),%eax
    1095:	2b 45 ec             	sub    -0x14(%ebp),%eax
    1098:	89 c2                	mov    %eax,%edx
    109a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    109d:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    10a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10a3:	8b 40 04             	mov    0x4(%eax),%eax
    10a6:	c1 e0 03             	shl    $0x3,%eax
    10a9:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    10ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10af:	8b 55 ec             	mov    -0x14(%ebp),%edx
    10b2:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    10b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    10b8:	a3 e0 15 00 00       	mov    %eax,0x15e0
      return (void*)(p + 1);
    10bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10c0:	83 c0 08             	add    $0x8,%eax
    10c3:	eb 38                	jmp    10fd <malloc+0xdc>
    }
    if(p == freep)
    10c5:	a1 e0 15 00 00       	mov    0x15e0,%eax
    10ca:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    10cd:	75 1b                	jne    10ea <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    10cf:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10d2:	89 04 24             	mov    %eax,(%esp)
    10d5:	e8 ef fe ff ff       	call   fc9 <morecore>
    10da:	89 45 f4             	mov    %eax,-0xc(%ebp)
    10dd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    10e1:	75 07                	jne    10ea <malloc+0xc9>
        return 0;
    10e3:	b8 00 00 00 00       	mov    $0x0,%eax
    10e8:	eb 13                	jmp    10fd <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10f8:	e9 70 ff ff ff       	jmp    106d <malloc+0x4c>
}
    10fd:	c9                   	leave  
    10fe:	c3                   	ret    
