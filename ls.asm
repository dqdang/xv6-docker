...
ls(char *path)
{
  ...
  if((fd = open(path, 0)) < 0){
    ...
    printf(2, "ls: cannot open %s\n", path);
      ...
      dc:	c7 44 24 04 ef 10 00 	movl   $0x10ef,0x4(%esp)
      e3:	00 
      e4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      eb:	e8 39 0c 00 00       	call   d29 <printf>
    return;
  ...
  if(fstat(fd, &st) < 0){
    ...
    printf(2, "ls: cannot stat %s\n", path);
     ...
     115:	c7 44 24 04 03 11 00 	movl   $0x1103,0x4(%esp)
     11c:	00 
     11d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     124:	e8 00 0c 00 00       	call   d29 <printf>
    close(fd);
  ...
  case T_FILE:
    printf(1, "%s %d %d %d\n", fmtname(path), st.type, st.ino, st.size);
     ...
     17e:	c7 44 24 04 17 11 00 	movl   $0x1117,0x4(%esp)
     185:	00 
     186:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     18d:	e8 97 0b 00 00       	call   d29 <printf>
    break;
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1ac:	c7 44 24 04 24 11 00 	movl   $0x1124,0x4(%esp)
     1b3:	00 
     1b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1bb:	e8 69 0b 00 00       	call   d29 <printf>
      break;
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     263:	c7 44 24 04 03 11 00 	movl   $0x1103,0x4(%esp)
     26a:	00 
     26b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     272:	e8 b2 0a 00 00       	call   d29 <printf>
        continue;
     ...
     2ac:	c7 44 24 04 17 11 00 	movl   $0x1117,0x4(%esp)
     2b3:	00 
     2b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     2bb:	e8 69 0a 00 00       	call   d29 <printf>
      break;
    }
    strcpy(buf, path);
    p = buf+strlen(buf);
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     30c:	c7 04 24 37 11 00 00 	movl   $0x1137,(%esp)
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
     ...
     3ce:	79 20                	jns    3f0 <copy+0x49>
  {
     ...
     3d7:	c7 44 24 04 39 11 00 	movl   $0x1139,0x4(%esp)
     3de:	00 
     3df:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     3e6:	e8 3e 09 00 00       	call   d29 <printf>
      exit();
     ...
     40a:	79 20                	jns    42c <copy+0x85>
  {
     ...
     413:	c7 44 24 04 54 11 00 	movl   $0x1154,0x4(%esp)
     41a:	00 
     41b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     422:	e8 02 09 00 00       	call   d29 <printf>
      exit();
...
putc(int fd, char c)
{
     ...
     c55:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     c58:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     c5f:	00 
     c60:	8d 45 f4             	lea    -0xc(%ebp),%eax
     c63:	89 44 24 04          	mov    %eax,0x4(%esp)
     c67:	8b 45 08             	mov    0x8(%ebp),%eax
     c6a:	89 04 24             	mov    %eax,(%esp)
     c6d:	e8 b2 fe ff ff       	call   b24 <write>
}
     c72:	c9                   	leave  
     c73:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     c7c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     c83:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     c87:	74 17                	je     ca0 <printint+0x2c>
     c89:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     c8d:	79 11                	jns    ca0 <printint+0x2c>
    neg = 1;
     c8f:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     c96:	8b 45 0c             	mov    0xc(%ebp),%eax
     c99:	f7 d8                	neg    %eax
     c9b:	89 45 ec             	mov    %eax,-0x14(%ebp)
     c9e:	eb 06                	jmp    ca6 <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     cad:	8b 4d f4             	mov    -0xc(%ebp),%ecx
     cb0:	8d 41 01             	lea    0x1(%ecx),%eax
     cb3:	89 45 f4             	mov    %eax,-0xc(%ebp)
     cb6:	8b 5d 10             	mov    0x10(%ebp),%ebx
     cb9:	8b 45 ec             	mov    -0x14(%ebp),%eax
     cbc:	ba 00 00 00 00       	mov    $0x0,%edx
     cc1:	f7 f3                	div    %ebx
     cc3:	89 d0                	mov    %edx,%eax
     cc5:	8a 80 ac 15 00 00    	mov    0x15ac(%eax),%al
     ccb:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
     ccf:	8b 75 10             	mov    0x10(%ebp),%esi
     cd2:	8b 45 ec             	mov    -0x14(%ebp),%eax
     cd5:	ba 00 00 00 00       	mov    $0x0,%edx
     cda:	f7 f6                	div    %esi
     cdc:	89 45 ec             	mov    %eax,-0x14(%ebp)
     cdf:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     ce3:	75 c8                	jne    cad <printint+0x39>
  if(neg)
     ce5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     ce9:	74 10                	je     cfb <printint+0x87>
    buf[i++] = '-';
     ceb:	8b 45 f4             	mov    -0xc(%ebp),%eax
     cee:	8d 50 01             	lea    0x1(%eax),%edx
     cf1:	89 55 f4             	mov    %edx,-0xc(%ebp)
     cf4:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
     cf9:	eb 1e                	jmp    d19 <printint+0xa5>
     cfb:	eb 1c                	jmp    d19 <printint+0xa5>
    putc(fd, buf[i]);
     cfd:	8d 55 dc             	lea    -0x24(%ebp),%edx
     ...
     d14:	e8 33 ff ff ff       	call   c4c <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
     d19:	ff 4d f4             	decl   -0xc(%ebp)
     d1c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     d20:	79 db                	jns    cfd <printint+0x89>
    putc(fd, buf[i]);
}
     d22:	83 c4 30             	add    $0x30,%esp
     d25:	5b                   	pop    %ebx
     d26:	5e                   	pop    %esi
     d27:	5d                   	pop    %ebp
     d28:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
     ...
     d2c:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
     d2f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
     d36:	8d 45 0c             	lea    0xc(%ebp),%eax
     d39:	83 c0 04             	add    $0x4,%eax
     d3c:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
     d3f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
     d46:	e9 77 01 00 00       	jmp    ec2 <printf+0x199>
    c = fmt[i] & 0xff;
     d4b:	8b 55 0c             	mov    0xc(%ebp),%edx
     d4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
     d51:	01 d0                	add    %edx,%eax
     d53:	8a 00                	mov    (%eax),%al
     d55:	0f be c0             	movsbl %al,%eax
     d58:	25 ff 00 00 00       	and    $0xff,%eax
     d5d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
     d60:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     d64:	75 2c                	jne    d92 <printf+0x69>
      if(c == '%'){
     d66:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     d6a:	75 0c                	jne    d78 <printf+0x4f>
        state = '%';
     d6c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
     d73:	e9 47 01 00 00       	jmp    ebf <printf+0x196>
      } else {
        putc(fd, c);
     ...
     d88:	e8 bf fe ff ff       	call   c4c <putc>
     d8d:	e9 2d 01 00 00       	jmp    ebf <printf+0x196>
      }
    } else if(state == '%'){
     d92:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
     d96:	0f 85 23 01 00 00    	jne    ebf <printf+0x196>
      if(c == 'd'){
     d9c:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
     da0:	75 2d                	jne    dcf <printf+0xa6>
        printint(fd, *ap, 10, 1);
     da2:	8b 45 e8             	mov    -0x18(%ebp),%eax
     da5:	8b 00                	mov    (%eax),%eax
     da7:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
     dae:	00 
     daf:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     db6:	00 
     db7:	89 44 24 04          	mov    %eax,0x4(%esp)
     dbb:	8b 45 08             	mov    0x8(%ebp),%eax
     dbe:	89 04 24             	mov    %eax,(%esp)
     dc1:	e8 ae fe ff ff       	call   c74 <printint>
        ap++;
     dc6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     dca:	e9 e9 00 00 00       	jmp    eb8 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
     dcf:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
     dd3:	74 06                	je     ddb <printf+0xb2>
     dd5:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
     dd9:	75 2d                	jne    e08 <printf+0xdf>
        printint(fd, *ap, 16, 0);
     ddb:	8b 45 e8             	mov    -0x18(%ebp),%eax
     dde:	8b 00                	mov    (%eax),%eax
     de0:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
     de7:	00 
     de8:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
     def:	00 
     df0:	89 44 24 04          	mov    %eax,0x4(%esp)
     df4:	8b 45 08             	mov    0x8(%ebp),%eax
     df7:	89 04 24             	mov    %eax,(%esp)
     dfa:	e8 75 fe ff ff       	call   c74 <printint>
        ap++;
     dff:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     e03:	e9 b0 00 00 00       	jmp    eb8 <printf+0x18f>
      } else if(c == 's'){
     e08:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
     e0c:	75 42                	jne    e50 <printf+0x127>
        s = (char*)*ap;
     e0e:	8b 45 e8             	mov    -0x18(%ebp),%eax
     e11:	8b 00                	mov    (%eax),%eax
     e13:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
     e16:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
     e1a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     e1e:	75 09                	jne    e29 <printf+0x100>
          s = "(null)";
     e20:	c7 45 f4 70 11 00 00 	movl   $0x1170,-0xc(%ebp)
        while(*s != 0){
     e27:	eb 1c                	jmp    e45 <printf+0x11c>
     e29:	eb 1a                	jmp    e45 <printf+0x11c>
          putc(fd, *s);
     ...
     e3d:	e8 0a fe ff ff       	call   c4c <putc>
          s++;
     e42:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
     ...
     e48:	8a 00                	mov    (%eax),%al
     e4a:	84 c0                	test   %al,%al
     e4c:	75 dd                	jne    e2b <printf+0x102>
     e4e:	eb 68                	jmp    eb8 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
     e50:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
     e54:	75 1d                	jne    e73 <printf+0x14a>
        putc(fd, *ap);
     e56:	8b 45 e8             	mov    -0x18(%ebp),%eax
     e59:	8b 00                	mov    (%eax),%eax
     e5b:	0f be c0             	movsbl %al,%eax
     e5e:	89 44 24 04          	mov    %eax,0x4(%esp)
     e62:	8b 45 08             	mov    0x8(%ebp),%eax
     e65:	89 04 24             	mov    %eax,(%esp)
     e68:	e8 df fd ff ff       	call   c4c <putc>
        ap++;
     e6d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     e71:	eb 45                	jmp    eb8 <printf+0x18f>
      } else if(c == '%'){
     e73:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     e77:	75 17                	jne    e90 <printf+0x167>
        putc(fd, c);
     e79:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     e7c:	0f be c0             	movsbl %al,%eax
     e7f:	89 44 24 04          	mov    %eax,0x4(%esp)
     e83:	8b 45 08             	mov    0x8(%ebp),%eax
     e86:	89 04 24             	mov    %eax,(%esp)
     e89:	e8 be fd ff ff       	call   c4c <putc>
     e8e:	eb 28                	jmp    eb8 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
     e90:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
     e97:	00 
     e98:	8b 45 08             	mov    0x8(%ebp),%eax
     e9b:	89 04 24             	mov    %eax,(%esp)
     e9e:	e8 a9 fd ff ff       	call   c4c <putc>
        putc(fd, c);
     ea3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     ea6:	0f be c0             	movsbl %al,%eax
     ea9:	89 44 24 04          	mov    %eax,0x4(%esp)
     ead:	8b 45 08             	mov    0x8(%ebp),%eax
     eb0:	89 04 24             	mov    %eax,(%esp)
     eb3:	e8 94 fd ff ff       	call   c4c <putc>
      }
      state = 0;
...
free(void *ap)
{
     ...
     edb:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
     ede:	8b 45 08             	mov    0x8(%ebp),%eax
     ee1:	83 e8 08             	sub    $0x8,%eax
     ee4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ee7:	a1 e0 15 00 00       	mov    0x15e0,%eax
     eec:	89 45 fc             	mov    %eax,-0x4(%ebp)
     eef:	eb 24                	jmp    f15 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     ef1:	8b 45 fc             	mov    -0x4(%ebp),%eax
     ef4:	8b 00                	mov    (%eax),%eax
     ef6:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     ef9:	77 12                	ja     f0d <free+0x35>
     efb:	8b 45 f8             	mov    -0x8(%ebp),%eax
     efe:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     f01:	77 24                	ja     f27 <free+0x4f>
     f03:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f06:	8b 00                	mov    (%eax),%eax
     f08:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f0b:	77 1a                	ja     f27 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     f0d:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f10:	8b 00                	mov    (%eax),%eax
     f12:	89 45 fc             	mov    %eax,-0x4(%ebp)
     f15:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f18:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     f1b:	76 d4                	jbe    ef1 <free+0x19>
     f1d:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f20:	8b 00                	mov    (%eax),%eax
     f22:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f25:	76 ca                	jbe    ef1 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
     f27:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f2a:	8b 40 04             	mov    0x4(%eax),%eax
     f2d:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f34:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f37:	01 c2                	add    %eax,%edx
     f39:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f3c:	8b 00                	mov    (%eax),%eax
     f3e:	39 c2                	cmp    %eax,%edx
     f40:	75 24                	jne    f66 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
     f42:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f45:	8b 50 04             	mov    0x4(%eax),%edx
     f48:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f4b:	8b 00                	mov    (%eax),%eax
     f4d:	8b 40 04             	mov    0x4(%eax),%eax
     f50:	01 c2                	add    %eax,%edx
     f52:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f55:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
     ...
     f64:	eb 0a                	jmp    f70 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
     f66:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f69:	8b 10                	mov    (%eax),%edx
     f6b:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f6e:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
     f70:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f73:	8b 40 04             	mov    0x4(%eax),%eax
     f76:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f7d:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f80:	01 d0                	add    %edx,%eax
     f82:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f85:	75 20                	jne    fa7 <free+0xcf>
    p->s.size += bp->s.size;
     f87:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f8a:	8b 50 04             	mov    0x4(%eax),%edx
     f8d:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f90:	8b 40 04             	mov    0x4(%eax),%eax
     f93:	01 c2                	add    %eax,%edx
    ...
    p->s.ptr = bp->s.ptr;
     ...
     fa5:	eb 08                	jmp    faf <free+0xd7>
  } else
    p->s.ptr = bp;
     fa7:	8b 45 fc             	mov    -0x4(%ebp),%eax
     faa:	8b 55 f8             	mov    -0x8(%ebp),%edx
     fad:	89 10                	mov    %edx,(%eax)
  freep = p;
     faf:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fb2:	a3 e0 15 00 00       	mov    %eax,0x15e0
}
     fb7:	c9                   	leave  
     fb8:	c3                   	ret    
...
morecore(uint nu)
{
     ...
     fbc:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
     fbf:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
     fc6:	77 07                	ja     fcf <morecore+0x16>
    nu = 4096;
     fc8:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
     fcf:	8b 45 08             	mov    0x8(%ebp),%eax
     fd2:	c1 e0 03             	shl    $0x3,%eax
     fd5:	89 04 24             	mov    %eax,(%esp)
     fd8:	e8 af fb ff ff       	call   b8c <sbrk>
     fdd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
     fe0:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
     fe4:	75 07                	jne    fed <morecore+0x34>
    return 0;
     fe6:	b8 00 00 00 00       	mov    $0x0,%eax
     feb:	eb 22                	jmp    100f <morecore+0x56>
  hp = (Header*)p;
     fed:	8b 45 f4             	mov    -0xc(%ebp),%eax
     ff0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
     ff3:	8b 45 f0             	mov    -0x10(%ebp),%eax
     ff6:	8b 55 08             	mov    0x8(%ebp),%edx
     ff9:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
     ffc:	8b 45 f0             	mov    -0x10(%ebp),%eax
     fff:	83 c0 08             	add    $0x8,%eax
    1002:	89 04 24             	mov    %eax,(%esp)
    1005:	e8 ce fe ff ff       	call   ed8 <free>
  return freep;
    100a:	a1 e0 15 00 00       	mov    0x15e0,%eax
}
    100f:	c9                   	leave  
    1010:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    1014:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1017:	8b 45 08             	mov    0x8(%ebp),%eax
    101a:	83 c0 07             	add    $0x7,%eax
    101d:	c1 e8 03             	shr    $0x3,%eax
    1020:	40                   	inc    %eax
    1021:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1024:	a1 e0 15 00 00       	mov    0x15e0,%eax
    1029:	89 45 f0             	mov    %eax,-0x10(%ebp)
    102c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1030:	75 23                	jne    1055 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1032:	c7 45 f0 d8 15 00 00 	movl   $0x15d8,-0x10(%ebp)
    1039:	8b 45 f0             	mov    -0x10(%ebp),%eax
    103c:	a3 e0 15 00 00       	mov    %eax,0x15e0
    1041:	a1 e0 15 00 00       	mov    0x15e0,%eax
    1046:	a3 d8 15 00 00       	mov    %eax,0x15d8
    base.s.size = 0;
    104b:	c7 05 dc 15 00 00 00 	movl   $0x0,0x15dc
    1052:	00 00 00 
  }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    10e8:	e9 70 ff ff ff       	jmp    105d <malloc+0x4c>
}
    10ed:	c9                   	leave  
    10ee:	c3                   	ret    
