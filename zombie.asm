...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  a7:	c7 44 24 04 9f 0d 00 	movl   $0xd9f,0x4(%esp)
  ae:	00 
  af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b6:	e8 1e 09 00 00       	call   9d9 <printf>
      exit();
  ...
  e3:	c7 44 24 04 ba 0d 00 	movl   $0xdba,0x4(%esp)
  ea:	00 
  eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f2:	e8 e2 08 00 00       	call   9d9 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 391:	75 08                	jne    39b <strtok+0x15>
  s = lasts;
 393:	a1 c4 11 00 00       	mov    0x11c4,%eax
 ...
 3e8:	a3 c4 11 00 00       	mov    %eax,0x11c4
    if (*lasts != 0)
 3ed:	a1 c4 11 00 00       	mov    0x11c4,%eax
 3f2:	8a 00                	mov    (%eax),%al
 3f4:	84 c0                	test   %al,%al
 3f6:	74 11                	je     409 <strtok+0x83>
  *lasts++ = 0;
 3f8:	a1 c4 11 00 00       	mov    0x11c4,%eax
 3fd:	8d 50 01             	lea    0x1(%eax),%edx
 400:	89 15 c4 11 00 00    	mov    %edx,0x11c4
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 582:	eb 22                	jmp    5a6 <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 584:	8a 86 60 11 00 00    	mov    0x1160(%esi),%al
 ...
 5b7:	eb 25                	jmp    5de <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 5b9:	8a 86 60 11 00 00    	mov    0x1160(%esi),%al
...
putc(int fd, char c)
{
 ...
 91d:	e8 d2 fe ff ff       	call   7f4 <write>
}
 922:	c9                   	leave  
 923:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 92c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 933:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 937:	74 17                	je     950 <printint+0x2c>
 939:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 93d:	79 11                	jns    950 <printint+0x2c>
    neg = 1;
 93f:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 946:	8b 45 0c             	mov    0xc(%ebp),%eax
 949:	f7 d8                	neg    %eax
 94b:	89 45 ec             	mov    %eax,-0x14(%ebp)
 94e:	eb 06                	jmp    956 <printint+0x32>
  } else {
    x = xx;
 ...
 953:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  i = 0;
 956:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 95d:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 960:	8d 41 01             	lea    0x1(%ecx),%eax
 963:	89 45 f4             	mov    %eax,-0xc(%ebp)
 966:	8b 5d 10             	mov    0x10(%ebp),%ebx
 969:	8b 45 ec             	mov    -0x14(%ebp),%eax
 96c:	ba 00 00 00 00       	mov    $0x0,%edx
 971:	f7 f3                	div    %ebx
 973:	89 d0                	mov    %edx,%eax
 975:	8a 80 ac 11 00 00    	mov    0x11ac(%eax),%al
 97b:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 97f:	8b 75 10             	mov    0x10(%ebp),%esi
 982:	8b 45 ec             	mov    -0x14(%ebp),%eax
 985:	ba 00 00 00 00       	mov    $0x0,%edx
 98a:	f7 f6                	div    %esi
 98c:	89 45 ec             	mov    %eax,-0x14(%ebp)
 98f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 993:	75 c8                	jne    95d <printint+0x39>
  if(neg)
 995:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 999:	74 10                	je     9ab <printint+0x87>
    buf[i++] = '-';
 99b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 99e:	8d 50 01             	lea    0x1(%eax),%edx
 9a1:	89 55 f4             	mov    %edx,-0xc(%ebp)
 9a4:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 9a9:	eb 1e                	jmp    9c9 <printint+0xa5>
 9ab:	eb 1c                	jmp    9c9 <printint+0xa5>
    putc(fd, buf[i]);
 9ad:	8d 55 dc             	lea    -0x24(%ebp),%edx
 9b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
 9b3:	01 d0                	add    %edx,%eax
 9b5:	8a 00                	mov    (%eax),%al
 9b7:	0f be c0             	movsbl %al,%eax
 9ba:	89 44 24 04          	mov    %eax,0x4(%esp)
 9be:	8b 45 08             	mov    0x8(%ebp),%eax
 9c1:	89 04 24             	mov    %eax,(%esp)
 9c4:	e8 33 ff ff ff       	call   8fc <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 9c9:	ff 4d f4             	decl   -0xc(%ebp)
 9cc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 9d0:	79 db                	jns    9ad <printint+0x89>
    putc(fd, buf[i]);
}
 9d2:	83 c4 30             	add    $0x30,%esp
 9d5:	5b                   	pop    %ebx
 9d6:	5e                   	pop    %esi
 9d7:	5d                   	pop    %ebp
 9d8:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 9df:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 9e6:	8d 45 0c             	lea    0xc(%ebp),%eax
 9e9:	83 c0 04             	add    $0x4,%eax
 9ec:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 9ef:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 9f6:	e9 77 01 00 00       	jmp    b72 <printf+0x199>
    c = fmt[i] & 0xff;
 9fb:	8b 55 0c             	mov    0xc(%ebp),%edx
 9fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a01:	01 d0                	add    %edx,%eax
 a03:	8a 00                	mov    (%eax),%al
 a05:	0f be c0             	movsbl %al,%eax
 a08:	25 ff 00 00 00       	and    $0xff,%eax
 a0d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 a10:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a14:	75 2c                	jne    a42 <printf+0x69>
      if(c == '%'){
 a16:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a1a:	75 0c                	jne    a28 <printf+0x4f>
        state = '%';
 a1c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 a23:	e9 47 01 00 00       	jmp    b6f <printf+0x196>
      } else {
        putc(fd, c);
 ...
 a38:	e8 bf fe ff ff       	call   8fc <putc>
 a3d:	e9 2d 01 00 00       	jmp    b6f <printf+0x196>
      }
    } else if(state == '%'){
 a42:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 a46:	0f 85 23 01 00 00    	jne    b6f <printf+0x196>
      if(c == 'd'){
 a4c:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 a50:	75 2d                	jne    a7f <printf+0xa6>
        printint(fd, *ap, 10, 1);
 a52:	8b 45 e8             	mov    -0x18(%ebp),%eax
 a55:	8b 00                	mov    (%eax),%eax
 a57:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 a5e:	00 
 a5f:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 a66:	00 
 a67:	89 44 24 04          	mov    %eax,0x4(%esp)
 a6b:	8b 45 08             	mov    0x8(%ebp),%eax
 a6e:	89 04 24             	mov    %eax,(%esp)
 a71:	e8 ae fe ff ff       	call   924 <printint>
        ap++;
 a76:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 a7a:	e9 e9 00 00 00       	jmp    b68 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 a7f:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 a83:	74 06                	je     a8b <printf+0xb2>
 a85:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 a89:	75 2d                	jne    ab8 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 a8b:	8b 45 e8             	mov    -0x18(%ebp),%eax
 a8e:	8b 00                	mov    (%eax),%eax
 a90:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 a97:	00 
 a98:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 a9f:	00 
 aa0:	89 44 24 04          	mov    %eax,0x4(%esp)
 aa4:	8b 45 08             	mov    0x8(%ebp),%eax
 aa7:	89 04 24             	mov    %eax,(%esp)
 aaa:	e8 75 fe ff ff       	call   924 <printint>
        ap++;
 aaf:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 ab3:	e9 b0 00 00 00       	jmp    b68 <printf+0x18f>
      } else if(c == 's'){
 ab8:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 abc:	75 42                	jne    b00 <printf+0x127>
        s = (char*)*ap;
 ...
 ace:	75 09                	jne    ad9 <printf+0x100>
          s = "(null)";
 ad0:	c7 45 f4 d6 0d 00 00 	movl   $0xdd6,-0xc(%ebp)
        while(*s != 0){
 ad7:	eb 1c                	jmp    af5 <printf+0x11c>
 ad9:	eb 1a                	jmp    af5 <printf+0x11c>
          putc(fd, *s);
 adb:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ade:	8a 00                	mov    (%eax),%al
 ae0:	0f be c0             	movsbl %al,%eax
 ae3:	89 44 24 04          	mov    %eax,0x4(%esp)
 ae7:	8b 45 08             	mov    0x8(%ebp),%eax
 aea:	89 04 24             	mov    %eax,(%esp)
 aed:	e8 0a fe ff ff       	call   8fc <putc>
          s++;
 af2:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 af8:	8a 00                	mov    (%eax),%al
 afa:	84 c0                	test   %al,%al
 afc:	75 dd                	jne    adb <printf+0x102>
 afe:	eb 68                	jmp    b68 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 b00:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 b04:	75 1d                	jne    b23 <printf+0x14a>
        putc(fd, *ap);
 ...
 b18:	e8 df fd ff ff       	call   8fc <putc>
        ap++;
 b1d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b21:	eb 45                	jmp    b68 <printf+0x18f>
      } else if(c == '%'){
 b23:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 b27:	75 17                	jne    b40 <printf+0x167>
        putc(fd, c);
 b29:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 b2c:	0f be c0             	movsbl %al,%eax
 b2f:	89 44 24 04          	mov    %eax,0x4(%esp)
 b33:	8b 45 08             	mov    0x8(%ebp),%eax
 b36:	89 04 24             	mov    %eax,(%esp)
 b39:	e8 be fd ff ff       	call   8fc <putc>
 b3e:	eb 28                	jmp    b68 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 b40:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 b47:	00 
 b48:	8b 45 08             	mov    0x8(%ebp),%eax
 b4b:	89 04 24             	mov    %eax,(%esp)
 b4e:	e8 a9 fd ff ff       	call   8fc <putc>
        putc(fd, c);
 b53:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 b56:	0f be c0             	movsbl %al,%eax
 b59:	89 44 24 04          	mov    %eax,0x4(%esp)
 b5d:	8b 45 08             	mov    0x8(%ebp),%eax
 b60:	89 04 24             	mov    %eax,(%esp)
 b63:	e8 94 fd ff ff       	call   8fc <putc>
      }
      state = 0;
 b68:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
...
free(void *ap)
{
 ...
 b8b:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
 b8e:	8b 45 08             	mov    0x8(%ebp),%eax
 b91:	83 e8 08             	sub    $0x8,%eax
 b94:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 b97:	a1 d0 11 00 00       	mov    0x11d0,%eax
 b9c:	89 45 fc             	mov    %eax,-0x4(%ebp)
 b9f:	eb 24                	jmp    bc5 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 ba1:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ba4:	8b 00                	mov    (%eax),%eax
 ba6:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 ba9:	77 12                	ja     bbd <free+0x35>
 bab:	8b 45 f8             	mov    -0x8(%ebp),%eax
 bae:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 bb1:	77 24                	ja     bd7 <free+0x4f>
 bb3:	8b 45 fc             	mov    -0x4(%ebp),%eax
 bb6:	8b 00                	mov    (%eax),%eax
 bb8:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 bbb:	77 1a                	ja     bd7 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 bc5:	8b 45 f8             	mov    -0x8(%ebp),%eax
 bc8:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 bcb:	76 d4                	jbe    ba1 <free+0x19>
 bcd:	8b 45 fc             	mov    -0x4(%ebp),%eax
 bd0:	8b 00                	mov    (%eax),%eax
 bd2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 bd5:	76 ca                	jbe    ba1 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
 ...
 bee:	39 c2                	cmp    %eax,%edx
 bf0:	75 24                	jne    c16 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
 bf2:	8b 45 f8             	mov    -0x8(%ebp),%eax
 ...
 c32:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c35:	75 20                	jne    c57 <free+0xcf>
    p->s.size += bp->s.size;
 c37:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c3a:	8b 50 04             	mov    0x4(%eax),%edx
 ...
 c55:	eb 08                	jmp    c5f <free+0xd7>
  } else
    p->s.ptr = bp;
 c57:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c5a:	8b 55 f8             	mov    -0x8(%ebp),%edx
 c5d:	89 10                	mov    %edx,(%eax)
  freep = p;
 c5f:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c62:	a3 d0 11 00 00       	mov    %eax,0x11d0
}
 c67:	c9                   	leave  
 c68:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 c6c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(nu < 4096)
 c6f:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 c76:	77 07                	ja     c7f <morecore+0x16>
    nu = 4096;
 c78:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 c7f:	8b 45 08             	mov    0x8(%ebp),%eax
 c82:	c1 e0 03             	shl    $0x3,%eax
 c85:	89 04 24             	mov    %eax,(%esp)
 c88:	e8 cf fb ff ff       	call   85c <sbrk>
 c8d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 c90:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 c94:	75 07                	jne    c9d <morecore+0x34>
    return 0;
 c96:	b8 00 00 00 00       	mov    $0x0,%eax
 c9b:	eb 22                	jmp    cbf <morecore+0x56>
  hp = (Header*)p;
 c9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ca0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
 ca3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ca6:	8b 55 08             	mov    0x8(%ebp),%edx
 ca9:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
 cac:	8b 45 f0             	mov    -0x10(%ebp),%eax
 caf:	83 c0 08             	add    $0x8,%eax
 cb2:	89 04 24             	mov    %eax,(%esp)
 cb5:	e8 ce fe ff ff       	call   b88 <free>
  return freep;
 cba:	a1 d0 11 00 00       	mov    0x11d0,%eax
}
 cbf:	c9                   	leave  
 cc0:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 cca:	83 c0 07             	add    $0x7,%eax
 ccd:	c1 e8 03             	shr    $0x3,%eax
 cd0:	40                   	inc    %eax
 cd1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 cd4:	a1 d0 11 00 00       	mov    0x11d0,%eax
 cd9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 cdc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 ce0:	75 23                	jne    d05 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 ce2:	c7 45 f0 c8 11 00 00 	movl   $0x11c8,-0x10(%ebp)
 ce9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 cec:	a3 d0 11 00 00       	mov    %eax,0x11d0
 cf1:	a1 d0 11 00 00       	mov    0x11d0,%eax
 cf6:	a3 c8 11 00 00       	mov    %eax,0x11c8
    base.s.size = 0;
 cfb:	c7 05 cc 11 00 00 00 	movl   $0x0,0x11cc
 d02:	00 00 00 
  }
 ...
 d98:	e9 70 ff ff ff       	jmp    d0d <malloc+0x4c>
}
 d9d:	c9                   	leave  
 d9e:	c3                   	ret    
