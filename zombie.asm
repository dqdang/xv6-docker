...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  a7:	c7 44 24 04 17 0d 00 	movl   $0xd17,0x4(%esp)
  ae:	00 
  af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b6:	e8 96 08 00 00       	call   951 <printf>
        exit();
  ...
  e3:	c7 44 24 04 32 0d 00 	movl   $0xd32,0x4(%esp)
  ea:	00 
  eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f2:	e8 5a 08 00 00       	call   951 <printf>
        exit();
...
strtok(char *s, const char *delim)
{
 ...
 391:	75 08                	jne    39b <strtok+0x15>
  s = lasts;
 393:	a1 44 11 00 00       	mov    0x1144,%eax
 ...
 3e8:	a3 44 11 00 00       	mov    %eax,0x1144
    if (*lasts != 0)
 3ed:	a1 44 11 00 00       	mov    0x1144,%eax
 3f2:	8a 00                	mov    (%eax),%al
 3f4:	84 c0                	test   %al,%al
 3f6:	74 11                	je     409 <strtok+0x83>
  *lasts++ = 0;
 3f8:	a1 44 11 00 00       	mov    0x1144,%eax
 3fd:	8d 50 01             	lea    0x1(%eax),%edx
 400:	89 15 44 11 00 00    	mov    %edx,0x1144
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 582:	eb 22                	jmp    5a6 <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 584:	8a 86 e0 10 00 00    	mov    0x10e0(%esi),%al
 ...
 5b7:	eb 25                	jmp    5de <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 5b9:	8a 86 e0 10 00 00    	mov    0x10e0(%esi),%al
...
0000089c <printint>:
 ...
 89f:	56                   	push   %esi
 8a0:	53                   	push   %ebx
 8a1:	83 ec 30             	sub    $0x30,%esp
 8a4:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 8ab:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 8af:	74 17                	je     8c8 <printint+0x2c>
 8b1:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 8b5:	79 11                	jns    8c8 <printint+0x2c>
 8b7:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
 8be:	8b 45 0c             	mov    0xc(%ebp),%eax
 8c1:	f7 d8                	neg    %eax
 8c3:	89 45 ec             	mov    %eax,-0x14(%ebp)
 8c6:	eb 06                	jmp    8ce <printint+0x32>
 8c8:	8b 45 0c             	mov    0xc(%ebp),%eax
 8cb:	89 45 ec             	mov    %eax,-0x14(%ebp)
 8ce:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 8d5:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 8d8:	8d 41 01             	lea    0x1(%ecx),%eax
 8db:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8de:	8b 5d 10             	mov    0x10(%ebp),%ebx
 8e1:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8e4:	ba 00 00 00 00       	mov    $0x0,%edx
 8e9:	f7 f3                	div    %ebx
 8eb:	89 d0                	mov    %edx,%eax
 8ed:	8a 80 2c 11 00 00    	mov    0x112c(%eax),%al
 8f3:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
 8f7:	8b 75 10             	mov    0x10(%ebp),%esi
 ...
 90b:	75 c8                	jne    8d5 <printint+0x39>
 90d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 911:	74 10                	je     923 <printint+0x87>
 913:	8b 45 f4             	mov    -0xc(%ebp),%eax
 916:	8d 50 01             	lea    0x1(%eax),%edx
 919:	89 55 f4             	mov    %edx,-0xc(%ebp)
 91c:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
 921:	eb 1e                	jmp    941 <printint+0xa5>
 923:	eb 1c                	jmp    941 <printint+0xa5>
 925:	8d 55 dc             	lea    -0x24(%ebp),%edx
 ...
 93c:	e8 33 ff ff ff       	call   874 <putc>
 941:	ff 4d f4             	decl   -0xc(%ebp)
 944:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 948:	79 db                	jns    925 <printint+0x89>
 94a:	83 c4 30             	add    $0x30,%esp
 94d:	5b                   	pop    %ebx
 94e:	5e                   	pop    %esi
 94f:	5d                   	pop    %ebp
 950:	c3                   	ret    
...
00000951 <printf>:
 ...
 954:	83 ec 38             	sub    $0x38,%esp
 957:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
 95e:	8d 45 0c             	lea    0xc(%ebp),%eax
 961:	83 c0 04             	add    $0x4,%eax
 964:	89 45 e8             	mov    %eax,-0x18(%ebp)
 967:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 96e:	e9 77 01 00 00       	jmp    aea <printf+0x199>
 973:	8b 55 0c             	mov    0xc(%ebp),%edx
 976:	8b 45 f0             	mov    -0x10(%ebp),%eax
 979:	01 d0                	add    %edx,%eax
 97b:	8a 00                	mov    (%eax),%al
 97d:	0f be c0             	movsbl %al,%eax
 980:	25 ff 00 00 00       	and    $0xff,%eax
 985:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 988:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 98c:	75 2c                	jne    9ba <printf+0x69>
 98e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 992:	75 0c                	jne    9a0 <printf+0x4f>
 994:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 99b:	e9 47 01 00 00       	jmp    ae7 <printf+0x196>
 ...
 9b0:	e8 bf fe ff ff       	call   874 <putc>
 9b5:	e9 2d 01 00 00       	jmp    ae7 <printf+0x196>
 9ba:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 9be:	0f 85 23 01 00 00    	jne    ae7 <printf+0x196>
 9c4:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 9c8:	75 2d                	jne    9f7 <printf+0xa6>
 9ca:	8b 45 e8             	mov    -0x18(%ebp),%eax
 9cd:	8b 00                	mov    (%eax),%eax
 9cf:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 9d6:	00 
 9d7:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 9de:	00 
 9df:	89 44 24 04          	mov    %eax,0x4(%esp)
 9e3:	8b 45 08             	mov    0x8(%ebp),%eax
 9e6:	89 04 24             	mov    %eax,(%esp)
 9e9:	e8 ae fe ff ff       	call   89c <printint>
 9ee:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 9f2:	e9 e9 00 00 00       	jmp    ae0 <printf+0x18f>
 9f7:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 9fb:	74 06                	je     a03 <printf+0xb2>
 9fd:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 a01:	75 2d                	jne    a30 <printf+0xdf>
 a03:	8b 45 e8             	mov    -0x18(%ebp),%eax
 a06:	8b 00                	mov    (%eax),%eax
 a08:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 a0f:	00 
 a10:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 a17:	00 
 a18:	89 44 24 04          	mov    %eax,0x4(%esp)
 a1c:	8b 45 08             	mov    0x8(%ebp),%eax
 a1f:	89 04 24             	mov    %eax,(%esp)
 a22:	e8 75 fe ff ff       	call   89c <printint>
 a27:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 a2b:	e9 b0 00 00 00       	jmp    ae0 <printf+0x18f>
 a30:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 a34:	75 42                	jne    a78 <printf+0x127>
 a36:	8b 45 e8             	mov    -0x18(%ebp),%eax
 a39:	8b 00                	mov    (%eax),%eax
 a3b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 a3e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 a42:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a46:	75 09                	jne    a51 <printf+0x100>
 a48:	c7 45 f4 4e 0d 00 00 	movl   $0xd4e,-0xc(%ebp)
 a4f:	eb 1c                	jmp    a6d <printf+0x11c>
 a51:	eb 1a                	jmp    a6d <printf+0x11c>
 a53:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a56:	8a 00                	mov    (%eax),%al
 a58:	0f be c0             	movsbl %al,%eax
 a5b:	89 44 24 04          	mov    %eax,0x4(%esp)
 a5f:	8b 45 08             	mov    0x8(%ebp),%eax
 a62:	89 04 24             	mov    %eax,(%esp)
 a65:	e8 0a fe ff ff       	call   874 <putc>
 a6a:	ff 45 f4             	incl   -0xc(%ebp)
 a6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a70:	8a 00                	mov    (%eax),%al
 a72:	84 c0                	test   %al,%al
 a74:	75 dd                	jne    a53 <printf+0x102>
 a76:	eb 68                	jmp    ae0 <printf+0x18f>
 a78:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 a7c:	75 1d                	jne    a9b <printf+0x14a>
 ...
 a90:	e8 df fd ff ff       	call   874 <putc>
 a95:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 a99:	eb 45                	jmp    ae0 <printf+0x18f>
 a9b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a9f:	75 17                	jne    ab8 <printf+0x167>
 aa1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 aa4:	0f be c0             	movsbl %al,%eax
 aa7:	89 44 24 04          	mov    %eax,0x4(%esp)
 aab:	8b 45 08             	mov    0x8(%ebp),%eax
 aae:	89 04 24             	mov    %eax,(%esp)
 ab1:	e8 be fd ff ff       	call   874 <putc>
 ab6:	eb 28                	jmp    ae0 <printf+0x18f>
 ab8:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 abf:	00 
 ac0:	8b 45 08             	mov    0x8(%ebp),%eax
 ac3:	89 04 24             	mov    %eax,(%esp)
 ac6:	e8 a9 fd ff ff       	call   874 <putc>
 ...
 adb:	e8 94 fd ff ff       	call   874 <putc>
 ae0:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
 ae7:	ff 45 f0             	incl   -0x10(%ebp)
 aea:	8b 55 0c             	mov    0xc(%ebp),%edx
 aed:	8b 45 f0             	mov    -0x10(%ebp),%eax
 af0:	01 d0                	add    %edx,%eax
 af2:	8a 00                	mov    (%eax),%al
 af4:	84 c0                	test   %al,%al
 af6:	0f 85 77 fe ff ff    	jne    973 <printf+0x22>
 afc:	c9                   	leave  
 afd:	c3                   	ret    
 afe:	90                   	nop
 aff:	90                   	nop
...
00000b00 <free>:
 ...
 b0f:	a1 50 11 00 00       	mov    0x1150,%eax
 ...
 bda:	a3 50 11 00 00       	mov    %eax,0x1150
 bdf:	c9                   	leave  
 be0:	c3                   	ret    
...
00000be1 <morecore>:
 ...
 c00:	e8 57 fc ff ff       	call   85c <sbrk>
 ...
 c32:	a1 50 11 00 00       	mov    0x1150,%eax
 c37:	c9                   	leave  
 c38:	c3                   	ret    
...
00000c39 <malloc>:
 ...
 c4c:	a1 50 11 00 00       	mov    0x1150,%eax
 c51:	89 45 f0             	mov    %eax,-0x10(%ebp)
 c54:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 c58:	75 23                	jne    c7d <malloc+0x44>
 c5a:	c7 45 f0 48 11 00 00 	movl   $0x1148,-0x10(%ebp)
 c61:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c64:	a3 50 11 00 00       	mov    %eax,0x1150
 c69:	a1 50 11 00 00       	mov    0x1150,%eax
 c6e:	a3 48 11 00 00       	mov    %eax,0x1148
 c73:	c7 05 4c 11 00 00 00 	movl   $0x0,0x114c
 c7a:	00 00 00 
 ...
 cbe:	c1 e0 03             	shl    $0x3,%eax
 cc1:	01 45 f4             	add    %eax,-0xc(%ebp)
 cc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
 cc7:	8b 55 ec             	mov    -0x14(%ebp),%edx
 cca:	89 50 04             	mov    %edx,0x4(%eax)
 ccd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 cd0:	a3 50 11 00 00       	mov    %eax,0x1150
 cd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 cd8:	83 c0 08             	add    $0x8,%eax
 cdb:	eb 38                	jmp    d15 <malloc+0xdc>
 cdd:	a1 50 11 00 00       	mov    0x1150,%eax
 ce2:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 ce5:	75 1b                	jne    d02 <malloc+0xc9>
 ce7:	8b 45 ec             	mov    -0x14(%ebp),%eax
 cea:	89 04 24             	mov    %eax,(%esp)
 ced:	e8 ef fe ff ff       	call   be1 <morecore>
 cf2:	89 45 f4             	mov    %eax,-0xc(%ebp)
 cf5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 cf9:	75 07                	jne    d02 <malloc+0xc9>
 cfb:	b8 00 00 00 00       	mov    $0x0,%eax
 d00:	eb 13                	jmp    d15 <malloc+0xdc>
 ...
 d10:	e9 70 ff ff ff       	jmp    c85 <malloc+0x4c>
 d15:	c9                   	leave  
 d16:	c3                   	ret    
