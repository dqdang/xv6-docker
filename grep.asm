...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    buf[m] = '\0';
      ...
      1b:	05 00 16 00 00       	add    $0x1600,%eax
      20:	c6 00 00             	movb   $0x0,(%eax)
    p = buf;
      23:	c7 45 f0 00 16 00 00 	movl   $0x1600,-0x10(%ebp)
    while((q = strchr(p, '\n')) != 0){
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    if(p == buf)
      95:	81 7d f0 00 16 00 00 	cmpl   $0x1600,-0x10(%ebp)
    ...
    if(m > 0){
      ...
      m -= p - buf;
      ab:	ba 00 16 00 00       	mov    $0x1600,%edx
      ...
      c8:	c7 04 24 00 16 00 00 	movl   $0x1600,(%esp)
      cf:	e8 dd 09 00 00       	call   ab1 <memmove>
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
      ...
      e3:	81 c2 00 16 00 00    	add    $0x1600,%edx
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    printf(2, "usage: grep pattern [file ...]\n");
     11a:	c7 44 24 04 f4 10 00 	movl   $0x10f4,0x4(%esp)
     121:	00 
     122:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     129:	e8 ff 0b 00 00       	call   d2d <printf>
    exit();
  ...
  for(i = 2; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1ac:	c7 44 24 04 14 11 00 	movl   $0x1114,0x4(%esp)
     1b3:	00 
     1b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1bb:	e8 6d 0b 00 00       	call   d2d <printf>
      exit();
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
     ...
     3c2:	79 20                	jns    3e4 <copy+0x49>
  {
     ...
     3cb:	c7 44 24 04 2a 11 00 	movl   $0x112a,0x4(%esp)
     3d2:	00 
     3d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     3da:	e8 4e 09 00 00       	call   d2d <printf>
      exit();
     ...
     3fe:	79 20                	jns    420 <copy+0x85>
  {
     ...
     407:	c7 44 24 04 45 11 00 	movl   $0x1145,0x4(%esp)
     40e:	00 
     40f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     416:	e8 12 09 00 00       	call   d2d <printf>
      exit();
...
strtok(char *s, const char *delim)
{
  ...
  s = lasts;
     6b7:	a1 e4 15 00 00       	mov    0x15e4,%eax
  ...
  if ((ch = *s++) == '\0')
    ...
    lasts = s + strcspn(s, delim);
     ...
     70c:	a3 e4 15 00 00       	mov    %eax,0x15e4
    if (*lasts != 0)
     711:	a1 e4 15 00 00       	mov    0x15e4,%eax
     716:	8a 00                	mov    (%eax),%al
     718:	84 c0                	test   %al,%al
     71a:	74 11                	je     72d <strtok+0x83>
  *lasts++ = 0;
     71c:	a1 e4 15 00 00       	mov    0x15e4,%eax
     721:	8d 50 01             	lea    0x1(%eax),%edx
     724:	89 15 e4 15 00 00    	mov    %edx,0x15e4
  ...
  for ( ; ; p += 1) {
    ...
    break;
     8a6:	eb 22                	jmp    8ca <strtoul+0x113>
      ...
      digit = cvtIn[digit];
     8a8:	8a 86 80 15 00 00    	mov    0x1580(%esi),%al
  ...
  for ( ; ; p += 1) {
    ...
    break;
     8db:	eb 25                	jmp    902 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
     8dd:	8a 86 80 15 00 00    	mov    0x1580(%esi),%al
...
00000c40 <getpath>:
SYSCALL(getpath)
     c40:	b8 2b 00 00 00       	mov    $0x2b,%eax
     c45:	cd 40                	int    $0x40
     c47:	c3                   	ret    

00000c48 <setpath>:
SYSCALL(setpath)
     c48:	b8 2c 00 00 00       	mov    $0x2c,%eax
     c4d:	cd 40                	int    $0x40
     c4f:	c3                   	ret    
...
putc(int fd, char c)
{
     ...
     c59:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     c5c:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     c63:	00 
     c64:	8d 45 f4             	lea    -0xc(%ebp),%eax
     c67:	89 44 24 04          	mov    %eax,0x4(%esp)
     c6b:	8b 45 08             	mov    0x8(%ebp),%eax
     c6e:	89 04 24             	mov    %eax,(%esp)
     c71:	e8 a2 fe ff ff       	call   b18 <write>
}
     c76:	c9                   	leave  
     c77:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     c80:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     c87:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     c8b:	74 17                	je     ca4 <printint+0x2c>
     c8d:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     c91:	79 11                	jns    ca4 <printint+0x2c>
    neg = 1;
     c93:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     c9a:	8b 45 0c             	mov    0xc(%ebp),%eax
     c9d:	f7 d8                	neg    %eax
     c9f:	89 45 ec             	mov    %eax,-0x14(%ebp)
     ca2:	eb 06                	jmp    caa <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
     caa:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
     cb1:	8b 4d f4             	mov    -0xc(%ebp),%ecx
     cb4:	8d 41 01             	lea    0x1(%ecx),%eax
     cb7:	89 45 f4             	mov    %eax,-0xc(%ebp)
     cba:	8b 5d 10             	mov    0x10(%ebp),%ebx
     cbd:	8b 45 ec             	mov    -0x14(%ebp),%eax
     cc0:	ba 00 00 00 00       	mov    $0x0,%edx
     cc5:	f7 f3                	div    %ebx
     cc7:	89 d0                	mov    %edx,%eax
     cc9:	8a 80 cc 15 00 00    	mov    0x15cc(%eax),%al
     ccf:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
     cd3:	8b 75 10             	mov    0x10(%ebp),%esi
     cd6:	8b 45 ec             	mov    -0x14(%ebp),%eax
     cd9:	ba 00 00 00 00       	mov    $0x0,%edx
     cde:	f7 f6                	div    %esi
     ce0:	89 45 ec             	mov    %eax,-0x14(%ebp)
     ce3:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     ce7:	75 c8                	jne    cb1 <printint+0x39>
  if(neg)
     ce9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     ced:	74 10                	je     cff <printint+0x87>
    buf[i++] = '-';
     cef:	8b 45 f4             	mov    -0xc(%ebp),%eax
     cf2:	8d 50 01             	lea    0x1(%eax),%edx
     cf5:	89 55 f4             	mov    %edx,-0xc(%ebp)
     cf8:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
     cfd:	eb 1e                	jmp    d1d <printint+0xa5>
     cff:	eb 1c                	jmp    d1d <printint+0xa5>
    putc(fd, buf[i]);
     d01:	8d 55 dc             	lea    -0x24(%ebp),%edx
     d04:	8b 45 f4             	mov    -0xc(%ebp),%eax
     d07:	01 d0                	add    %edx,%eax
     d09:	8a 00                	mov    (%eax),%al
     d0b:	0f be c0             	movsbl %al,%eax
     d0e:	89 44 24 04          	mov    %eax,0x4(%esp)
     d12:	8b 45 08             	mov    0x8(%ebp),%eax
     d15:	89 04 24             	mov    %eax,(%esp)
     d18:	e8 33 ff ff ff       	call   c50 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
     d1d:	ff 4d f4             	decl   -0xc(%ebp)
     d20:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     d24:	79 db                	jns    d01 <printint+0x89>
    putc(fd, buf[i]);
}
     d26:	83 c4 30             	add    $0x30,%esp
     d29:	5b                   	pop    %ebx
     d2a:	5e                   	pop    %esi
     d2b:	5d                   	pop    %ebp
     d2c:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
     ...
     d30:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
     d33:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
     d3a:	8d 45 0c             	lea    0xc(%ebp),%eax
     d3d:	83 c0 04             	add    $0x4,%eax
     d40:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
     d43:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
     d4a:	e9 77 01 00 00       	jmp    ec6 <printf+0x199>
    c = fmt[i] & 0xff;
     d4f:	8b 55 0c             	mov    0xc(%ebp),%edx
     d52:	8b 45 f0             	mov    -0x10(%ebp),%eax
     d55:	01 d0                	add    %edx,%eax
     d57:	8a 00                	mov    (%eax),%al
     d59:	0f be c0             	movsbl %al,%eax
     d5c:	25 ff 00 00 00       	and    $0xff,%eax
     d61:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
     d64:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     d68:	75 2c                	jne    d96 <printf+0x69>
      if(c == '%'){
     d6a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     d6e:	75 0c                	jne    d7c <printf+0x4f>
        state = '%';
     d70:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
     d77:	e9 47 01 00 00       	jmp    ec3 <printf+0x196>
      } else {
        putc(fd, c);
     d7c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     d7f:	0f be c0             	movsbl %al,%eax
     d82:	89 44 24 04          	mov    %eax,0x4(%esp)
     d86:	8b 45 08             	mov    0x8(%ebp),%eax
     d89:	89 04 24             	mov    %eax,(%esp)
     d8c:	e8 bf fe ff ff       	call   c50 <putc>
     d91:	e9 2d 01 00 00       	jmp    ec3 <printf+0x196>
      }
    } else if(state == '%'){
     d96:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
     d9a:	0f 85 23 01 00 00    	jne    ec3 <printf+0x196>
      if(c == 'd'){
     da0:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
     da4:	75 2d                	jne    dd3 <printf+0xa6>
        printint(fd, *ap, 10, 1);
     da6:	8b 45 e8             	mov    -0x18(%ebp),%eax
     da9:	8b 00                	mov    (%eax),%eax
     dab:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
     db2:	00 
     db3:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     dba:	00 
     dbb:	89 44 24 04          	mov    %eax,0x4(%esp)
     dbf:	8b 45 08             	mov    0x8(%ebp),%eax
     dc2:	89 04 24             	mov    %eax,(%esp)
     dc5:	e8 ae fe ff ff       	call   c78 <printint>
        ap++;
     dca:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     dce:	e9 e9 00 00 00       	jmp    ebc <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
     dd3:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
     dd7:	74 06                	je     ddf <printf+0xb2>
     dd9:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
     ddd:	75 2d                	jne    e0c <printf+0xdf>
        printint(fd, *ap, 16, 0);
     ddf:	8b 45 e8             	mov    -0x18(%ebp),%eax
     de2:	8b 00                	mov    (%eax),%eax
     de4:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
     deb:	00 
     dec:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
     df3:	00 
     df4:	89 44 24 04          	mov    %eax,0x4(%esp)
     df8:	8b 45 08             	mov    0x8(%ebp),%eax
     dfb:	89 04 24             	mov    %eax,(%esp)
     dfe:	e8 75 fe ff ff       	call   c78 <printint>
        ap++;
     e03:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     e07:	e9 b0 00 00 00       	jmp    ebc <printf+0x18f>
      } else if(c == 's'){
     e0c:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
     e10:	75 42                	jne    e54 <printf+0x127>
        s = (char*)*ap;
     e12:	8b 45 e8             	mov    -0x18(%ebp),%eax
     e15:	8b 00                	mov    (%eax),%eax
     e17:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
     e1a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
     e1e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     e22:	75 09                	jne    e2d <printf+0x100>
          s = "(null)";
     e24:	c7 45 f4 61 11 00 00 	movl   $0x1161,-0xc(%ebp)
        while(*s != 0){
     e2b:	eb 1c                	jmp    e49 <printf+0x11c>
     e2d:	eb 1a                	jmp    e49 <printf+0x11c>
          putc(fd, *s);
     ...
     e41:	e8 0a fe ff ff       	call   c50 <putc>
          s++;
     e46:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
     ...
     e50:	75 dd                	jne    e2f <printf+0x102>
     e52:	eb 68                	jmp    ebc <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
     e54:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
     e58:	75 1d                	jne    e77 <printf+0x14a>
        putc(fd, *ap);
     e5a:	8b 45 e8             	mov    -0x18(%ebp),%eax
     e5d:	8b 00                	mov    (%eax),%eax
     e5f:	0f be c0             	movsbl %al,%eax
     e62:	89 44 24 04          	mov    %eax,0x4(%esp)
     e66:	8b 45 08             	mov    0x8(%ebp),%eax
     e69:	89 04 24             	mov    %eax,(%esp)
     e6c:	e8 df fd ff ff       	call   c50 <putc>
        ap++;
     e71:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     e75:	eb 45                	jmp    ebc <printf+0x18f>
      } else if(c == '%'){
     e77:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     e7b:	75 17                	jne    e94 <printf+0x167>
        putc(fd, c);
     e7d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     e80:	0f be c0             	movsbl %al,%eax
     e83:	89 44 24 04          	mov    %eax,0x4(%esp)
     e87:	8b 45 08             	mov    0x8(%ebp),%eax
     e8a:	89 04 24             	mov    %eax,(%esp)
     e8d:	e8 be fd ff ff       	call   c50 <putc>
     e92:	eb 28                	jmp    ebc <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
     e94:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
     e9b:	00 
     e9c:	8b 45 08             	mov    0x8(%ebp),%eax
     e9f:	89 04 24             	mov    %eax,(%esp)
     ea2:	e8 a9 fd ff ff       	call   c50 <putc>
        putc(fd, c);
     ...
     eb7:	e8 94 fd ff ff       	call   c50 <putc>
      }
      state = 0;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     ec3:	ff 45 f0             	incl   -0x10(%ebp)
     ec6:	8b 55 0c             	mov    0xc(%ebp),%edx
     ec9:	8b 45 f0             	mov    -0x10(%ebp),%eax
     ecc:	01 d0                	add    %edx,%eax
     ece:	8a 00                	mov    (%eax),%al
     ed0:	84 c0                	test   %al,%al
     ed2:	0f 85 77 fe ff ff    	jne    d4f <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
     ...
     edf:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
     ee2:	8b 45 08             	mov    0x8(%ebp),%eax
     ee5:	83 e8 08             	sub    $0x8,%eax
     ee8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     eeb:	a1 f0 15 00 00       	mov    0x15f0,%eax
     ef0:	89 45 fc             	mov    %eax,-0x4(%ebp)
     ef3:	eb 24                	jmp    f19 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     ef5:	8b 45 fc             	mov    -0x4(%ebp),%eax
     ef8:	8b 00                	mov    (%eax),%eax
     efa:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     efd:	77 12                	ja     f11 <free+0x35>
     eff:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f02:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     f05:	77 24                	ja     f2b <free+0x4f>
     f07:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f0a:	8b 00                	mov    (%eax),%eax
     f0c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f0f:	77 1a                	ja     f2b <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     f19:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f1c:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     f1f:	76 d4                	jbe    ef5 <free+0x19>
     f21:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f24:	8b 00                	mov    (%eax),%eax
     f26:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f29:	76 ca                	jbe    ef5 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
     f2b:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f2e:	8b 40 04             	mov    0x4(%eax),%eax
     f31:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f38:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f3b:	01 c2                	add    %eax,%edx
     f3d:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f40:	8b 00                	mov    (%eax),%eax
     f42:	39 c2                	cmp    %eax,%edx
     f44:	75 24                	jne    f6a <free+0x8e>
    ...
    bp->s.ptr = p->s.ptr->s.ptr;
     ...
     f68:	eb 0a                	jmp    f74 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
     f6a:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f6d:	8b 10                	mov    (%eax),%edx
     f6f:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f72:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
     f74:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f77:	8b 40 04             	mov    0x4(%eax),%eax
     f7a:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f81:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f84:	01 d0                	add    %edx,%eax
     f86:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f89:	75 20                	jne    fab <free+0xcf>
    p->s.size += bp->s.size;
     f8b:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f8e:	8b 50 04             	mov    0x4(%eax),%edx
     f91:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f94:	8b 40 04             	mov    0x4(%eax),%eax
     f97:	01 c2                	add    %eax,%edx
     f99:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f9c:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
     f9f:	8b 45 f8             	mov    -0x8(%ebp),%eax
     fa2:	8b 10                	mov    (%eax),%edx
     fa4:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fa7:	89 10                	mov    %edx,(%eax)
     fa9:	eb 08                	jmp    fb3 <free+0xd7>
  } else
    p->s.ptr = bp;
     fab:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fae:	8b 55 f8             	mov    -0x8(%ebp),%edx
     fb1:	89 10                	mov    %edx,(%eax)
  freep = p;
     fb3:	8b 45 fc             	mov    -0x4(%ebp),%eax
     fb6:	a3 f0 15 00 00       	mov    %eax,0x15f0
}
     fbb:	c9                   	leave  
     fbc:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
     fc3:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
     fca:	77 07                	ja     fd3 <morecore+0x16>
    nu = 4096;
     fcc:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
     fd3:	8b 45 08             	mov    0x8(%ebp),%eax
     fd6:	c1 e0 03             	shl    $0x3,%eax
     fd9:	89 04 24             	mov    %eax,(%esp)
     fdc:	e8 9f fb ff ff       	call   b80 <sbrk>
     fe1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
     fe4:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
     fe8:	75 07                	jne    ff1 <morecore+0x34>
    return 0;
     fea:	b8 00 00 00 00       	mov    $0x0,%eax
     fef:	eb 22                	jmp    1013 <morecore+0x56>
  hp = (Header*)p;
     ff1:	8b 45 f4             	mov    -0xc(%ebp),%eax
     ff4:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
     ff7:	8b 45 f0             	mov    -0x10(%ebp),%eax
     ffa:	8b 55 08             	mov    0x8(%ebp),%edx
     ffd:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1000:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1003:	83 c0 08             	add    $0x8,%eax
    1006:	89 04 24             	mov    %eax,(%esp)
    1009:	e8 ce fe ff ff       	call   edc <free>
  return freep;
    100e:	a1 f0 15 00 00       	mov    0x15f0,%eax
}
    1013:	c9                   	leave  
    1014:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    101e:	83 c0 07             	add    $0x7,%eax
    1021:	c1 e8 03             	shr    $0x3,%eax
    1024:	40                   	inc    %eax
    1025:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1028:	a1 f0 15 00 00       	mov    0x15f0,%eax
    102d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1030:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1034:	75 23                	jne    1059 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1036:	c7 45 f0 e8 15 00 00 	movl   $0x15e8,-0x10(%ebp)
    103d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1040:	a3 f0 15 00 00       	mov    %eax,0x15f0
    1045:	a1 f0 15 00 00       	mov    0x15f0,%eax
    104a:	a3 e8 15 00 00       	mov    %eax,0x15e8
    base.s.size = 0;
    104f:	c7 05 ec 15 00 00 00 	movl   $0x0,0x15ec
    1056:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1064:	8b 40 04             	mov    0x4(%eax),%eax
    1067:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    106a:	72 4d                	jb     10b9 <malloc+0xa4>
      if(p->s.size == nunits)
    106c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    106f:	8b 40 04             	mov    0x4(%eax),%eax
    1072:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1075:	75 0c                	jne    1083 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    1077:	8b 45 f4             	mov    -0xc(%ebp),%eax
    107a:	8b 10                	mov    (%eax),%edx
    107c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    107f:	89 10                	mov    %edx,(%eax)
    1081:	eb 26                	jmp    10a9 <malloc+0x94>
      else {
        p->s.size -= nunits;
    1083:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1086:	8b 40 04             	mov    0x4(%eax),%eax
    1089:	2b 45 ec             	sub    -0x14(%ebp),%eax
    ...
    109d:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    10a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10a3:	8b 55 ec             	mov    -0x14(%ebp),%edx
    10a6:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    10a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    10ac:	a3 f0 15 00 00       	mov    %eax,0x15f0
      return (void*)(p + 1);
    10b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10b4:	83 c0 08             	add    $0x8,%eax
    10b7:	eb 38                	jmp    10f1 <malloc+0xdc>
    }
    if(p == freep)
    10b9:	a1 f0 15 00 00       	mov    0x15f0,%eax
    10be:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    10c1:	75 1b                	jne    10de <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    10c3:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10c6:	89 04 24             	mov    %eax,(%esp)
    10c9:	e8 ef fe ff ff       	call   fbd <morecore>
    10ce:	89 45 f4             	mov    %eax,-0xc(%ebp)
    10d1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    10d5:	75 07                	jne    10de <malloc+0xc9>
        return 0;
    10d7:	b8 00 00 00 00       	mov    $0x0,%eax
    10dc:	eb 13                	jmp    10f1 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10e1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    10ec:	e9 70 ff ff ff       	jmp    1061 <malloc+0x4c>
}
    10f1:	c9                   	leave  
    10f2:	c3                   	ret    
