...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    buf[m] = '\0';
      ...
      1b:	05 c0 15 00 00       	add    $0x15c0,%eax
      20:	c6 00 00             	movb   $0x0,(%eax)
    p = buf;
      23:	c7 45 f0 c0 15 00 00 	movl   $0x15c0,-0x10(%ebp)
    while((q = strchr(p, '\n')) != 0){
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    if(p == buf)
      95:	81 7d f0 c0 15 00 00 	cmpl   $0x15c0,-0x10(%ebp)
    ...
    if(m > 0){
      ...
      m -= p - buf;
      ab:	ba c0 15 00 00       	mov    $0x15c0,%edx
      ...
      c8:	c7 04 24 c0 15 00 00 	movl   $0x15c0,(%esp)
      cf:	e8 dd 09 00 00       	call   ab1 <memmove>
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
      ...
      e3:	81 c2 c0 15 00 00    	add    $0x15c0,%edx
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    printf(2, "usage: grep pattern [file ...]\n");
     11a:	c7 44 24 04 c4 10 00 	movl   $0x10c4,0x4(%esp)
     121:	00 
     122:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     129:	e8 cf 0b 00 00       	call   cfd <printf>
    exit();
  ...
  for(i = 2; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1ac:	c7 44 24 04 e4 10 00 	movl   $0x10e4,0x4(%esp)
     1b3:	00 
     1b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     1bb:	e8 3d 0b 00 00       	call   cfd <printf>
      exit();
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
     ...
     3c2:	79 20                	jns    3e4 <copy+0x49>
  {
     ...
     3cb:	c7 44 24 04 fa 10 00 	movl   $0x10fa,0x4(%esp)
     3d2:	00 
     3d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     3da:	e8 1e 09 00 00       	call   cfd <printf>
      exit();
     ...
     3fe:	79 20                	jns    420 <copy+0x85>
  {
     ...
     407:	c7 44 24 04 15 11 00 	movl   $0x1115,0x4(%esp)
     40e:	00 
     40f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     416:	e8 e2 08 00 00       	call   cfd <printf>
      exit();
...
strtok(char *s, const char *delim)
{
  ...
  s = lasts;
     6b7:	a1 a4 15 00 00       	mov    0x15a4,%eax
  ...
  if ((ch = *s++) == '\0')
    ...
    lasts = s + strcspn(s, delim);
     ...
     70c:	a3 a4 15 00 00       	mov    %eax,0x15a4
    if (*lasts != 0)
     711:	a1 a4 15 00 00       	mov    0x15a4,%eax
     716:	8a 00                	mov    (%eax),%al
     718:	84 c0                	test   %al,%al
     71a:	74 11                	je     72d <strtok+0x83>
  *lasts++ = 0;
     71c:	a1 a4 15 00 00       	mov    0x15a4,%eax
     721:	8d 50 01             	lea    0x1(%eax),%edx
     724:	89 15 a4 15 00 00    	mov    %edx,0x15a4
  ...
  for ( ; ; p += 1) {
    ...
    break;
     8a6:	eb 22                	jmp    8ca <strtoul+0x113>
      ...
      digit = cvtIn[digit];
     8a8:	8a 86 40 15 00 00    	mov    0x1540(%esi),%al
  ...
  for ( ; ; p += 1) {
    ...
    break;
     8db:	eb 25                	jmp    902 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
     8dd:	8a 86 40 15 00 00    	mov    0x1540(%esi),%al
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     c50:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     c57:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     c5b:	74 17                	je     c74 <printint+0x2c>
     c5d:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     c61:	79 11                	jns    c74 <printint+0x2c>
    neg = 1;
     c63:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     c6a:	8b 45 0c             	mov    0xc(%ebp),%eax
     c6d:	f7 d8                	neg    %eax
     c6f:	89 45 ec             	mov    %eax,-0x14(%ebp)
     c72:	eb 06                	jmp    c7a <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     c81:	8b 4d f4             	mov    -0xc(%ebp),%ecx
     c84:	8d 41 01             	lea    0x1(%ecx),%eax
     c87:	89 45 f4             	mov    %eax,-0xc(%ebp)
     c8a:	8b 5d 10             	mov    0x10(%ebp),%ebx
     c8d:	8b 45 ec             	mov    -0x14(%ebp),%eax
     c90:	ba 00 00 00 00       	mov    $0x0,%edx
     c95:	f7 f3                	div    %ebx
     c97:	89 d0                	mov    %edx,%eax
     c99:	8a 80 8c 15 00 00    	mov    0x158c(%eax),%al
     c9f:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
     ...
     cb7:	75 c8                	jne    c81 <printint+0x39>
  if(neg)
     cb9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     cbd:	74 10                	je     ccf <printint+0x87>
    buf[i++] = '-';
     cbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
     cc2:	8d 50 01             	lea    0x1(%eax),%edx
     cc5:	89 55 f4             	mov    %edx,-0xc(%ebp)
     cc8:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
     ccd:	eb 1e                	jmp    ced <printint+0xa5>
     ccf:	eb 1c                	jmp    ced <printint+0xa5>
    putc(fd, buf[i]);
     cd1:	8d 55 dc             	lea    -0x24(%ebp),%edx
     ...
     ce8:	e8 33 ff ff ff       	call   c20 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
     ced:	ff 4d f4             	decl   -0xc(%ebp)
     cf0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     cf4:	79 db                	jns    cd1 <printint+0x89>
    putc(fd, buf[i]);
}
     cf6:	83 c4 30             	add    $0x30,%esp
     cf9:	5b                   	pop    %ebx
     cfa:	5e                   	pop    %esi
     cfb:	5d                   	pop    %ebp
     cfc:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
     ...
     d00:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
     d03:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
     d0a:	8d 45 0c             	lea    0xc(%ebp),%eax
     d0d:	83 c0 04             	add    $0x4,%eax
     d10:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
     d13:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
     d1a:	e9 77 01 00 00       	jmp    e96 <printf+0x199>
    c = fmt[i] & 0xff;
     d1f:	8b 55 0c             	mov    0xc(%ebp),%edx
     d22:	8b 45 f0             	mov    -0x10(%ebp),%eax
     d25:	01 d0                	add    %edx,%eax
     d27:	8a 00                	mov    (%eax),%al
     d29:	0f be c0             	movsbl %al,%eax
     d2c:	25 ff 00 00 00       	and    $0xff,%eax
     d31:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
     d34:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     d38:	75 2c                	jne    d66 <printf+0x69>
      if(c == '%'){
     d3a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     d3e:	75 0c                	jne    d4c <printf+0x4f>
        state = '%';
     d40:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
     d47:	e9 47 01 00 00       	jmp    e93 <printf+0x196>
      } else {
        putc(fd, c);
     d4c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     d4f:	0f be c0             	movsbl %al,%eax
     d52:	89 44 24 04          	mov    %eax,0x4(%esp)
     d56:	8b 45 08             	mov    0x8(%ebp),%eax
     d59:	89 04 24             	mov    %eax,(%esp)
     d5c:	e8 bf fe ff ff       	call   c20 <putc>
     d61:	e9 2d 01 00 00       	jmp    e93 <printf+0x196>
      }
    } else if(state == '%'){
     d66:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
     d6a:	0f 85 23 01 00 00    	jne    e93 <printf+0x196>
      if(c == 'd'){
     d70:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
     d74:	75 2d                	jne    da3 <printf+0xa6>
        printint(fd, *ap, 10, 1);
     d76:	8b 45 e8             	mov    -0x18(%ebp),%eax
     d79:	8b 00                	mov    (%eax),%eax
     d7b:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
     d82:	00 
     d83:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     d8a:	00 
     d8b:	89 44 24 04          	mov    %eax,0x4(%esp)
     d8f:	8b 45 08             	mov    0x8(%ebp),%eax
     d92:	89 04 24             	mov    %eax,(%esp)
     d95:	e8 ae fe ff ff       	call   c48 <printint>
        ap++;
     d9a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     d9e:	e9 e9 00 00 00       	jmp    e8c <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
     da3:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
     da7:	74 06                	je     daf <printf+0xb2>
     da9:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
     dad:	75 2d                	jne    ddc <printf+0xdf>
        printint(fd, *ap, 16, 0);
     daf:	8b 45 e8             	mov    -0x18(%ebp),%eax
     db2:	8b 00                	mov    (%eax),%eax
     db4:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
     dbb:	00 
     dbc:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
     dc3:	00 
     dc4:	89 44 24 04          	mov    %eax,0x4(%esp)
     dc8:	8b 45 08             	mov    0x8(%ebp),%eax
     dcb:	89 04 24             	mov    %eax,(%esp)
     dce:	e8 75 fe ff ff       	call   c48 <printint>
        ap++;
     dd3:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     dd7:	e9 b0 00 00 00       	jmp    e8c <printf+0x18f>
      } else if(c == 's'){
     ddc:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
     de0:	75 42                	jne    e24 <printf+0x127>
        s = (char*)*ap;
     de2:	8b 45 e8             	mov    -0x18(%ebp),%eax
     de5:	8b 00                	mov    (%eax),%eax
     de7:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
     dea:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
     dee:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     df2:	75 09                	jne    dfd <printf+0x100>
          s = "(null)";
     df4:	c7 45 f4 31 11 00 00 	movl   $0x1131,-0xc(%ebp)
        while(*s != 0){
     dfb:	eb 1c                	jmp    e19 <printf+0x11c>
     dfd:	eb 1a                	jmp    e19 <printf+0x11c>
          putc(fd, *s);
     ...
     e11:	e8 0a fe ff ff       	call   c20 <putc>
          s++;
     e16:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
     ...
     e1c:	8a 00                	mov    (%eax),%al
     e1e:	84 c0                	test   %al,%al
     e20:	75 dd                	jne    dff <printf+0x102>
     e22:	eb 68                	jmp    e8c <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
     e24:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
     e28:	75 1d                	jne    e47 <printf+0x14a>
        putc(fd, *ap);
     e2a:	8b 45 e8             	mov    -0x18(%ebp),%eax
     e2d:	8b 00                	mov    (%eax),%eax
     e2f:	0f be c0             	movsbl %al,%eax
     e32:	89 44 24 04          	mov    %eax,0x4(%esp)
     e36:	8b 45 08             	mov    0x8(%ebp),%eax
     e39:	89 04 24             	mov    %eax,(%esp)
     e3c:	e8 df fd ff ff       	call   c20 <putc>
        ap++;
     e41:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
     e45:	eb 45                	jmp    e8c <printf+0x18f>
      } else if(c == '%'){
     e47:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
     e4b:	75 17                	jne    e64 <printf+0x167>
        putc(fd, c);
     e4d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     e50:	0f be c0             	movsbl %al,%eax
     e53:	89 44 24 04          	mov    %eax,0x4(%esp)
     e57:	8b 45 08             	mov    0x8(%ebp),%eax
     e5a:	89 04 24             	mov    %eax,(%esp)
     e5d:	e8 be fd ff ff       	call   c20 <putc>
     e62:	eb 28                	jmp    e8c <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
     e64:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
     e6b:	00 
     e6c:	8b 45 08             	mov    0x8(%ebp),%eax
     e6f:	89 04 24             	mov    %eax,(%esp)
     e72:	e8 a9 fd ff ff       	call   c20 <putc>
        putc(fd, c);
     e77:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     e7a:	0f be c0             	movsbl %al,%eax
     e7d:	89 44 24 04          	mov    %eax,0x4(%esp)
     e81:	8b 45 08             	mov    0x8(%ebp),%eax
     e84:	89 04 24             	mov    %eax,(%esp)
     e87:	e8 94 fd ff ff       	call   c20 <putc>
      }
      state = 0;
     e8c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
...
free(void *ap)
{
     ...
     eaf:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
     eb2:	8b 45 08             	mov    0x8(%ebp),%eax
     eb5:	83 e8 08             	sub    $0x8,%eax
     eb8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ebb:	a1 b0 15 00 00       	mov    0x15b0,%eax
     ec0:	89 45 fc             	mov    %eax,-0x4(%ebp)
     ec3:	eb 24                	jmp    ee9 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     ec5:	8b 45 fc             	mov    -0x4(%ebp),%eax
     ec8:	8b 00                	mov    (%eax),%eax
     eca:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     ecd:	77 12                	ja     ee1 <free+0x35>
     ecf:	8b 45 f8             	mov    -0x8(%ebp),%eax
     ed2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     ed5:	77 24                	ja     efb <free+0x4f>
     ed7:	8b 45 fc             	mov    -0x4(%ebp),%eax
     eda:	8b 00                	mov    (%eax),%eax
     edc:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     edf:	77 1a                	ja     efb <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ee6:	89 45 fc             	mov    %eax,-0x4(%ebp)
     ee9:	8b 45 f8             	mov    -0x8(%ebp),%eax
     eec:	3b 45 fc             	cmp    -0x4(%ebp),%eax
     eef:	76 d4                	jbe    ec5 <free+0x19>
     ef1:	8b 45 fc             	mov    -0x4(%ebp),%eax
     ef4:	8b 00                	mov    (%eax),%eax
     ef6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     ef9:	76 ca                	jbe    ec5 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
     efb:	8b 45 f8             	mov    -0x8(%ebp),%eax
     efe:	8b 40 04             	mov    0x4(%eax),%eax
     f01:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f08:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f0b:	01 c2                	add    %eax,%edx
     f0d:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f10:	8b 00                	mov    (%eax),%eax
     f12:	39 c2                	cmp    %eax,%edx
     f14:	75 24                	jne    f3a <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
     f16:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f19:	8b 50 04             	mov    0x4(%eax),%edx
     f1c:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f1f:	8b 00                	mov    (%eax),%eax
     f21:	8b 40 04             	mov    0x4(%eax),%eax
     f24:	01 c2                	add    %eax,%edx
     f26:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f29:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
     f2c:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f2f:	8b 00                	mov    (%eax),%eax
     f31:	8b 10                	mov    (%eax),%edx
     f33:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f36:	89 10                	mov    %edx,(%eax)
     f38:	eb 0a                	jmp    f44 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
  ...
  if(p + p->s.size == bp){
     ...
     f4a:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
     f51:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f54:	01 d0                	add    %edx,%eax
     f56:	3b 45 f8             	cmp    -0x8(%ebp),%eax
     f59:	75 20                	jne    f7b <free+0xcf>
    p->s.size += bp->s.size;
     f5b:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f5e:	8b 50 04             	mov    0x4(%eax),%edx
     f61:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f64:	8b 40 04             	mov    0x4(%eax),%eax
     f67:	01 c2                	add    %eax,%edx
     f69:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f6c:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
     f6f:	8b 45 f8             	mov    -0x8(%ebp),%eax
     f72:	8b 10                	mov    (%eax),%edx
     f74:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f77:	89 10                	mov    %edx,(%eax)
     f79:	eb 08                	jmp    f83 <free+0xd7>
  } else
    p->s.ptr = bp;
     f7b:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f7e:	8b 55 f8             	mov    -0x8(%ebp),%edx
     f81:	89 10                	mov    %edx,(%eax)
  freep = p;
     f83:	8b 45 fc             	mov    -0x4(%ebp),%eax
     f86:	a3 b0 15 00 00       	mov    %eax,0x15b0
}
     f8b:	c9                   	leave  
     f8c:	c3                   	ret    
...
morecore(uint nu)
{
     ...
     f90:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
     f93:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
     f9a:	77 07                	ja     fa3 <morecore+0x16>
    nu = 4096;
     f9c:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
     fa3:	8b 45 08             	mov    0x8(%ebp),%eax
     fa6:	c1 e0 03             	shl    $0x3,%eax
     fa9:	89 04 24             	mov    %eax,(%esp)
     fac:	e8 cf fb ff ff       	call   b80 <sbrk>
     fb1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
     fb4:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
     fb8:	75 07                	jne    fc1 <morecore+0x34>
    return 0;
     fba:	b8 00 00 00 00       	mov    $0x0,%eax
     fbf:	eb 22                	jmp    fe3 <morecore+0x56>
  hp = (Header*)p;
     fc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
     fc4:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
     fc7:	8b 45 f0             	mov    -0x10(%ebp),%eax
     fca:	8b 55 08             	mov    0x8(%ebp),%edx
     fcd:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
     fd0:	8b 45 f0             	mov    -0x10(%ebp),%eax
     fd3:	83 c0 08             	add    $0x8,%eax
     fd6:	89 04 24             	mov    %eax,(%esp)
     fd9:	e8 ce fe ff ff       	call   eac <free>
  return freep;
     fde:	a1 b0 15 00 00       	mov    0x15b0,%eax
}
     fe3:	c9                   	leave  
     fe4:	c3                   	ret    
...
malloc(uint nbytes)
{
     ...
     fe8:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
     feb:	8b 45 08             	mov    0x8(%ebp),%eax
     fee:	83 c0 07             	add    $0x7,%eax
     ff1:	c1 e8 03             	shr    $0x3,%eax
     ff4:	40                   	inc    %eax
     ff5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
     ff8:	a1 b0 15 00 00       	mov    0x15b0,%eax
     ffd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1000:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1004:	75 23                	jne    1029 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1006:	c7 45 f0 a8 15 00 00 	movl   $0x15a8,-0x10(%ebp)
    100d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1010:	a3 b0 15 00 00       	mov    %eax,0x15b0
    1015:	a1 b0 15 00 00       	mov    0x15b0,%eax
    101a:	a3 a8 15 00 00       	mov    %eax,0x15a8
    base.s.size = 0;
    101f:	c7 05 ac 15 00 00 00 	movl   $0x0,0x15ac
    1026:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1029:	8b 45 f0             	mov    -0x10(%ebp),%eax
    102c:	8b 00                	mov    (%eax),%eax
    102e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    1031:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1034:	8b 40 04             	mov    0x4(%eax),%eax
    1037:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    103a:	72 4d                	jb     1089 <malloc+0xa4>
      if(p->s.size == nunits)
    103c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    103f:	8b 40 04             	mov    0x4(%eax),%eax
    1042:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1045:	75 0c                	jne    1053 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
    1047:	8b 45 f4             	mov    -0xc(%ebp),%eax
    104a:	8b 10                	mov    (%eax),%edx
    104c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    104f:	89 10                	mov    %edx,(%eax)
    1051:	eb 26                	jmp    1079 <malloc+0x94>
      else {
        p->s.size -= nunits;
    1053:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1056:	8b 40 04             	mov    0x4(%eax),%eax
    1059:	2b 45 ec             	sub    -0x14(%ebp),%eax
    105c:	89 c2                	mov    %eax,%edx
    105e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1061:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    1064:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1067:	8b 40 04             	mov    0x4(%eax),%eax
    106a:	c1 e0 03             	shl    $0x3,%eax
    106d:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    1070:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1073:	8b 55 ec             	mov    -0x14(%ebp),%edx
    1076:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    1079:	8b 45 f0             	mov    -0x10(%ebp),%eax
    107c:	a3 b0 15 00 00       	mov    %eax,0x15b0
      return (void*)(p + 1);
    1081:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1084:	83 c0 08             	add    $0x8,%eax
    1087:	eb 38                	jmp    10c1 <malloc+0xdc>
    }
    if(p == freep)
    1089:	a1 b0 15 00 00       	mov    0x15b0,%eax
    108e:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    1091:	75 1b                	jne    10ae <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
    1093:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1096:	89 04 24             	mov    %eax,(%esp)
    1099:	e8 ef fe ff ff       	call   f8d <morecore>
    109e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    10a1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    10a5:	75 07                	jne    10ae <malloc+0xc9>
        return 0;
    10a7:	b8 00 00 00 00       	mov    $0x0,%eax
    10ac:	eb 13                	jmp    10c1 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10b1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    10bc:	e9 70 ff ff ff       	jmp    1031 <malloc+0x4c>
}
    10c1:	c9                   	leave  
    10c2:	c3                   	ret    
