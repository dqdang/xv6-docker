...
wc(int fd, char *name)
{
  ...
  50:	c7 04 24 7f 0f 00 00 	movl   $0xf7f,(%esp)
  ...
  b2:	c7 44 24 04 85 0f 00 	movl   $0xf85,0x4(%esp)
  b9:	00 
  ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c1:	e8 f3 0a 00 00       	call   bb9 <printf>
    exit();
  ...
  e7:	c7 44 24 04 95 0f 00 	movl   $0xf95,0x4(%esp)
  ee:	00 
  ef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f6:	e8 be 0a 00 00       	call   bb9 <printf>
}
  fb:	c9                   	leave  
  fc:	c3                   	ret    
...
main(int argc, char *argv[])
{
 ...
 10a:	7f 19                	jg     125 <main+0x28>
    wc(0, "");
 10c:	c7 44 24 04 a2 0f 00 	movl   $0xfa2,0x4(%esp)
 113:	00 
 ...
 175:	c7 44 24 04 a3 0f 00 	movl   $0xfa3,0x4(%esp)
 17c:	00 
 17d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 184:	e8 30 0a 00 00       	call   bb9 <printf>
      exit();
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 257:	c7 44 24 04 b7 0f 00 	movl   $0xfb7,0x4(%esp)
 25e:	00 
 25f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 266:	e8 4e 09 00 00       	call   bb9 <printf>
      exit();
 ...
 293:	c7 44 24 04 d2 0f 00 	movl   $0xfd2,0x4(%esp)
 29a:	00 
 29b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 2a2:	e8 12 09 00 00       	call   bb9 <printf>
      exit();
...
00000acc <getpath>:
SYSCALL(getpath)
 acc:	b8 2b 00 00 00       	mov    $0x2b,%eax
 ad1:	cd 40                	int    $0x40
 ad3:	c3                   	ret    

00000ad4 <setpath>:
SYSCALL(setpath)
 ad4:	b8 2c 00 00 00       	mov    $0x2c,%eax
 ad9:	cd 40                	int    $0x40
 adb:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 b17:	74 17                	je     b30 <printint+0x2c>
 b19:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 b1d:	79 11                	jns    b30 <printint+0x2c>
    neg = 1;
 ...
 b2e:	eb 06                	jmp    b36 <printint+0x32>
  } else {
    x = xx;
 ...
 b36:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 b3d:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 b40:	8d 41 01             	lea    0x1(%ecx),%eax
 b43:	89 45 f4             	mov    %eax,-0xc(%ebp)
 b46:	8b 5d 10             	mov    0x10(%ebp),%ebx
 b49:	8b 45 ec             	mov    -0x14(%ebp),%eax
 b4c:	ba 00 00 00 00       	mov    $0x0,%edx
 b51:	f7 f3                	div    %ebx
 b53:	89 d0                	mov    %edx,%eax
 b55:	8a 80 ec 13 00 00    	mov    0x13ec(%eax),%al
 b5b:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 b5f:	8b 75 10             	mov    0x10(%ebp),%esi
 b62:	8b 45 ec             	mov    -0x14(%ebp),%eax
 b65:	ba 00 00 00 00       	mov    $0x0,%edx
 b6a:	f7 f6                	div    %esi
 b6c:	89 45 ec             	mov    %eax,-0x14(%ebp)
 b6f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 b73:	75 c8                	jne    b3d <printint+0x39>
  if(neg)
 b75:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 b79:	74 10                	je     b8b <printint+0x87>
    buf[i++] = '-';
 b7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b7e:	8d 50 01             	lea    0x1(%eax),%edx
 b81:	89 55 f4             	mov    %edx,-0xc(%ebp)
 b84:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 b89:	eb 1e                	jmp    ba9 <printint+0xa5>
 b8b:	eb 1c                	jmp    ba9 <printint+0xa5>
    putc(fd, buf[i]);
 b8d:	8d 55 dc             	lea    -0x24(%ebp),%edx
 b90:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b93:	01 d0                	add    %edx,%eax
 b95:	8a 00                	mov    (%eax),%al
 b97:	0f be c0             	movsbl %al,%eax
 b9a:	89 44 24 04          	mov    %eax,0x4(%esp)
 b9e:	8b 45 08             	mov    0x8(%ebp),%eax
 ba1:	89 04 24             	mov    %eax,(%esp)
 ba4:	e8 33 ff ff ff       	call   adc <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 ba9:	ff 4d f4             	decl   -0xc(%ebp)
 bac:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 bb0:	79 db                	jns    b8d <printint+0x89>
    putc(fd, buf[i]);
}
 bb2:	83 c4 30             	add    $0x30,%esp
 bb5:	5b                   	pop    %ebx
 bb6:	5e                   	pop    %esi
 bb7:	5d                   	pop    %ebp
 bb8:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 bbc:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
 bbf:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 bc6:	8d 45 0c             	lea    0xc(%ebp),%eax
 bc9:	83 c0 04             	add    $0x4,%eax
 bcc:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 bcf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 bd6:	e9 77 01 00 00       	jmp    d52 <printf+0x199>
    c = fmt[i] & 0xff;
 bdb:	8b 55 0c             	mov    0xc(%ebp),%edx
 bde:	8b 45 f0             	mov    -0x10(%ebp),%eax
 be1:	01 d0                	add    %edx,%eax
 be3:	8a 00                	mov    (%eax),%al
 be5:	0f be c0             	movsbl %al,%eax
 be8:	25 ff 00 00 00       	and    $0xff,%eax
 bed:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 bf0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 bf4:	75 2c                	jne    c22 <printf+0x69>
      if(c == '%'){
 bf6:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 bfa:	75 0c                	jne    c08 <printf+0x4f>
        state = '%';
 bfc:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 c03:	e9 47 01 00 00       	jmp    d4f <printf+0x196>
      } else {
        putc(fd, c);
 c08:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 c0b:	0f be c0             	movsbl %al,%eax
 c0e:	89 44 24 04          	mov    %eax,0x4(%esp)
 c12:	8b 45 08             	mov    0x8(%ebp),%eax
 c15:	89 04 24             	mov    %eax,(%esp)
 c18:	e8 bf fe ff ff       	call   adc <putc>
 c1d:	e9 2d 01 00 00       	jmp    d4f <printf+0x196>
      }
    } else if(state == '%'){
 c22:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 c26:	0f 85 23 01 00 00    	jne    d4f <printf+0x196>
      if(c == 'd'){
 c2c:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 c30:	75 2d                	jne    c5f <printf+0xa6>
        printint(fd, *ap, 10, 1);
 c32:	8b 45 e8             	mov    -0x18(%ebp),%eax
 c35:	8b 00                	mov    (%eax),%eax
 c37:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 c3e:	00 
 c3f:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 c46:	00 
 c47:	89 44 24 04          	mov    %eax,0x4(%esp)
 c4b:	8b 45 08             	mov    0x8(%ebp),%eax
 c4e:	89 04 24             	mov    %eax,(%esp)
 c51:	e8 ae fe ff ff       	call   b04 <printint>
        ap++;
 c56:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 c5a:	e9 e9 00 00 00       	jmp    d48 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 c5f:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 c63:	74 06                	je     c6b <printf+0xb2>
 c65:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 c69:	75 2d                	jne    c98 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 c6b:	8b 45 e8             	mov    -0x18(%ebp),%eax
 c6e:	8b 00                	mov    (%eax),%eax
 c70:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 c77:	00 
 c78:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 c7f:	00 
 c80:	89 44 24 04          	mov    %eax,0x4(%esp)
 c84:	8b 45 08             	mov    0x8(%ebp),%eax
 c87:	89 04 24             	mov    %eax,(%esp)
 c8a:	e8 75 fe ff ff       	call   b04 <printint>
        ap++;
 c8f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 c93:	e9 b0 00 00 00       	jmp    d48 <printf+0x18f>
      } else if(c == 's'){
 c98:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 c9c:	75 42                	jne    ce0 <printf+0x127>
        s = (char*)*ap;
 c9e:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ca1:	8b 00                	mov    (%eax),%eax
 ca3:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
 ca6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
 caa:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 cae:	75 09                	jne    cb9 <printf+0x100>
          s = "(null)";
 cb0:	c7 45 f4 ee 0f 00 00 	movl   $0xfee,-0xc(%ebp)
        while(*s != 0){
 cb7:	eb 1c                	jmp    cd5 <printf+0x11c>
 cb9:	eb 1a                	jmp    cd5 <printf+0x11c>
          putc(fd, *s);
 cbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
 cbe:	8a 00                	mov    (%eax),%al
 cc0:	0f be c0             	movsbl %al,%eax
 cc3:	89 44 24 04          	mov    %eax,0x4(%esp)
 cc7:	8b 45 08             	mov    0x8(%ebp),%eax
 cca:	89 04 24             	mov    %eax,(%esp)
 ccd:	e8 0a fe ff ff       	call   adc <putc>
          s++;
 cd2:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 cdc:	75 dd                	jne    cbb <printf+0x102>
 cde:	eb 68                	jmp    d48 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 ce0:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 ce4:	75 1d                	jne    d03 <printf+0x14a>
        putc(fd, *ap);
 ...
 cf8:	e8 df fd ff ff       	call   adc <putc>
        ap++;
 cfd:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 d01:	eb 45                	jmp    d48 <printf+0x18f>
      } else if(c == '%'){
 d03:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 d07:	75 17                	jne    d20 <printf+0x167>
        putc(fd, c);
 ...
 d19:	e8 be fd ff ff       	call   adc <putc>
 d1e:	eb 28                	jmp    d48 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 d20:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 d27:	00 
 d28:	8b 45 08             	mov    0x8(%ebp),%eax
 d2b:	89 04 24             	mov    %eax,(%esp)
 d2e:	e8 a9 fd ff ff       	call   adc <putc>
        putc(fd, c);
 d33:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 d36:	0f be c0             	movsbl %al,%eax
 d39:	89 44 24 04          	mov    %eax,0x4(%esp)
 d3d:	8b 45 08             	mov    0x8(%ebp),%eax
 d40:	89 04 24             	mov    %eax,(%esp)
 d43:	e8 94 fd ff ff       	call   adc <putc>
      }
      state = 0;
 d48:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
...
free(void *ap)
{
 ...
 d6b:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
 d6e:	8b 45 08             	mov    0x8(%ebp),%eax
 d71:	83 e8 08             	sub    $0x8,%eax
 d74:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 d77:	a1 10 14 00 00       	mov    0x1410,%eax
 d7c:	89 45 fc             	mov    %eax,-0x4(%ebp)
 d7f:	eb 24                	jmp    da5 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 d81:	8b 45 fc             	mov    -0x4(%ebp),%eax
 d84:	8b 00                	mov    (%eax),%eax
 d86:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 d89:	77 12                	ja     d9d <free+0x35>
 d8b:	8b 45 f8             	mov    -0x8(%ebp),%eax
 d8e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 d91:	77 24                	ja     db7 <free+0x4f>
 d93:	8b 45 fc             	mov    -0x4(%ebp),%eax
 d96:	8b 00                	mov    (%eax),%eax
 d98:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 d9b:	77 1a                	ja     db7 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 da8:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 dab:	76 d4                	jbe    d81 <free+0x19>
 dad:	8b 45 fc             	mov    -0x4(%ebp),%eax
 db0:	8b 00                	mov    (%eax),%eax
 db2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 db5:	76 ca                	jbe    d81 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
 db7:	8b 45 f8             	mov    -0x8(%ebp),%eax
 dba:	8b 40 04             	mov    0x4(%eax),%eax
 dbd:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 dc4:	8b 45 f8             	mov    -0x8(%ebp),%eax
 dc7:	01 c2                	add    %eax,%edx
 dc9:	8b 45 fc             	mov    -0x4(%ebp),%eax
 dcc:	8b 00                	mov    (%eax),%eax
 dce:	39 c2                	cmp    %eax,%edx
 dd0:	75 24                	jne    df6 <free+0x8e>
 ...
 de0:	01 c2                	add    %eax,%edx
 de2:	8b 45 f8             	mov    -0x8(%ebp),%eax
 de5:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
 de8:	8b 45 fc             	mov    -0x4(%ebp),%eax
 deb:	8b 00                	mov    (%eax),%eax
 ded:	8b 10                	mov    (%eax),%edx
 def:	8b 45 f8             	mov    -0x8(%ebp),%eax
 df2:	89 10                	mov    %edx,(%eax)
 df4:	eb 0a                	jmp    e00 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
 ...
 e06:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 e0d:	8b 45 fc             	mov    -0x4(%ebp),%eax
 e10:	01 d0                	add    %edx,%eax
 e12:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 e15:	75 20                	jne    e37 <free+0xcf>
    p->s.size += bp->s.size;
 e17:	8b 45 fc             	mov    -0x4(%ebp),%eax
 e1a:	8b 50 04             	mov    0x4(%eax),%edx
 e1d:	8b 45 f8             	mov    -0x8(%ebp),%eax
 e20:	8b 40 04             	mov    0x4(%eax),%eax
 e23:	01 c2                	add    %eax,%edx
 e25:	8b 45 fc             	mov    -0x4(%ebp),%eax
 e28:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 e2b:	8b 45 f8             	mov    -0x8(%ebp),%eax
 e2e:	8b 10                	mov    (%eax),%edx
 e30:	8b 45 fc             	mov    -0x4(%ebp),%eax
 e33:	89 10                	mov    %edx,(%eax)
 e35:	eb 08                	jmp    e3f <free+0xd7>
  } else
    p->s.ptr = bp;
 e37:	8b 45 fc             	mov    -0x4(%ebp),%eax
 e3a:	8b 55 f8             	mov    -0x8(%ebp),%edx
 e3d:	89 10                	mov    %edx,(%eax)
  freep = p;
 e3f:	8b 45 fc             	mov    -0x4(%ebp),%eax
 e42:	a3 10 14 00 00       	mov    %eax,0x1410
}
 e47:	c9                   	leave  
 e48:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 e4c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(nu < 4096)
 e4f:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 e56:	77 07                	ja     e5f <morecore+0x16>
    nu = 4096;
 e58:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 e5f:	8b 45 08             	mov    0x8(%ebp),%eax
 e62:	c1 e0 03             	shl    $0x3,%eax
 e65:	89 04 24             	mov    %eax,(%esp)
 e68:	e8 9f fb ff ff       	call   a0c <sbrk>
 e6d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 e70:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 e74:	75 07                	jne    e7d <morecore+0x34>
    return 0;
 e76:	b8 00 00 00 00       	mov    $0x0,%eax
 e7b:	eb 22                	jmp    e9f <morecore+0x56>
  hp = (Header*)p;
 e7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 e80:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
 e83:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ...
 e95:	e8 ce fe ff ff       	call   d68 <free>
  return freep;
 e9a:	a1 10 14 00 00       	mov    0x1410,%eax
}
 e9f:	c9                   	leave  
 ea0:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 ea4:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ea7:	8b 45 08             	mov    0x8(%ebp),%eax
 eaa:	83 c0 07             	add    $0x7,%eax
 ead:	c1 e8 03             	shr    $0x3,%eax
 eb0:	40                   	inc    %eax
 eb1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 eb4:	a1 10 14 00 00       	mov    0x1410,%eax
 eb9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 ebc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 ec0:	75 23                	jne    ee5 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 ec2:	c7 45 f0 08 14 00 00 	movl   $0x1408,-0x10(%ebp)
 ec9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ecc:	a3 10 14 00 00       	mov    %eax,0x1410
 ed1:	a1 10 14 00 00       	mov    0x1410,%eax
 ed6:	a3 08 14 00 00       	mov    %eax,0x1408
    base.s.size = 0;
 edb:	c7 05 0c 14 00 00 00 	movl   $0x0,0x140c
 ee2:	00 00 00 
  }
 ...
 ef3:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 ef6:	72 4d                	jb     f45 <malloc+0xa4>
      if(p->s.size == nunits)
 ef8:	8b 45 f4             	mov    -0xc(%ebp),%eax
 efb:	8b 40 04             	mov    0x4(%eax),%eax
 efe:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 f01:	75 0c                	jne    f0f <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
 f03:	8b 45 f4             	mov    -0xc(%ebp),%eax
 f06:	8b 10                	mov    (%eax),%edx
 f08:	8b 45 f0             	mov    -0x10(%ebp),%eax
 f0b:	89 10                	mov    %edx,(%eax)
 f0d:	eb 26                	jmp    f35 <malloc+0x94>
      else {
        p->s.size -= nunits;
 f0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 f12:	8b 40 04             	mov    0x4(%eax),%eax
 f15:	2b 45 ec             	sub    -0x14(%ebp),%eax
 ...
 f26:	c1 e0 03             	shl    $0x3,%eax
 f29:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 f2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 f2f:	8b 55 ec             	mov    -0x14(%ebp),%edx
 f32:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 f35:	8b 45 f0             	mov    -0x10(%ebp),%eax
 f38:	a3 10 14 00 00       	mov    %eax,0x1410
      return (void*)(p + 1);
 f3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 f40:	83 c0 08             	add    $0x8,%eax
 f43:	eb 38                	jmp    f7d <malloc+0xdc>
    }
    if(p == freep)
 f45:	a1 10 14 00 00       	mov    0x1410,%eax
 f4a:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 f4d:	75 1b                	jne    f6a <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
 f4f:	8b 45 ec             	mov    -0x14(%ebp),%eax
 f52:	89 04 24             	mov    %eax,(%esp)
 f55:	e8 ef fe ff ff       	call   e49 <morecore>
 f5a:	89 45 f4             	mov    %eax,-0xc(%ebp)
 f5d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 f61:	75 07                	jne    f6a <malloc+0xc9>
        return 0;
 f63:	b8 00 00 00 00       	mov    $0x0,%eax
 f68:	eb 13                	jmp    f7d <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 f6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 f70:	8b 45 f4             	mov    -0xc(%ebp),%eax
 f73:	8b 00                	mov    (%eax),%eax
 f75:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
 ...
 f78:	e9 70 ff ff ff       	jmp    eed <malloc+0x4c>
}
 f7d:	c9                   	leave  
 f7e:	c3                   	ret    
