...
00000000 <main>:
  ...
  66:	c7 44 24 04 9a 0d 00 	movl   $0xd9a,0x4(%esp)
  6d:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 113:	c7 44 24 04 b6 0d 00 	movl   $0xdb6,0x4(%esp)
 11a:	00 
 ...
 14f:	c7 44 24 04 d1 0d 00 	movl   $0xdd1,0x4(%esp)
 156:	00 
...
000009bd <printf>:
 ...
 ab4:	c7 45 f4 ed 0d 00 00 	movl   $0xded,-0xc(%ebp)
