...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 fa 0d 00 	movl   $0xdfa,0x4(%esp)
  6d:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 113:	c7 44 24 04 16 0e 00 	movl   $0xe16,0x4(%esp)
 11a:	00 
 ...
 14f:	c7 44 24 04 31 0e 00 	movl   $0xe31,0x4(%esp)
 156:	00 
...
printf(int fd, char *fmt, ...)
{
 ...
 b12:	75 09                	jne    b1d <printf+0x100>
          s = "(null)";
 b14:	c7 45 f4 4d 0e 00 00 	movl   $0xe4d,-0xc(%ebp)
        while(*s != 0){
