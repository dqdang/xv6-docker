...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 22 0e 00 	movl   $0xe22,0x4(%esp)
  6d:	00 
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 113:	c7 44 24 04 3e 0e 00 	movl   $0xe3e,0x4(%esp)
 11a:	00 
 ...
 14f:	c7 44 24 04 59 0e 00 	movl   $0xe59,0x4(%esp)
 156:	00 
...
printf(int fd, char *fmt, ...)
{
 ...
 b3a:	75 09                	jne    b45 <printf+0x100>
          s = "(null)";
 b3c:	c7 45 f4 75 0e 00 00 	movl   $0xe75,-0xc(%ebp)
        while(*s != 0){
