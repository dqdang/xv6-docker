...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 2b 0e 00 	movl   $0xe2b,0x4(%esp)
  16:	00 
  17:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1e:	e8 42 0a 00 00       	call   a65 <printf>
    exit();
  ...
  66:	c7 44 24 04 42 0e 00 	movl   $0xe42,0x4(%esp)
  6d:	00 
  6e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  75:	e8 eb 09 00 00       	call   a65 <printf>
      break;
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 113:	c7 44 24 04 5e 0e 00 	movl   $0xe5e,0x4(%esp)
 11a:	00 
 11b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 122:	e8 3e 09 00 00       	call   a65 <printf>
      exit();
 ...
 14f:	c7 44 24 04 79 0e 00 	movl   $0xe79,0x4(%esp)
 156:	00 
 157:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 15e:	e8 02 09 00 00       	call   a65 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 3fd:	75 08                	jne    407 <strtok+0x15>
  s = lasts;
 3ff:	a1 84 12 00 00       	mov    0x1284,%eax
 ...
 454:	a3 84 12 00 00       	mov    %eax,0x1284
    if (*lasts != 0)
 459:	a1 84 12 00 00       	mov    0x1284,%eax
 45e:	8a 00                	mov    (%eax),%al
 460:	84 c0                	test   %al,%al
 462:	74 11                	je     475 <strtok+0x83>
  *lasts++ = 0;
 464:	a1 84 12 00 00       	mov    0x1284,%eax
 469:	8d 50 01             	lea    0x1(%eax),%edx
 46c:	89 15 84 12 00 00    	mov    %edx,0x1284
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 5ee:	eb 22                	jmp    612 <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 5f0:	8a 86 20 12 00 00    	mov    0x1220(%esi),%al
 ...
 623:	eb 25                	jmp    64a <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 625:	8a 86 20 12 00 00    	mov    0x1220(%esi),%al
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 9b8:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 9bf:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 9c3:	74 17                	je     9dc <printint+0x2c>
 9c5:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 9c9:	79 11                	jns    9dc <printint+0x2c>
    neg = 1;
 9cb:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 9d2:	8b 45 0c             	mov    0xc(%ebp),%eax
 9d5:	f7 d8                	neg    %eax
 9d7:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9da:	eb 06                	jmp    9e2 <printint+0x32>
  } else {
    x = xx;
 ...
 9df:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  i = 0;
 9e2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 9e9:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 9ec:	8d 41 01             	lea    0x1(%ecx),%eax
 9ef:	89 45 f4             	mov    %eax,-0xc(%ebp)
 9f2:	8b 5d 10             	mov    0x10(%ebp),%ebx
 9f5:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9f8:	ba 00 00 00 00       	mov    $0x0,%edx
 9fd:	f7 f3                	div    %ebx
 9ff:	89 d0                	mov    %edx,%eax
 a01:	8a 80 6c 12 00 00    	mov    0x126c(%eax),%al
 a07:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 a0b:	8b 75 10             	mov    0x10(%ebp),%esi
 ...
 a1f:	75 c8                	jne    9e9 <printint+0x39>
  if(neg)
 a21:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a25:	74 10                	je     a37 <printint+0x87>
    buf[i++] = '-';
 a27:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a2a:	8d 50 01             	lea    0x1(%eax),%edx
 a2d:	89 55 f4             	mov    %edx,-0xc(%ebp)
 a30:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 a35:	eb 1e                	jmp    a55 <printint+0xa5>
 a37:	eb 1c                	jmp    a55 <printint+0xa5>
    putc(fd, buf[i]);
 a39:	8d 55 dc             	lea    -0x24(%ebp),%edx
 ...
 a50:	e8 33 ff ff ff       	call   988 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 a55:	ff 4d f4             	decl   -0xc(%ebp)
 a58:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a5c:	79 db                	jns    a39 <printint+0x89>
    putc(fd, buf[i]);
}
 a5e:	83 c4 30             	add    $0x30,%esp
 a61:	5b                   	pop    %ebx
 a62:	5e                   	pop    %esi
 a63:	5d                   	pop    %ebp
 a64:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 a6b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 a72:	8d 45 0c             	lea    0xc(%ebp),%eax
 a75:	83 c0 04             	add    $0x4,%eax
 a78:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 a7b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 a82:	e9 77 01 00 00       	jmp    bfe <printf+0x199>
    c = fmt[i] & 0xff;
 a87:	8b 55 0c             	mov    0xc(%ebp),%edx
 a8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a8d:	01 d0                	add    %edx,%eax
 a8f:	8a 00                	mov    (%eax),%al
 a91:	0f be c0             	movsbl %al,%eax
 a94:	25 ff 00 00 00       	and    $0xff,%eax
 a99:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 a9c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 aa0:	75 2c                	jne    ace <printf+0x69>
      if(c == '%'){
 aa2:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 aa6:	75 0c                	jne    ab4 <printf+0x4f>
        state = '%';
 aa8:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 aaf:	e9 47 01 00 00       	jmp    bfb <printf+0x196>
      } else {
        putc(fd, c);
 ab4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 ab7:	0f be c0             	movsbl %al,%eax
 aba:	89 44 24 04          	mov    %eax,0x4(%esp)
 abe:	8b 45 08             	mov    0x8(%ebp),%eax
 ac1:	89 04 24             	mov    %eax,(%esp)
 ac4:	e8 bf fe ff ff       	call   988 <putc>
 ac9:	e9 2d 01 00 00       	jmp    bfb <printf+0x196>
      }
    } else if(state == '%'){
 ace:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 ad2:	0f 85 23 01 00 00    	jne    bfb <printf+0x196>
      if(c == 'd'){
 ad8:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 adc:	75 2d                	jne    b0b <printf+0xa6>
        printint(fd, *ap, 10, 1);
 ade:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ae1:	8b 00                	mov    (%eax),%eax
 ae3:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 aea:	00 
 aeb:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 af2:	00 
 af3:	89 44 24 04          	mov    %eax,0x4(%esp)
 af7:	8b 45 08             	mov    0x8(%ebp),%eax
 afa:	89 04 24             	mov    %eax,(%esp)
 afd:	e8 ae fe ff ff       	call   9b0 <printint>
        ap++;
 b02:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b06:	e9 e9 00 00 00       	jmp    bf4 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 b0b:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 b0f:	74 06                	je     b17 <printf+0xb2>
 b11:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 b15:	75 2d                	jne    b44 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 b17:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b1a:	8b 00                	mov    (%eax),%eax
 b1c:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 b23:	00 
 b24:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 b2b:	00 
 b2c:	89 44 24 04          	mov    %eax,0x4(%esp)
 b30:	8b 45 08             	mov    0x8(%ebp),%eax
 b33:	89 04 24             	mov    %eax,(%esp)
 b36:	e8 75 fe ff ff       	call   9b0 <printint>
        ap++;
 b3b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b3f:	e9 b0 00 00 00       	jmp    bf4 <printf+0x18f>
      } else if(c == 's'){
 b44:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 b48:	75 42                	jne    b8c <printf+0x127>
        s = (char*)*ap;
 ...
 b5a:	75 09                	jne    b65 <printf+0x100>
          s = "(null)";
 b5c:	c7 45 f4 95 0e 00 00 	movl   $0xe95,-0xc(%ebp)
        while(*s != 0){
 b63:	eb 1c                	jmp    b81 <printf+0x11c>
 b65:	eb 1a                	jmp    b81 <printf+0x11c>
          putc(fd, *s);
 b67:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b6a:	8a 00                	mov    (%eax),%al
 b6c:	0f be c0             	movsbl %al,%eax
 b6f:	89 44 24 04          	mov    %eax,0x4(%esp)
 b73:	8b 45 08             	mov    0x8(%ebp),%eax
 b76:	89 04 24             	mov    %eax,(%esp)
 b79:	e8 0a fe ff ff       	call   988 <putc>
          s++;
 b7e:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 b84:	8a 00                	mov    (%eax),%al
 b86:	84 c0                	test   %al,%al
 b88:	75 dd                	jne    b67 <printf+0x102>
 b8a:	eb 68                	jmp    bf4 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 b8c:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 b90:	75 1d                	jne    baf <printf+0x14a>
        putc(fd, *ap);
 ...
 ba4:	e8 df fd ff ff       	call   988 <putc>
        ap++;
 ba9:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 bad:	eb 45                	jmp    bf4 <printf+0x18f>
      } else if(c == '%'){
 baf:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 bb3:	75 17                	jne    bcc <printf+0x167>
        putc(fd, c);
 bb5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 bb8:	0f be c0             	movsbl %al,%eax
 bbb:	89 44 24 04          	mov    %eax,0x4(%esp)
 bbf:	8b 45 08             	mov    0x8(%ebp),%eax
 bc2:	89 04 24             	mov    %eax,(%esp)
 bc5:	e8 be fd ff ff       	call   988 <putc>
 bca:	eb 28                	jmp    bf4 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 bcc:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 bd3:	00 
 bd4:	8b 45 08             	mov    0x8(%ebp),%eax
 bd7:	89 04 24             	mov    %eax,(%esp)
 bda:	e8 a9 fd ff ff       	call   988 <putc>
        putc(fd, c);
 bdf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 be2:	0f be c0             	movsbl %al,%eax
 be5:	89 44 24 04          	mov    %eax,0x4(%esp)
 be9:	8b 45 08             	mov    0x8(%ebp),%eax
 bec:	89 04 24             	mov    %eax,(%esp)
 bef:	e8 94 fd ff ff       	call   988 <putc>
      }
      state = 0;
 bf4:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 bfb:	ff 45 f0             	incl   -0x10(%ebp)
 bfe:	8b 55 0c             	mov    0xc(%ebp),%edx
 c01:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c04:	01 d0                	add    %edx,%eax
 c06:	8a 00                	mov    (%eax),%al
 c08:	84 c0                	test   %al,%al
 c0a:	0f 85 77 fe ff ff    	jne    a87 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 c1d:	83 e8 08             	sub    $0x8,%eax
 c20:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 c23:	a1 90 12 00 00       	mov    0x1290,%eax
 c28:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c2b:	eb 24                	jmp    c51 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 c2d:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c30:	8b 00                	mov    (%eax),%eax
 c32:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c35:	77 12                	ja     c49 <free+0x35>
 c37:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c3a:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c3d:	77 24                	ja     c63 <free+0x4f>
 c3f:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c42:	8b 00                	mov    (%eax),%eax
 c44:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c47:	77 1a                	ja     c63 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 c4e:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c51:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c54:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c57:	76 d4                	jbe    c2d <free+0x19>
 c59:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c5c:	8b 00                	mov    (%eax),%eax
 c5e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c61:	76 ca                	jbe    c2d <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
 c63:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c66:	8b 40 04             	mov    0x4(%eax),%eax
 c69:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 c70:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c73:	01 c2                	add    %eax,%edx
 c75:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c78:	8b 00                	mov    (%eax),%eax
 c7a:	39 c2                	cmp    %eax,%edx
 c7c:	75 24                	jne    ca2 <free+0x8e>
 ...
 cbe:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 cc1:	75 20                	jne    ce3 <free+0xcf>
    p->s.size += bp->s.size;
 cc3:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cc6:	8b 50 04             	mov    0x4(%eax),%edx
 cc9:	8b 45 f8             	mov    -0x8(%ebp),%eax
 ...
 ce1:	eb 08                	jmp    ceb <free+0xd7>
  } else
    p->s.ptr = bp;
 ce3:	8b 45 fc             	mov    -0x4(%ebp),%eax
 ce6:	8b 55 f8             	mov    -0x8(%ebp),%edx
 ce9:	89 10                	mov    %edx,(%eax)
  freep = p;
 ceb:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cee:	a3 90 12 00 00       	mov    %eax,0x1290
}
 cf3:	c9                   	leave  
 cf4:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 cf8:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
 cfb:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 d02:	77 07                	ja     d0b <morecore+0x16>
    nu = 4096;
 d04:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 d0b:	8b 45 08             	mov    0x8(%ebp),%eax
 d0e:	c1 e0 03             	shl    $0x3,%eax
 d11:	89 04 24             	mov    %eax,(%esp)
 d14:	e8 af fb ff ff       	call   8c8 <sbrk>
 d19:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 d1c:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 d20:	75 07                	jne    d29 <morecore+0x34>
    return 0;
 d22:	b8 00 00 00 00       	mov    $0x0,%eax
 d27:	eb 22                	jmp    d4b <morecore+0x56>
  hp = (Header*)p;
 ...
 d41:	e8 ce fe ff ff       	call   c14 <free>
  return freep;
 d46:	a1 90 12 00 00       	mov    0x1290,%eax
}
 d4b:	c9                   	leave  
 d4c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d56:	83 c0 07             	add    $0x7,%eax
 d59:	c1 e8 03             	shr    $0x3,%eax
 d5c:	40                   	inc    %eax
 d5d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d60:	a1 90 12 00 00       	mov    0x1290,%eax
 d65:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d68:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d6c:	75 23                	jne    d91 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d6e:	c7 45 f0 88 12 00 00 	movl   $0x1288,-0x10(%ebp)
 d75:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d78:	a3 90 12 00 00       	mov    %eax,0x1290
 d7d:	a1 90 12 00 00       	mov    0x1290,%eax
 d82:	a3 88 12 00 00       	mov    %eax,0x1288
    base.s.size = 0;
 d87:	c7 05 8c 12 00 00 00 	movl   $0x0,0x128c
 d8e:	00 00 00 
  }
 ...
 d9c:	8b 40 04             	mov    0x4(%eax),%eax
 d9f:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 da2:	72 4d                	jb     df1 <malloc+0xa4>
      if(p->s.size == nunits)
 da4:	8b 45 f4             	mov    -0xc(%ebp),%eax
 da7:	8b 40 04             	mov    0x4(%eax),%eax
 daa:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 dad:	75 0c                	jne    dbb <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
 daf:	8b 45 f4             	mov    -0xc(%ebp),%eax
 db2:	8b 10                	mov    (%eax),%edx
 db4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 db7:	89 10                	mov    %edx,(%eax)
 db9:	eb 26                	jmp    de1 <malloc+0x94>
      else {
        p->s.size -= nunits;
 dbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dbe:	8b 40 04             	mov    0x4(%eax),%eax
 dc1:	2b 45 ec             	sub    -0x14(%ebp),%eax
 ...
 dd5:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 dd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ddb:	8b 55 ec             	mov    -0x14(%ebp),%edx
 dde:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 de1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 de4:	a3 90 12 00 00       	mov    %eax,0x1290
      return (void*)(p + 1);
 de9:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dec:	83 c0 08             	add    $0x8,%eax
 def:	eb 38                	jmp    e29 <malloc+0xdc>
    }
    if(p == freep)
 df1:	a1 90 12 00 00       	mov    0x1290,%eax
 df6:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 df9:	75 1b                	jne    e16 <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
 dfb:	8b 45 ec             	mov    -0x14(%ebp),%eax
 dfe:	89 04 24             	mov    %eax,(%esp)
 e01:	e8 ef fe ff ff       	call   cf5 <morecore>
 e06:	89 45 f4             	mov    %eax,-0xc(%ebp)
 e09:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 e0d:	75 07                	jne    e16 <malloc+0xc9>
        return 0;
 e0f:	b8 00 00 00 00       	mov    $0x0,%eax
 e14:	eb 13                	jmp    e29 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 e24:	e9 70 ff ff ff       	jmp    d99 <malloc+0x4c>
}
 e29:	c9                   	leave  
 e2a:	c3                   	ret    
