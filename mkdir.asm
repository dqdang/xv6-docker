...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 3e 08 00 	movl   $0x83e,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fd:	8a 80 a8 0a 00 00    	mov    0xaa8(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 556:	75 09                	jne    561 <printf+0x100>
          s = "(null)";
 558:	c7 45 f4 5a 08 00 00 	movl   $0x85a,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 61f:	a1 c4 0a 00 00       	mov    0xac4,%eax
...
morecore(uint nu)
{
 ...
 73d:	e8 ce fe ff ff       	call   610 <free>
  return freep;
 742:	a1 c4 0a 00 00       	mov    0xac4,%eax
}
 747:	c9                   	leave  
 748:	c3                   	ret    
