...
main(int argc, char *argv[])
{
  ...
  1d:	b8 17 0e 00 00       	mov    $0xe17,%eax
  22:	eb 05                	jmp    29 <main+0x29>
  24:	b8 19 0e 00 00       	mov    $0xe19,%eax
  ...
  43:	c7 44 24 04 1b 0e 00 	movl   $0xe1b,0x4(%esp)
  4a:	00 
  4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  52:	e8 fa 09 00 00       	call   a51 <printf>
int
main(int argc, char *argv[])
{
  int i;
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  ef:	c7 44 24 04 20 0e 00 	movl   $0xe20,0x4(%esp)
  f6:	00 
  f7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fe:	e8 4e 09 00 00       	call   a51 <printf>
      exit();
 ...
 12b:	c7 44 24 04 3b 0e 00 	movl   $0xe3b,0x4(%esp)
 132:	00 
 133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 13a:	e8 12 09 00 00       	call   a51 <printf>
      exit();
...
00000964 <getpath>:
SYSCALL(getpath)
 964:	b8 2b 00 00 00       	mov    $0x2b,%eax
 969:	cd 40                	int    $0x40
 96b:	c3                   	ret    

0000096c <setpath>:
SYSCALL(setpath)
 96c:	b8 2c 00 00 00       	mov    $0x2c,%eax
 971:	cd 40                	int    $0x40
 973:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 9a1:	83 ec 30             	sub    $0x30,%esp
  ...
  neg = 0;
 9a4:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 9ab:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 9af:	74 17                	je     9c8 <printint+0x2c>
 9b1:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 9b5:	79 11                	jns    9c8 <printint+0x2c>
    neg = 1;
 9b7:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 9be:	8b 45 0c             	mov    0xc(%ebp),%eax
 9c1:	f7 d8                	neg    %eax
 9c3:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9c6:	eb 06                	jmp    9ce <printint+0x32>
  } else {
    x = xx;
 ...
 9ce:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 9d5:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 9d8:	8d 41 01             	lea    0x1(%ecx),%eax
 9db:	89 45 f4             	mov    %eax,-0xc(%ebp)
 9de:	8b 5d 10             	mov    0x10(%ebp),%ebx
 9e1:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9e4:	ba 00 00 00 00       	mov    $0x0,%edx
 9e9:	f7 f3                	div    %ebx
 9eb:	89 d0                	mov    %edx,%eax
 9ed:	8a 80 2c 12 00 00    	mov    0x122c(%eax),%al
 9f3:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 9f7:	8b 75 10             	mov    0x10(%ebp),%esi
 9fa:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9fd:	ba 00 00 00 00       	mov    $0x0,%edx
 a02:	f7 f6                	div    %esi
 a04:	89 45 ec             	mov    %eax,-0x14(%ebp)
 a07:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a0b:	75 c8                	jne    9d5 <printint+0x39>
  if(neg)
 a0d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a11:	74 10                	je     a23 <printint+0x87>
    buf[i++] = '-';
 a13:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a16:	8d 50 01             	lea    0x1(%eax),%edx
 a19:	89 55 f4             	mov    %edx,-0xc(%ebp)
 a1c:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 a21:	eb 1e                	jmp    a41 <printint+0xa5>
 a23:	eb 1c                	jmp    a41 <printint+0xa5>
    putc(fd, buf[i]);
 a25:	8d 55 dc             	lea    -0x24(%ebp),%edx
 a28:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a2b:	01 d0                	add    %edx,%eax
 a2d:	8a 00                	mov    (%eax),%al
 a2f:	0f be c0             	movsbl %al,%eax
 a32:	89 44 24 04          	mov    %eax,0x4(%esp)
 a36:	8b 45 08             	mov    0x8(%ebp),%eax
 a39:	89 04 24             	mov    %eax,(%esp)
 a3c:	e8 33 ff ff ff       	call   974 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 a41:	ff 4d f4             	decl   -0xc(%ebp)
 a44:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a48:	79 db                	jns    a25 <printint+0x89>
    putc(fd, buf[i]);
}
 a4a:	83 c4 30             	add    $0x30,%esp
 a4d:	5b                   	pop    %ebx
 a4e:	5e                   	pop    %esi
 a4f:	5d                   	pop    %ebp
 a50:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 a54:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
 a57:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 a5e:	8d 45 0c             	lea    0xc(%ebp),%eax
 a61:	83 c0 04             	add    $0x4,%eax
 a64:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 a67:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 a6e:	e9 77 01 00 00       	jmp    bea <printf+0x199>
    c = fmt[i] & 0xff;
 a73:	8b 55 0c             	mov    0xc(%ebp),%edx
 a76:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a79:	01 d0                	add    %edx,%eax
 a7b:	8a 00                	mov    (%eax),%al
 a7d:	0f be c0             	movsbl %al,%eax
 a80:	25 ff 00 00 00       	and    $0xff,%eax
 a85:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 a88:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a8c:	75 2c                	jne    aba <printf+0x69>
      if(c == '%'){
 a8e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a92:	75 0c                	jne    aa0 <printf+0x4f>
        state = '%';
 a94:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 a9b:	e9 47 01 00 00       	jmp    be7 <printf+0x196>
      } else {
        putc(fd, c);
 aa0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 aa3:	0f be c0             	movsbl %al,%eax
 aa6:	89 44 24 04          	mov    %eax,0x4(%esp)
 aaa:	8b 45 08             	mov    0x8(%ebp),%eax
 aad:	89 04 24             	mov    %eax,(%esp)
 ab0:	e8 bf fe ff ff       	call   974 <putc>
 ab5:	e9 2d 01 00 00       	jmp    be7 <printf+0x196>
      }
    } else if(state == '%'){
 aba:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 abe:	0f 85 23 01 00 00    	jne    be7 <printf+0x196>
      if(c == 'd'){
 ac4:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 ac8:	75 2d                	jne    af7 <printf+0xa6>
        printint(fd, *ap, 10, 1);
 aca:	8b 45 e8             	mov    -0x18(%ebp),%eax
 acd:	8b 00                	mov    (%eax),%eax
 acf:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 ad6:	00 
 ad7:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 ade:	00 
 adf:	89 44 24 04          	mov    %eax,0x4(%esp)
 ae3:	8b 45 08             	mov    0x8(%ebp),%eax
 ae6:	89 04 24             	mov    %eax,(%esp)
 ae9:	e8 ae fe ff ff       	call   99c <printint>
        ap++;
 aee:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 af2:	e9 e9 00 00 00       	jmp    be0 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 af7:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 afb:	74 06                	je     b03 <printf+0xb2>
 afd:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 b01:	75 2d                	jne    b30 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 b03:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b06:	8b 00                	mov    (%eax),%eax
 b08:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 b0f:	00 
 b10:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 b17:	00 
 b18:	89 44 24 04          	mov    %eax,0x4(%esp)
 b1c:	8b 45 08             	mov    0x8(%ebp),%eax
 b1f:	89 04 24             	mov    %eax,(%esp)
 b22:	e8 75 fe ff ff       	call   99c <printint>
        ap++;
 b27:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b2b:	e9 b0 00 00 00       	jmp    be0 <printf+0x18f>
      } else if(c == 's'){
 b30:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 b34:	75 42                	jne    b78 <printf+0x127>
        s = (char*)*ap;
 ...
 b46:	75 09                	jne    b51 <printf+0x100>
          s = "(null)";
 b48:	c7 45 f4 57 0e 00 00 	movl   $0xe57,-0xc(%ebp)
        while(*s != 0){
 b4f:	eb 1c                	jmp    b6d <printf+0x11c>
 b51:	eb 1a                	jmp    b6d <printf+0x11c>
          putc(fd, *s);
 b53:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b56:	8a 00                	mov    (%eax),%al
 b58:	0f be c0             	movsbl %al,%eax
 b5b:	89 44 24 04          	mov    %eax,0x4(%esp)
 b5f:	8b 45 08             	mov    0x8(%ebp),%eax
 b62:	89 04 24             	mov    %eax,(%esp)
 b65:	e8 0a fe ff ff       	call   974 <putc>
          s++;
 b6a:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 b70:	8a 00                	mov    (%eax),%al
 b72:	84 c0                	test   %al,%al
 b74:	75 dd                	jne    b53 <printf+0x102>
 b76:	eb 68                	jmp    be0 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 b78:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 b7c:	75 1d                	jne    b9b <printf+0x14a>
        putc(fd, *ap);
 b7e:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b81:	8b 00                	mov    (%eax),%eax
 b83:	0f be c0             	movsbl %al,%eax
 b86:	89 44 24 04          	mov    %eax,0x4(%esp)
 b8a:	8b 45 08             	mov    0x8(%ebp),%eax
 b8d:	89 04 24             	mov    %eax,(%esp)
 b90:	e8 df fd ff ff       	call   974 <putc>
        ap++;
 b95:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b99:	eb 45                	jmp    be0 <printf+0x18f>
      } else if(c == '%'){
 b9b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 b9f:	75 17                	jne    bb8 <printf+0x167>
        putc(fd, c);
 ba1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 ba4:	0f be c0             	movsbl %al,%eax
 ba7:	89 44 24 04          	mov    %eax,0x4(%esp)
 bab:	8b 45 08             	mov    0x8(%ebp),%eax
 bae:	89 04 24             	mov    %eax,(%esp)
 bb1:	e8 be fd ff ff       	call   974 <putc>
 bb6:	eb 28                	jmp    be0 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 bb8:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 bbf:	00 
 bc0:	8b 45 08             	mov    0x8(%ebp),%eax
 bc3:	89 04 24             	mov    %eax,(%esp)
 bc6:	e8 a9 fd ff ff       	call   974 <putc>
        putc(fd, c);
 ...
 bdb:	e8 94 fd ff ff       	call   974 <putc>
      }
      state = 0;
 ...
 bf6:	0f 85 77 fe ff ff    	jne    a73 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 c09:	83 e8 08             	sub    $0x8,%eax
 c0c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 c0f:	a1 50 12 00 00       	mov    0x1250,%eax
 c14:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c17:	eb 24                	jmp    c3d <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 c19:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c1c:	8b 00                	mov    (%eax),%eax
 c1e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c21:	77 12                	ja     c35 <free+0x35>
 c23:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c26:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c29:	77 24                	ja     c4f <free+0x4f>
 c2b:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c2e:	8b 00                	mov    (%eax),%eax
 c30:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c33:	77 1a                	ja     c4f <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 c3d:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c40:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c43:	76 d4                	jbe    c19 <free+0x19>
 c45:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c48:	8b 00                	mov    (%eax),%eax
 c4a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c4d:	76 ca                	jbe    c19 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
 c4f:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c52:	8b 40 04             	mov    0x4(%eax),%eax
 c55:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 c5c:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c5f:	01 c2                	add    %eax,%edx
 c61:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c64:	8b 00                	mov    (%eax),%eax
 c66:	39 c2                	cmp    %eax,%edx
 c68:	75 24                	jne    c8e <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
 c6a:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c6d:	8b 50 04             	mov    0x4(%eax),%edx
 ...
 ccb:	89 10                	mov    %edx,(%eax)
 ccd:	eb 08                	jmp    cd7 <free+0xd7>
  } else
    p->s.ptr = bp;
 ccf:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cd2:	8b 55 f8             	mov    -0x8(%ebp),%edx
 cd5:	89 10                	mov    %edx,(%eax)
  freep = p;
 cd7:	8b 45 fc             	mov    -0x4(%ebp),%eax
 cda:	a3 50 12 00 00       	mov    %eax,0x1250
}
 cdf:	c9                   	leave  
 ce0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 d00:	e8 9f fb ff ff       	call   8a4 <sbrk>
 d05:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 d08:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 d0c:	75 07                	jne    d15 <morecore+0x34>
    return 0;
 d0e:	b8 00 00 00 00       	mov    $0x0,%eax
 d13:	eb 22                	jmp    d37 <morecore+0x56>
  hp = (Header*)p;
 d15:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d18:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
 d1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d1e:	8b 55 08             	mov    0x8(%ebp),%edx
 d21:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
 d24:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d27:	83 c0 08             	add    $0x8,%eax
 d2a:	89 04 24             	mov    %eax,(%esp)
 d2d:	e8 ce fe ff ff       	call   c00 <free>
  return freep;
 d32:	a1 50 12 00 00       	mov    0x1250,%eax
}
 d37:	c9                   	leave  
 d38:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d3c:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 d3f:	8b 45 08             	mov    0x8(%ebp),%eax
 d42:	83 c0 07             	add    $0x7,%eax
 d45:	c1 e8 03             	shr    $0x3,%eax
 d48:	40                   	inc    %eax
 d49:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d4c:	a1 50 12 00 00       	mov    0x1250,%eax
 d51:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d54:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d58:	75 23                	jne    d7d <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d5a:	c7 45 f0 48 12 00 00 	movl   $0x1248,-0x10(%ebp)
 d61:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d64:	a3 50 12 00 00       	mov    %eax,0x1250
 d69:	a1 50 12 00 00       	mov    0x1250,%eax
 d6e:	a3 48 12 00 00       	mov    %eax,0x1248
    base.s.size = 0;
 d73:	c7 05 4c 12 00 00 00 	movl   $0x0,0x124c
 d7a:	00 00 00 
  }
 ...
 dc1:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 dc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dc7:	8b 55 ec             	mov    -0x14(%ebp),%edx
 dca:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 dcd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 dd0:	a3 50 12 00 00       	mov    %eax,0x1250
      return (void*)(p + 1);
 dd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dd8:	83 c0 08             	add    $0x8,%eax
 ddb:	eb 38                	jmp    e15 <malloc+0xdc>
    }
    if(p == freep)
 ddd:	a1 50 12 00 00       	mov    0x1250,%eax
 de2:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 de5:	75 1b                	jne    e02 <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
 de7:	8b 45 ec             	mov    -0x14(%ebp),%eax
 dea:	89 04 24             	mov    %eax,(%esp)
 ded:	e8 ef fe ff ff       	call   ce1 <morecore>
 df2:	89 45 f4             	mov    %eax,-0xc(%ebp)
 df5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 df9:	75 07                	jne    e02 <malloc+0xc9>
        return 0;
 dfb:	b8 00 00 00 00       	mov    $0x0,%eax
 e00:	eb 13                	jmp    e15 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 e10:	e9 70 ff ff ff       	jmp    d85 <malloc+0x4c>
}
 e15:	c9                   	leave  
 e16:	c3                   	ret    
