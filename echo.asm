...
main(int argc, char *argv[])
{
  ...
  1d:	b8 07 0e 00 00       	mov    $0xe07,%eax
  22:	eb 05                	jmp    29 <main+0x29>
  24:	b8 09 0e 00 00       	mov    $0xe09,%eax
  ...
  43:	c7 44 24 04 0b 0e 00 	movl   $0xe0b,0x4(%esp)
  4a:	00 
  4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  52:	e8 ea 09 00 00       	call   a41 <printf>
int
main(int argc, char *argv[])
{
  int i;
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
  ...
  ef:	c7 44 24 04 10 0e 00 	movl   $0xe10,0x4(%esp)
  f6:	00 
  f7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  fe:	e8 3e 09 00 00       	call   a41 <printf>
      exit();
 ...
 12b:	c7 44 24 04 2b 0e 00 	movl   $0xe2b,0x4(%esp)
 132:	00 
 133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 13a:	e8 02 09 00 00       	call   a41 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 3d9:	75 08                	jne    3e3 <strtok+0x15>
  s = lasts;
 3db:	a1 44 12 00 00       	mov    0x1244,%eax
 ...
 430:	a3 44 12 00 00       	mov    %eax,0x1244
    if (*lasts != 0)
 435:	a1 44 12 00 00       	mov    0x1244,%eax
 43a:	8a 00                	mov    (%eax),%al
 43c:	84 c0                	test   %al,%al
 43e:	74 11                	je     451 <strtok+0x83>
  *lasts++ = 0;
 440:	a1 44 12 00 00       	mov    0x1244,%eax
 445:	8d 50 01             	lea    0x1(%eax),%edx
 448:	89 15 44 12 00 00    	mov    %edx,0x1244
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 5ca:	eb 22                	jmp    5ee <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 5cc:	8a 86 e0 11 00 00    	mov    0x11e0(%esi),%al
 ...
 5ff:	eb 25                	jmp    626 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 601:	8a 86 e0 11 00 00    	mov    0x11e0(%esi),%al
...
00000944 <tostring>:
SYSCALL(tostring)
 944:	b8 27 00 00 00       	mov    $0x27,%eax
 949:	cd 40                	int    $0x40
 94b:	c3                   	ret    

0000094c <getactivefsindex>:
SYSCALL(getactivefsindex)
 94c:	b8 28 00 00 00       	mov    $0x28,%eax
 951:	cd 40                	int    $0x40
 953:	c3                   	ret    

00000954 <setatroot>:
SYSCALL(setatroot)
 954:	b8 2a 00 00 00       	mov    $0x2a,%eax
 959:	cd 40                	int    $0x40
 95b:	c3                   	ret    

0000095c <getatroot>:
SYSCALL(getatroot)
 95c:	b8 29 00 00 00       	mov    $0x29,%eax
 961:	cd 40                	int    $0x40
 963:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 96d:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
 970:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 977:	00 
 978:	8d 45 f4             	lea    -0xc(%ebp),%eax
 97b:	89 44 24 04          	mov    %eax,0x4(%esp)
 97f:	8b 45 08             	mov    0x8(%ebp),%eax
 982:	89 04 24             	mov    %eax,(%esp)
 985:	e8 b2 fe ff ff       	call   83c <write>
}
 98a:	c9                   	leave  
 98b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 991:	83 ec 30             	sub    $0x30,%esp
  ...
  neg = 0;
 994:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 99b:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 99f:	74 17                	je     9b8 <printint+0x2c>
 9a1:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 9a5:	79 11                	jns    9b8 <printint+0x2c>
    neg = 1;
 9a7:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 9ae:	8b 45 0c             	mov    0xc(%ebp),%eax
 9b1:	f7 d8                	neg    %eax
 9b3:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9b6:	eb 06                	jmp    9be <printint+0x32>
  } else {
    x = xx;
 9b8:	8b 45 0c             	mov    0xc(%ebp),%eax
 9bb:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }
 ...
 9dd:	8a 80 2c 12 00 00    	mov    0x122c(%eax),%al
 9e3:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 9e7:	8b 75 10             	mov    0x10(%ebp),%esi
 9ea:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9ed:	ba 00 00 00 00       	mov    $0x0,%edx
 9f2:	f7 f6                	div    %esi
 9f4:	89 45 ec             	mov    %eax,-0x14(%ebp)
 9f7:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 9fb:	75 c8                	jne    9c5 <printint+0x39>
  if(neg)
 9fd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a01:	74 10                	je     a13 <printint+0x87>
    buf[i++] = '-';
 a03:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a06:	8d 50 01             	lea    0x1(%eax),%edx
 a09:	89 55 f4             	mov    %edx,-0xc(%ebp)
 a0c:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 a11:	eb 1e                	jmp    a31 <printint+0xa5>
 a13:	eb 1c                	jmp    a31 <printint+0xa5>
    putc(fd, buf[i]);
 a15:	8d 55 dc             	lea    -0x24(%ebp),%edx
 a18:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a1b:	01 d0                	add    %edx,%eax
 a1d:	8a 00                	mov    (%eax),%al
 a1f:	0f be c0             	movsbl %al,%eax
 a22:	89 44 24 04          	mov    %eax,0x4(%esp)
 a26:	8b 45 08             	mov    0x8(%ebp),%eax
 a29:	89 04 24             	mov    %eax,(%esp)
 a2c:	e8 33 ff ff ff       	call   964 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
 a31:	ff 4d f4             	decl   -0xc(%ebp)
 a34:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a38:	79 db                	jns    a15 <printint+0x89>
    putc(fd, buf[i]);
}
 a3a:	83 c4 30             	add    $0x30,%esp
 a3d:	5b                   	pop    %ebx
 a3e:	5e                   	pop    %esi
 a3f:	5d                   	pop    %ebp
 a40:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 a44:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
 a47:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 a4e:	8d 45 0c             	lea    0xc(%ebp),%eax
 a51:	83 c0 04             	add    $0x4,%eax
 a54:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 a57:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 a5e:	e9 77 01 00 00       	jmp    bda <printf+0x199>
    c = fmt[i] & 0xff;
 a63:	8b 55 0c             	mov    0xc(%ebp),%edx
 a66:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a69:	01 d0                	add    %edx,%eax
 a6b:	8a 00                	mov    (%eax),%al
 a6d:	0f be c0             	movsbl %al,%eax
 a70:	25 ff 00 00 00       	and    $0xff,%eax
 a75:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 a78:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 a7c:	75 2c                	jne    aaa <printf+0x69>
      if(c == '%'){
 a7e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 a82:	75 0c                	jne    a90 <printf+0x4f>
        state = '%';
 a84:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 a8b:	e9 47 01 00 00       	jmp    bd7 <printf+0x196>
      } else {
        putc(fd, c);
 a90:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a93:	0f be c0             	movsbl %al,%eax
 a96:	89 44 24 04          	mov    %eax,0x4(%esp)
 a9a:	8b 45 08             	mov    0x8(%ebp),%eax
 a9d:	89 04 24             	mov    %eax,(%esp)
 aa0:	e8 bf fe ff ff       	call   964 <putc>
 aa5:	e9 2d 01 00 00       	jmp    bd7 <printf+0x196>
      }
    } else if(state == '%'){
 aaa:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 aae:	0f 85 23 01 00 00    	jne    bd7 <printf+0x196>
      if(c == 'd'){
 ab4:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 ab8:	75 2d                	jne    ae7 <printf+0xa6>
        printint(fd, *ap, 10, 1);
 aba:	8b 45 e8             	mov    -0x18(%ebp),%eax
 abd:	8b 00                	mov    (%eax),%eax
 abf:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 ac6:	00 
 ac7:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 ace:	00 
 acf:	89 44 24 04          	mov    %eax,0x4(%esp)
 ad3:	8b 45 08             	mov    0x8(%ebp),%eax
 ad6:	89 04 24             	mov    %eax,(%esp)
 ad9:	e8 ae fe ff ff       	call   98c <printint>
        ap++;
 ade:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 ae2:	e9 e9 00 00 00       	jmp    bd0 <printf+0x18f>
      } else if(c == 'x' || c == 'p'){
 ae7:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 aeb:	74 06                	je     af3 <printf+0xb2>
 aed:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 af1:	75 2d                	jne    b20 <printf+0xdf>
        printint(fd, *ap, 16, 0);
 af3:	8b 45 e8             	mov    -0x18(%ebp),%eax
 af6:	8b 00                	mov    (%eax),%eax
 af8:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 aff:	00 
 b00:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 b07:	00 
 b08:	89 44 24 04          	mov    %eax,0x4(%esp)
 b0c:	8b 45 08             	mov    0x8(%ebp),%eax
 b0f:	89 04 24             	mov    %eax,(%esp)
 b12:	e8 75 fe ff ff       	call   98c <printint>
        ap++;
 b17:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b1b:	e9 b0 00 00 00       	jmp    bd0 <printf+0x18f>
      } else if(c == 's'){
 b20:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 b24:	75 42                	jne    b68 <printf+0x127>
        s = (char*)*ap;
 b26:	8b 45 e8             	mov    -0x18(%ebp),%eax
 b29:	8b 00                	mov    (%eax),%eax
 b2b:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
 b2e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
 b32:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b36:	75 09                	jne    b41 <printf+0x100>
          s = "(null)";
 b38:	c7 45 f4 47 0e 00 00 	movl   $0xe47,-0xc(%ebp)
        while(*s != 0){
 b3f:	eb 1c                	jmp    b5d <printf+0x11c>
 b41:	eb 1a                	jmp    b5d <printf+0x11c>
          putc(fd, *s);
 b43:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b46:	8a 00                	mov    (%eax),%al
 b48:	0f be c0             	movsbl %al,%eax
 b4b:	89 44 24 04          	mov    %eax,0x4(%esp)
 b4f:	8b 45 08             	mov    0x8(%ebp),%eax
 b52:	89 04 24             	mov    %eax,(%esp)
 b55:	e8 0a fe ff ff       	call   964 <putc>
          s++;
 b5a:	ff 45 f4             	incl   -0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 b60:	8a 00                	mov    (%eax),%al
 b62:	84 c0                	test   %al,%al
 b64:	75 dd                	jne    b43 <printf+0x102>
 b66:	eb 68                	jmp    bd0 <printf+0x18f>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 b68:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 b6c:	75 1d                	jne    b8b <printf+0x14a>
        putc(fd, *ap);
 ...
 b80:	e8 df fd ff ff       	call   964 <putc>
        ap++;
 b85:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 b89:	eb 45                	jmp    bd0 <printf+0x18f>
      } else if(c == '%'){
 b8b:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 b8f:	75 17                	jne    ba8 <printf+0x167>
        putc(fd, c);
 b91:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 b94:	0f be c0             	movsbl %al,%eax
 b97:	89 44 24 04          	mov    %eax,0x4(%esp)
 b9b:	8b 45 08             	mov    0x8(%ebp),%eax
 b9e:	89 04 24             	mov    %eax,(%esp)
 ba1:	e8 be fd ff ff       	call   964 <putc>
 ba6:	eb 28                	jmp    bd0 <printf+0x18f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 ba8:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 baf:	00 
 bb0:	8b 45 08             	mov    0x8(%ebp),%eax
 bb3:	89 04 24             	mov    %eax,(%esp)
 bb6:	e8 a9 fd ff ff       	call   964 <putc>
        putc(fd, c);
 bbb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 bbe:	0f be c0             	movsbl %al,%eax
 bc1:	89 44 24 04          	mov    %eax,0x4(%esp)
 bc5:	8b 45 08             	mov    0x8(%ebp),%eax
 bc8:	89 04 24             	mov    %eax,(%esp)
 bcb:	e8 94 fd ff ff       	call   964 <putc>
      }
      state = 0;
 bd0:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 bd7:	ff 45 f0             	incl   -0x10(%ebp)
 bda:	8b 55 0c             	mov    0xc(%ebp),%edx
 bdd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 be0:	01 d0                	add    %edx,%eax
 be2:	8a 00                	mov    (%eax),%al
 be4:	84 c0                	test   %al,%al
 be6:	0f 85 77 fe ff ff    	jne    a63 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 bf9:	83 e8 08             	sub    $0x8,%eax
 bfc:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 bff:	a1 50 12 00 00       	mov    0x1250,%eax
 c04:	89 45 fc             	mov    %eax,-0x4(%ebp)
 c07:	eb 24                	jmp    c2d <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 c09:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c0c:	8b 00                	mov    (%eax),%eax
 c0e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c11:	77 12                	ja     c25 <free+0x35>
 c13:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c16:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c19:	77 24                	ja     c3f <free+0x4f>
 c1b:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c1e:	8b 00                	mov    (%eax),%eax
 c20:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c23:	77 1a                	ja     c3f <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
 ...
 c30:	3b 45 fc             	cmp    -0x4(%ebp),%eax
 c33:	76 d4                	jbe    c09 <free+0x19>
 c35:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c38:	8b 00                	mov    (%eax),%eax
 c3a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
 c3d:	76 ca                	jbe    c09 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
 c3f:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c42:	8b 40 04             	mov    0x4(%eax),%eax
 c45:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
 c4c:	8b 45 f8             	mov    -0x8(%ebp),%eax
 c4f:	01 c2                	add    %eax,%edx
 c51:	8b 45 fc             	mov    -0x4(%ebp),%eax
 c54:	8b 00                	mov    (%eax),%eax
 c56:	39 c2                	cmp    %eax,%edx
 c58:	75 24                	jne    c7e <free+0x8e>
 ...
 cca:	a3 50 12 00 00       	mov    %eax,0x1250
}
 ccf:	c9                   	leave  
 cd0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 cd4:	83 ec 28             	sub    $0x28,%esp
  ...
  if(nu < 4096)
 cd7:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 cde:	77 07                	ja     ce7 <morecore+0x16>
    nu = 4096;
 ce0:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 ce7:	8b 45 08             	mov    0x8(%ebp),%eax
 cea:	c1 e0 03             	shl    $0x3,%eax
 ced:	89 04 24             	mov    %eax,(%esp)
 cf0:	e8 af fb ff ff       	call   8a4 <sbrk>
 cf5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 cf8:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 cfc:	75 07                	jne    d05 <morecore+0x34>
    return 0;
 cfe:	b8 00 00 00 00       	mov    $0x0,%eax
 d03:	eb 22                	jmp    d27 <morecore+0x56>
  hp = (Header*)p;
 d05:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d08:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
 d0b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d0e:	8b 55 08             	mov    0x8(%ebp),%edx
 d11:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
 d14:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d17:	83 c0 08             	add    $0x8,%eax
 d1a:	89 04 24             	mov    %eax,(%esp)
 d1d:	e8 ce fe ff ff       	call   bf0 <free>
  return freep;
 d22:	a1 50 12 00 00       	mov    0x1250,%eax
}
 d27:	c9                   	leave  
 d28:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 d2c:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 d2f:	8b 45 08             	mov    0x8(%ebp),%eax
 d32:	83 c0 07             	add    $0x7,%eax
 d35:	c1 e8 03             	shr    $0x3,%eax
 d38:	40                   	inc    %eax
 d39:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 d3c:	a1 50 12 00 00       	mov    0x1250,%eax
 d41:	89 45 f0             	mov    %eax,-0x10(%ebp)
 d44:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 d48:	75 23                	jne    d6d <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 d4a:	c7 45 f0 48 12 00 00 	movl   $0x1248,-0x10(%ebp)
 d51:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d54:	a3 50 12 00 00       	mov    %eax,0x1250
 d59:	a1 50 12 00 00       	mov    0x1250,%eax
 d5e:	a3 48 12 00 00       	mov    %eax,0x1248
    base.s.size = 0;
 d63:	c7 05 4c 12 00 00 00 	movl   $0x0,0x124c
 d6a:	00 00 00 
  }
 ...
 d7b:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 d7e:	72 4d                	jb     dcd <malloc+0xa4>
      if(p->s.size == nunits)
 d80:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d83:	8b 40 04             	mov    0x4(%eax),%eax
 d86:	3b 45 ec             	cmp    -0x14(%ebp),%eax
 d89:	75 0c                	jne    d97 <malloc+0x6e>
        prevp->s.ptr = p->s.ptr;
 d8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d8e:	8b 10                	mov    (%eax),%edx
 d90:	8b 45 f0             	mov    -0x10(%ebp),%eax
 d93:	89 10                	mov    %edx,(%eax)
 d95:	eb 26                	jmp    dbd <malloc+0x94>
      else {
        p->s.size -= nunits;
 d97:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d9a:	8b 40 04             	mov    0x4(%eax),%eax
 d9d:	2b 45 ec             	sub    -0x14(%ebp),%eax
 da0:	89 c2                	mov    %eax,%edx
 da2:	8b 45 f4             	mov    -0xc(%ebp),%eax
 da5:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 da8:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dab:	8b 40 04             	mov    0x4(%eax),%eax
 dae:	c1 e0 03             	shl    $0x3,%eax
 db1:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 db4:	8b 45 f4             	mov    -0xc(%ebp),%eax
 db7:	8b 55 ec             	mov    -0x14(%ebp),%edx
 dba:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 dbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 dc0:	a3 50 12 00 00       	mov    %eax,0x1250
      return (void*)(p + 1);
 dc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dc8:	83 c0 08             	add    $0x8,%eax
 dcb:	eb 38                	jmp    e05 <malloc+0xdc>
    }
    if(p == freep)
 dcd:	a1 50 12 00 00       	mov    0x1250,%eax
 dd2:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 dd5:	75 1b                	jne    df2 <malloc+0xc9>
      if((p = morecore(nunits)) == 0)
 dd7:	8b 45 ec             	mov    -0x14(%ebp),%eax
 dda:	89 04 24             	mov    %eax,(%esp)
 ddd:	e8 ef fe ff ff       	call   cd1 <morecore>
 de2:	89 45 f4             	mov    %eax,-0xc(%ebp)
 de5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 de9:	75 07                	jne    df2 <malloc+0xc9>
        return 0;
 deb:	b8 00 00 00 00       	mov    $0x0,%eax
 df0:	eb 13                	jmp    e05 <malloc+0xdc>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 e00:	e9 70 ff ff ff       	jmp    d75 <malloc+0x4c>
}
 e05:	c9                   	leave  
 e06:	c3                   	ret    
