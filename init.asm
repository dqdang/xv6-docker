...
create_vcs(void)
{
  ...
  int i, fd;
  char *dname = "vc0";
   6:	c7 45 f0 2a 0f 00 00 	movl   $0xf2a,-0x10(%ebp)
...
main(void)
{
  ...
  86:	00 
  87:	c7 04 24 2e 0f 00 00 	movl   $0xf2e,(%esp)
  ...
  a6:	00 
  a7:	c7 04 24 2e 0f 00 00 	movl   $0xf2e,(%esp)
  ae:	e8 d1 08 00 00       	call   984 <mknod>
    open("console", O_RDWR);
  b3:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  ba:	00 
  bb:	c7 04 24 2e 0f 00 00 	movl   $0xf2e,(%esp)
  ...
  e4:	c7 44 24 04 36 0f 00 	movl   $0xf36,0x4(%esp)
  eb:	00 
  ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f3:	e8 69 0a 00 00       	call   b61 <printf>
    pid = fork();
 ...
 108:	c7 44 24 04 49 0f 00 	movl   $0xf49,0x4(%esp)
 10f:	00 
 110:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 117:	e8 45 0a 00 00       	call   b61 <printf>
      exit();
 ...
 126:	75 2d                	jne    155 <main+0xdf>
      exec("sh", argv);
 128:	c7 44 24 04 60 13 00 	movl   $0x1360,0x4(%esp)
 12f:	00 
 130:	c7 04 24 27 0f 00 00 	movl   $0xf27,(%esp)
 137:	e8 38 08 00 00       	call   974 <exec>
      printf(1, "init: exec sh failed\n");
 13c:	c7 44 24 04 5c 0f 00 	movl   $0xf5c,0x4(%esp)
 143:	00 
 144:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 14b:	e8 11 0a 00 00       	call   b61 <printf>
      exit();
 ...
 155:	eb 14                	jmp    16b <main+0xf5>
      printf(1, "zombie!\n");
 157:	c7 44 24 04 72 0f 00 	movl   $0xf72,0x4(%esp)
 15e:	00 
 15f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 166:	e8 f6 09 00 00       	call   b61 <printf>
    if(pid == 0){
      exec("sh", argv);
      printf(1, "init: exec sh failed\n");
      exit();
...
copy(char *inputfile, char *outputfile, int used_disk, int max_disk)
{
 ...
 20f:	c7 44 24 04 7b 0f 00 	movl   $0xf7b,0x4(%esp)
 216:	00 
 217:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 21e:	e8 3e 09 00 00       	call   b61 <printf>
      exit();
 ...
 24b:	c7 44 24 04 96 0f 00 	movl   $0xf96,0x4(%esp)
 252:	00 
 253:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 25a:	e8 02 09 00 00       	call   b61 <printf>
      exit();
...
strtok(char *s, const char *delim)
{
 ...
 4f9:	75 08                	jne    503 <strtok+0x15>
  s = lasts;
 4fb:	a1 e4 13 00 00       	mov    0x13e4,%eax
 ...
 550:	a3 e4 13 00 00       	mov    %eax,0x13e4
    if (*lasts != 0)
 555:	a1 e4 13 00 00       	mov    0x13e4,%eax
 55a:	8a 00                	mov    (%eax),%al
 55c:	84 c0                	test   %al,%al
 55e:	74 11                	je     571 <strtok+0x83>
  *lasts++ = 0;
 560:	a1 e4 13 00 00       	mov    0x13e4,%eax
 565:	8d 50 01             	lea    0x1(%eax),%edx
 568:	89 15 e4 13 00 00    	mov    %edx,0x13e4
...
strtoul(char *string, char **endPtr, int base)
{
 ...
 6ea:	eb 22                	jmp    70e <strtoul+0x113>
      ...
      digit = cvtIn[digit];
 6ec:	8a 86 80 13 00 00    	mov    0x1380(%esi),%al
 ...
 71f:	eb 25                	jmp    746 <strtoul+0x14b>
      ...
      digit = cvtIn[digit];
 721:	8a 86 80 13 00 00    	mov    0x1380(%esi),%al
...
putc(int fd, char c)
{
 ...
 aa5:	e8 b2 fe ff ff       	call   95c <write>
}
 aaa:	c9                   	leave  
 aab:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 afd:	8a 80 cc 13 00 00    	mov    0x13cc(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 c56:	75 09                	jne    c61 <printf+0x100>
          s = "(null)";
 c58:	c7 45 f4 b2 0f 00 00 	movl   $0xfb2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 d1f:	a1 f0 13 00 00       	mov    0x13f0,%eax
...
free(void *ap)
{
 ...
 dea:	a3 f0 13 00 00       	mov    %eax,0x13f0
}
 def:	c9                   	leave  
 df0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 e10:	e8 af fb ff ff       	call   9c4 <sbrk>
 ...
 e3d:	e8 ce fe ff ff       	call   d10 <free>
  return freep;
 e42:	a1 f0 13 00 00       	mov    0x13f0,%eax
}
 e47:	c9                   	leave  
 e48:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 e59:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 e5c:	a1 f0 13 00 00       	mov    0x13f0,%eax
 e61:	89 45 f0             	mov    %eax,-0x10(%ebp)
 e64:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 e68:	75 23                	jne    e8d <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 e6a:	c7 45 f0 e8 13 00 00 	movl   $0x13e8,-0x10(%ebp)
 e71:	8b 45 f0             	mov    -0x10(%ebp),%eax
 e74:	a3 f0 13 00 00       	mov    %eax,0x13f0
 e79:	a1 f0 13 00 00       	mov    0x13f0,%eax
 e7e:	a3 e8 13 00 00       	mov    %eax,0x13e8
    base.s.size = 0;
 e83:	c7 05 ec 13 00 00 00 	movl   $0x0,0x13ec
 e8a:	00 00 00 
  }
 ...
 ee0:	a3 f0 13 00 00       	mov    %eax,0x13f0
      return (void*)(p + 1);
 ...
 eeb:	eb 38                	jmp    f25 <malloc+0xdc>
    ...
    if(p == freep)
 eed:	a1 f0 13 00 00       	mov    0x13f0,%eax
